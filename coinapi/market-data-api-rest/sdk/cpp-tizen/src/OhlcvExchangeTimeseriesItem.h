/*
 * Ohlcv.ExchangeTimeseriesItem.h
 *
 * Represents a timeseries item with price and volume information.
 */

#ifndef _Ohlcv.ExchangeTimeseriesItem_H_
#define _Ohlcv.ExchangeTimeseriesItem_H_
...
class Ohlcv.ExchangeTimeseriesItem : public Object {
public:
	/*! \brief Constructor.
	 */
	Ohlcv.ExchangeTimeseriesItem();
	Ohlcv.ExchangeTimeseriesItem(char* str);

	/*! \brief Destructor.
	 */
	virtual ~Ohlcv.ExchangeTimeseriesItem();
...
#endif /* _Ohlcv.ExchangeTimeseriesItem_H_ */
