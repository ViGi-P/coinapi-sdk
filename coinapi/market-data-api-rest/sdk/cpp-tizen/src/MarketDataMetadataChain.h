/*
 * MarketDataMetadata.Chain.h
 *
 * Represents a blockchain chain.
 */

#ifndef _MarketDataMetadata.Chain_H_
#define _MarketDataMetadata.Chain_H_
...
class MarketDataMetadata.Chain : public Object {
public:
	/*! \brief Constructor.
	 */
	MarketDataMetadata.Chain();
	MarketDataMetadata.Chain(char* str);

	/*! \brief Destructor.
	 */
	virtual ~MarketDataMetadata.Chain();
...
#endif /* _MarketDataMetadata.Chain_H_ */
