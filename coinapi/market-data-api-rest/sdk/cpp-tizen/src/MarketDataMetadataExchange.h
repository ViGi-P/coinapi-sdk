/*
 * MarketDataMetadata.Exchange.h
 *
 * Represents an exchange.
 */

#ifndef _MarketDataMetadata.Exchange_H_
#define _MarketDataMetadata.Exchange_H_
...
class MarketDataMetadata.Exchange : public Object {
public:
	/*! \brief Constructor.
	 */
	MarketDataMetadata.Exchange();
	MarketDataMetadata.Exchange(char* str);

	/*! \brief Destructor.
	 */
	virtual ~MarketDataMetadata.Exchange();
	 ...
	 */
	std::list<MarketDataMetadata.Icon> getIcons();

	/*! \brief Set Gets or sets the list of icons for the exchange.
	 */
	void setIcons(std::list <MarketDataMetadata.Icon> icons);
...
private:
	...
	std::list <MarketDataMetadata.Icon>icons;
	double rank;
...
#endif /* _MarketDataMetadata.Exchange_H_ */
