...
MarketDataMetadata.Exchange::MarketDataMetadata.Exchange()
{
	//__init();
}
...
void
MarketDataMetadata.Exchange::__init()
{
...
void
MarketDataMetadata.Exchange::__cleanup()
{
	//if(exchange_id != NULL) {
	//
	//delete exchange_id;
...
void
MarketDataMetadata.Exchange::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
	
		{
			JsonArray* arr = json_node_get_array(node);
			JsonNode*  temp_json;
			list<MarketDataMetadata.Icon> new_list;
			MarketDataMetadata.Icon inst;
			for (guint i=0;i<json_array_get_length(arr);i++) {
				temp_json = json_array_get_element(arr,i);
				if (isprimitive("MarketDataMetadata.Icon")) {
					jsonToValue(&inst, temp_json, "MarketDataMetadata.Icon", "");
				} else {
...
MarketDataMetadata.Exchange::MarketDataMetadata.Exchange(char* json)
{
	this->fromJson(json);
}

char*
MarketDataMetadata.Exchange::toJson()
{
	...
	if (isprimitive("MarketDataMetadata.Icon")) {
		list<MarketDataMetadata.Icon> new_list = static_cast<list <MarketDataMetadata.Icon> > (getIcons());
		node = converttoJson(&new_list, "MarketDataMetadata.Icon", "array");
	} else {
		node = json_node_alloc();
		list<MarketDataMetadata.Icon> new_list = static_cast<list <MarketDataMetadata.Icon> > (getIcons());
		JsonArray* json_array = json_array_new();
		...
		for (list<MarketDataMetadata.Icon>::iterator it = new_list.begin(); it != new_list.end(); it++) {
			mygerror = NULL;
			MarketDataMetadata.Icon obj = *it;
...
std::string
MarketDataMetadata.Exchange::getExchangeId()
{
	return exchange_id;
}

void
MarketDataMetadata.Exchange::setExchangeId(std::string  exchange_id)
{
	this->exchange_id = exchange_id;
}

std::string
MarketDataMetadata.Exchange::getWebsite()
{
	return website;
}

void
MarketDataMetadata.Exchange::setWebsite(std::string  website)
{
	this->website = website;
}

std::string
MarketDataMetadata.Exchange::getName()
{
	return name;
}

void
MarketDataMetadata.Exchange::setName(std::string  name)
{
	this->name = name;
}

std::string
MarketDataMetadata.Exchange::getDataStart()
{
	return data_start;
}

void
MarketDataMetadata.Exchange::setDataStart(std::string  data_start)
{
	this->data_start = data_start;
}

std::string
MarketDataMetadata.Exchange::getDataEnd()
{
	return data_end;
}

void
MarketDataMetadata.Exchange::setDataEnd(std::string  data_end)
{
	this->data_end = data_end;
}

std::string
MarketDataMetadata.Exchange::getDataQuoteStart()
{
	return data_quote_start;
}

void
MarketDataMetadata.Exchange::setDataQuoteStart(std::string  data_quote_start)
{
	this->data_quote_start = data_quote_start;
}

std::string
MarketDataMetadata.Exchange::getDataQuoteEnd()
{
	return data_quote_end;
}

void
MarketDataMetadata.Exchange::setDataQuoteEnd(std::string  data_quote_end)
{
	this->data_quote_end = data_quote_end;
}

std::string
MarketDataMetadata.Exchange::getDataOrderbookStart()
{
	return data_orderbook_start;
}

void
MarketDataMetadata.Exchange::setDataOrderbookStart(std::string  data_orderbook_start)
{
	this->data_orderbook_start = data_orderbook_start;
}

std::string
MarketDataMetadata.Exchange::getDataOrderbookEnd()
{
	return data_orderbook_end;
}

void
MarketDataMetadata.Exchange::setDataOrderbookEnd(std::string  data_orderbook_end)
{
	this->data_orderbook_end = data_orderbook_end;
}

std::string
MarketDataMetadata.Exchange::getDataTradeStart()
{
	return data_trade_start;
}

void
MarketDataMetadata.Exchange::setDataTradeStart(std::string  data_trade_start)
{
	this->data_trade_start = data_trade_start;
}

std::string
MarketDataMetadata.Exchange::getDataTradeEnd()
{
	return data_trade_end;
}

void
MarketDataMetadata.Exchange::setDataTradeEnd(std::string  data_trade_end)
{
	this->data_trade_end = data_trade_end;
}

long long
MarketDataMetadata.Exchange::getDataTradeCount()
{
	return data_trade_count;
}

void
MarketDataMetadata.Exchange::setDataTradeCount(long long  data_trade_count)
{
	this->data_trade_count = data_trade_count;
}

long long
MarketDataMetadata.Exchange::getDataSymbolsCount()
{
	return data_symbols_count;
}

void
MarketDataMetadata.Exchange::setDataSymbolsCount(long long  data_symbols_count)
{
	this->data_symbols_count = data_symbols_count;
}

double
MarketDataMetadata.Exchange::getVolume1hrsUsd()
{
	return volume_1hrs_usd;
}

void
MarketDataMetadata.Exchange::setVolume1hrsUsd(double  volume_1hrs_usd)
{
	this->volume_1hrs_usd = volume_1hrs_usd;
}

double
MarketDataMetadata.Exchange::getVolume1dayUsd()
{
	return volume_1day_usd;
}

void
MarketDataMetadata.Exchange::setVolume1dayUsd(double  volume_1day_usd)
{
	this->volume_1day_usd = volume_1day_usd;
}

double
MarketDataMetadata.Exchange::getVolume1mthUsd()
{
	return volume_1mth_usd;
}

void
MarketDataMetadata.Exchange::setVolume1mthUsd(double  volume_1mth_usd)
{
	this->volume_1mth_usd = volume_1mth_usd;
}

std::list<std::string>
MarketDataMetadata.Exchange::getMetricId()
{
	return metric_id;
}

void
MarketDataMetadata.Exchange::setMetricId(std::list <std::string> metric_id)
{
	this->metric_id = metric_id;
}

std::list<MarketDataMetadata.Icon>
MarketDataMetadata.Exchange::getIcons()
{
	return icons;
}

void
MarketDataMetadata.Exchange::setIcons(std::list <MarketDataMetadata.Icon> icons)
{
	this->icons = icons;
}

double
MarketDataMetadata.Exchange::getRank()
{
	return rank;
}

void
MarketDataMetadata.Exchange::setRank(double  rank)
{
	this->rank = rank;
}

std::string
MarketDataMetadata.Exchange::getIntegrationStatus()
{
	return integration_status;
}

void
MarketDataMetadata.Exchange::setIntegrationStatus(std::string  integration_status)
{
