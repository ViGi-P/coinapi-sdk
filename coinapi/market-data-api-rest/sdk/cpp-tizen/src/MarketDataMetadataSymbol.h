/*
 * MarketDataMetadata.Symbol.h
 *
 * Represents a symbol data model.
 */

#ifndef _MarketDataMetadata.Symbol_H_
#define _MarketDataMetadata.Symbol_H_
...
class MarketDataMetadata.Symbol : public Object {
public:
	/*! \brief Constructor.
	 */
	MarketDataMetadata.Symbol();
	MarketDataMetadata.Symbol(char* str);

	/*! \brief Destructor.
	 */
	virtual ~MarketDataMetadata.Symbol();
...
#endif /* _MarketDataMetadata.Symbol_H_ */
