/*
 * MarketDataMetadata.Asset.h
 *
 * Represents an asset.
 */

#ifndef _MarketDataMetadata.Asset_H_
#define _MarketDataMetadata.Asset_H_
...
class MarketDataMetadata.Asset : public Object {
public:
	/*! \brief Constructor.
	 */
	MarketDataMetadata.Asset();
	MarketDataMetadata.Asset(char* str);

	/*! \brief Destructor.
	 */
	virtual ~MarketDataMetadata.Asset();
...
#endif /* _MarketDataMetadata.Asset_H_ */
