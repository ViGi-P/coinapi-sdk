...
void
V1.Strike::fromJson(char* jsonStr)
{
...
double
V1.Strike::getStrikePrice()
{
	return strike_price;
}

void
V1.Strike::setStrikePrice(double  strike_price)
{
...
void
V1.Strike::setCall(V1.QuoteTrade  call)
{
	this->call = call;
}
...
void
V1.Strike::setPut(V1.QuoteTrade  put)
{
	this->put = put;
}
