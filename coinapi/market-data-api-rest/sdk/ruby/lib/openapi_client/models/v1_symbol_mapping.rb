  ...
  class V1SymbolMapping
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::V1SymbolMapping` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::V1SymbolMapping`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'coinapi_datainfo_id')
        self.coinapi_datainfo_id = attributes[:'coinapi_datainfo_id']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          coinapi_datainfo_id == o.coinapi_datainfo_id &&
    ...
    def hash
      [symbol_id, symbol_id_exchange, coinapi_datainfo_id, asset_id_base_exchange, asset_id_quote_exchange, asset_id_base, asset_id_quote, price_precision, size_precision].hash
    end
