...
> <Array<OhlcvExchangeTimeseriesItem>> v1_ohlcv_exchanges_exchange_id_history_get(exchange_id, period_id, time_start, time_end)
...
> <Array(<Array<OhlcvExchangeTimeseriesItem>>, Integer, Hash)> v1_ohlcv_exchanges_exchange_id_history_get_with_http_info(exchange_id, period_id, time_start, time_end)
