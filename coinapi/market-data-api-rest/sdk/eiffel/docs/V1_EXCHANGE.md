...
**data_start** | [**STRING_32**](STRING_32.md) | Gets the start date of the exchange&#39;s data. | [optional] [readonly] [default to null]
**data_end** | [**STRING_32**](STRING_32.md) | Gets the end date of the exchange&#39;s data. | [optional] [readonly] [default to null]
...
**rank** | **REAL_64** | Rank of the exchange - higher rank means exchange is more reliable | [optional] [default to null]
