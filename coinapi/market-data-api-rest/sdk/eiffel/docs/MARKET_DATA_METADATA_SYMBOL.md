...
**option_exercise_style** | [**STRING_32**](STRING_32.md) | The exercise style for options. Possible values: AMERICAN, ASIAN, BARRIER, BERMUDAN, BINARY, EUROPEAN, EXOTIC. | [optional] [default to null]
...
**future_is_inverse** | **BOOLEAN** | Indicates whether the futures contract is inverse (coin-margined). | [optional] [default to null]
**future_is_quanto** | **BOOLEAN** | Indicates whether the futures contract is quanto. | [optional] [default to null]
**volume_to_usd** | **REAL_64** | Volume unit in USD. | [optional] [default to null]
**option_barrier_up_price** | **REAL_64** | The up barrier price for barrier options. | [optional] [default to null]
**option_barrier_up_type** | [**STRING_32**](STRING_32.md) | The up barrier type for barrier options. Possible values: EXPIRATION, IN, OUT. | [optional] [default to null]
**option_barrier_down_price** | **REAL_64** | The down barrier price for barrier options. | [optional] [default to null]
**option_barrier_down_type** | [**STRING_32**](STRING_32.md) | The down barrier type for barrier options. Possible values: EXPIRATION, IN, OUT. | [optional] [default to null]
**symbol_id_int** | **INTEGER_32** | The symbol identifier in integer immutable format, used to correlate data across different APIs. | [optional] [readonly] [default to null]
