...
**icons** | [**LIST [MARKET_DATA_METADATA_ICON]**](MarketDataMetadata.Icon.md) | Gets or sets the list of icons for the exchange. | [optional] [readonly] [default to null]
