...
class MARKET_DATA_METADATA_SYMBOL
...
feature -- Change Element
    ...
    set_future_is_inverse (a_name: like future_is_inverse)
        -- Set 'future_is_inverse' with 'a_name'.
      do
        future_is_inverse := a_name
      ensure
        future_is_inverse_set: future_is_inverse = a_name
      end

    set_future_is_quanto (a_name: like future_is_quanto)
        -- Set 'future_is_quanto' with 'a_name'.
      do
        future_is_quanto := a_name
      ensure
        future_is_quanto_set: future_is_quanto = a_name
      end
    ...
    set_option_barrier_up_price (a_name: like option_barrier_up_price)
        -- Set 'option_barrier_up_price' with 'a_name'.
      do
        option_barrier_up_price := a_name
      ensure
        option_barrier_up_price_set: option_barrier_up_price = a_name
      end

    set_option_barrier_up_type (a_name: like option_barrier_up_type)
        -- Set 'option_barrier_up_type' with 'a_name'.
      do
        option_barrier_up_type := a_name
      ensure
        option_barrier_up_type_set: option_barrier_up_type = a_name
      end

    set_option_barrier_down_price (a_name: like option_barrier_down_price)
        -- Set 'option_barrier_down_price' with 'a_name'.
      do
        option_barrier_down_price := a_name
      ensure
        option_barrier_down_price_set: option_barrier_down_price = a_name
      end

    set_option_barrier_down_type (a_name: like option_barrier_down_type)
        -- Set 'option_barrier_down_type' with 'a_name'.
      do
        option_barrier_down_type := a_name
      ensure
        option_barrier_down_type_set: option_barrier_down_type = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass MARKET_DATA_METADATA_SYMBOL%N")
        ...
        if attached future_is_inverse as l_future_is_inverse then
          Result.append ("%Nfuture_is_inverse:")
          Result.append (l_future_is_inverse.out)
          Result.append ("%N")
        end
        if attached future_is_quanto as l_future_is_quanto then
          Result.append ("%Nfuture_is_quanto:")
          Result.append (l_future_is_quanto.out)
          Result.append ("%N")
        end
        ...
        if attached option_barrier_up_price as l_option_barrier_up_price then
          Result.append ("%Noption_barrier_up_price:")
          Result.append (l_option_barrier_up_price.out)
          Result.append ("%N")
        end
        if attached option_barrier_up_type as l_option_barrier_up_type then
          Result.append ("%Noption_barrier_up_type:")
          Result.append (l_option_barrier_up_type.out)
          Result.append ("%N")
        end
        if attached option_barrier_down_price as l_option_barrier_down_price then
          Result.append ("%Noption_barrier_down_price:")
          Result.append (l_option_barrier_down_price.out)
          Result.append ("%N")
        end
        if attached option_barrier_down_type as l_option_barrier_down_type then
          Result.append ("%Noption_barrier_down_type:")
          Result.append (l_option_barrier_down_type.out)
          Result.append ("%N")
        end
