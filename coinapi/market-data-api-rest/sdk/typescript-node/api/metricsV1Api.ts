...
export enum MetricsV1ApiApiKeys {
    APIKey,
}

export class MetricsV1Api {
    ...
    public setApiKey(key: MetricsV1ApiApiKeys, value: string) {
        (this.authentications as any)[MetricsV1ApiApiKeys[key]].apiKey = value;
    }
