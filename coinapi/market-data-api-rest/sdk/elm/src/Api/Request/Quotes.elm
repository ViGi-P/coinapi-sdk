...
-}
v1QuotesSymbolIdCurrentGet : String -> String -> Api.Request Api.Data.V1QuoteTrade
v1QuotesSymbolIdCurrentGet symbolId_path auth_token =
    Api.request
        "GET"
...
-}
v1QuotesSymbolIdHistoryGet : String -> Maybe String -> Maybe String -> Maybe String -> Maybe Int -> String -> Api.Request (List Api.Data.V1Quote)
v1QuotesSymbolIdHistoryGet symbolId_path date_query timeStart_query timeEnd_query limit_query auth_token =
    Api.request
        "GET"
...
-}
v1QuotesSymbolIdLatestGet : String -> Maybe Int -> String -> Api.Request (List Api.Data.V1Quote)
v1QuotesSymbolIdLatestGet symbolId_path limit_query auth_token =
    Api.request
        "GET"
