...
%% 
-spec v1_chains_chain_id_get(ctx:ctx(), binary()) -> {ok, [openapi_v1_chain:openapi_v1_chain()], openapi_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), openapi_utils:response_info()}.
v1_chains_chain_id_get(Ctx, ChainId) ->
    v1_chains_chain_id_get(Ctx, ChainId, #{}).

-spec v1_chains_chain_id_get(ctx:ctx(), binary(), maps:map()) -> {ok, [openapi_v1_chain:openapi_v1_chain()], openapi_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), openapi_utils:response_info()}.
...
-spec v1_chains_get(ctx:ctx()) -> {ok, [openapi_v1_chain:openapi_v1_chain()], openapi_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), openapi_utils:response_info()}.
v1_chains_get(Ctx) ->
    v1_chains_get(Ctx, #{}).

-spec v1_chains_get(ctx:ctx(), maps:map()) -> {ok, [openapi_v1_chain:openapi_v1_chain()], openapi_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), openapi_utils:response_info()}.
...
-spec v1_symbols_exchange_id_active_get(ctx:ctx(), binary()) -> {ok, [openapi_v1_symbol:openapi_v1_symbol()], openapi_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), openapi_utils:response_info()}.
v1_symbols_exchange_id_active_get(Ctx, ExchangeId) ->
    v1_symbols_exchange_id_active_get(Ctx, ExchangeId, #{}).

-spec v1_symbols_exchange_id_active_get(ctx:ctx(), binary(), maps:map()) -> {ok, [openapi_v1_symbol:openapi_v1_symbol()], openapi_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), openapi_utils:response_info()}.
