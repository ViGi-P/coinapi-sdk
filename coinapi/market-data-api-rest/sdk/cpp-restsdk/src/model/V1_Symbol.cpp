...
bool V1_Symbol::isFutureIsInverse() const
{
    return m_Future_is_inverse.get();
}

void V1_Symbol::setFutureIsInverse(bool value)
{
    m_Future_is_inverse = value;
}

bool V1_Symbol::futureIsInverseIsSet() const
{
    return m_Future_is_inverse.has_value();
}

void V1_Symbol::unsetFuture_is_inverse()
{
    m_Future_is_inverse.reset();
}
bool V1_Symbol::isFutureIsQuanto() const
{
    return m_Future_is_quanto.get();
}

void V1_Symbol::setFutureIsQuanto(bool value)
{
    m_Future_is_quanto = value;
}

bool V1_Symbol::futureIsQuantoIsSet() const
{
    return m_Future_is_quanto.has_value();
}

void V1_Symbol::unsetFuture_is_quanto()
{
...
double V1_Symbol::getOptionBarrierUpPrice() const
{
    return m_Option_barrier_up_price.get();
}

void V1_Symbol::setOptionBarrierUpPrice(double value)
{
    m_Option_barrier_up_price = value;
}

bool V1_Symbol::optionBarrierUpPriceIsSet() const
{
    return m_Option_barrier_up_price.has_value();
}

void V1_Symbol::unsetOption_barrier_up_price()
{
    m_Option_barrier_up_price.reset();
}
utility::string_t V1_Symbol::getOptionBarrierUpType() const
{
    return m_Option_barrier_up_type.get();
}


void V1_Symbol::setOptionBarrierUpType(const utility::string_t& value)
{
    m_Option_barrier_up_type = value;
}

bool V1_Symbol::optionBarrierUpTypeIsSet() const
{
    return m_Option_barrier_up_type.has_value();
}

void V1_Symbol::unsetOption_barrier_up_type()
{
    m_Option_barrier_up_type.reset();
}
double V1_Symbol::getOptionBarrierDownPrice() const
{
    return m_Option_barrier_down_price.get();
}

void V1_Symbol::setOptionBarrierDownPrice(double value)
{
    m_Option_barrier_down_price = value;
}

bool V1_Symbol::optionBarrierDownPriceIsSet() const
{
    return m_Option_barrier_down_price.has_value();
}

void V1_Symbol::unsetOption_barrier_down_price()
{
    m_Option_barrier_down_price.reset();
}
utility::string_t V1_Symbol::getOptionBarrierDownType() const
{
    return m_Option_barrier_down_type.get();
}


void V1_Symbol::setOptionBarrierDownType(const utility::string_t& value)
{
    m_Option_barrier_down_type = value;
}

bool V1_Symbol::optionBarrierDownTypeIsSet() const
{
    return m_Option_barrier_down_type.has_value();
}

void V1_Symbol::unsetOption_barrier_down_type()
{
