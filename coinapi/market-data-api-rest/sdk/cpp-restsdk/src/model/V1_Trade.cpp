...
web::json::value V1_Trade::toJson() const
{
    ...
    {   
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("id_trade"))] = ModelBase::toJson(m_Id_trade);
    }
    if(m_Id_order_makerIsSet)
    {   
        
        val[utility::conversions::to_string_t(_XPLATSTR("id_order_maker"))] = ModelBase::toJson(m_Id_order_maker);
    }
    if(m_Id_order_takerIsSet)
    {   
        
        val[utility::conversions::to_string_t(_XPLATSTR("id_order_taker"))] = ModelBase::toJson(m_Id_order_taker);
    }
...
void V1_Trade::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Id_tradeIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("id_trade")), m_Id_trade));
    }
    if(m_Id_order_makerIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("id_order_maker")), m_Id_order_maker));
    }
    if(m_Id_order_takerIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("id_order_taker")), m_Id_order_taker));
    }
}
