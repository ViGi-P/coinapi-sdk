...
web::json::value V1_OrderBookDepth::toJson() const
{
    ...
    if(m_Ask_levelsIsSet)
    {
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("ask_levels"))] = ModelBase::toJson(m_Ask_levels);
    }
    if(m_Bid_levelsIsSet)
    {
        
        val[utility::conversions::to_string_t(_XPLATSTR("bid_levels"))] = ModelBase::toJson(m_Bid_levels);
    }
    if(m_Ask_depthIsSet)
    {
        
        val[utility::conversions::to_string_t(_XPLATSTR("ask_depth"))] = ModelBase::toJson(m_Ask_depth);
    }
    if(m_Bid_depthIsSet)
    {
        
        val[utility::conversions::to_string_t(_XPLATSTR("bid_depth"))] = ModelBase::toJson(m_Bid_depth);
    }
...
bool V1_OrderBookDepth::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("ask_levels"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("ask_levels")));
        if(!fieldValue.is_null())
        {
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("bid_levels"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("bid_levels")));
        if(!fieldValue.is_null())
        {
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("ask_depth"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("ask_depth")));
        if(!fieldValue.is_null())
        {
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("bid_depth"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("bid_depth")));
        if(!fieldValue.is_null())
        {
...
void V1_OrderBookDepth::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Ask_levelsIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("ask_levels")), m_Ask_levels));
    }
    if(m_Bid_levelsIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("bid_levels")), m_Bid_levels));
    }
    if(m_Ask_depthIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("ask_depth")), m_Ask_depth));
    }
    if(m_Bid_depthIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("bid_depth")), m_Bid_depth));
    }
}
...
bool V1_OrderBookDepth::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("ask_levels"))))
    {
        int64_t refVal_setAskLevels;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("ask_levels"))), refVal_setAskLevels );
        setAskLevels(refVal_setAskLevels);
    }
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("bid_levels"))))
    {
        int64_t refVal_setBidLevels;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("bid_levels"))), refVal_setBidLevels );
        setBidLevels(refVal_setBidLevels);
    }
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("ask_depth"))))
    {
        double refVal_setAskDepth;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("ask_depth"))), refVal_setAskDepth );
        setAskDepth(refVal_setAskDepth);
    }
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("bid_depth"))))
    {
        double refVal_setBidDepth;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("bid_depth"))), refVal_setBidDepth );
        setBidDepth(refVal_setBidDepth);
    }
    return ok;
}
