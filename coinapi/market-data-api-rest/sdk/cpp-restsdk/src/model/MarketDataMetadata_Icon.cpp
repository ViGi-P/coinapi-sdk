...
MarketDataMetadata_Icon::MarketDataMetadata_Icon()
{
}
...
void MarketDataMetadata_Icon::validate()
{
    // TODO: implement validation
}

web::json::value MarketDataMetadata_Icon::toJson() const
{
...
bool MarketDataMetadata_Icon::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void MarketDataMetadata_Icon::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool MarketDataMetadata_Icon::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t MarketDataMetadata_Icon::getExchangeId() const
{
    return m_Exchange_id.get();
}


void MarketDataMetadata_Icon::setExchangeId(const utility::string_t& value)
{
    m_Exchange_id = value;
}

bool MarketDataMetadata_Icon::exchangeIdIsSet() const
{
    return m_Exchange_id.has_value();
}

void MarketDataMetadata_Icon::unsetExchange_id()
{
    m_Exchange_id.reset();
}
utility::string_t MarketDataMetadata_Icon::getAssetId() const
{
    return m_Asset_id.get();
}


void MarketDataMetadata_Icon::setAssetId(const utility::string_t& value)
{
    m_Asset_id = value;
}

bool MarketDataMetadata_Icon::assetIdIsSet() const
{
    return m_Asset_id.has_value();
}

void MarketDataMetadata_Icon::unsetAsset_id()
{
    m_Asset_id.reset();
}
utility::string_t MarketDataMetadata_Icon::getUrl() const
{
    return m_Url.get();
}


void MarketDataMetadata_Icon::setUrl(const utility::string_t& value)
{
    m_Url = value;
}

bool MarketDataMetadata_Icon::urlIsSet() const
{
    return m_Url.has_value();
}

void MarketDataMetadata_Icon::unsetUrl()
{
    m_Url.reset();
}
