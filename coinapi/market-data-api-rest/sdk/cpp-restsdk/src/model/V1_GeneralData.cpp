...
web::json::value V1_GeneralData::toJson() const
{
    ...
    {   
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("value_decimal"))] = ModelBase::toJson(m_Value_decimal);
    }
    if(m_Value_textIsSet)
    {   
        
        val[utility::conversions::to_string_t(_XPLATSTR("value_text"))] = ModelBase::toJson(m_Value_text);
    }
    if(m_Value_timeIsSet)
    {   
        
        val[utility::conversions::to_string_t(_XPLATSTR("value_time"))] = ModelBase::toJson(m_Value_time);
    }
...
void V1_GeneralData::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Value_decimalIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("value_decimal")), m_Value_decimal));
    }
    if(m_Value_textIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("value_text")), m_Value_text));
    }
    if(m_Value_timeIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("value_time")), m_Value_time));
    }
}
