...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_MetricsV2Api_H_
#define ORG_OPENAPITOOLS_CLIENT_API_MetricsV2Api_H_
...
public:
    ...
    explicit MetricsV2Api( std::shared_ptr<const ApiClient> apiClient );

    virtual ~MetricsV2Api();
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_MetricsV2Api_H_ */
