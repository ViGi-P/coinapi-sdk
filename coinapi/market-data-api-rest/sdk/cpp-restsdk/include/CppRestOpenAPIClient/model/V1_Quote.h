...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_V1_Quote_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_V1_Quote_H_
...
protected:
    ...
    boost::optional<double> m_Ask_price;

    boost::optional<double> m_Ask_size;

    boost::optional<double> m_Bid_price;

    boost::optional<double> m_Bid_size;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_V1_Quote_H_ */
