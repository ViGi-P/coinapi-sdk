...
defmodule CoinAPIMarketDataRESTAPI.RequestBuilder do
  @moduledoc """
  ...
  defp decode(%Tesla.Env{body: body}, %{}) do
    CoinAPIMarketDataRESTAPI.Deserializer.json_decode(body)
  end

  defp decode(%Tesla.Env{body: body}, module) do
    CoinAPIMarketDataRESTAPI.Deserializer.json_decode(body, module)
  end
end
