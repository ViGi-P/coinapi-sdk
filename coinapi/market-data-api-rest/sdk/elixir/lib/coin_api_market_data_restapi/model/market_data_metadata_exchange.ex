...
defmodule CoinAPIMarketDataRESTAPI.Model.MarketDataMetadataExchange do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :icons => [CoinAPIMarketDataRESTAPI.Model.MarketDataMetadataIcon.t] | nil,
    :rank => float() | nil,
  ...
  def decode(value) do
    value
     |> Deserializer.deserialize(:icons, :list, CoinAPIMarketDataRESTAPI.Model.MarketDataMetadataIcon)
  end
end
