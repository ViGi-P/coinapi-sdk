...
defmodule CoinAPIMarketDataRESTAPI.Connection do
  @moduledoc """
  Handle Tesla connections for CoinAPIMarketDataRESTAPI.

  Additional middleware can be set in the compile-time or runtime configuration:

      config :tesla, CoinAPIMarketDataRESTAPI.Connection,
        base_url: "https://rest.coinapi.io",
        adapter: Tesla.Adapter.Hackney

  The default base URL can also be set as:

      config :coin_api_market_data_restapi,
        :base_url, "https://rest.coinapi.io"
  """

  @default_base_url Application.compile_env(
                      :coin_api_market_data_restapi,
                      :base_url,
  ...
  @doc """
  Configure a CoinAPIMarketDataRESTAPI client.

  ### Parameters

  - `options`: an optional keyword list of CoinAPIMarketDataRESTAPI.Connection.options.
  ...
  def middleware(options \\ []) do
    base_url =
      Keyword.get(
        options,
        :base_url,
        Application.get_env(:coin_api_market_data_restapi, :base_url, @default_base_url)
      )
    ...
    user_agent =
      Keyword.get(
        ...
        Keyword.get(
          tesla_options,
          :user_agent,
          "openapi-generator - CoinAPIMarketDataRESTAPI 1.0.0 - elixir"
        )
      )
