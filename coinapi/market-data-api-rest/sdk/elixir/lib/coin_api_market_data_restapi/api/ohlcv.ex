...
defmodule CoinAPIMarketDataRESTAPI.Api.OHLCV do
  ...
  """
  @spec v1_ohlcv_exchanges_exchange_id_history_get(Tesla.Env.client, String.t, String.t, String.t, String.t, keyword()) :: {:ok, [CoinAPIMarketDataRESTAPI.Model.OhlcvExchangeTimeseriesItem.t]} | {:error, Tesla.Env.t}
  def v1_ohlcv_exchanges_exchange_id_history_get(connection, exchange_id, period_id, time_start, time_end, _opts \\ []) do
    ...
    |> evaluate_response([
      {200, CoinAPIMarketDataRESTAPI.Model.OhlcvExchangeTimeseriesItem}
    ])
  end
