...
public class OhlcvExchangeTimeseriesItem {
  ...
  public OhlcvExchangeTimeseriesItem symbolIdCoinapi(@javax.annotation.Nullable String symbolIdCoinapi) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.timePeriodStart, ohlcvExchangeTimeseriesItem.timePeriodStart) &&
        ...
        Objects.equals(this.symbolIdCoinapi, ohlcvExchangeTimeseriesItem.symbolIdCoinapi);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OhlcvExchangeTimeseriesItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in OhlcvExchangeTimeseriesItem is not found in the empty JSON string", OhlcvExchangeTimeseriesItem.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OhlcvExchangeTimeseriesItem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `OhlcvExchangeTimeseriesItem` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
