 ...
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-02-16T06:04:03.925003493Z[Etc/UTC]", comments = "Generator version: 7.19.0")
public class ModelsExchangeTimeseriesItem {
  ...
  public ModelsExchangeTimeseriesItem timePeriodStart(@javax.annotation.Nullable OffsetDateTime timePeriodStart) {
  ...
  public ModelsExchangeTimeseriesItem timePeriodEnd(@javax.annotation.Nullable OffsetDateTime timePeriodEnd) {
  ...
  public ModelsExchangeTimeseriesItem timeOpen(@javax.annotation.Nullable OffsetDateTime timeOpen) {
  ...
  public ModelsExchangeTimeseriesItem timeClose(@javax.annotation.Nullable OffsetDateTime timeClose) {
  ...
  public ModelsExchangeTimeseriesItem priceOpen(@javax.annotation.Nullable Double priceOpen) {
  ...
  public ModelsExchangeTimeseriesItem priceHigh(@javax.annotation.Nullable Double priceHigh) {
  ...
  public ModelsExchangeTimeseriesItem priceLow(@javax.annotation.Nullable Double priceLow) {
  ...
  public ModelsExchangeTimeseriesItem priceClose(@javax.annotation.Nullable Double priceClose) {
  ...
  public ModelsExchangeTimeseriesItem volumeTraded(@javax.annotation.Nullable Double volumeTraded) {
  ...
  public ModelsExchangeTimeseriesItem tradesCount(@javax.annotation.Nullable Long tradesCount) {
  ...
  public ModelsExchangeTimeseriesItem symbolIdExchange(@javax.annotation.Nullable String symbolIdExchange) {
  ...
  public ModelsExchangeTimeseriesItem symbolIdCoinapi(@javax.annotation.Nullable String symbolIdCoinapi) {
  ...
  public void setSymbolIdCoinapi(@javax.annotation.Nullable String symbolIdCoinapi) {
    this.symbolIdCoinapi = symbolIdCoinapi;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.timePeriodStart, modelsExchangeTimeseriesItem.timePeriodStart) &&
        Objects.equals(this.timePeriodEnd, modelsExchangeTimeseriesItem.timePeriodEnd) &&
        Objects.equals(this.timeOpen, modelsExchangeTimeseriesItem.timeOpen) &&
        Objects.equals(this.timeClose, modelsExchangeTimeseriesItem.timeClose) &&
        Objects.equals(this.priceOpen, modelsExchangeTimeseriesItem.priceOpen) &&
        Objects.equals(this.priceHigh, modelsExchangeTimeseriesItem.priceHigh) &&
        Objects.equals(this.priceLow, modelsExchangeTimeseriesItem.priceLow) &&
        Objects.equals(this.priceClose, modelsExchangeTimeseriesItem.priceClose) &&
        Objects.equals(this.volumeTraded, modelsExchangeTimeseriesItem.volumeTraded) &&
        Objects.equals(this.tradesCount, modelsExchangeTimeseriesItem.tradesCount) &&
        Objects.equals(this.symbolIdExchange, modelsExchangeTimeseriesItem.symbolIdExchange) &&
        Objects.equals(this.symbolIdCoinapi, modelsExchangeTimeseriesItem.symbolIdCoinapi);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(timePeriodStart, timePeriodEnd, timeOpen, timeClose, priceOpen, priceHigh, priceLow, priceClose, volumeTraded, tradesCount, symbolIdExchange, symbolIdCoinapi);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ModelsExchangeTimeseriesItem
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ModelsExchangeTimeseriesItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ModelsExchangeTimeseriesItem is not found in the empty JSON string", ModelsExchangeTimeseriesItem.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ModelsExchangeTimeseriesItem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ModelsExchangeTimeseriesItem` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("symbol_id_coinapi") != null && !jsonObj.get("symbol_id_coinapi").isJsonNull()) && !jsonObj.get("symbol_id_coinapi").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `symbol_id_coinapi` to be a primitive type in the JSON string but got `%s`", jsonObj.get("symbol_id_coinapi").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ModelsExchangeTimeseriesItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ModelsExchangeTimeseriesItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ModelsExchangeTimeseriesItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ModelsExchangeTimeseriesItem.class));

       return (TypeAdapter<T>) new TypeAdapter<ModelsExchangeTimeseriesItem>() {
           @Override
           public void write(JsonWriter out, ModelsExchangeTimeseriesItem value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ModelsExchangeTimeseriesItem read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ModelsExchangeTimeseriesItem given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ModelsExchangeTimeseriesItem
   * @throws IOException if the JSON string is invalid with respect to ModelsExchangeTimeseriesItem
   */
  public static ModelsExchangeTimeseriesItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ModelsExchangeTimeseriesItem.class);
  }

  /**
   * Convert an instance of ModelsExchangeTimeseriesItem to an JSON string
   *
   * @return JSON string
   */
