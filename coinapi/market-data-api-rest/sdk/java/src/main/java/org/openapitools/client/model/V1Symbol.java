...
public class V1Symbol {
  ...
  public V1Symbol futureIsInverse(@javax.annotation.Nullable Boolean futureIsInverse) {
  ...
  public V1Symbol futureIsQuanto(@javax.annotation.Nullable Boolean futureIsQuanto) {
  ...
  public V1Symbol optionBarrierUpPrice(@javax.annotation.Nullable Double optionBarrierUpPrice) {
  ...
  public V1Symbol optionBarrierUpType(@javax.annotation.Nullable String optionBarrierUpType) {
  ...
  public V1Symbol optionBarrierDownPrice(@javax.annotation.Nullable Double optionBarrierDownPrice) {
  ...
  public V1Symbol optionBarrierDownType(@javax.annotation.Nullable String optionBarrierDownType) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.symbolId, v1Symbol.symbolId) &&
        ...
        Objects.equals(this.futureIsInverse, v1Symbol.futureIsInverse) &&
        Objects.equals(this.futureIsQuanto, v1Symbol.futureIsQuanto) &&
        Objects.equals(this.volumeToUsd, v1Symbol.volumeToUsd) &&
        Objects.equals(this.optionBarrierUpPrice, v1Symbol.optionBarrierUpPrice) &&
        Objects.equals(this.optionBarrierUpType, v1Symbol.optionBarrierUpType) &&
        Objects.equals(this.optionBarrierDownPrice, v1Symbol.optionBarrierDownPrice) &&
        Objects.equals(this.optionBarrierDownType, v1Symbol.optionBarrierDownType) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1Symbol.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in V1Symbol is not found in the empty JSON string", V1Symbol.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1Symbol.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1Symbol` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
