...
public class OptionsApi {
    ...
    /**
     * Build call for v1OptionsExchangeIdCurrentGet
     ...
     */
    public okhttp3.Call v1OptionsExchangeIdCurrentGetCall(@javax.annotation.Nonnull String exchangeId, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/v1/options/{exchange_id}/current"
    ...
    private okhttp3.Call v1OptionsExchangeIdCurrentGetValidateBeforeCall(@javax.annotation.Nonnull String exchangeId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'exchangeId' is set
        if (exchangeId == null) {
            throw new ApiException("Missing the required parameter 'exchangeId' when calling v1OptionsExchangeIdCurrentGet(Async)");
        }

        return v1OptionsExchangeIdCurrentGetCall(exchangeId, _callback);
    ...
    /**
     * Current data by Exchange (asynchronously)
     * Get current options data for a specific exchange.  Returns option data grouped by underlying asset, quote currency, and expiration time, with quotes for both calls and puts at each strike price.
     * @param exchangeId Exchange identifier (from the Metadata -&gt; Exchanges) (required)
