...
class ModelsExchangeTimeseriesItemTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of ModelsExchangeTimeseriesItem
        //val modelInstance = ModelsExchangeTimeseriesItem()
        ...
        // to test the property `symbolIdExchange`
        should("test symbolIdExchange") {
            // uncomment below to test the property
            //modelInstance.symbolIdExchange shouldBe ("TODO")
        }

        // to test the property `symbolIdCoinapi`
        should("test symbolIdCoinapi") {
            // uncomment below to test the property
            //modelInstance.symbolIdCoinapi shouldBe ("TODO")
        }
