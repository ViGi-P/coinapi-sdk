...
**timeExchange** | [**Date**](Date.md) | Gets or sets the exchange time of the quote trade. |  [optional]
**timeCoinapi** | [**Date**](Date.md) | Gets or sets the CoinAPI time when the quote trade was received. |  [optional]
