...
**futureDeliveryTime** | [**Date**](Date.md) | Gets or sets the future delivery time for futures contract. |  [optional]
...
**optionExpirationTime** | [**Date**](Date.md) | Gets or sets the expiration time for options. |  [optional]
**contractDeliveryTime** | [**Date**](Date.md) | Gets or sets the delivery time for contracts. |  [optional]
