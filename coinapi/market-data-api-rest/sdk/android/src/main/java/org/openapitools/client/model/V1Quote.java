 ...
 **/
@ApiModel(description = "Represents a quote data model.")
public class V1Quote {
  ...
  public boolean equals(Object o) {
    ...
    return (this.symbolId == null ? v1Quote.symbolId == null : this.symbolId.equals(v1Quote.symbolId)) &&
        (this.timeExchange == null ? v1Quote.timeExchange == null : this.timeExchange.equals(v1Quote.timeExchange)) &&
        (this.timeCoinapi == null ? v1Quote.timeCoinapi == null : this.timeCoinapi.equals(v1Quote.timeCoinapi)) &&
        (this.askPrice == null ? v1Quote.askPrice == null : this.askPrice.equals(v1Quote.askPrice)) &&
        (this.askSize == null ? v1Quote.askSize == null : this.askSize.equals(v1Quote.askSize)) &&
        (this.bidPrice == null ? v1Quote.bidPrice == null : this.bidPrice.equals(v1Quote.bidPrice)) &&
        (this.bidSize == null ? v1Quote.bidSize == null : this.bidSize.equals(v1Quote.bidSize));
  }
