...
export class OhlcvApi {
     ...
     */
    public v1OhlcvExchangesExchangeIdHistoryGet(exchangeId: string, periodId: string, timeStart: string, timeEnd: string, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: Array<models.ModelsExchangeTimeseriesItem>;  },
    ...
    > {
        ...
        $.ajax(requestOptions).then(
            (data: Array<models.ModelsExchangeTimeseriesItem>, textStatus: string, jqXHR: JQueryXHR) =>
    ...
    > {
        ...
        >();
        $.ajax(requestOptions).then(
            (data: Array<models.V1TimeseriesItem>, textStatus: string, jqXHR: JQueryXHR) =>
                dfd.resolve({response: jqXHR, body: data}),
            (xhr: JQueryXHR, textStatus: string, errorThrown: string) =>
                dfd.reject({response: xhr, errorThrown: errorThrown})
        );
     ...
     * @param limit Amount of items to return (mininum is 1, maximum is 100000, default value is 100, if the parameter is used then every 100 output items are counted as one request)
     */
    public v1OhlcvSymbolIdLatestGet(symbolId: string, periodId: string, limit?: number, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: Array<models.V1TimeseriesItem>;  },
    { response: JQueryXHR; errorThrown: string }
    > {
