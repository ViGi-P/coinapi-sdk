...
#
package WWW::OpenAPIClient::Object::V1ExchangeRatesTimeseriesItem;
...
__PACKAGE__->class_documentation({description => 'Represents an item in the exchange rate timeseries.',
