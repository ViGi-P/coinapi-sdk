...
#
package WWW::OpenAPIClient::Object::V1ExchangeRatesRate;
...
__PACKAGE__->class_documentation({description => 'Represents an exchange rate within a collection of exchange rates.',
