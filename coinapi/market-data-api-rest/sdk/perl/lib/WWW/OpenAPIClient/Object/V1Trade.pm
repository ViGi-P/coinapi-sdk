...
#
package WWW::OpenAPIClient::Object::V1Trade;
...
__PACKAGE__->class_documentation({description => 'Represents a trade executed on the exchange.',
                                  class => 'V1Trade',
                                  required => [], # TODO
}                                 );
