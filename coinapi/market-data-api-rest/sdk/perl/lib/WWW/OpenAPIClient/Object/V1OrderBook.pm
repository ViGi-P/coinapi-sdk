...
#
package WWW::OpenAPIClient::Object::V1OrderBook;
...
__PACKAGE__->class_documentation({description => 'Represents an order book with additional information and functionality.',
                                  class => 'V1OrderBook',
                                  required => [], # TODO
}                                 );
