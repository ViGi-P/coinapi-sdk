...
#
package WWW::OpenAPIClient::Object::V1QuoteTrade;
...
__PACKAGE__->class_documentation({description => 'Represents a quote trade data model.',
                                  class => 'V1QuoteTrade',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    ...
    'ask_size' => {
        datatype => 'double',
        base_name => 'ask_size',
        description => 'Gets or sets the volume resting on the best ask. If the value is equal to zero, then the size is unknown.',
        format => '',
        read_only => '',
            },
    'bid_price' => {
    ...
    'bid_size' => {
        datatype => 'double',
        base_name => 'bid_size',
        description => 'Gets or sets the volume resting on the best bid. If the value is equal to zero, then the size is unknown.',
        format => '',
        read_only => '',
            },
    'last_trade' => {
        datatype => 'V1LastTrade',
        base_name => 'last_trade',
        description => '',
        format => '',
        read_only => '',
            },
...
__PACKAGE__->openapi_types( {
    'symbol_id' => 'string',
    'time_exchange' => 'DATE_TIME',
    'time_coinapi' => 'DATE_TIME',
    'ask_price' => 'double',
    'ask_size' => 'double',
    'bid_price' => 'double',
    'bid_size' => 'double',
