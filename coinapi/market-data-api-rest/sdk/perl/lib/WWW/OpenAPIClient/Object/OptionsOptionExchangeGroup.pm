...
#
package WWW::OpenAPIClient::Object::OptionsOptionExchangeGroup;
...
__PACKAGE__->class_documentation({description => 'Represents an option exchange group data model.',
...
__PACKAGE__->method_documentation({
    ...
    'time_expiration' => {
        datatype => 'DATE_TIME',
        base_name => 'time_expiration',
        description => 'The expiration time of the option.',
        format => '',
        read_only => '',
            },
    'strikes' => {
        datatype => 'ARRAY[OptionsStrike]',
        base_name => 'strikes',
