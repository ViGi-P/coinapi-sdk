...
__PACKAGE__->method_documentation({
    ...
    'option_exercise_style' => {
        ...
        description => 'Gets or sets the exercise style for options. Possible values: AMERICAN, ASIAN, BARRIER, BERMUDAN, BINARY, EUROPEAN, EXOTIC.',
        format => '',
        read_only => '',
            },
    ...
    'volume_1hrs' => {
        ...
        description => 'Gets or sets the volume in the last 1 hour.',
        format => '',
        read_only => '',
            },
    'volume_1hrs_usd' => {
        ...
        description => 'Gets or sets the volume in USD in the last 1 hour.',
        format => '',
        read_only => '',
            },
    'volume_1day' => {
        ...
        description => 'Gets or sets the volume in the last 1 day.',
        format => '',
        read_only => '',
            },
    'volume_1day_usd' => {
        ...
        description => 'Gets or sets the volume in USD in the last 1 day.',
        format => '',
        read_only => '',
            },
    'volume_1mth' => {
        ...
        description => 'Gets or sets the volume in the last 1 month.',
        format => '',
        read_only => '',
            },
    'volume_1mth_usd' => {
        ...
        description => 'Gets or sets the volume in USD in the last 1 month.',
        format => '',
        read_only => '',
            },
    'price' => {
    ...
    'future_is_inverse' => {
        datatype => 'boolean',
        base_name => 'future_is_inverse',
        description => 'Gets or sets a value indicating whether the futures contract is inverse (coin-margined).',
        format => '',
        read_only => '',
            },
    'future_is_quanto' => {
        datatype => 'boolean',
        base_name => 'future_is_quanto',
        description => 'Gets or sets a value indicating whether the futures contract is quanto.',
        format => '',
        read_only => '',
            },
    'volume_to_usd' => {
        ...
        description => 'Gets or sets the volume in USD.',
        format => '',
        read_only => '',
            },
    'option_barrier_up_price' => {
        datatype => 'double',
        base_name => 'option_barrier_up_price',
        description => 'Gets or sets the up barrier price for barrier options.',
        format => '',
        read_only => '',
            },
    'option_barrier_up_type' => {
        datatype => 'string',
        base_name => 'option_barrier_up_type',
        description => 'Gets or sets the up barrier type for barrier options. Possible values: EXPIRATION, IN, OUT.',
        format => '',
        read_only => '',
            },
    'option_barrier_down_price' => {
        datatype => 'double',
        base_name => 'option_barrier_down_price',
        description => 'Gets or sets the down barrier price for barrier options.',
        format => '',
        read_only => '',
            },
    'option_barrier_down_type' => {
        datatype => 'string',
        base_name => 'option_barrier_down_type',
        description => 'Gets or sets the down barrier type for barrier options. Possible values: EXPIRATION, IN, OUT.',
        format => '',
        read_only => '',
            },
    'symbol_id_int' => {
        ...
        description => 'Gets or sets the symbol identifier in integer immutable format, used to correlate data across different APIs.',
        format => '',
        read_only => '',
            },
});
