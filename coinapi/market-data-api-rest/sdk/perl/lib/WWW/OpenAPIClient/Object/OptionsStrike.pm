...
#
package WWW::OpenAPIClient::Object::OptionsStrike;
...
__PACKAGE__->class_documentation({description => 'Represents a strike within the option exchange group.',
                                  class => 'OptionsStrike',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    'strike_price' => {
        datatype => 'double',
        base_name => 'strike_price',
        description => 'The strike price.',
        format => '',
        read_only => '',
            },
    'call' => {
        datatype => 'V1QuoteTrade',
        base_name => 'call',
        description => '',
        format => '',
        read_only => '',
