...
#
package WWW::OpenAPIClient::Object::V1ExchangeRates;
...
__PACKAGE__->class_documentation({description => 'Represents exchange rates for a specific base asset.',
...
__PACKAGE__->method_documentation({
    ...
    'rates' => {
        datatype => 'ARRAY[V1ExchangeRatesRate]',
        base_name => 'rates',
