...
#
package WWW::OpenAPIClient::OptionsApi;
...
sub v1_options_exchange_id_current_get {
    ...
    unless (exists $args{'exchange_id'}) {
      croak("Missing the required parameter 'exchange_id' when calling v1_options_exchange_id_current_get");
    }

    # parse inputs
    my $_resource_path = '/v1/options/{exchange_id}/current';
