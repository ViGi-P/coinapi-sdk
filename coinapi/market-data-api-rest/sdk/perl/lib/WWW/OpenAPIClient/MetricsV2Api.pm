...
#
package WWW::OpenAPIClient::MetricsV2Api;
...
sub marketdata_list_metrics_v2_asset_history {
    ...
    # parse inputs
    my $_resource_path = '/v2/metrics/asset/history';
...
sub marketdata_list_metrics_v2_asset_listing {
    ...
    # parse inputs
    my $_resource_path = '/v2/metrics/asset/listing';
...
sub marketdata_list_metrics_v2_chain_history {
    ...
    # parse inputs
    my $_resource_path = '/v2/metrics/chain/history';
...
sub marketdata_list_metrics_v2_chain_listing {
    ...
    # parse inputs
    my $_resource_path = '/v2/metrics/chain/listing';
...
sub marketdata_list_metrics_v2_exchange_history {
    ...
    # parse inputs
    my $_resource_path = '/v2/metrics/exchange/history';
...
sub marketdata_list_metrics_v2_exchange_listing {
    ...
    # parse inputs
    my $_resource_path = '/v2/metrics/exchange/listing';
...
sub marketdata_list_metrics_v2_listing {
    ...
    # parse inputs
    my $_resource_path = '/v2/metrics/listing';
