# WWW::OpenAPIClient::Object::MarketDataMetadataSymbol
...
**option_barrier_up_price** | **double** | The up barrier price for barrier options. | [optional] 
**option_barrier_up_type** | **string** | The up barrier type for barrier options. Possible values: EXPIRATION, IN, OUT. | [optional] 
**option_barrier_down_price** | **double** | The down barrier price for barrier options. | [optional] 
