...
**ExchangeId** | Pointer to **NullableString** | Gets or sets the exchange identifier. | [optional] 
**SymbolType** | Pointer to **NullableString** | Gets or sets the symbol type. | [optional] 
...
**AssetIdUnit** | Pointer to **NullableString** | Gets or sets the unit asset identifier. | [optional] 
**FutureContractUnit** | Pointer to **NullableFloat64** | Gets or sets the contract unit for futures. | [optional] 
**FutureContractUnitAsset** | Pointer to **NullableString** | Gets or sets the asset used as the unit for futures contract. | [optional] 
**FutureDeliveryTime** | Pointer to **NullableTime** | Gets or sets the future delivery time for futures contract. | [optional] 
**OptionTypeIsCall** | Pointer to **NullableBool** | Gets or sets a value indicating whether the option type is a call. | [optional] 
**OptionStrikePrice** | Pointer to **NullableFloat64** | Gets or sets the strike price for options. | [optional] 
**OptionContractUnit** | Pointer to **NullableFloat64** | Gets or sets the contract unit for options. | [optional] 
**OptionExerciseStyle** | Pointer to **NullableString** | Gets or sets the exercise style for options. Possible values: AMERICAN, ASIAN, BARRIER, BERMUDAN, BINARY, EUROPEAN, EXOTIC. | [optional] 
**OptionExpirationTime** | Pointer to **NullableTime** | Gets or sets the expiration time for options. | [optional] 
**ContractDeliveryTime** | Pointer to **NullableTime** | Gets or sets the delivery time for contracts. | [optional] 
**ContractUnit** | Pointer to **NullableFloat64** | Gets or sets the contract unit for contracts. | [optional] 
**ContractUnitAsset** | Pointer to **NullableString** | Gets or sets the asset used as the unit for contracts. | [optional] 
**ContractId** | Pointer to **NullableString** | Gets or sets the contract identifier. | [optional] 
**ContractDisplayName** | Pointer to **NullableString** | Gets or sets the display name of the contract. | [optional] 
**ContractDisplayDescription** | Pointer to **NullableString** | Gets or sets the display description of the contract. | [optional] 
**DataStart** | Pointer to **NullableString** | Gets the start date of the data in string format (\&quot;yyyy-MM-dd\&quot;). | [optional] [readonly] 
**DataEnd** | Pointer to **NullableString** | Gets the end date of the data in string format (\&quot;yyyy-MM-dd\&quot;). | [optional] [readonly] 
...
**IndexId** | Pointer to **NullableString** | Gets or sets the index identifier. | [optional] 
**IndexDisplayName** | Pointer to **NullableString** | Gets or sets the display name of the index. | [optional] 
**IndexDisplayDescription** | Pointer to **NullableString** | Gets or sets the display description of the index. | [optional] 
**Volume1hrs** | Pointer to **NullableFloat64** | Gets or sets the volume in the last 1 hour. | [optional] 
**Volume1hrsUsd** | Pointer to **NullableFloat64** | Gets or sets the volume in USD in the last 1 hour. | [optional] 
**Volume1day** | Pointer to **NullableFloat64** | Gets or sets the volume in the last 1 day. | [optional] 
**Volume1dayUsd** | Pointer to **NullableFloat64** | Gets or sets the volume in USD in the last 1 day. | [optional] 
**Volume1mth** | Pointer to **NullableFloat64** | Gets or sets the volume in the last 1 month. | [optional] 
**Volume1mthUsd** | Pointer to **NullableFloat64** | Gets or sets the volume in USD in the last 1 month. | [optional] 
**Price** | Pointer to **NullableFloat64** | Gets or sets the price. | [optional] 
**SymbolIdExchange** | Pointer to **NullableString** | Gets or sets the symbol identifier in the exchange. | [optional] 
**AssetIdBaseExchange** | Pointer to **NullableString** | Gets or sets the base asset identifier in the exchange. | [optional] 
**AssetIdQuoteExchange** | Pointer to **NullableString** | Gets or sets the quote asset identifier in the exchange. | [optional] 
...
**FutureIsInverse** | Pointer to **NullableBool** | Gets or sets a value indicating whether the futures contract is inverse (coin-margined). | [optional] 
**FutureIsQuanto** | Pointer to **NullableBool** | Gets or sets a value indicating whether the futures contract is quanto. | [optional] 
**VolumeToUsd** | Pointer to **NullableFloat64** | Gets or sets the volume in USD. | [optional] 
**OptionBarrierUpPrice** | Pointer to **NullableFloat64** | Gets or sets the up barrier price for barrier options. | [optional] 
**OptionBarrierUpType** | Pointer to **NullableString** | Gets or sets the up barrier type for barrier options. Possible values: EXPIRATION, IN, OUT. | [optional] 
**OptionBarrierDownPrice** | Pointer to **NullableFloat64** | Gets or sets the down barrier price for barrier options. | [optional] 
**OptionBarrierDownType** | Pointer to **NullableString** | Gets or sets the down barrier type for barrier options. Possible values: EXPIRATION, IN, OUT. | [optional] 
**SymbolIdInt** | Pointer to **NullableInt32** | Gets or sets the symbol identifier in integer immutable format, used to correlate data across different APIs. | [optional] [readonly] 
...
`func (o *V1Symbol) SetSymbolIdIntNil(b bool)`
