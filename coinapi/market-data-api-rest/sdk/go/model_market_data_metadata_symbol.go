...
// checks if the MarketDataMetadataSymbol type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MarketDataMetadataSymbol{}

// MarketDataMetadataSymbol Represents a symbol data model.
type MarketDataMetadataSymbol struct {
...
func (o *MarketDataMetadataSymbol) SetSymbolIdNil() {
	o.SymbolId.Set(nil)
}
...
func (o *MarketDataMetadataSymbol) SetExchangeIdNil() {
...
func (o *MarketDataMetadataSymbol) SetSymbolTypeNil() {
...
func (o *MarketDataMetadataSymbol) SetAssetIdBaseNil() {
...
func (o *MarketDataMetadataSymbol) SetAssetIdQuoteNil() {
...
func (o *MarketDataMetadataSymbol) SetAssetIdUnitNil() {
...
func (o *MarketDataMetadataSymbol) SetFutureContractUnitNil() {
...
func (o *MarketDataMetadataSymbol) SetFutureContractUnitAssetNil() {
...
func (o *MarketDataMetadataSymbol) SetFutureDeliveryTimeNil() {
...
func (o *MarketDataMetadataSymbol) SetOptionTypeIsCallNil() {
...
func (o *MarketDataMetadataSymbol) SetOptionStrikePriceNil() {
...
func (o *MarketDataMetadataSymbol) SetOptionContractUnitNil() {
...
func (o *MarketDataMetadataSymbol) SetOptionExerciseStyleNil() {
...
func (o *MarketDataMetadataSymbol) SetOptionExpirationTimeNil() {
...
func (o *MarketDataMetadataSymbol) SetContractDeliveryTimeNil() {
...
func (o *MarketDataMetadataSymbol) SetContractUnitNil() {
...
func (o *MarketDataMetadataSymbol) SetContractUnitAssetNil() {
...
func (o *MarketDataMetadataSymbol) SetContractIdNil() {
...
func (o *MarketDataMetadataSymbol) SetContractDisplayNameNil() {
...
func (o *MarketDataMetadataSymbol) SetContractDisplayDescriptionNil() {
...
func (o *MarketDataMetadataSymbol) SetDataStartNil() {
	o.DataStart.Set(nil)
}
...
func (o *MarketDataMetadataSymbol) SetDataEndNil() {
	o.DataEnd.Set(nil)
}
...
func (o *MarketDataMetadataSymbol) SetDataQuoteStartNil() {
...
func (o *MarketDataMetadataSymbol) SetDataQuoteEndNil() {
...
func (o *MarketDataMetadataSymbol) SetDataOrderbookStartNil() {
...
func (o *MarketDataMetadataSymbol) SetDataOrderbookEndNil() {
...
func (o *MarketDataMetadataSymbol) SetDataTradeStartNil() {
...
func (o *MarketDataMetadataSymbol) SetDataTradeEndNil() {
...
func (o *MarketDataMetadataSymbol) SetIndexIdNil() {
	o.IndexId.Set(nil)
}
...
func (o *MarketDataMetadataSymbol) SetIndexDisplayNameNil() {
...
func (o *MarketDataMetadataSymbol) SetIndexDisplayDescriptionNil() {
...
func (o *MarketDataMetadataSymbol) SetVolume1hrsNil() {
...
func (o *MarketDataMetadataSymbol) SetVolume1hrsUsdNil() {
...
func (o *MarketDataMetadataSymbol) SetVolume1dayNil() {
...
func (o *MarketDataMetadataSymbol) SetVolume1dayUsdNil() {
...
func (o *MarketDataMetadataSymbol) SetVolume1mthNil() {
...
func (o *MarketDataMetadataSymbol) SetVolume1mthUsdNil() {
...
func (o *MarketDataMetadataSymbol) SetPriceNil() {
	o.Price.Set(nil)
}
...
func (o *MarketDataMetadataSymbol) SetSymbolIdExchangeNil() {
...
func (o *MarketDataMetadataSymbol) SetAssetIdBaseExchangeNil() {
...
func (o *MarketDataMetadataSymbol) SetAssetIdQuoteExchangeNil() {
...
func (o *MarketDataMetadataSymbol) SetPricePrecisionNil() {
...
func (o *MarketDataMetadataSymbol) SetSizePrecisionNil() {
...
// GetFutureIsInverse returns the FutureIsInverse field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *MarketDataMetadataSymbol) GetFutureIsInverse() bool {
	if o == nil || IsNil(o.FutureIsInverse.Get()) {
		var ret bool
		return ret
	}
	return *o.FutureIsInverse.Get()
}

// GetFutureIsInverseOk returns a tuple with the FutureIsInverse field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
...
// SetFutureIsInverse gets a reference to the given NullableBool and assigns it to the FutureIsInverse field.
func (o *MarketDataMetadataSymbol) SetFutureIsInverse(v bool) {
	o.FutureIsInverse.Set(&v)
}
// SetFutureIsInverseNil sets the value for FutureIsInverse to be an explicit nil
func (o *MarketDataMetadataSymbol) SetFutureIsInverseNil() {
	o.FutureIsInverse.Set(nil)
}
...
func (o *MarketDataMetadataSymbol) UnsetFutureIsInverse() {
	o.FutureIsInverse.Unset()
}

// GetFutureIsQuanto returns the FutureIsQuanto field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *MarketDataMetadataSymbol) GetFutureIsQuanto() bool {
	if o == nil || IsNil(o.FutureIsQuanto.Get()) {
		var ret bool
		return ret
	}
	return *o.FutureIsQuanto.Get()
}

// GetFutureIsQuantoOk returns a tuple with the FutureIsQuanto field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
...
// SetFutureIsQuanto gets a reference to the given NullableBool and assigns it to the FutureIsQuanto field.
func (o *MarketDataMetadataSymbol) SetFutureIsQuanto(v bool) {
	o.FutureIsQuanto.Set(&v)
}
// SetFutureIsQuantoNil sets the value for FutureIsQuanto to be an explicit nil
func (o *MarketDataMetadataSymbol) SetFutureIsQuantoNil() {
	o.FutureIsQuanto.Set(nil)
}
...
func (o *MarketDataMetadataSymbol) SetVolumeToUsdNil() {
...
// GetOptionBarrierUpPrice returns the OptionBarrierUpPrice field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *MarketDataMetadataSymbol) GetOptionBarrierUpPrice() float64 {
	if o == nil || IsNil(o.OptionBarrierUpPrice.Get()) {
		var ret float64
		return ret
	}
	return *o.OptionBarrierUpPrice.Get()
}

// GetOptionBarrierUpPriceOk returns a tuple with the OptionBarrierUpPrice field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *MarketDataMetadataSymbol) GetOptionBarrierUpPriceOk() (*float64, bool) {
	...
	return o.OptionBarrierUpPrice.Get(), o.OptionBarrierUpPrice.IsSet()
}
...
func (o *MarketDataMetadataSymbol) HasOptionBarrierUpPrice() bool {
	if o != nil && o.OptionBarrierUpPrice.IsSet() {
		return true
	}
...
// SetOptionBarrierUpPrice gets a reference to the given NullableFloat64 and assigns it to the OptionBarrierUpPrice field.
func (o *MarketDataMetadataSymbol) SetOptionBarrierUpPrice(v float64) {
	o.OptionBarrierUpPrice.Set(&v)
}
// SetOptionBarrierUpPriceNil sets the value for OptionBarrierUpPrice to be an explicit nil
func (o *MarketDataMetadataSymbol) SetOptionBarrierUpPriceNil() {
	o.OptionBarrierUpPrice.Set(nil)
}
...
func (o *MarketDataMetadataSymbol) UnsetOptionBarrierUpPrice() {
	o.OptionBarrierUpPrice.Unset()
}

// GetOptionBarrierUpType returns the OptionBarrierUpType field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *MarketDataMetadataSymbol) GetOptionBarrierUpType() string {
	if o == nil || IsNil(o.OptionBarrierUpType.Get()) {
		var ret string
		return ret
	}
	return *o.OptionBarrierUpType.Get()
}

// GetOptionBarrierUpTypeOk returns a tuple with the OptionBarrierUpType field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *MarketDataMetadataSymbol) GetOptionBarrierUpTypeOk() (*string, bool) {
	...
	return o.OptionBarrierUpType.Get(), o.OptionBarrierUpType.IsSet()
}
...
func (o *MarketDataMetadataSymbol) HasOptionBarrierUpType() bool {
	if o != nil && o.OptionBarrierUpType.IsSet() {
		return true
	}
...
// SetOptionBarrierUpType gets a reference to the given NullableString and assigns it to the OptionBarrierUpType field.
func (o *MarketDataMetadataSymbol) SetOptionBarrierUpType(v string) {
	o.OptionBarrierUpType.Set(&v)
}
// SetOptionBarrierUpTypeNil sets the value for OptionBarrierUpType to be an explicit nil
func (o *MarketDataMetadataSymbol) SetOptionBarrierUpTypeNil() {
	o.OptionBarrierUpType.Set(nil)
}
...
func (o *MarketDataMetadataSymbol) UnsetOptionBarrierUpType() {
	o.OptionBarrierUpType.Unset()
}

// GetOptionBarrierDownPrice returns the OptionBarrierDownPrice field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *MarketDataMetadataSymbol) GetOptionBarrierDownPrice() float64 {
	if o == nil || IsNil(o.OptionBarrierDownPrice.Get()) {
		var ret float64
		return ret
	}
	return *o.OptionBarrierDownPrice.Get()
}

// GetOptionBarrierDownPriceOk returns a tuple with the OptionBarrierDownPrice field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *MarketDataMetadataSymbol) GetOptionBarrierDownPriceOk() (*float64, bool) {
	...
	return o.OptionBarrierDownPrice.Get(), o.OptionBarrierDownPrice.IsSet()
}
...
func (o *MarketDataMetadataSymbol) HasOptionBarrierDownPrice() bool {
	if o != nil && o.OptionBarrierDownPrice.IsSet() {
		return true
	}
...
// SetOptionBarrierDownPrice gets a reference to the given NullableFloat64 and assigns it to the OptionBarrierDownPrice field.
func (o *MarketDataMetadataSymbol) SetOptionBarrierDownPrice(v float64) {
	o.OptionBarrierDownPrice.Set(&v)
}
// SetOptionBarrierDownPriceNil sets the value for OptionBarrierDownPrice to be an explicit nil
func (o *MarketDataMetadataSymbol) SetOptionBarrierDownPriceNil() {
	o.OptionBarrierDownPrice.Set(nil)
}
...
func (o *MarketDataMetadataSymbol) UnsetOptionBarrierDownPrice() {
	o.OptionBarrierDownPrice.Unset()
}

// GetOptionBarrierDownType returns the OptionBarrierDownType field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *MarketDataMetadataSymbol) GetOptionBarrierDownType() string {
	if o == nil || IsNil(o.OptionBarrierDownType.Get()) {
		var ret string
		return ret
	}
	return *o.OptionBarrierDownType.Get()
}

// GetOptionBarrierDownTypeOk returns a tuple with the OptionBarrierDownType field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *MarketDataMetadataSymbol) GetOptionBarrierDownTypeOk() (*string, bool) {
	...
	return o.OptionBarrierDownType.Get(), o.OptionBarrierDownType.IsSet()
}
...
func (o *MarketDataMetadataSymbol) HasOptionBarrierDownType() bool {
	if o != nil && o.OptionBarrierDownType.IsSet() {
		return true
	}
...
// SetOptionBarrierDownType gets a reference to the given NullableString and assigns it to the OptionBarrierDownType field.
func (o *MarketDataMetadataSymbol) SetOptionBarrierDownType(v string) {
	o.OptionBarrierDownType.Set(&v)
}
// SetOptionBarrierDownTypeNil sets the value for OptionBarrierDownType to be an explicit nil
func (o *MarketDataMetadataSymbol) SetOptionBarrierDownTypeNil() {
	o.OptionBarrierDownType.Set(nil)
}
...
func (o *MarketDataMetadataSymbol) SetSymbolIdIntNil() {
...
func (o MarketDataMetadataSymbol) MarshalJSON() ([]byte, error) {
...
func (o MarketDataMetadataSymbol) ToMap() (map[string]interface{}, error) {
	...
	if o.FutureIsInverse.IsSet() {
		toSerialize["future_is_inverse"] = o.FutureIsInverse.Get()
	}
	if o.FutureIsQuanto.IsSet() {
		toSerialize["future_is_quanto"] = o.FutureIsQuanto.Get()
	}
	if o.VolumeToUsd.IsSet() {
		toSerialize["volume_to_usd"] = o.VolumeToUsd.Get()
	}
	if o.OptionBarrierUpPrice.IsSet() {
		toSerialize["option_barrier_up_price"] = o.OptionBarrierUpPrice.Get()
	}
	if o.OptionBarrierUpType.IsSet() {
		toSerialize["option_barrier_up_type"] = o.OptionBarrierUpType.Get()
	}
	if o.OptionBarrierDownPrice.IsSet() {
		toSerialize["option_barrier_down_price"] = o.OptionBarrierDownPrice.Get()
	}
	if o.OptionBarrierDownType.IsSet() {
		toSerialize["option_barrier_down_type"] = o.OptionBarrierDownType.Get()
	}
...
type NullableMarketDataMetadataSymbol struct {
	value *MarketDataMetadataSymbol
	isSet bool
}

func (v NullableMarketDataMetadataSymbol) Get() *MarketDataMetadataSymbol {
	return v.value
}

func (v *NullableMarketDataMetadataSymbol) Set(val *MarketDataMetadataSymbol) {
	v.value = val
	v.isSet = true
}

func (v NullableMarketDataMetadataSymbol) IsSet() bool {
	return v.isSet
}

func (v *NullableMarketDataMetadataSymbol) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMarketDataMetadataSymbol(val *MarketDataMetadataSymbol) *NullableMarketDataMetadataSymbol {
	return &NullableMarketDataMetadataSymbol{value: val, isSet: true}
}

func (v NullableMarketDataMetadataSymbol) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMarketDataMetadataSymbol) UnmarshalJSON(src []byte) error {
	v.isSet = true
