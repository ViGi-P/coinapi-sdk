(ns coin-api-market-data-rest-api.specs.market-data-metadata/asset
...
(def market-data-metadata/asset-data
  {
...
(def market-data-metadata/asset-spec
  (ds/spec
    {:name ::market-data-metadata/asset
     :spec market-data-metadata/asset-data}))
