(ns coin-api-market-data-rest-api.specs.market-data-metadata/exchange
...
(def market-data-metadata/exchange-data
  {
   ...
   (ds/opt :icons) (s/coll-of market-data-metadata/icon-spec)
   (ds/opt :rank) float?
   (ds/opt :integration_status) string?
   })

(def market-data-metadata/exchange-spec
  (ds/spec
    {:name ::market-data-metadata/exchange
     :spec market-data-metadata/exchange-data}))
