...
/**
 * MarketDataMetadataChain Class Doc Comment
 *
 * @category Class
 ...
 */
class MarketDataMetadataChain implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'MarketDataMetadata.Chain';
     ...
     * Sets chain_id
     *
     * @param string|null $chain_id Gets or sets the chain identifier.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Gets or sets the name of the chain.
     *
     * @return self
     */
