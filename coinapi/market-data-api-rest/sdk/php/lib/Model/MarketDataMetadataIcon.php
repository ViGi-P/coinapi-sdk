...
/**
 * MarketDataMetadataIcon Class Doc Comment
 *
 * @category Class
 ...
 */
class MarketDataMetadataIcon implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'MarketDataMetadata.Icon';
     ...
     * Sets exchange_id
     *
     * @param string|null $exchange_id Gets or sets the exchange ID associated with the icon.
     *
     * @return self
     */
     ...
     * Sets asset_id
     *
     * @param string|null $asset_id Gets or sets the asset ID associated with the icon.
     *
     * @return self
     */
     ...
     * Sets url
     *
     * @param string|null $url Gets or sets the URL of the icon.
     *
     * @return self
     */
