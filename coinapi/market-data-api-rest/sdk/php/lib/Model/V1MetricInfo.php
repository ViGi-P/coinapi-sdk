...
/**
 * V1MetricInfo Class Doc Comment
 *
 * @category Class
 ...
 */
class V1MetricInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'v1.MetricInfo';
    ...
    */
     ...
     * Sets metric_id
     *
     * @param string|null $metric_id Gets or sets the metric identifier.
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description Gets or sets the description of the metric.
     *
     * @return self
     */
     ...
     * Sets source_id
     *
     * @param string|null $source_id Gets or sets the source identifier of the metric.
     *
     * @return self
     */
