...
/**
 * ModelsExchangeTimeseriesItem Class Doc Comment
 *
 * @category Class
 ...
 */
class ModelsExchangeTimeseriesItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Models.ExchangeTimeseriesItem';
    ...
    */
     ...
     *
     * @param string|null $symbol_id_exchange symbol_id_exchange
     *
     * @return self
     */
     ...
     *
     * @param string|null $symbol_id_coinapi symbol_id_coinapi
     *
     * @return self
     */
    public function setSymbolIdCoinapi($symbol_id_coinapi)
    {
        if (is_null($symbol_id_coinapi)) {
            array_push($this->openAPINullablesSetToNull, 'symbol_id_coinapi');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('symbol_id_coinapi', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
