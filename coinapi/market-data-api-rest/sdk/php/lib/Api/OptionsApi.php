...
class OptionsApi
{
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v1OptionsExchangeIdCurrentGet'] to see the possible values for this operation
     *
    ...
    {
        list($response) = $this->v1OptionsExchangeIdCurrentGetWithHttpInfo($exchange_id, $contentType);
        return $response;
    }

    /**
     * Operation v1OptionsExchangeIdCurrentGetWithHttpInfo
     *
     * Current data by Exchange
     *
     * @param  string $exchange_id Exchange identifier (from the Metadata -&gt; Exchanges) (required)
    ...
    /**
     * Operation v1OptionsExchangeIdCurrentGetAsync
     *
     * Current data by Exchange
     *
     * @param  string $exchange_id Exchange identifier (from the Metadata -&gt; Exchanges) (required)
     ...
     */
    public function v1OptionsExchangeIdCurrentGetAsync($exchange_id, string $contentType = self::contentTypes['v1OptionsExchangeIdCurrentGet'][0])
    {
        return $this->v1OptionsExchangeIdCurrentGetAsyncWithHttpInfo($exchange_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v1OptionsExchangeIdCurrentGetAsyncWithHttpInfo
     *
     * Current data by Exchange
     *
     * @param  string $exchange_id Exchange identifier (from the Metadata -&gt; Exchanges) (required)
    ...
    /**
     * Create request for operation 'v1OptionsExchangeIdCurrentGet'
     *
     * @param  string $exchange_id Exchange identifier (from the Metadata -&gt; Exchanges) (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v1OptionsExchangeIdCurrentGet'] to see the possible values for this operation
     *
     ...
     */
    public function v1OptionsExchangeIdCurrentGetRequest($exchange_id, string $contentType = self::contentTypes['v1OptionsExchangeIdCurrentGet'][0])
    {

        // verify the required parameter 'exchange_id' is set
        if ($exchange_id === null || (is_array($exchange_id) && count($exchange_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $exchange_id when calling v1OptionsExchangeIdCurrentGet'
            );
        }


        $resourcePath = '/v1/options/{exchange_id}/current';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
