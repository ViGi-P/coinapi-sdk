...
module CoinAPIMarketDataREST.Client where
...
dispatchLbs
  ...
  -> CoinAPIMarketDataRESTConfig -- ^ config
  -> CoinAPIMarketDataRESTRequest req contentType res accept -- ^ request
