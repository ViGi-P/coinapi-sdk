...
module CoinAPIMarketDataREST.API.Trades where
...
v1TradesLatestGet
  ...
  -> CoinAPIMarketDataRESTRequest V1TradesLatestGet MimeNoContent [V1Trade] accept
v1TradesLatestGet  _ =
...
v1TradesSymbolIdHistoryGet
  ...
  -> CoinAPIMarketDataRESTRequest V1TradesSymbolIdHistoryGet MimeNoContent [V1Trade] accept
...
v1TradesSymbolIdLatestGet
  :: Accept accept -- ^ request accept ('MimeType')
  -> SymbolId -- ^ "symbolId" -  Symbol identifier for requested timeseries (from the Metadata -> Symbols)
  -> CoinAPIMarketDataRESTRequest V1TradesSymbolIdLatestGet MimeNoContent [V1Trade] accept
