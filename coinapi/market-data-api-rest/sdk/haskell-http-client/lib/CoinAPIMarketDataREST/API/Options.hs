...
module CoinAPIMarketDataREST.API.Options where
...
data V1OptionsExchangeIdCurrentGet  
-- | @application/json@
instance Produces V1OptionsExchangeIdCurrentGet MimeJSON
-- | @application/x-msgpack@
instance Produces V1OptionsExchangeIdCurrentGet MimeXMsgpack
-- | @text/json@
instance Produces V1OptionsExchangeIdCurrentGet MimeTextJson
-- | @text/plain@
instance Produces V1OptionsExchangeIdCurrentGet MimePlainText
