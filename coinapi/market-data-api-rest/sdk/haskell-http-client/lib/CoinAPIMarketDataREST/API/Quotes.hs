...
module CoinAPIMarketDataREST.API.Quotes where
...
v1QuotesCurrentGet
  ...
  -> CoinAPIMarketDataRESTRequest V1QuotesCurrentGet MimeNoContent [V1QuoteTrade] accept
...
v1QuotesLatestGet
  :: Accept accept -- ^ request accept ('MimeType')
  -> CoinAPIMarketDataRESTRequest V1QuotesLatestGet MimeNoContent [V1Quote] accept
v1QuotesLatestGet  _ =
...
v1QuotesSymbolIdCurrentGet
  ...
  -> CoinAPIMarketDataRESTRequest V1QuotesSymbolIdCurrentGet MimeNoContent V1QuoteTrade accept
...
v1QuotesSymbolIdHistoryGet
  ...
  -> CoinAPIMarketDataRESTRequest V1QuotesSymbolIdHistoryGet MimeNoContent [V1Quote] accept
...
v1QuotesSymbolIdLatestGet
  ...
  -> CoinAPIMarketDataRESTRequest V1QuotesSymbolIdLatestGet MimeNoContent [V1Quote] accept
