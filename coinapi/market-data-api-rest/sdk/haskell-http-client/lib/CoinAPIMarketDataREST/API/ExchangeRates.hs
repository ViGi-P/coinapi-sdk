...
module CoinAPIMarketDataREST.API.ExchangeRates where
...
getSpecificRate
  ...
  -> CoinAPIMarketDataRESTRequest GetSpecificRate MimeNoContent V1ExchangeRate accept
...
v1ExchangerateAssetIdBaseAssetIdQuoteHistoryGet
  ...
  -> CoinAPIMarketDataRESTRequest V1ExchangerateAssetIdBaseAssetIdQuoteHistoryGet MimeNoContent [V1ExchangeRatesTimeseriesItem] accept
...
-- | @application/x-msgpack@
instance Produces V1ExchangerateAssetIdBaseAssetIdQuoteHistoryGet MimeXMsgpack
-- | @text/json@
...
v1ExchangerateAssetIdBaseGet
  :: Accept accept -- ^ request accept ('MimeType')
  -> AssetIdBase -- ^ "assetIdBase" -  Requested exchange rates base asset identifier (from the Metadata -> Assets)
  -> CoinAPIMarketDataRESTRequest V1ExchangerateAssetIdBaseGet MimeNoContent V1ExchangeRates accept
...
v1ExchangerateHistoryPeriodsGet
  :: Accept accept -- ^ request accept ('MimeType')
  -> CoinAPIMarketDataRESTRequest V1ExchangerateHistoryPeriodsGet MimeNoContent [V1TimeseriesPeriod] accept
...
-- | @application/x-msgpack@
instance Produces V1ExchangerateHistoryPeriodsGet MimeXMsgpack
-- | @text/json@
