...
module CoinAPIMarketDataREST.Core where
...
-- * CoinAPIMarketDataRESTConfig

-- |
data CoinAPIMarketDataRESTConfig = CoinAPIMarketDataRESTConfig
...
-- | display the config
instance P.Show CoinAPIMarketDataRESTConfig where
  show c =
    T.printf
...
-- | constructs a default CoinAPIMarketDataRESTConfig
--
-- configHost:
--
...
-- configUserAgent:
--
-- @"coinapi-market-data-rest/0.1.0.0"@
--
newConfig :: IO CoinAPIMarketDataRESTConfig
newConfig = do
    logCxt <- initLogContext
    return $ CoinAPIMarketDataRESTConfig
        { configHost = "https://rest.coinapi.io"
        , configUserAgent = "coinapi-market-data-rest/0.1.0.0"
...
addAuthMethod :: AuthMethod auth => CoinAPIMarketDataRESTConfig -> auth -> CoinAPIMarketDataRESTConfig
addAuthMethod config@CoinAPIMarketDataRESTConfig {configAuthMethods = as} a =
  config { configAuthMethods = AnyAuthMethod a : as}

-- | updates the config to use stdout logging
withStdoutLogging :: CoinAPIMarketDataRESTConfig -> IO CoinAPIMarketDataRESTConfig
...
withStderrLogging :: CoinAPIMarketDataRESTConfig -> IO CoinAPIMarketDataRESTConfig
...
withNoLogging :: CoinAPIMarketDataRESTConfig -> CoinAPIMarketDataRESTConfig
withNoLogging p = p { configLogExecWithContext =  runNullLogExec}

-- * CoinAPIMarketDataRESTRequest
...
data CoinAPIMarketDataRESTRequest req contentType res accept = CoinAPIMarketDataRESTRequest
  { rMethod  :: NH.Method   -- ^ Method of CoinAPIMarketDataRESTRequest
  , rUrlPath :: [BCL.ByteString] -- ^ Endpoint of CoinAPIMarketDataRESTRequest
  , rParams   :: Params -- ^ params of CoinAPIMarketDataRESTRequest
  , rAuthTypes :: [P.TypeRep] -- ^ types of auth methods
  }
  deriving (P.Show)

-- | 'rMethod' Lens
rMethodL :: Lens_' (CoinAPIMarketDataRESTRequest req contentType res accept) NH.Method
rMethodL f CoinAPIMarketDataRESTRequest{..} = (\rMethod -> CoinAPIMarketDataRESTRequest { rMethod, ..} ) <$> f rMethod
{-# INLINE rMethodL #-}

-- | 'rUrlPath' Lens
rUrlPathL :: Lens_' (CoinAPIMarketDataRESTRequest req contentType res accept) [BCL.ByteString]
rUrlPathL f CoinAPIMarketDataRESTRequest{..} = (\rUrlPath -> CoinAPIMarketDataRESTRequest { rUrlPath, ..} ) <$> f rUrlPath
{-# INLINE rUrlPathL #-}

-- | 'rParams' Lens
rParamsL :: Lens_' (CoinAPIMarketDataRESTRequest req contentType res accept) Params
rParamsL f CoinAPIMarketDataRESTRequest{..} = (\rParams -> CoinAPIMarketDataRESTRequest { rParams, ..} ) <$> f rParams
{-# INLINE rParamsL #-}

-- | 'rParams' Lens
rAuthTypesL :: Lens_' (CoinAPIMarketDataRESTRequest req contentType res accept) [P.TypeRep]
rAuthTypesL f CoinAPIMarketDataRESTRequest{..} = (\rAuthTypes -> CoinAPIMarketDataRESTRequest { rAuthTypes, ..} ) <$> f rAuthTypes
{-# INLINE rAuthTypesL #-}
...
class HasBodyParam req param where
  setBodyParam :: forall contentType res accept. (Consumes req contentType, MimeRender contentType param) => CoinAPIMarketDataRESTRequest req contentType res accept -> param -> CoinAPIMarketDataRESTRequest req contentType res accept
  setBodyParam req xs =
...
class HasOptionalParam req param where
  ...
  applyOptionalParam :: CoinAPIMarketDataRESTRequest req contentType res accept -> param -> CoinAPIMarketDataRESTRequest req contentType res accept
  applyOptionalParam = (-&-)
  {-# INLINE applyOptionalParam #-}

  -- | infix operator \/ alias for 'addOptionalParam'
  (-&-) :: CoinAPIMarketDataRESTRequest req contentType res accept -> param -> CoinAPIMarketDataRESTRequest req contentType res accept
  (-&-) = applyOptionalParam
  {-# INLINE (-&-) #-}
...
-- ** CoinAPIMarketDataRESTRequest Utils

_mkRequest :: NH.Method -- ^ Method
          -> [BCL.ByteString] -- ^ Endpoint
          -> CoinAPIMarketDataRESTRequest req contentType res accept -- ^ req: Request Type, res: Response Type
_mkRequest m u = CoinAPIMarketDataRESTRequest m u _mkParams []

_mkParams :: Params
_mkParams = Params [] [] ParamBodyNone

setHeader ::
     CoinAPIMarketDataRESTRequest req contentType res accept
  -> [NH.Header]
  -> CoinAPIMarketDataRESTRequest req contentType res accept
...
removeHeader :: CoinAPIMarketDataRESTRequest req contentType res accept -> [NH.HeaderName] -> CoinAPIMarketDataRESTRequest req contentType res accept
...
_setContentTypeHeader :: forall req contentType res accept. MimeType contentType => CoinAPIMarketDataRESTRequest req contentType res accept -> CoinAPIMarketDataRESTRequest req contentType res accept
_setContentTypeHeader req =
    case mimeType (P.Proxy :: P.Proxy contentType) of
        Just m -> req `setHeader` [("content-type", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["content-type"]

_setAcceptHeader :: forall req contentType res accept. MimeType accept => CoinAPIMarketDataRESTRequest req contentType res accept -> CoinAPIMarketDataRESTRequest req contentType res accept
...
addForm :: CoinAPIMarketDataRESTRequest req contentType res accept -> WH.Form -> CoinAPIMarketDataRESTRequest req contentType res accept
addForm req newform =
...
_addMultiFormPart :: CoinAPIMarketDataRESTRequest req contentType res accept -> NH.Part -> CoinAPIMarketDataRESTRequest req contentType res accept
...
_setBodyBS :: CoinAPIMarketDataRESTRequest req contentType res accept -> B.ByteString -> CoinAPIMarketDataRESTRequest req contentType res accept
_setBodyBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyB body)

_setBodyLBS :: CoinAPIMarketDataRESTRequest req contentType res accept -> BL.ByteString -> CoinAPIMarketDataRESTRequest req contentType res accept
_setBodyLBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyBL body)

_hasAuthType :: AuthMethod authMethod => CoinAPIMarketDataRESTRequest req contentType res accept -> P.Proxy authMethod -> CoinAPIMarketDataRESTRequest req contentType res accept
...
class P.Typeable a =>
  ...
  applyAuthMethod
    ...
    -> a
    -> CoinAPIMarketDataRESTRequest req contentType res accept
    -> IO (CoinAPIMarketDataRESTRequest req contentType res accept)
...
_applyAuthMethods
  ...
  -> CoinAPIMarketDataRESTConfig
  -> IO (CoinAPIMarketDataRESTRequest req contentType res accept)
_applyAuthMethods req config@(CoinAPIMarketDataRESTConfig {configAuthMethods = as}) =
  foldlM go req as
  where
