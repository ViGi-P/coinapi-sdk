...
local function new_options_api(authority, basePath, schemes)
	local schemes_map = {}
...
function options_api:v1_options_exchange_id_current_get(exchange_id)
	local req = http_request.new_from_uri({
		scheme = self.default_scheme;
		host = self.host;
		port = self.port;
		path = string.format("%s/v1/options/%s/current",
