...
local metrics_v1_api = {}
local metrics_v1_api_mt = {
	__name = "metrics_v1_api";
	__index = metrics_v1_api;
}

local function new_metrics_v1_api(authority, basePath, schemes)
	local schemes_map = {}
...
function metrics_v1_api:v1_metrics_asset_current_get(metric_id, asset_id, asset_id_external, exchange_id)
...
function metrics_v1_api:v1_metrics_asset_history_get(metric_id, exchange_id, asset_id, asset_id_external, time_start, time_end, time_format, period_id, limit)
	local req = http_request.new_from_uri({
		scheme = self.default_scheme;
		host = self.host;
		port = self.port;
...
function metrics_v1_api:v1_metrics_asset_listing_get(metric_id, exchange_id, chain_id, network_id, asset_id, asset_id_external)
	local req = http_request.new_from_uri({
		scheme = self.default_scheme;
		host = self.host;
		port = self.port;
...
function metrics_v1_api:v1_metrics_exchange_current_get(exchange_id, metric_id)
	local req = http_request.new_from_uri({
		scheme = self.default_scheme;
		host = self.host;
		port = self.port;
...
function metrics_v1_api:v1_metrics_exchange_history_get(metric_id, exchange_id, time_start, time_end, time_format, period_id, limit)
	local req = http_request.new_from_uri({
		scheme = self.default_scheme;
		host = self.host;
		port = self.port;
...
function metrics_v1_api:v1_metrics_exchange_listing_get(exchange_id, metric_id)
	local req = http_request.new_from_uri({
		scheme = self.default_scheme;
		host = self.host;
		port = self.port;
...
function metrics_v1_api:v1_metrics_listing_get()
	local req = http_request.new_from_uri({
		scheme = self.default_scheme;
		host = self.host;
		port = self.port;
...
function metrics_v1_api:v1_metrics_symbol_current_get(metric_id, symbol_id, exchange_id)
	local req = http_request.new_from_uri({
		scheme = self.default_scheme;
		host = self.host;
		port = self.port;
...
function metrics_v1_api:v1_metrics_symbol_history_get(metric_id, symbol_id, time_start, time_end, time_format, period_id, limit)
	local req = http_request.new_from_uri({
		scheme = self.default_scheme;
		host = self.host;
		port = self.port;
...
function metrics_v1_api:v1_metrics_symbol_listing_get(metric_id, exchange_id, symbol_id)
	local req = http_request.new_from_uri({
		scheme = self.default_scheme;
		host = self.host;
		port = self.port;
