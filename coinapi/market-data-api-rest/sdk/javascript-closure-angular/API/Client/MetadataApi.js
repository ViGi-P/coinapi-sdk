...
API.Client.MetadataApi.prototype.v1SymbolsExchangeIdActiveGet = function(exchangeId, opt_filterSymbolId, opt_filterAssetId, opt_extraHttpRequestParams) {
  /** @const {string} */
  var path = this.basePath_ + '/v1/symbols/{exchange_id}/active'
      .replace('{' + 'exchange_id' + '}', String(exchangeId));
  ...
  // verify required parameter 'exchangeId' is set
  if (!exchangeId) {
    throw new Error('Missing required parameter exchangeId when calling v1SymbolsExchangeIdActiveGet');
  }
...
API.Client.MetadataApi.prototype.v1SymbolsExchangeIdHistoryGet = function(exchangeId, opt_page, opt_limit, opt_extraHttpRequestParams) {
  /** @const {string} */
  var path = this.basePath_ + '/v1/symbols/{exchange_id}/history'
      .replace('{' + 'exchange_id' + '}', String(exchangeId));
