...
void main() {
  ...
  group(MetadataApi, () {
    ...
    //
    //Future<BuiltList<MarketDataMetadataAsset>> v1AssetsAssetIdGet(String assetId) async
    ...
    //
    //Future<BuiltList<MarketDataMetadataAsset>> v1AssetsGet({ String filterAssetId }) async
    ...
    //
    //Future<BuiltList<MarketDataMetadataIcon>> v1AssetsIconsSizeGet(int size) async
    ...
    //
    //Future<BuiltList<MarketDataMetadataChain>> v1ChainsChainIdGet(String chainId) async
    ...
    //
    //Future<BuiltList<MarketDataMetadataChain>> v1ChainsGet({ String filterChainId }) async
    ...
    //
    //Future<BuiltList<MarketDataMetadataExchange>> v1ExchangesExchangeIdGet(String exchangeId) async
    ...
    //
    //Future<BuiltList<MarketDataMetadataExchange>> v1ExchangesGet({ String filterExchangeId }) async
    ...
    //
    //Future<BuiltList<MarketDataMetadataIcon>> v1ExchangesIconsSizeGet(int size) async
    ...
    //
    //Future<BuiltList<MarketDataMetadataSymbol>> v1SymbolsExchangeIdActiveGet(String exchangeId, { String filterSymbolId, String filterAssetId }) async
    ...
    //
    //Future<BuiltList<MarketDataMetadataSymbol>> v1SymbolsExchangeIdHistoryGet(String exchangeId, { int page, int limit }) async
    ...
    //
    //Future<BuiltList<V1SymbolMapping>> v1SymbolsMapExchangeIdGet(String exchangeId) async
    test('test v1SymbolsMapExchangeIdGet', () async {
      // TODO
    });
