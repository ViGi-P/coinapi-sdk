...
void main() {
  ...
  group(MetadataApi, () {
    ...
    //
    //Future<BuiltList<V1Chain>> v1ChainsChainIdGet(String chainId) async
    ...
    //
    //Future<BuiltList<V1Chain>> v1ChainsGet({ String filterChainId }) async
    ...
    //
    //Future<BuiltList<V1Exchange>> v1ExchangesExchangeIdGet(String exchangeId) async
    ...
    //
    //Future<BuiltList<V1Exchange>> v1ExchangesGet({ String filterExchangeId }) async
    ...
    //
    //Future<BuiltList<V1Icon>> v1ExchangesIconsSizeGet(int size) async
    ...
    //
    //Future<BuiltList<V1Symbol>> v1SymbolsExchangeIdGet(String exchangeId, { String filterSymbolId, String filterAssetId }) async
    ...
    //
    //Future<BuiltList<V1Symbol>> v1SymbolsExchangeIdHistoryGet(String exchangeId, { int page, int limit }) async
    ...
    //
    //Future<BuiltList<V1Symbol>> v1SymbolsGet({ String filterSymbolId, String filterExchangeId, String filterAssetId }) async
    test('test v1SymbolsGet', () async {
      // TODO
    });
