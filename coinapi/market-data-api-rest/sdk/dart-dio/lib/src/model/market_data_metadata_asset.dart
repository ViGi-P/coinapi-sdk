...
part 'market_data_metadata_asset.g.dart';
...
/// * [dataEnd] 
@BuiltValue()
abstract class MarketDataMetadataAsset implements Built<MarketDataMetadataAsset, MarketDataMetadataAssetBuilder> {
  ...
  MarketDataMetadataAsset._();

  factory MarketDataMetadataAsset([void updates(MarketDataMetadataAssetBuilder b)]) = _$MarketDataMetadataAsset;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(MarketDataMetadataAssetBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<MarketDataMetadataAsset> get serializer => _$MarketDataMetadataAssetSerializer();
}

class _$MarketDataMetadataAssetSerializer implements PrimitiveSerializer<MarketDataMetadataAsset> {
  @override
  final Iterable<Type> types = const [MarketDataMetadataAsset, _$MarketDataMetadataAsset];

  @override
  final String wireName = r'MarketDataMetadataAsset';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    MarketDataMetadataAsset object, {
  ...
  void _deserializeProperties(
    ...
    required MarketDataMetadataAssetBuilder result,
  ...
  @override
  MarketDataMetadataAsset deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = MarketDataMetadataAssetBuilder();
