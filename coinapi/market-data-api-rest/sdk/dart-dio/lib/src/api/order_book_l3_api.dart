...
class OrderBookL3Api {
  ...
  const OrderBookL3Api(this._dio, this._serializers);

  /// Current order books
  /// 
  ///
  /// Parameters:
  /// * [filterSymbolId] - Comma or semicolon delimited parts of symbol identifier used to filter the response.
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<V1OrderBookBase>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<V1OrderBookBase>>> v1Orderbooks3CurrentGet({ 
    ...
    final _path = r'/v1/orderbooks3/current';
    ...
    BuiltList<V1OrderBookBase>? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BuiltList, [FullType(V1OrderBookBase)]),
      ) as BuiltList<V1OrderBookBase>;
    ...
    return Response<BuiltList<V1OrderBookBase>>(
      data: _responseData,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<V1OrderBookBase>> v1Orderbooks3SymbolIdCurrentGet({ 
    ...
    final _path = r'/v1/orderbooks3/{symbol_id}/current'.replaceAll('{' r'symbol_id' '}', encodeQueryParameter(_serializers, symbolId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
