...
namespace APIBricks.CoinAPI.MarketDataAPI.REST.V1.Model
{
    ...
    /// </summary>
    public partial class V1QuoteJsonConverter : JsonConverter<V1Quote>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="V1QuoteJsonConverter" /> class.
        /// </summary>
        public V1QuoteJsonConverter()
        {
            OnCreated();
        }
