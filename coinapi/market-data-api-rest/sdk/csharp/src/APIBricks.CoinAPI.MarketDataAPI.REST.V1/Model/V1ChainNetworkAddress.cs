...
namespace APIBricks.CoinAPI.MarketDataAPI.REST.V1.Model
{
    ...
    /// </summary>
    public partial class V1ChainNetworkAddressJsonConverter : JsonConverter<V1ChainNetworkAddress>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="V1ChainNetworkAddressJsonConverter" /> class.
        /// </summary>
        public V1ChainNetworkAddressJsonConverter()
        {
            OnCreated();
        }
