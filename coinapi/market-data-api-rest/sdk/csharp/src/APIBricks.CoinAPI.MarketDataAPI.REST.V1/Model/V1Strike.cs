...
namespace APIBricks.CoinAPI.MarketDataAPI.REST.V1.Model
{
    ...
    /// </summary>
    public partial class V1StrikeJsonConverter : JsonConverter<V1Strike>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="V1StrikeJsonConverter" /> class.
        /// </summary>
        public V1StrikeJsonConverter()
        {
            OnCreated();
        }
