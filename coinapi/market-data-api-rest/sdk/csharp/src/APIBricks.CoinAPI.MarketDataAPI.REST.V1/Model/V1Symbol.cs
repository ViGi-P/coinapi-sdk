...
namespace APIBricks.CoinAPI.MarketDataAPI.REST.V1.Model
{
    ...
    public class V1SymbolJsonConverter : JsonConverter<V1Symbol>
    {
        ...
        public void WriteProperties(Utf8JsonWriter writer, V1Symbol v1Symbol, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (v1Symbol.FutureIsInverseOption.IsSet)
                if (v1Symbol.FutureIsInverseOption.Value != null)
                    writer.WriteBoolean("future_is_inverse", v1Symbol.FutureIsInverseOption.Value!.Value);
                else
                    writer.WriteNull("future_is_inverse");

            if (v1Symbol.FutureIsQuantoOption.IsSet)
                if (v1Symbol.FutureIsQuantoOption.Value != null)
                    writer.WriteBoolean("future_is_quanto", v1Symbol.FutureIsQuantoOption.Value!.Value);
                else
            ...
            if (v1Symbol.OptionBarrierUpPriceOption.IsSet)
                if (v1Symbol.OptionBarrierUpPriceOption.Value != null)
                    writer.WriteNumber("option_barrier_up_price", v1Symbol.OptionBarrierUpPriceOption.Value!.Value);
                else
                    writer.WriteNull("option_barrier_up_price");

            if (v1Symbol.OptionBarrierUpTypeOption.IsSet)
                if (v1Symbol.OptionBarrierUpTypeOption.Value != null)
                    writer.WriteString("option_barrier_up_type", v1Symbol.OptionBarrierUpType);
                else
                    writer.WriteNull("option_barrier_up_type");

            if (v1Symbol.OptionBarrierDownPriceOption.IsSet)
                if (v1Symbol.OptionBarrierDownPriceOption.Value != null)
                    writer.WriteNumber("option_barrier_down_price", v1Symbol.OptionBarrierDownPriceOption.Value!.Value);
                else
                    writer.WriteNull("option_barrier_down_price");

            if (v1Symbol.OptionBarrierDownTypeOption.IsSet)
                if (v1Symbol.OptionBarrierDownTypeOption.Value != null)
                    writer.WriteString("option_barrier_down_type", v1Symbol.OptionBarrierDownType);
                else
