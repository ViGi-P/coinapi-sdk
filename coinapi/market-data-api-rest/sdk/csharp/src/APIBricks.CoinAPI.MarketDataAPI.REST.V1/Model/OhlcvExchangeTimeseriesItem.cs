...
namespace APIBricks.CoinAPI.MarketDataAPI.REST.V1.Model
{
    ...
    public partial class OhlcvExchangeTimeseriesItem : IValidatableObject
    {
        ...
        public string? SymbolIdCoinapi { get { return this.SymbolIdCoinapiOption.Value; } set { this.SymbolIdCoinapiOption = new(value); } }
    ...
    public class OhlcvExchangeTimeseriesItemJsonConverter : JsonConverter<OhlcvExchangeTimeseriesItem>
    {
        ...
        public void WriteProperties(Utf8JsonWriter writer, OhlcvExchangeTimeseriesItem ohlcvExchangeTimeseriesItem, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (ohlcvExchangeTimeseriesItem.SymbolIdCoinapiOption.IsSet)
                if (ohlcvExchangeTimeseriesItem.SymbolIdCoinapiOption.Value != null)
                    writer.WriteString("symbol_id_coinapi", ohlcvExchangeTimeseriesItem.SymbolIdCoinapi);
                else
