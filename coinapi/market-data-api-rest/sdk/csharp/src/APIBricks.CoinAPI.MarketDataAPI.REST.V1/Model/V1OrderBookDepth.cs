...
namespace APIBricks.CoinAPI.MarketDataAPI.REST.V1.Model
{
    ...
    /// </summary>
    public partial class V1OrderBookDepthJsonConverter : JsonConverter<V1OrderBookDepth>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="V1OrderBookDepthJsonConverter" /> class.
        /// </summary>
        public V1OrderBookDepthJsonConverter()
        {
            OnCreated();
        }
