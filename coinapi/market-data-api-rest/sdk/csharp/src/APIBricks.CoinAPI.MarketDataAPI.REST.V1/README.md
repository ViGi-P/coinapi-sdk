...
- How do I validate requests and process responses?
  Use the provided On and After methods in the Api class from the namespace APIBricks.CoinAPI.MarketDataAPI.REST.V1.Rest.DefaultApi.
...
## Api Information
- appName: CoinAPI Market Data REST API
- appVersion: v1
...
- packageCopyright: No Copyright
- packageDescription: A library generated from a OpenAPI doc
- packageGuid: {49BE2F95-04BB-4DB8-BD7C-B938082250E0}
- packageName: APIBricks.CoinAPI.MarketDataAPI.REST.V1
- packageTags: 
- packageTitle: OpenAPI Library
- packageVersion: 1.0.0
