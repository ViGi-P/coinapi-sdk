...
additionalProperties:
  packageGuid: '{BA2968FD-9F46-4568-9301-DD11A52D673E}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            IGetSpecificRateApiResponse apiResponse = await api.GetSpecificRateAsync("todo");
...
- appVersion: v1
- appDescription: Cryptocurrency market data: metadata, quotes, books, trades, OHLCV, rates, metrics, options.
