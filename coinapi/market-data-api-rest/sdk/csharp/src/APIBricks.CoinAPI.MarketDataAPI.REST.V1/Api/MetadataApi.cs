...
namespace APIBricks.CoinAPI.MarketDataAPI.REST.V1.Api
{
    ...
    public sealed partial class MetadataApi : IMetadataApi
    {
        ...
        public async Task<IV1ChainsChainIdGetApiResponse> V1ChainsChainIdGetAsync(string chainId, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    uriBuilderLocalVar.Path = HttpClient.BaseAddress.AbsolutePath == "/"
                        ? "/v1/chains/{chain_id}"
                        : string.Concat(HttpClient.BaseAddress.AbsolutePath, "/v1/chains/{chain_id}");
        ...
        public partial class V1ChainsChainIdGetApiResponse : APIBricks.CoinAPI.MarketDataAPI.REST.V1.Client.ApiResponse, IV1ChainsChainIdGetApiResponse
        {
            ...
            /// The logger
            /// </summary>
            public ILogger<V1ChainsChainIdGetApiResponse> Logger { get; }
        ...
        public async Task<IV1ChainsGetApiResponse> V1ChainsGetAsync(Option<string> filterChainId = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    uriBuilderLocalVar.Path = HttpClient.BaseAddress.AbsolutePath == "/"
                        ? "/v1/chains"
                        : string.Concat(HttpClient.BaseAddress.AbsolutePath, "/v1/chains");
        ...
        public partial class V1ChainsGetApiResponse : APIBricks.CoinAPI.MarketDataAPI.REST.V1.Client.ApiResponse, IV1ChainsGetApiResponse
        {
            ...
            /// The logger
            /// </summary>
            public ILogger<V1ChainsGetApiResponse> Logger { get; }
            ...
            try
            {
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        V1SymbolsExchangeIdActiveGetApiResponse apiResponseLocalVar = new(apiResponseLoggerLocalVar, httpRequestMessageLocalVar, httpResponseMessageLocalVar, responseContentLocalVar, "/v1/symbols/{exchange_id}/active", requestedAtLocalVar, _jsonSerializerOptions);
