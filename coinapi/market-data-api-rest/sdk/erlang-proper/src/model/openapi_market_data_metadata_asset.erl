-module(openapi_market_data_metadata_asset).

-include("openapi.hrl").

-export([openapi_market_data_metadata_asset/0]).

-export([openapi_market_data_metadata_asset/1]).

-export_type([openapi_market_data_metadata_asset/0]).

-type openapi_market_data_metadata_asset() ::
  [ {'asset_id', binary() }
  | {'name', binary() }
...
openapi_market_data_metadata_asset() ->
    openapi_market_data_metadata_asset([]).

openapi_market_data_metadata_asset(Fields) ->
