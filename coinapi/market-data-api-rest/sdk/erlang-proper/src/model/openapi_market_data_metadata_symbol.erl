-module(openapi_market_data_metadata_symbol).

-include("openapi.hrl").

-export([openapi_market_data_metadata_symbol/0]).

-export([openapi_market_data_metadata_symbol/1]).

-export_type([openapi_market_data_metadata_symbol/0]).

-type openapi_market_data_metadata_symbol() ::
  [ {'symbol_id', binary() }
  | {'exchange_id', binary() }
  | {'symbol_type', binary() }
...
openapi_market_data_metadata_symbol() ->
    openapi_market_data_metadata_symbol([]).

openapi_market_data_metadata_symbol(Fields) ->
