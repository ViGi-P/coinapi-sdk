...
class OptionsApi:
    ...
    @validate_call
    def v1_options_exchange_id_current_get(
        self,
        ...
        _param = self._v1_options_exchange_id_current_get_serialize(
    ...
    @validate_call
    def v1_options_exchange_id_current_get_with_http_info(
        self,
        exchange_id: Annotated[StrictStr, Field(description="Exchange identifier (from the Metadata -> Exchanges)")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def v1_options_exchange_id_current_get_without_preload_content(
        self,
        exchange_id: Annotated[StrictStr, Field(description="Exchange identifier (from the Metadata -> Exchanges)")],
        _request_timeout: Union[
            None,
    ...
    def _v1_options_exchange_id_current_get_serialize(
        self,
        exchange_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/options/{exchange_id}/current',
