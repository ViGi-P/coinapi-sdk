...
class OHLCVApi:
    ...
    @validate_call
    def v1_ohlcv_exchanges_exchange_id_history_get(
        self,
        ...
        _param = self._v1_ohlcv_exchanges_exchange_id_history_get_serialize(
    ...
    @validate_call
    def v1_ohlcv_exchanges_exchange_id_history_get_with_http_info(
        self,
        exchange_id: Annotated[StrictStr, Field(description="Exchange identifier of requested timeseries (from the Metadata -> Exchanges)")],
        period_id: Annotated[StrictStr, Field(description="Identifier of requested timeseries period (e.g. `5SEC` or `1DAY`)")],
        time_start: Annotated[StrictStr, Field(description="Timeseries starting time in ISO 8601")],
    ...
    @validate_call
    def v1_ohlcv_exchanges_exchange_id_history_get_without_preload_content(
        self,
        exchange_id: Annotated[StrictStr, Field(description="Exchange identifier of requested timeseries (from the Metadata -> Exchanges)")],
        period_id: Annotated[StrictStr, Field(description="Identifier of requested timeseries period (e.g. `5SEC` or `1DAY`)")],
        time_start: Annotated[StrictStr, Field(description="Timeseries starting time in ISO 8601")],
    ...
    def _v1_ohlcv_exchanges_exchange_id_history_get_serialize(
        self,
        exchange_id,
        period_id,
        time_start,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/ohlcv/exchanges/{exchange_id}/history',
    ...
    @validate_call
    def v1_ohlcv_symbol_id_history_get(
        self,
        ...
        _param = self._v1_ohlcv_symbol_id_history_get_serialize(
            symbol_id=symbol_id,
            period_id=period_id,
            time_start=time_start,
            time_end=time_end,
    ...
    @validate_call
    def v1_ohlcv_symbol_id_history_get_with_http_info(
        self,
        symbol_id: Annotated[StrictStr, Field(description="Symbol identifier of requested timeseries (from the Metadata -> Symbols)")],
        period_id: Annotated[StrictStr, Field(description="Identifier of requested timeseries period (e.g. `5SEC` or `2MTH`)")],
        time_start: Annotated[Optional[StrictStr], Field(description="Timeseries starting time in ISO 8601")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[V1TimeseriesItem]]:
        """Historical data
    ...
    @validate_call
    def v1_ohlcv_symbol_id_history_get_without_preload_content(
        self,
        symbol_id: Annotated[StrictStr, Field(description="Symbol identifier of requested timeseries (from the Metadata -> Symbols)")],
        period_id: Annotated[StrictStr, Field(description="Identifier of requested timeseries period (e.g. `5SEC` or `2MTH`)")],
        time_start: Annotated[Optional[StrictStr], Field(description="Timeseries starting time in ISO 8601")] = None,
    ...
    def _v1_ohlcv_symbol_id_history_get_serialize(
        self,
        symbol_id,
        period_id,
        time_start,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/ohlcv/{symbol_id}/history',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def v1_ohlcv_symbol_id_latest_get(
        self,
        symbol_id: Annotated[StrictStr, Field(description="Symbol identifier of requested timeseries (from the Metadata -> Symbols)")],
        period_id: Annotated[StrictStr, Field(description="Identifier of requested timeseries period (e.g. `5SEC` or `2MTH`)")],
        limit: Annotated[Optional[StrictInt], Field(description="Amount of items to return (mininum is 1, maximum is 100000, default value is 100, if the parameter is used then every 100 output items are counted as one request)")] = None,
        ...
        _param = self._v1_ohlcv_symbol_id_latest_get_serialize(
            symbol_id=symbol_id,
            period_id=period_id,
            limit=limit,
            _request_auth=_request_auth,
    ...
    @validate_call
    def v1_ohlcv_symbol_id_latest_get_with_http_info(
        self,
        symbol_id: Annotated[StrictStr, Field(description="Symbol identifier of requested timeseries (from the Metadata -> Symbols)")],
        period_id: Annotated[StrictStr, Field(description="Identifier of requested timeseries period (e.g. `5SEC` or `2MTH`)")],
        limit: Annotated[Optional[StrictInt], Field(description="Amount of items to return (mininum is 1, maximum is 100000, default value is 100, if the parameter is used then every 100 output items are counted as one request)")] = None,
    ...
    @validate_call
    def v1_ohlcv_symbol_id_latest_get_without_preload_content(
        self,
        symbol_id: Annotated[StrictStr, Field(description="Symbol identifier of requested timeseries (from the Metadata -> Symbols)")],
        period_id: Annotated[StrictStr, Field(description="Identifier of requested timeseries period (e.g. `5SEC` or `2MTH`)")],
        limit: Annotated[Optional[StrictInt], Field(description="Amount of items to return (mininum is 1, maximum is 100000, default value is 100, if the parameter is used then every 100 output items are counted as one request)")] = None,
    ...
    def _v1_ohlcv_symbol_id_latest_get_serialize(
        self,
        symbol_id,
        period_id,
        limit,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/ohlcv/{symbol_id}/latest',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
