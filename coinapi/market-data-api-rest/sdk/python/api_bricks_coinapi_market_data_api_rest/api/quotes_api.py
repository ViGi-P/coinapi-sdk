...
class QuotesApi:
    ...
    def _v1_quotes_current_get_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/quotes/current',
    ...
    def _v1_quotes_latest_get_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/quotes/latest',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def v1_quotes_symbol_id_current_get(
        self,
        symbol_id: Annotated[StrictStr, Field(description="The symbol identifier (from the Metadata -> Symbols)")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param symbol_id: The symbol identifier (from the Metadata -> Symbols) (required)
        :type symbol_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._v1_quotes_symbol_id_current_get_serialize(
            symbol_id=symbol_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def v1_quotes_symbol_id_current_get_with_http_info(
        self,
        symbol_id: Annotated[StrictStr, Field(description="The symbol identifier (from the Metadata -> Symbols)")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def v1_quotes_symbol_id_current_get_without_preload_content(
        self,
        symbol_id: Annotated[StrictStr, Field(description="The symbol identifier (from the Metadata -> Symbols)")],
        _request_timeout: Union[
            None,
    ...
    def _v1_quotes_symbol_id_current_get_serialize(
        self,
        symbol_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/quotes/{symbol_id}/current',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def v1_quotes_symbol_id_history_get(
        ...
        _param = self._v1_quotes_symbol_id_history_get_serialize(
            symbol_id=symbol_id,
            var_date=var_date,
    ...
    def _v1_quotes_symbol_id_history_get_serialize(
        self,
        symbol_id,
        var_date,
        time_start,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/quotes/{symbol_id}/history',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def v1_quotes_symbol_id_latest_get(
        self,
        ...
        _param = self._v1_quotes_symbol_id_latest_get_serialize(
            symbol_id=symbol_id,
            limit=limit,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def v1_quotes_symbol_id_latest_get_with_http_info(
        self,
        symbol_id: Annotated[StrictStr, Field(description="Symbol identifier of requested timeseries (from the Metadata -> Symbols)")],
        limit: Annotated[Optional[StrictInt], Field(description="Amount of items to return (optional, mininum is 1, maximum is 100000, default value is 100, if the parameter is used then every 100 output items are counted as one request)")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def v1_quotes_symbol_id_latest_get_without_preload_content(
        self,
        symbol_id: Annotated[StrictStr, Field(description="Symbol identifier of requested timeseries (from the Metadata -> Symbols)")],
        limit: Annotated[Optional[StrictInt], Field(description="Amount of items to return (optional, mininum is 1, maximum is 100000, default value is 100, if the parameter is used then every 100 output items are counted as one request)")] = None,
        _request_timeout: Union[
    ...
    def _v1_quotes_symbol_id_latest_get_serialize(
        self,
        symbol_id,
        limit,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/quotes/{symbol_id}/latest',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
