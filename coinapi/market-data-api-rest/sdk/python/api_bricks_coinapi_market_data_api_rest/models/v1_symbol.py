...
class V1Symbol(BaseModel):
    ...
    exchange_id: Optional[StrictStr] = Field(default=None, description="Gets or sets the exchange identifier.")
    symbol_type: Optional[StrictStr] = Field(default=None, description="Gets or sets the symbol type.")
    asset_id_base: Optional[StrictStr] = Field(default=None, description="Gets or sets the base asset identifier.")
    asset_id_quote: Optional[StrictStr] = Field(default=None, description="Gets or sets the quote asset identifier.")
    asset_id_unit: Optional[StrictStr] = Field(default=None, description="Gets or sets the unit asset identifier.")
    future_contract_unit: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Gets or sets the contract unit for futures.")
    future_contract_unit_asset: Optional[StrictStr] = Field(default=None, description="Gets or sets the asset used as the unit for futures contract.")
    future_delivery_time: Optional[datetime] = Field(default=None, description="Gets or sets the future delivery time for futures contract.")
    option_type_is_call: Optional[StrictBool] = Field(default=None, description="Gets or sets a value indicating whether the option type is a call.")
    option_strike_price: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Gets or sets the strike price for options.")
    option_contract_unit: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Gets or sets the contract unit for options.")
    option_exercise_style: Optional[StrictStr] = Field(default=None, description="Gets or sets the exercise style for options. Possible values: AMERICAN, ASIAN, BARRIER, BERMUDAN, BINARY, EUROPEAN, EXOTIC.")
    option_expiration_time: Optional[datetime] = Field(default=None, description="Gets or sets the expiration time for options.")
    contract_delivery_time: Optional[datetime] = Field(default=None, description="Gets or sets the delivery time for contracts.")
    contract_unit: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Gets or sets the contract unit for contracts.")
    contract_unit_asset: Optional[StrictStr] = Field(default=None, description="Gets or sets the asset used as the unit for contracts.")
    contract_id: Optional[StrictStr] = Field(default=None, description="Gets or sets the contract identifier.")
    contract_display_name: Optional[StrictStr] = Field(default=None, description="Gets or sets the display name of the contract.")
    contract_display_description: Optional[StrictStr] = Field(default=None, description="Gets or sets the display description of the contract.")
    data_start: Optional[StrictStr] = Field(default=None, description="Gets the start date of the data in string format (\"yyyy-MM-dd\").")
    data_end: Optional[StrictStr] = Field(default=None, description="Gets the end date of the data in string format (\"yyyy-MM-dd\").")
    ...
    index_id: Optional[StrictStr] = Field(default=None, description="Gets or sets the index identifier.")
    index_display_name: Optional[StrictStr] = Field(default=None, description="Gets or sets the display name of the index.")
    index_display_description: Optional[StrictStr] = Field(default=None, description="Gets or sets the display description of the index.")
    volume_1hrs: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Gets or sets the volume in the last 1 hour.")
    volume_1hrs_usd: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Gets or sets the volume in USD in the last 1 hour.")
    volume_1day: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Gets or sets the volume in the last 1 day.")
    volume_1day_usd: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Gets or sets the volume in USD in the last 1 day.")
    volume_1mth: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Gets or sets the volume in the last 1 month.")
    volume_1mth_usd: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Gets or sets the volume in USD in the last 1 month.")
    price: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Gets or sets the price.")
    symbol_id_exchange: Optional[StrictStr] = Field(default=None, description="Gets or sets the symbol identifier in the exchange.")
    asset_id_base_exchange: Optional[StrictStr] = Field(default=None, description="Gets or sets the base asset identifier in the exchange.")
    asset_id_quote_exchange: Optional[StrictStr] = Field(default=None, description="Gets or sets the quote asset identifier in the exchange.")
    ...
    raw_kvp: Optional[Dict[str, Optional[StrictStr]]] = Field(default=None, description="Key Value Pair store with raw data from the data source.")
    future_is_inverse: Optional[StrictBool] = Field(default=None, description="Gets or sets a value indicating whether the futures contract is inverse (coin-margined).")
    future_is_quanto: Optional[StrictBool] = Field(default=None, description="Gets or sets a value indicating whether the futures contract is quanto.")
    volume_to_usd: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Gets or sets the volume in USD.")
    option_barrier_up_price: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Gets or sets the up barrier price for barrier options.")
    option_barrier_up_type: Optional[StrictStr] = Field(default=None, description="Gets or sets the up barrier type for barrier options. Possible values: EXPIRATION, IN, OUT.")
    option_barrier_down_price: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Gets or sets the down barrier price for barrier options.")
    option_barrier_down_type: Optional[StrictStr] = Field(default=None, description="Gets or sets the down barrier type for barrier options. Possible values: EXPIRATION, IN, OUT.")
    symbol_id_int: Optional[StrictInt] = Field(default=None, description="Gets or sets the symbol identifier in integer immutable format, used to correlate data across different APIs.")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if future_is_inverse (nullable) is None
        # and model_fields_set contains the field
        if self.future_is_inverse is None and "future_is_inverse" in self.model_fields_set:
            _dict['future_is_inverse'] = None

        # set to None if future_is_quanto (nullable) is None
        # and model_fields_set contains the field
        if self.future_is_quanto is None and "future_is_quanto" in self.model_fields_set:
            _dict['future_is_quanto'] = None
        ...
        # set to None if option_barrier_up_price (nullable) is None
        # and model_fields_set contains the field
        if self.option_barrier_up_price is None and "option_barrier_up_price" in self.model_fields_set:
            _dict['option_barrier_up_price'] = None

        # set to None if option_barrier_up_type (nullable) is None
        # and model_fields_set contains the field
        if self.option_barrier_up_type is None and "option_barrier_up_type" in self.model_fields_set:
            _dict['option_barrier_up_type'] = None

        # set to None if option_barrier_down_price (nullable) is None
        # and model_fields_set contains the field
        if self.option_barrier_down_price is None and "option_barrier_down_price" in self.model_fields_set:
            _dict['option_barrier_down_price'] = None

        # set to None if option_barrier_down_type (nullable) is None
        # and model_fields_set contains the field
        if self.option_barrier_down_type is None and "option_barrier_down_type" in self.model_fields_set:
            _dict['option_barrier_down_type'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "future_is_inverse": obj.get("future_is_inverse"),
            "future_is_quanto": obj.get("future_is_quanto"),
            "volume_to_usd": obj.get("volume_to_usd"),
            "option_barrier_up_price": obj.get("option_barrier_up_price"),
            "option_barrier_up_type": obj.get("option_barrier_up_type"),
            "option_barrier_down_price": obj.get("option_barrier_down_price"),
            "option_barrier_down_type": obj.get("option_barrier_down_type"),
