...
class MarketDataMetadataChain(BaseModel):
    """
    Represents a blockchain chain.
    """ # noqa: E501
    chain_id: Optional[StrictStr] = Field(default=None, description="Gets or sets the chain identifier.")
    name: Optional[StrictStr] = Field(default=None, description="Gets or sets the name of the chain.")
    __properties: ClassVar[List[str]] = ["chain_id", "name"]
