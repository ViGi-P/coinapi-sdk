...
class V1Quote(BaseModel):
    ...
    time_exchange: Optional[datetime] = Field(default=None, description="Gets or sets the exchange time of the quote.")
    time_coinapi: Optional[datetime] = Field(default=None, description="Gets or sets the CoinAPI time when the quote was received.")
    ...
    __properties: ClassVar[List[str]] = ["symbol_id", "time_exchange", "time_coinapi", "ask_price", "ask_size", "bid_price", "bid_size"]
