...
class V1Quote(BaseModel):
    ...
    time_exchange: Optional[datetime] = Field(default=None, description="The exchange time of the quote.")
    time_coinapi: Optional[datetime] = Field(default=None, description="The CoinAPI time when the quote was received.")
