...
class MarketDataMetadataSymbol(BaseModel):
    """
    ...
    option_exercise_style: Optional[StrictStr] = Field(default=None, description="The exercise style for options. Possible values: AMERICAN, ASIAN, BARRIER, BERMUDAN, BINARY, EUROPEAN, EXOTIC.")
    ...
    future_is_inverse: Optional[StrictBool] = Field(default=None, description="Indicates whether the futures contract is inverse (coin-margined).")
    future_is_quanto: Optional[StrictBool] = Field(default=None, description="Indicates whether the futures contract is quanto.")
    volume_to_usd: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Volume unit in USD.")
    option_barrier_up_price: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The up barrier price for barrier options.")
    option_barrier_up_type: Optional[StrictStr] = Field(default=None, description="The up barrier type for barrier options. Possible values: EXPIRATION, IN, OUT.")
    option_barrier_down_price: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The down barrier price for barrier options.")
    option_barrier_down_type: Optional[StrictStr] = Field(default=None, description="The down barrier type for barrier options. Possible values: EXPIRATION, IN, OUT.")
