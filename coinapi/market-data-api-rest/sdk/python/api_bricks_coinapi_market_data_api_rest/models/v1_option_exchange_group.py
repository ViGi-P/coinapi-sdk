...
class V1OptionExchangeGroup(BaseModel):
    """
    ...
    underlying_price: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Gets or sets the underlying price of the option.")
    time_expiration: Optional[datetime] = Field(default=None, description="Gets or sets the expiration time of the option.")
    strikes: Optional[List[V1Strike]] = Field(default=None, description="Gets or sets the list of strikes available.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "strikes": [V1Strike.from_dict(_item) for _item in obj["strikes"]] if obj.get("strikes") is not None else None
        })
        return _obj
