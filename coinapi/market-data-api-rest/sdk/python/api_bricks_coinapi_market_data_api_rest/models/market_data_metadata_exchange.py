...
class MarketDataMetadataExchange(BaseModel):
    """
    ...
    icons: Optional[List[MarketDataMetadataIcon]] = Field(default=None, description="Gets or sets the list of icons for the exchange.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "icons": [MarketDataMetadataIcon.from_dict(_item) for _item in obj["icons"]] if obj.get("icons") is not None else None,
            "rank": obj.get("rank"),
