...
class MarketDataMetadataIcon(BaseModel):
    """
    Represents an icon.
    """ # noqa: E501
    exchange_id: Optional[StrictStr] = Field(default=None, description="Gets or sets the exchange ID associated with the icon.")
    asset_id: Optional[StrictStr] = Field(default=None, description="Gets or sets the asset ID associated with the icon.")
    url: Optional[StrictStr] = Field(default=None, description="Gets or sets the URL of the icon.")
    __properties: ClassVar[List[str]] = ["exchange_id", "asset_id", "url"]
