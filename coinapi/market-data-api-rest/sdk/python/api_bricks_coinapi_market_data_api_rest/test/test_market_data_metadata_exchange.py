...
class TestMarketDataMetadataExchange(unittest.TestCase):
    """MarketDataMetadataExchange unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MarketDataMetadataExchange:
        """Test MarketDataMetadataExchange
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MarketDataMetadataExchange`
        """
        model = MarketDataMetadataExchange()
        if include_optional:
            return MarketDataMetadataExchange(
                ...
                icons = [
                    api_bricks_coinapi_market_data_api_rest.models.market_data_metadata/icon.MarketDataMetadata.Icon(
                        exchange_id = '', 
                        asset_id = '', 
                        url = '', )
                    ],
    ...
    def testMarketDataMetadataExchange(self):
        """Test MarketDataMetadataExchange"""
