...
class TestV1OrderBookBase(unittest.TestCase):
    """V1OrderBookBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1OrderBookBase:
        """Test V1OrderBookBase
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1OrderBookBase`
        """
        model = V1OrderBookBase()
        if include_optional:
