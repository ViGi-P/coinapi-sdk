...
class TestMarketDataMetadataSymbol(unittest.TestCase):
    """MarketDataMetadataSymbol unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MarketDataMetadataSymbol:
        """Test MarketDataMetadataSymbol
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MarketDataMetadataSymbol`
        """
        model = MarketDataMetadataSymbol()
        if include_optional:
            return MarketDataMetadataSymbol(
                ...
                volume_to_usd = 1.337,
                option_barrier_up_price = 1.337,
                option_barrier_up_type = '',
                option_barrier_down_price = 1.337,
    ...
    def testMarketDataMetadataSymbol(self):
        """Test MarketDataMetadataSymbol"""
