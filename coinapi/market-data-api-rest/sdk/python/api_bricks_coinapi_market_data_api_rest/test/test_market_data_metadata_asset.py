...
class TestMarketDataMetadataAsset(unittest.TestCase):
    """MarketDataMetadataAsset unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MarketDataMetadataAsset:
        """Test MarketDataMetadataAsset
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MarketDataMetadataAsset`
        """
        model = MarketDataMetadataAsset()
        if include_optional:
            return MarketDataMetadataAsset(
                ...
                supply_max = 1.337,
                chain_addresses = [
                    api_bricks_coinapi_market_data_api_rest.models.v1/chain_network_address.v1.ChainNetworkAddress(
                        chain_id = '', 
                        network_id = '', 
                        address = '', )
                    ],
    ...
    def testMarketDataMetadataAsset(self):
        """Test MarketDataMetadataAsset"""
