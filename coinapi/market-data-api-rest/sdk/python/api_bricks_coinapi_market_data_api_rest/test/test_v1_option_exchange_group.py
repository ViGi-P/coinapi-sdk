...
class TestV1OptionExchangeGroup(unittest.TestCase):
    """V1OptionExchangeGroup unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1OptionExchangeGroup:
        ...
        if include_optional:
            return V1OptionExchangeGroup(
                ...
                strikes = [
                    api_bricks_coinapi_market_data_api_rest.models.v1/strike.v1.Strike(
                        strike_price = 1.337, 
    ...
    def testV1OptionExchangeGroup(self):
        """Test V1OptionExchangeGroup"""
