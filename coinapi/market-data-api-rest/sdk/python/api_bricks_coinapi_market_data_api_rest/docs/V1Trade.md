...
**user_taker** | **str** | Wallet address of the taker (aggressive) side. Present only for L4 data sources. | [optional] 
**user_maker** | **str** | Wallet address of the maker (passive) side. Present only for L4 data sources. | [optional] 
