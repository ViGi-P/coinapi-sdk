...
**symbol_id** | **str** | Gets or sets the CoinAPI symbol ID. Null for exchange-level metrics. | [optional] 
**symbol_id_external** | **str** | Gets or sets the exchange-native symbol ID. Null for exchange-level metrics. | [optional] 
**exchange_id** | **str** | Gets or sets the exchange ID. | [optional] 
**asset_id** | **str** | Gets or sets the asset ID. | [optional] 
**asset_id_external** | **str** | Gets or sets the asset ID. | [optional] 
