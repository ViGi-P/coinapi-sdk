...
**option_exercise_style** | **char \*** | The exercise style for options. Possible values: AMERICAN, ASIAN, BARRIER, BERMUDAN, BINARY, EUROPEAN, EXOTIC. | [optional] 
...
**future_is_inverse** | **int** | Indicates whether the futures contract is inverse (coin-margined). | [optional] 
**future_is_quanto** | **int** | Indicates whether the futures contract is quanto. | [optional] 
...
**option_barrier_up_type** | **char \*** | The up barrier type for barrier options. Possible values: EXPIRATION, IN, OUT. | [optional] 
**option_barrier_down_price** | **double** | The down barrier price for barrier options. | [optional] 
**option_barrier_down_type** | **char \*** | The down barrier type for barrier options. Possible values: EXPIRATION, IN, OUT. | [optional] 
