...
static v1_timeseries_item_t *v1_timeseries_item_create_internal(
    ...
    memset(v1_timeseries_item_local_var, 0, sizeof(v1_timeseries_item_t));
...
__attribute__((deprecated)) v1_timeseries_item_t *v1_timeseries_item_create(
    ...
    v1_timeseries_item_t *result = v1_timeseries_item_create_internal (
        time_period_start,
        time_period_end,
        time_open,
        time_close,
...
void v1_timeseries_item_free(v1_timeseries_item_t *v1_timeseries_item) {
    ...
    if (v1_timeseries_item->price_open) {
        free(v1_timeseries_item->price_open);
        v1_timeseries_item->price_open = NULL;
    }
    if (v1_timeseries_item->price_high) {
        free(v1_timeseries_item->price_high);
        v1_timeseries_item->price_high = NULL;
    }
    if (v1_timeseries_item->price_low) {
        free(v1_timeseries_item->price_low);
        v1_timeseries_item->price_low = NULL;
    }
    if (v1_timeseries_item->price_close) {
        free(v1_timeseries_item->price_close);
        v1_timeseries_item->price_close = NULL;
    }
    if (v1_timeseries_item->volume_traded) {
        free(v1_timeseries_item->volume_traded);
        v1_timeseries_item->volume_traded = NULL;
    }
    if (v1_timeseries_item->trades_count) {
        free(v1_timeseries_item->trades_count);
        v1_timeseries_item->trades_count = NULL;
    }
...
v1_timeseries_item_t *v1_timeseries_item_parseFromJSON(cJSON *v1_timeseries_itemJSON){
    ...
    // define the local variable for v1_timeseries_item->price_open
    double *price_open_local_var = NULL;

    // define the local variable for v1_timeseries_item->price_high
    double *price_high_local_var = NULL;

    // define the local variable for v1_timeseries_item->price_low
    double *price_low_local_var = NULL;

    // define the local variable for v1_timeseries_item->price_close
    double *price_close_local_var = NULL;

    // define the local variable for v1_timeseries_item->volume_traded
    double *volume_traded_local_var = NULL;

    // define the local variable for v1_timeseries_item->trades_count
