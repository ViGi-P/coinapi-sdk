# CoinApiMarketDataRestApi.MarketDataMetadataSymbol
...
**optionBarrierUpPrice** | **Number** | The up barrier price for barrier options. | [optional] 
**optionBarrierUpType** | **String** | The up barrier type for barrier options. Possible values: EXPIRATION, IN, OUT. | [optional] 
**optionBarrierDownPrice** | **Number** | The down barrier price for barrier options. | [optional] 
