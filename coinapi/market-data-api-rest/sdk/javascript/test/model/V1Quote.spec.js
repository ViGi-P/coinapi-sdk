...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoinApiMarketDataRestApi.V1Quote();
  });
  ...
  describe('V1Quote', function() {
    it('should create an instance of V1Quote', function() {
      // uncomment below and update the code to test V1Quote
      //var instance = new CoinApiMarketDataRestApi.V1Quote();
      //expect(instance).to.be.a(CoinApiMarketDataRestApi.V1Quote);
    });
