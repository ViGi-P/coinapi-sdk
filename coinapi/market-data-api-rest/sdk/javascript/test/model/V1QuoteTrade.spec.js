...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoinApiMarketDataRestApi.V1QuoteTrade();
  });
  ...
  describe('V1QuoteTrade', function() {
    it('should create an instance of V1QuoteTrade', function() {
      // uncomment below and update the code to test V1QuoteTrade
      //var instance = new CoinApiMarketDataRestApi.V1QuoteTrade();
      //expect(instance).to.be.a(CoinApiMarketDataRestApi.V1QuoteTrade);
    });
