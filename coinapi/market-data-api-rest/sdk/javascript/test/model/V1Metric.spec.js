...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoinApiMarketDataRestApi.V1Metric();
  });
  ...
  describe('V1Metric', function() {
    it('should create an instance of V1Metric', function() {
      // uncomment below and update the code to test V1Metric
      //var instance = new CoinApiMarketDataRestApi.V1Metric();
      //expect(instance).to.be.a(CoinApiMarketDataRestApi.V1Metric);
    });
