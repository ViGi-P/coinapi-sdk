...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoinApiMarketDataRestApi.V1MetricInfo();
  });
  ...
  describe('V1MetricInfo', function() {
    it('should create an instance of V1MetricInfo', function() {
      ...
      //var instance = new CoinApiMarketDataRestApi.V1MetricInfo();
      //expect(instance).to.be.a(CoinApiMarketDataRestApi.V1MetricInfo);
    });
