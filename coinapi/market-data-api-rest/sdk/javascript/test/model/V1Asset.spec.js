...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoinApiMarketDataRestApi.V1Asset();
  });
  ...
  describe('V1Asset', function() {
    it('should create an instance of V1Asset', function() {
      ...
      //var instance = new CoinApiMarketDataRestApi.V1Asset();
      //expect(instance).to.be.a(CoinApiMarketDataRestApi.V1Asset);
    });
