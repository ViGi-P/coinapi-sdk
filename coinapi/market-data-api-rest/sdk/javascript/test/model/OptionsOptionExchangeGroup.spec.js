...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoinApiMarketDataRestApi.OptionsOptionExchangeGroup();
  });
  ...
  describe('OptionsOptionExchangeGroup', function() {
    it('should create an instance of OptionsOptionExchangeGroup', function() {
      // uncomment below and update the code to test OptionsOptionExchangeGroup
      //var instance = new CoinApiMarketDataRestApi.OptionsOptionExchangeGroup();
      //expect(instance).to.be.a(CoinApiMarketDataRestApi.OptionsOptionExchangeGroup);
    });
