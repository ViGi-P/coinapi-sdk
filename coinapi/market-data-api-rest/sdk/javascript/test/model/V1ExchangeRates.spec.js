...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoinApiMarketDataRestApi.V1ExchangeRates();
  });
  ...
  describe('V1ExchangeRates', function() {
    it('should create an instance of V1ExchangeRates', function() {
      ...
      //var instance = new CoinApiMarketDataRestApi.V1ExchangeRates();
      //expect(instance).to.be.a(CoinApiMarketDataRestApi.V1ExchangeRates);
    });
