...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoinApiMarketDataRestApi.V1Strike();
  });
  ...
  describe('V1Strike', function() {
    it('should create an instance of V1Strike', function() {
      // uncomment below and update the code to test V1Strike
      //var instance = new CoinApiMarketDataRestApi.V1Strike();
      //expect(instance).to.be.a(CoinApiMarketDataRestApi.V1Strike);
    });
