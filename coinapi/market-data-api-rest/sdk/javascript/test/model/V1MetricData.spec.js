...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoinApiMarketDataRestApi.V1MetricData();
  });
  ...
  describe('V1MetricData', function() {
    it('should create an instance of V1MetricData', function() {
      // uncomment below and update the code to test V1MetricData
      //var instance = new CoinApiMarketDataRestApi.V1MetricData();
      //expect(instance).to.be.a(CoinApiMarketDataRestApi.V1MetricData);
    });
