...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoinApiMarketDataRestApi.MarketDataMetadataIcon();
  });
  ...
  describe('MarketDataMetadataIcon', function() {
    it('should create an instance of MarketDataMetadataIcon', function() {
      // uncomment below and update the code to test MarketDataMetadataIcon
      //var instance = new CoinApiMarketDataRestApi.MarketDataMetadataIcon();
      //expect(instance).to.be.a(CoinApiMarketDataRestApi.MarketDataMetadataIcon);
    });
