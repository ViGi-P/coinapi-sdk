...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoinApiMarketDataRestApi.V1ExchangeRatesRate();
  });
  ...
  describe('V1ExchangeRatesRate', function() {
    it('should create an instance of V1ExchangeRatesRate', function() {
      ...
      //var instance = new CoinApiMarketDataRestApi.V1ExchangeRatesRate();
      //expect(instance).to.be.a(CoinApiMarketDataRestApi.V1ExchangeRatesRate);
    });
