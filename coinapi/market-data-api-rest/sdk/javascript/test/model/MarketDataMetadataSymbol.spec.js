...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoinApiMarketDataRestApi.MarketDataMetadataSymbol();
  });
  ...
  describe('MarketDataMetadataSymbol', function() {
    it('should create an instance of MarketDataMetadataSymbol', function() {
      // uncomment below and update the code to test MarketDataMetadataSymbol
      //var instance = new CoinApiMarketDataRestApi.MarketDataMetadataSymbol();
      //expect(instance).to.be.a(CoinApiMarketDataRestApi.MarketDataMetadataSymbol);
    });
    ...
    it('should have the property futureIsInverse (base name: "future_is_inverse")', function() {
      // uncomment below and update the code to test the property futureIsInverse
      //var instance = new CoinApiMarketDataRestApi.MarketDataMetadataSymbol();
      //expect(instance).to.be();
    });

    it('should have the property futureIsQuanto (base name: "future_is_quanto")', function() {
      // uncomment below and update the code to test the property futureIsQuanto
      //var instance = new CoinApiMarketDataRestApi.MarketDataMetadataSymbol();
      //expect(instance).to.be();
    });
    ...
    it('should have the property optionBarrierUpPrice (base name: "option_barrier_up_price")', function() {
      // uncomment below and update the code to test the property optionBarrierUpPrice
      //var instance = new CoinApiMarketDataRestApi.MarketDataMetadataSymbol();
      //expect(instance).to.be();
    });

    it('should have the property optionBarrierUpType (base name: "option_barrier_up_type")', function() {
      // uncomment below and update the code to test the property optionBarrierUpType
      //var instance = new CoinApiMarketDataRestApi.MarketDataMetadataSymbol();
      //expect(instance).to.be();
    });

    it('should have the property optionBarrierDownPrice (base name: "option_barrier_down_price")', function() {
      // uncomment below and update the code to test the property optionBarrierDownPrice
      //var instance = new CoinApiMarketDataRestApi.MarketDataMetadataSymbol();
      //expect(instance).to.be();
    });

    it('should have the property optionBarrierDownType (base name: "option_barrier_down_type")', function() {
      // uncomment below and update the code to test the property optionBarrierDownType
      //var instance = new CoinApiMarketDataRestApi.MarketDataMetadataSymbol();
      //expect(instance).to.be();
    });

    it('should have the property symbolIdInt (base name: "symbol_id_int")', function() {
      // uncomment below and update the code to test the property symbolIdInt
      //var instance = new CoinApiMarketDataRestApi.MarketDataMetadataSymbol();
      //expect(instance).to.be();
    });
