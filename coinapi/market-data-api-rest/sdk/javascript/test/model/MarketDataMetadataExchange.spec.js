...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoinApiMarketDataRestApi.MarketDataMetadataExchange();
  });
  ...
  describe('MarketDataMetadataExchange', function() {
    it('should create an instance of MarketDataMetadataExchange', function() {
      // uncomment below and update the code to test MarketDataMetadataExchange
      //var instance = new CoinApiMarketDataRestApi.MarketDataMetadataExchange();
      //expect(instance).to.be.a(CoinApiMarketDataRestApi.MarketDataMetadataExchange);
    });
