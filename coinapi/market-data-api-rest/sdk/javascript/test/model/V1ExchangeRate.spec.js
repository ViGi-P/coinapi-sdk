...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoinApiMarketDataRestApi.V1ExchangeRate();
  });
  ...
  describe('V1ExchangeRate', function() {
    it('should create an instance of V1ExchangeRate', function() {
      ...
      //var instance = new CoinApiMarketDataRestApi.V1ExchangeRate();
      //expect(instance).to.be.a(CoinApiMarketDataRestApi.V1ExchangeRate);
    });
