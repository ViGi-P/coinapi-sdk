...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoinApiMarketDataRestApi.V1SymbolMapping();
  });
  ...
  describe('V1SymbolMapping', function() {
    it('should create an instance of V1SymbolMapping', function() {
      ...
      //var instance = new CoinApiMarketDataRestApi.V1SymbolMapping();
      //expect(instance).to.be.a(CoinApiMarketDataRestApi.V1SymbolMapping);
    });
