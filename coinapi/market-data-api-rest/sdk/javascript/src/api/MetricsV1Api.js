...
/**
* MetricsV1 service.
* @module api/MetricsV1Api
* @version v1
*/
export default class MetricsV1Api {

    /**
    * Constructs a new MetricsV1Api. 
    * @alias module:api/MetricsV1Api
    * @class
    ...
    */
     ...
     * @callback module:api/MetricsV1Api~v1MetricsAssetCurrentGetCallback
     ...
     * @param {module:api/MetricsV1Api~v1MetricsAssetCurrentGetCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/MetricsV1Api~v1MetricsAssetHistoryGetCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/MetricsV1Api~v1MetricsAssetHistoryGetCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/MetricsV1Api~v1MetricsAssetListingGetCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/MetricsV1Api~v1MetricsAssetListingGetCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/MetricsV1Api~v1MetricsExchangeCurrentGetCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/V1GeneralData>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/MetricsV1Api~v1MetricsExchangeCurrentGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/V1GeneralData>}
     */
     ...
     * @callback module:api/MetricsV1Api~v1MetricsExchangeHistoryGetCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/V1MetricData>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} [periodId] Identifier of requested timeseries period (e.g. `5SEC` or `2MTH`), default value is `1SEC`
     * @param {Number} [limit = 100)] Amount of items to return (optional, mininum is 1, maximum is 100000, default value is 100, if the parameter is used then every 100 output items are counted as one request)
     * @param {module:api/MetricsV1Api~v1MetricsExchangeHistoryGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/V1MetricData>}
     */
     ...
     * @callback module:api/MetricsV1Api~v1MetricsExchangeListingGetCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/V1ListingItem>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} [metricId] The metric identifier (from the Metrics -> Listing)
     * @param {module:api/MetricsV1Api~v1MetricsExchangeListingGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/V1ListingItem>}
     */
     ...
     * @callback module:api/MetricsV1Api~v1MetricsListingGetCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/MetricsV1Api~v1MetricsListingGetCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/MetricsV1Api~v1MetricsSymbolCurrentGetCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/V1GeneralData>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/MetricsV1Api~v1MetricsSymbolCurrentGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/V1GeneralData>}
     */
     ...
     * @callback module:api/MetricsV1Api~v1MetricsSymbolHistoryGetCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/V1MetricData>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} [periodId] Identifier of requested timeseries period (e.g. `5SEC` or `2MTH`), default value is `1SEC`
     * @param {Number} [limit = 100)] Amount of items to return (optional, mininum is 1, maximum is 100000, default value is 100, if the parameter is used then every 100 output items are counted as one request)
     * @param {module:api/MetricsV1Api~v1MetricsSymbolHistoryGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/V1MetricData>}
     */
     ...
     * @callback module:api/MetricsV1Api~v1MetricsSymbolListingGetCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/V1ListingItem>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} [exchangeId] Exchange identifier (from the Metadata -> Exchanges)
     * @param {String} [symbolId] Symbol identifier (from the Metadata -> Symbols)
     * @param {module:api/MetricsV1Api~v1MetricsSymbolListingGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/V1ListingItem>}
     */
