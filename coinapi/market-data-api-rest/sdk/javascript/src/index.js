...
/**
* Cryptocurrency market data: metadata, quotes, books, trades, OHLCV, rates, metrics, options..<br>
* The <code>index</code> module provides access to constructors for all the classes which comprise the public API.
* <p>
* An AMD (recommended!) or CommonJS application will generally do something equivalent to the following:
* <pre>
* var CoinApiMarketDataRestApi = require('index'); // See note below*.
* var xxxSvc = new CoinApiMarketDataRestApi.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new CoinApiMarketDataRestApi.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new CoinApiMarketDataRestApi.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new CoinApiMarketDataRestApi.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
