...
/**
 * The MarketDataMetadataAsset model module.
 * @module model/MarketDataMetadataAsset
 * @version v1
 */
class MarketDataMetadataAsset {
    /**
     * Constructs a new <code>MarketDataMetadataAsset</code>.
     * Represents an asset.
     * @alias module:model/MarketDataMetadataAsset
     */
    constructor() { 
        
        MarketDataMetadataAsset.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MarketDataMetadataAsset</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MarketDataMetadataAsset} obj Optional instance to populate.
     * @return {module:model/MarketDataMetadataAsset} The populated <code>MarketDataMetadataAsset</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MarketDataMetadataAsset();
    ...
    /**
     * Validates the JSON data with respect to <code>MarketDataMetadataAsset</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MarketDataMetadataAsset</code>.
     */
 ...
 */
MarketDataMetadataAsset.prototype['asset_id'] = undefined;

/**
 * Gets or sets the name of the asset.
 * @member {String} name
 */
MarketDataMetadataAsset.prototype['name'] = undefined;

/**
 * Gets or sets a value indicating whether the asset is a cryptocurrency.
 * @member {Number} type_is_crypto
 */
MarketDataMetadataAsset.prototype['type_is_crypto'] = undefined;

/**
 * Gets or sets the start date of quote data.
 * @member {Date} data_quote_start
 */
MarketDataMetadataAsset.prototype['data_quote_start'] = undefined;

/**
 * Gets or sets the end date of quote data.
 * @member {Date} data_quote_end
 */
MarketDataMetadataAsset.prototype['data_quote_end'] = undefined;

/**
 * Gets or sets the start date of order book data.
 * @member {Date} data_orderbook_start
 */
MarketDataMetadataAsset.prototype['data_orderbook_start'] = undefined;

/**
 * Gets or sets the end date of order book data.
 * @member {Date} data_orderbook_end
 */
MarketDataMetadataAsset.prototype['data_orderbook_end'] = undefined;

/**
 * Gets or sets the start date of trade data.
 * @member {Date} data_trade_start
 */
MarketDataMetadataAsset.prototype['data_trade_start'] = undefined;

/**
 * Gets or sets the end date of trade data.
 * @member {Date} data_trade_end
 */
MarketDataMetadataAsset.prototype['data_trade_end'] = undefined;

/**
 * Gets or sets the number of symbols.
 * @member {Number} data_symbols_count
 */
MarketDataMetadataAsset.prototype['data_symbols_count'] = undefined;

/**
 * Gets or sets the USD volume in the last 1 hour.
 * @member {Number} volume_1hrs_usd
 */
MarketDataMetadataAsset.prototype['volume_1hrs_usd'] = undefined;

/**
 * Gets or sets the USD volume in the last 1 day.
 * @member {Number} volume_1day_usd
 */
MarketDataMetadataAsset.prototype['volume_1day_usd'] = undefined;

/**
 * Gets or sets the USD volume in the last 1 month.
 * @member {Number} volume_1mth_usd
 */
MarketDataMetadataAsset.prototype['volume_1mth_usd'] = undefined;

/**
 * Gets or sets the USD price of the asset.
 * @member {Number} price_usd
 */
MarketDataMetadataAsset.prototype['price_usd'] = undefined;

/**
 * Gets or sets the ID of the icon for the asset.
 * @member {String} id_icon
 */
MarketDataMetadataAsset.prototype['id_icon'] = undefined;

/**
 * Gets or sets the current supply of the asset.
 * @member {Number} supply_current
 */
MarketDataMetadataAsset.prototype['supply_current'] = undefined;

/**
 * Gets or sets the total supply of the asset.
 * @member {Number} supply_total
 */
MarketDataMetadataAsset.prototype['supply_total'] = undefined;

/**
 * Gets or sets the maximum supply of the asset.
 * @member {Number} supply_max
 */
MarketDataMetadataAsset.prototype['supply_max'] = undefined;
 ...
 */
MarketDataMetadataAsset.prototype['data_start'] = undefined;

/**
 * @member {String} data_end
 */
MarketDataMetadataAsset.prototype['data_end'] = undefined;
...
export default MarketDataMetadataAsset;
