...
/**
 * The MarketDataMetadataExchange model module.
 * @module model/MarketDataMetadataExchange
 * @version v1
 */
class MarketDataMetadataExchange {
    /**
     * Constructs a new <code>MarketDataMetadataExchange</code>.
     * Represents an exchange.
     * @alias module:model/MarketDataMetadataExchange
     */
    constructor() { 
        
        MarketDataMetadataExchange.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MarketDataMetadataExchange</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MarketDataMetadataExchange} obj Optional instance to populate.
     * @return {module:model/MarketDataMetadataExchange} The populated <code>MarketDataMetadataExchange</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MarketDataMetadataExchange();
            ...
            if (data.hasOwnProperty('icons')) {
                obj['icons'] = ApiClient.convertToType(data['icons'], [MarketDataMetadataIcon]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>MarketDataMetadataExchange</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MarketDataMetadataExchange</code>.
     */
    static validateJSON(data) {
        ...
        if (data['icons']) { // data not null
            ...
            for (const item of data['icons']) {
                MarketDataMetadataIcon.validateJSON(item);
            };
        }
        // ensure the json data is a string
 ...
 */
MarketDataMetadataExchange.prototype['exchange_id'] = undefined;

/**
 * Gets or sets the website URL of the exchange.
 * @member {String} website
 */
MarketDataMetadataExchange.prototype['website'] = undefined;

/**
 * Gets or sets the name of the exchange.
 * @member {String} name
 */
MarketDataMetadataExchange.prototype['name'] = undefined;

/**
 * @member {String} data_start
 */
MarketDataMetadataExchange.prototype['data_start'] = undefined;

/**
 * @member {String} data_end
 */
MarketDataMetadataExchange.prototype['data_end'] = undefined;

/**
 * Gets or sets the start date of quote data.
 * @member {Date} data_quote_start
 */
MarketDataMetadataExchange.prototype['data_quote_start'] = undefined;

/**
 * Gets or sets the end date of quote data.
 * @member {Date} data_quote_end
 */
MarketDataMetadataExchange.prototype['data_quote_end'] = undefined;

/**
 * Gets or sets the start date of order book data.
 * @member {Date} data_orderbook_start
 */
MarketDataMetadataExchange.prototype['data_orderbook_start'] = undefined;

/**
 * Gets or sets the end date of order book data.
 * @member {Date} data_orderbook_end
 */
MarketDataMetadataExchange.prototype['data_orderbook_end'] = undefined;

/**
 * Gets or sets the start date of trade data.
 * @member {Date} data_trade_start
 */
MarketDataMetadataExchange.prototype['data_trade_start'] = undefined;

/**
 * Gets or sets the end date of trade data.
 * @member {Date} data_trade_end
 */
MarketDataMetadataExchange.prototype['data_trade_end'] = undefined;

/**
 * Gets or sets the number of trades.
 * @member {Number} data_trade_count
 */
MarketDataMetadataExchange.prototype['data_trade_count'] = undefined;

/**
 * Gets or sets the number of symbols.
 * @member {Number} data_symbols_count
 */
MarketDataMetadataExchange.prototype['data_symbols_count'] = undefined;

/**
 * Gets or sets the USD volume in the last 1 hour.
 * @member {Number} volume_1hrs_usd
 */
MarketDataMetadataExchange.prototype['volume_1hrs_usd'] = undefined;

/**
 * Gets or sets the USD volume in the last 1 day.
 * @member {Number} volume_1day_usd
 */
MarketDataMetadataExchange.prototype['volume_1day_usd'] = undefined;

/**
 * Gets or sets the USD volume in the last 1 month.
 * @member {Number} volume_1mth_usd
 */
MarketDataMetadataExchange.prototype['volume_1mth_usd'] = undefined;

/**
 * Gets or sets the list of metric IDs.
 * @member {Array.<String>} metric_id
 */
MarketDataMetadataExchange.prototype['metric_id'] = undefined;

/**
 * Gets or sets the list of icons for the exchange.
 * @member {Array.<module:model/MarketDataMetadataIcon>} icons
 */
MarketDataMetadataExchange.prototype['icons'] = undefined;

/**
 * Rank of the exchange.
 * @member {Number} rank
 */
MarketDataMetadataExchange.prototype['rank'] = undefined;

/**
 * Status of the integration
 * @member {String} integration_status
 */
MarketDataMetadataExchange.prototype['integration_status'] = undefined;
...
export default MarketDataMetadataExchange;
