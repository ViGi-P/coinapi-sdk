...
/**
 * The MarketDataMetadataSymbol model module.
 * @module model/MarketDataMetadataSymbol
 * @version v1
 */
class MarketDataMetadataSymbol {
    /**
     * Constructs a new <code>MarketDataMetadataSymbol</code>.
     * Represents a symbol data model.
     * @alias module:model/MarketDataMetadataSymbol
     */
    constructor() { 
        
        MarketDataMetadataSymbol.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MarketDataMetadataSymbol</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MarketDataMetadataSymbol} obj Optional instance to populate.
     * @return {module:model/MarketDataMetadataSymbol} The populated <code>MarketDataMetadataSymbol</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MarketDataMetadataSymbol();
            ...
            if (data.hasOwnProperty('future_is_inverse')) {
                obj['future_is_inverse'] = ApiClient.convertToType(data['future_is_inverse'], 'Boolean');
            }
            if (data.hasOwnProperty('future_is_quanto')) {
                obj['future_is_quanto'] = ApiClient.convertToType(data['future_is_quanto'], 'Boolean');
            }
            if (data.hasOwnProperty('volume_to_usd')) {
                obj['volume_to_usd'] = ApiClient.convertToType(data['volume_to_usd'], 'Number');
            }
            if (data.hasOwnProperty('option_barrier_up_price')) {
                obj['option_barrier_up_price'] = ApiClient.convertToType(data['option_barrier_up_price'], 'Number');
            }
            if (data.hasOwnProperty('option_barrier_up_type')) {
                obj['option_barrier_up_type'] = ApiClient.convertToType(data['option_barrier_up_type'], 'String');
            }
            if (data.hasOwnProperty('option_barrier_down_price')) {
                obj['option_barrier_down_price'] = ApiClient.convertToType(data['option_barrier_down_price'], 'Number');
            }
            if (data.hasOwnProperty('option_barrier_down_type')) {
                obj['option_barrier_down_type'] = ApiClient.convertToType(data['option_barrier_down_type'], 'String');
            }
            if (data.hasOwnProperty('symbol_id_int')) {
                obj['symbol_id_int'] = ApiClient.convertToType(data['symbol_id_int'], 'Number');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>MarketDataMetadataSymbol</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MarketDataMetadataSymbol</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['option_barrier_up_type'] && !(typeof data['option_barrier_up_type'] === 'string' || data['option_barrier_up_type'] instanceof String)) {
            throw new Error("Expected the field `option_barrier_up_type` to be a primitive type in the JSON string but got " + data['option_barrier_up_type']);
        }
        // ensure the json data is a string
        if (data['option_barrier_down_type'] && !(typeof data['option_barrier_down_type'] === 'string' || data['option_barrier_down_type'] instanceof String)) {
            throw new Error("Expected the field `option_barrier_down_type` to be a primitive type in the JSON string but got " + data['option_barrier_down_type']);
        }
 ...
 */
MarketDataMetadataSymbol.prototype['symbol_id'] = undefined;

/**
 * The exchange identifier.
 * @member {String} exchange_id
 */
MarketDataMetadataSymbol.prototype['exchange_id'] = undefined;

/**
 * The symbol type.
 * @member {String} symbol_type
 */
MarketDataMetadataSymbol.prototype['symbol_type'] = undefined;

/**
 * The base asset identifier.
 * @member {String} asset_id_base
 */
MarketDataMetadataSymbol.prototype['asset_id_base'] = undefined;

/**
 * The quote asset identifier.
 * @member {String} asset_id_quote
 */
MarketDataMetadataSymbol.prototype['asset_id_quote'] = undefined;

/**
 * The unit asset identifier.
 * @member {String} asset_id_unit
 */
MarketDataMetadataSymbol.prototype['asset_id_unit'] = undefined;

/**
 * The contract unit for futures.
 * @member {Number} future_contract_unit
 */
MarketDataMetadataSymbol.prototype['future_contract_unit'] = undefined;

/**
 * The asset used as the unit for futures contract.
 * @member {String} future_contract_unit_asset
 */
MarketDataMetadataSymbol.prototype['future_contract_unit_asset'] = undefined;

/**
 * The future delivery time for futures contract.
 * @member {Date} future_delivery_time
 */
MarketDataMetadataSymbol.prototype['future_delivery_time'] = undefined;

/**
 * Indicates whether the option type is a call.
 * @member {Boolean} option_type_is_call
 */
MarketDataMetadataSymbol.prototype['option_type_is_call'] = undefined;

/**
 * The strike price for options.
 * @member {Number} option_strike_price
 */
MarketDataMetadataSymbol.prototype['option_strike_price'] = undefined;

/**
 * The contract unit for options.
 * @member {Number} option_contract_unit
 */
MarketDataMetadataSymbol.prototype['option_contract_unit'] = undefined;
 ...
 */
MarketDataMetadataSymbol.prototype['option_exercise_style'] = undefined;

/**
 * The expiration time for options.
 * @member {Date} option_expiration_time
 */
MarketDataMetadataSymbol.prototype['option_expiration_time'] = undefined;

/**
 * The delivery time for contracts.
 * @member {Date} contract_delivery_time
 */
MarketDataMetadataSymbol.prototype['contract_delivery_time'] = undefined;

/**
 * The contract unit for contracts.
 * @member {Number} contract_unit
 */
MarketDataMetadataSymbol.prototype['contract_unit'] = undefined;

/**
 * The asset used as the unit for contracts.
 * @member {String} contract_unit_asset
 */
MarketDataMetadataSymbol.prototype['contract_unit_asset'] = undefined;

/**
 * The contract identifier.
 * @member {String} contract_id
 */
MarketDataMetadataSymbol.prototype['contract_id'] = undefined;

/**
 * The display name of the contract.
 * @member {String} contract_display_name
 */
MarketDataMetadataSymbol.prototype['contract_display_name'] = undefined;

/**
 * The display description of the contract.
 * @member {String} contract_display_description
 */
MarketDataMetadataSymbol.prototype['contract_display_description'] = undefined;

/**
 * @member {String} data_start
 */
MarketDataMetadataSymbol.prototype['data_start'] = undefined;

/**
 * @member {String} data_end
 */
MarketDataMetadataSymbol.prototype['data_end'] = undefined;

/**
 * The start date of quote data.
 * @member {Date} data_quote_start
 */
MarketDataMetadataSymbol.prototype['data_quote_start'] = undefined;

/**
 * The end date of quote data.
 * @member {Date} data_quote_end
 */
MarketDataMetadataSymbol.prototype['data_quote_end'] = undefined;

/**
 * The start date of order book data.
 * @member {Date} data_orderbook_start
 */
MarketDataMetadataSymbol.prototype['data_orderbook_start'] = undefined;

/**
 * The end date of order book data.
 * @member {Date} data_orderbook_end
 */
MarketDataMetadataSymbol.prototype['data_orderbook_end'] = undefined;

/**
 * The start date of trade data.
 * @member {Date} data_trade_start
 */
MarketDataMetadataSymbol.prototype['data_trade_start'] = undefined;

/**
 * The end date of trade data.
 * @member {Date} data_trade_end
 */
MarketDataMetadataSymbol.prototype['data_trade_end'] = undefined;

/**
 * The index identifier.
 * @member {String} index_id
 */
MarketDataMetadataSymbol.prototype['index_id'] = undefined;

/**
 * The display name of the index.
 * @member {String} index_display_name
 */
MarketDataMetadataSymbol.prototype['index_display_name'] = undefined;

/**
 * The display description of the index.
 * @member {String} index_display_description
 */
MarketDataMetadataSymbol.prototype['index_display_description'] = undefined;

/**
 * The volume in the last 1 hour.
 * @member {Number} volume_1hrs
 */
MarketDataMetadataSymbol.prototype['volume_1hrs'] = undefined;

/**
 * The volume in USD in the last 1 hour.
 * @member {Number} volume_1hrs_usd
 */
MarketDataMetadataSymbol.prototype['volume_1hrs_usd'] = undefined;

/**
 * The volume in the last 1 day.
 * @member {Number} volume_1day
 */
MarketDataMetadataSymbol.prototype['volume_1day'] = undefined;

/**
 * The volume in USD in the last 1 day.
 * @member {Number} volume_1day_usd
 */
MarketDataMetadataSymbol.prototype['volume_1day_usd'] = undefined;

/**
 * The volume in the last 1 month.
 * @member {Number} volume_1mth
 */
MarketDataMetadataSymbol.prototype['volume_1mth'] = undefined;

/**
 * The volume in USD in the last 1 month.
 * @member {Number} volume_1mth_usd
 */
MarketDataMetadataSymbol.prototype['volume_1mth_usd'] = undefined;

/**
 * The price.
 * @member {Number} price
 */
MarketDataMetadataSymbol.prototype['price'] = undefined;

/**
 * The symbol identifier in the exchange.
 * @member {String} symbol_id_exchange
 */
MarketDataMetadataSymbol.prototype['symbol_id_exchange'] = undefined;

/**
 * The base asset identifier in the exchange.
 * @member {String} asset_id_base_exchange
 */
MarketDataMetadataSymbol.prototype['asset_id_base_exchange'] = undefined;

/**
 * The quote asset identifier in the exchange.
 * @member {String} asset_id_quote_exchange
 */
MarketDataMetadataSymbol.prototype['asset_id_quote_exchange'] = undefined;

/**
 * The price precision.
 * @member {Number} price_precision
 */
MarketDataMetadataSymbol.prototype['price_precision'] = undefined;

/**
 * The size precision.
 * @member {Number} size_precision
 */
MarketDataMetadataSymbol.prototype['size_precision'] = undefined;

/**
 * Key Value Pair store with raw data from the data source.
 * @member {Object.<String, String>} raw_kvp
 */
MarketDataMetadataSymbol.prototype['raw_kvp'] = undefined;

/**
 * Indicates whether the futures contract is inverse (coin-margined).
 * @member {Boolean} future_is_inverse
 */
MarketDataMetadataSymbol.prototype['future_is_inverse'] = undefined;

/**
 * Indicates whether the futures contract is quanto.
 * @member {Boolean} future_is_quanto
 */
MarketDataMetadataSymbol.prototype['future_is_quanto'] = undefined;

/**
 * Volume unit in USD.
 * @member {Number} volume_to_usd
 */
MarketDataMetadataSymbol.prototype['volume_to_usd'] = undefined;

/**
 * The up barrier price for barrier options.
 * @member {Number} option_barrier_up_price
 */
MarketDataMetadataSymbol.prototype['option_barrier_up_price'] = undefined;

/**
 * The up barrier type for barrier options. Possible values: EXPIRATION, IN, OUT.
 * @member {String} option_barrier_up_type
 */
MarketDataMetadataSymbol.prototype['option_barrier_up_type'] = undefined;

/**
 * The down barrier price for barrier options.
 * @member {Number} option_barrier_down_price
 */
MarketDataMetadataSymbol.prototype['option_barrier_down_price'] = undefined;

/**
 * The down barrier type for barrier options. Possible values: EXPIRATION, IN, OUT.
 * @member {String} option_barrier_down_type
 */
MarketDataMetadataSymbol.prototype['option_barrier_down_type'] = undefined;

/**
 * The symbol identifier in integer immutable format, used to correlate data across different APIs.
 * @member {Number} symbol_id_int
 */
MarketDataMetadataSymbol.prototype['symbol_id_int'] = undefined;
...
export default MarketDataMetadataSymbol;
