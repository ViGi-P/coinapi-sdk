...
**Icons** | [**MarketDataMetadataIcon[]**](MarketDataMetadataIcon.md) | Gets or sets the list of icons for the exchange. | [optional] [readonly] 
...
```powershell
$MarketDataMetadataExchange = Initialize-PSOpenAPIToolsMarketDataMetadataExchange  -ExchangeId null `
 -Website null `
 -Name null `
 -DataStart null `
 -DataEnd null `
...
```powershell
$MarketDataMetadataExchange | ConvertTo-JSON
```
