...
V1QuoteTrade[]
#>
function Invoke-V1QuotesCurrentGet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Invoke-V1QuotesCurrentGet' | Write-Debug
...
V1Quote[]
#>
function Invoke-V1QuotesLatestGet {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-V1QuotesLatestGet' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
V1QuoteTrade
#>
function Invoke-V1QuotesSymbolIdCurrentGet {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-V1QuotesSymbolIdCurrentGet' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/v1/quotes/{symbol_id}/current'
        if (!$SymbolId) {
...
V1Quote[]
#>
function Invoke-V1QuotesSymbolIdHistoryGet {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-V1QuotesSymbolIdHistoryGet' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/v1/quotes/{symbol_id}/history'
        if (!$SymbolId) {
...
V1Quote[]
#>
function Invoke-V1QuotesSymbolIdLatestGet {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-V1QuotesSymbolIdLatestGet' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/v1/quotes/{symbol_id}/latest'
        if (!$SymbolId) {
