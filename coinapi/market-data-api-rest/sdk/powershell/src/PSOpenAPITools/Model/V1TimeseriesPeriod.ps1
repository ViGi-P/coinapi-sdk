...
function Initialize-V1TimeseriesPeriod {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => V1TimeseriesPeriod' | Write-Debug
...
Convert from JSON to V1TimeseriesPeriod<PSCustomObject>
...
V1TimeseriesPeriod<PSCustomObject>
#>
function ConvertFrom-JsonToV1TimeseriesPeriod {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => V1TimeseriesPeriod' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
