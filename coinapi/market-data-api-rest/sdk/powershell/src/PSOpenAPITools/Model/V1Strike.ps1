...
V1Strike<PSCustomObject>
#>

function Initialize-V1Strike {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => V1Strike' | Write-Debug
...
Convert from JSON to V1Strike<PSCustomObject>
...
V1Strike<PSCustomObject>
#>
function ConvertFrom-JsonToV1Strike {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => V1Strike' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
