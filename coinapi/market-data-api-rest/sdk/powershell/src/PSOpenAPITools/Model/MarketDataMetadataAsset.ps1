...
MarketDataMetadataAsset<PSCustomObject>
#>

function Initialize-MarketDataMetadataAsset {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => MarketDataMetadataAsset' | Write-Debug
...
Convert from JSON to MarketDataMetadataAsset<PSCustomObject>
...
MarketDataMetadataAsset<PSCustomObject>
#>
function ConvertFrom-JsonToMarketDataMetadataAsset {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => MarketDataMetadataAsset' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
