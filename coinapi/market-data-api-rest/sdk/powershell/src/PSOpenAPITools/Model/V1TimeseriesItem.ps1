...
function Initialize-V1TimeseriesItem {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => V1TimeseriesItem' | Write-Debug
...
Convert from JSON to V1TimeseriesItem<PSCustomObject>
...
V1TimeseriesItem<PSCustomObject>
#>
function ConvertFrom-JsonToV1TimeseriesItem {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => V1TimeseriesItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
