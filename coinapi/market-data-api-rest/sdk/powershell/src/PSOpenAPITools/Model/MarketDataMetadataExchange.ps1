...
MarketDataMetadataExchange<PSCustomObject>
#>

function Initialize-MarketDataMetadataExchange {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => MarketDataMetadataExchange' | Write-Debug
...
Convert from JSON to MarketDataMetadataExchange<PSCustomObject>
...
MarketDataMetadataExchange<PSCustomObject>
#>
function ConvertFrom-JsonToMarketDataMetadataExchange {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => MarketDataMetadataExchange' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in MarketDataMetadataExchange
