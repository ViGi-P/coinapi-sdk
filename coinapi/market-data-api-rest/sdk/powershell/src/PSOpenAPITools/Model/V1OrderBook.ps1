...
V1OrderBook<PSCustomObject>
#>

function Initialize-V1OrderBook {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => V1OrderBook' | Write-Debug
...
Convert from JSON to V1OrderBook<PSCustomObject>
...
V1OrderBook<PSCustomObject>
#>
function ConvertFrom-JsonToV1OrderBook {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => V1OrderBook' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
