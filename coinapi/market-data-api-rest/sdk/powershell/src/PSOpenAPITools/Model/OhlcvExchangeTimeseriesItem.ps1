...
OhlcvExchangeTimeseriesItem<PSCustomObject>
#>

function Initialize-OhlcvExchangeTimeseriesItem {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => OhlcvExchangeTimeseriesItem' | Write-Debug
...
Convert from JSON to OhlcvExchangeTimeseriesItem<PSCustomObject>
...
OhlcvExchangeTimeseriesItem<PSCustomObject>
#>
function ConvertFrom-JsonToOhlcvExchangeTimeseriesItem {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => OhlcvExchangeTimeseriesItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in OhlcvExchangeTimeseriesItem
