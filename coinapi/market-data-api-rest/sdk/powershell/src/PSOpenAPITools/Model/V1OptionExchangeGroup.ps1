...
V1OptionExchangeGroup<PSCustomObject>
#>

function Initialize-V1OptionExchangeGroup {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => V1OptionExchangeGroup' | Write-Debug
...
Convert from JSON to V1OptionExchangeGroup<PSCustomObject>
...
V1OptionExchangeGroup<PSCustomObject>
#>
function ConvertFrom-JsonToV1OptionExchangeGroup {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => V1OptionExchangeGroup' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
