...
MarketDataMetadataSymbol<PSCustomObject>
#>

function Initialize-MarketDataMetadataSymbol {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => MarketDataMetadataSymbol' | Write-Debug
...
Convert from JSON to MarketDataMetadataSymbol<PSCustomObject>
...
MarketDataMetadataSymbol<PSCustomObject>
#>
function ConvertFrom-JsonToMarketDataMetadataSymbol {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => MarketDataMetadataSymbol' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in MarketDataMetadataSymbol
