...
export class OHLCVApi extends BaseAPI {
     ...
     */
    v1OhlcvExchangesExchangeIdHistoryGet({ exchangeId, periodId, timeStart, timeEnd }: V1OhlcvExchangesExchangeIdHistoryGetRequest): Observable<Array<OhlcvExchangeTimeseriesItem>>
    v1OhlcvExchangesExchangeIdHistoryGet({ exchangeId, periodId, timeStart, timeEnd }: V1OhlcvExchangesExchangeIdHistoryGetRequest, opts?: OperationOpts): Observable<AjaxResponse<Array<OhlcvExchangeTimeseriesItem>>>
    v1OhlcvExchangesExchangeIdHistoryGet({ exchangeId, periodId, timeStart, timeEnd }: V1OhlcvExchangesExchangeIdHistoryGetRequest, opts?: OperationOpts): Observable<Array<OhlcvExchangeTimeseriesItem> | AjaxResponse<Array<OhlcvExchangeTimeseriesItem>>> {
