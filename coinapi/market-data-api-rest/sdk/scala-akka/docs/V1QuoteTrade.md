...
**timeExchange** | **OffsetDateTime** | Gets or sets the exchange time of the quote trade. |  [optional]
**timeCoinapi** | **OffsetDateTime** | Gets or sets the CoinAPI time when the quote trade was received. |  [optional]
