...
object Example extends App {
    ...
    val timeStart: String = timeStart_example // String | Starting time in ISO 8601 (supports hourly precision, e.g., 2026-01-16T11:00:00Z)

    val timeEnd: String = timeEnd_example // String | Timeseries ending time in ISO 8601 (optional, supports cross-day queries)
    ...
    val limitLevels: Int = 56 // Int | Maximum amount of levels from each side of the book to include in response (optional, maximum is 50)
 ...
 **limitLevels** | **Int**| Maximum amount of levels from each side of the book to include in response (optional, maximum is 50) | [optional]
