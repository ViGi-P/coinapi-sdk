...
class MetadataApi(baseUrl: String) {
   ...
   */
  def v1ChainsChainIdGet(chainId: String)(implicit apiKey: ApiKeyValue, bearerToken: BearerToken): ApiRequest[Seq[Chain]] =
    ApiRequest[Seq[Chain]](ApiMethods.GET, baseUrl, "/v1/chains/{chain_id}", "application/json")
      .withApiKey(apiKey, "Authorization", HEADER)
      .withCredentials(bearerToken).withPathParam("chain_id", chainId)
   ...
   */
  def v1ChainsGet(filterChainId: Option[String] = None)(implicit apiKey: ApiKeyValue, bearerToken: BearerToken): ApiRequest[Seq[Chain]] =
    ApiRequest[Seq[Chain]](ApiMethods.GET, baseUrl, "/v1/chains", "application/json")
      .withApiKey(apiKey, "Authorization", HEADER)
      .withCredentials(bearerToken).withQueryParam("filter_chain_id", filterChainId)
      .withSuccessResponse[Seq[Chain]](200)
   ...
   */
  def v1ExchangesExchangeIdGet(exchangeId: String)(implicit apiKey: ApiKeyValue, bearerToken: BearerToken): ApiRequest[Seq[Exchange]] =
   ...
   */
  def v1ExchangesGet(filterExchangeId: Option[String] = None)(implicit apiKey: ApiKeyValue, bearerToken: BearerToken): ApiRequest[Seq[Exchange]] =
   ...
   * @param size The size of the icons.
   */
  def v1ExchangesIconsSizeGet(size: Int)(implicit apiKey: ApiKeyValue, bearerToken: BearerToken): ApiRequest[Seq[Icon]] =
   ...
   */
  def v1SymbolsExchangeIdGet(exchangeId: String, filterSymbolId: Option[String] = None, filterAssetId: Option[String] = None)(implicit apiKey: ApiKeyValue, bearerToken: BearerToken): ApiRequest[Seq[Symbol]] =
   ...
   * @param filterAssetId The filter for asset ID.
   */
  def v1SymbolsGet(filterSymbolId: Option[String] = None, filterExchangeId: Option[String] = None, filterAssetId: Option[String] = None)(implicit apiKey: ApiKeyValue, bearerToken: BearerToken): ApiRequest[Seq[Symbol]] =
   ...
   * @param exchangeId The ID of the exchange (from the Metadata -> Exchanges)
   */
  def v1SymbolsMapExchangeIdGet(exchangeId: String)(implicit apiKey: ApiKeyValue, bearerToken: BearerToken): ApiRequest[Seq[SymbolMapping]] =
