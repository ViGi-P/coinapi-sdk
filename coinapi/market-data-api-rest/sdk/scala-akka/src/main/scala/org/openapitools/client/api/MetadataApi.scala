...
class MetadataApi(baseUrl: String) {
   ...
   */
  def v1SymbolsExchangeIdActiveGet(exchangeId: String, filterSymbolId: Option[String] = None, filterAssetId: Option[String] = None)(implicit apiKey: ApiKeyValue, bearerToken: BearerToken): ApiRequest[Seq[Symbol]] =
    ApiRequest[Seq[Symbol]](ApiMethods.GET, baseUrl, "/v1/symbols/{exchange_id}/active", "application/json")
      .withApiKey(apiKey, "Authorization", HEADER)
