...
object ExchangeRatesApi {
  ...
  def apply(baseUrl: String = "https://rest.coinapi.io") = new ExchangeRatesApi(baseUrl)
}
...
class ExchangeRatesApi(baseUrl: String) {
   ...
   */
  def getSpecificRate(assetIdBase: String, assetIdQuote: String, time: Option[String] = None)(implicit apiKey: ApiKeyValue, bearerToken: BearerToken): ApiRequest[ExchangeRate] =
   ...
   */
  def v1ExchangerateAssetIdBaseAssetIdQuoteHistoryGet(assetIdBase: String, assetIdQuote: String, periodId: Option[String] = None, timeStart: Option[String] = None, timeEnd: Option[String] = None, limit: Option[Int] = None)(implicit apiKey: ApiKeyValue, bearerToken: BearerToken): ApiRequest[Seq[ExchangeRatesTimeseriesItem]] =
   ...
   */
  def v1ExchangerateAssetIdBaseGet(assetIdBase: String, filterAssetId: Option[String] = None, invert: Option[Boolean] = None, time: Option[String] = None)(implicit apiKey: ApiKeyValue, bearerToken: BearerToken): ApiRequest[ExchangeRates] =
   ...
   *   JWT (http)
   */
  def v1ExchangerateHistoryPeriodsGet()(implicit apiKey: ApiKeyValue, bearerToken: BearerToken): ApiRequest[Seq[TimeseriesPeriod]] =
