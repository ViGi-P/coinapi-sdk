...
class OrderBookApi(baseUrl: String) {
   ...
   */
  def v1OrderbooksSymbolIdCurrentGet(symbolId: String, limitLevels: Option[Int] = None)(implicit apiKey: ApiKeyValue, bearerToken: BearerToken): ApiRequest[OrderBookBase] =
    ApiRequest[OrderBookBase](ApiMethods.GET, baseUrl, "/v1/orderbooks/{symbol_id}/current", "application/json")
      .withApiKey(apiKey, "Authorization", HEADER)
      .withCredentials(bearerToken).withQueryParam("limit_levels", limitLevels)
   ...
   * @param limitLevels The maximum number of levels to include in the response.
   */
  def v1OrderbooksSymbolIdDepthCurrentGet(symbolId: String, limitLevels: Option[Int] = None)(implicit apiKey: ApiKeyValue, bearerToken: BearerToken): ApiRequest[OrderBookDepth] =
   ...
   */
  def v1OrderbooksSymbolIdHistoryGet(symbolId: String, date: Option[String] = None, timeStart: Option[String] = None, timeEnd: Option[String] = None, limit: Option[Int] = None, limitLevels: Option[Int] = None)(implicit apiKey: ApiKeyValue, bearerToken: BearerToken): ApiRequest[Seq[OrderBook]] =
