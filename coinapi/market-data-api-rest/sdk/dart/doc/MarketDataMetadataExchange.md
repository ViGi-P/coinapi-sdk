# openapi.model.MarketDataMetadataExchange
...
**icons** | [**List<MarketDataMetadataIcon>**](MarketDataMetadataIcon.md) | Gets or sets the list of icons for the exchange. | [optional] [readonly] [default to const []]
