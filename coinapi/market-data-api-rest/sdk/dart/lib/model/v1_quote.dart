...
class V1Quote {
  /// Returns a new [V1Quote] instance.
  V1Quote({
    this.symbolId,
    this.timeExchange,
    this.timeCoinapi,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is V1Quote &&
  ...
  @override
  String toString() => 'V1Quote[symbolId=$symbolId, timeExchange=$timeExchange, timeCoinapi=$timeCoinapi, askPrice=$askPrice, askSize=$askSize, bidPrice=$bidPrice, bidSize=$bidSize]';
  ...
  /// Returns a new [V1Quote] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static V1Quote? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<V1Quote> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <V1Quote>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = V1Quote.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, V1Quote> mapFromJson(dynamic json) {
    final map = <String, V1Quote>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = V1Quote.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of V1Quote-objects as value to a dart map
  static Map<String, List<V1Quote>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<V1Quote>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = V1Quote.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
