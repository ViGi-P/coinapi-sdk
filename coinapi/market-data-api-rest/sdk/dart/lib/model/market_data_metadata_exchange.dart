...
class MarketDataMetadataExchange {
  /// Returns a new [MarketDataMetadataExchange] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is MarketDataMetadataExchange &&
  ...
  /// Returns a new [MarketDataMetadataExchange] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MarketDataMetadataExchange? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return MarketDataMetadataExchange(
        ...
        metricId: json[r'metric_id'] is Iterable
            ...
            : const [],
        icons: MarketDataMetadataIcon.listFromJson(json[r'icons']),
  ...
  static List<MarketDataMetadataExchange> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <MarketDataMetadataExchange>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MarketDataMetadataExchange.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MarketDataMetadataExchange> mapFromJson(dynamic json) {
    final map = <String, MarketDataMetadataExchange>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MarketDataMetadataExchange.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of MarketDataMetadataExchange-objects as value to a dart map
  static Map<String, List<MarketDataMetadataExchange>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<MarketDataMetadataExchange>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = MarketDataMetadataExchange.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
