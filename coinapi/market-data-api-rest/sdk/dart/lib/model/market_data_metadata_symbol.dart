...
class MarketDataMetadataSymbol {
  /// Returns a new [MarketDataMetadataSymbol] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is MarketDataMetadataSymbol &&
  ...
  /// Returns a new [MarketDataMetadataSymbol] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MarketDataMetadataSymbol? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<MarketDataMetadataSymbol> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <MarketDataMetadataSymbol>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MarketDataMetadataSymbol.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MarketDataMetadataSymbol> mapFromJson(dynamic json) {
    final map = <String, MarketDataMetadataSymbol>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MarketDataMetadataSymbol.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of MarketDataMetadataSymbol-objects as value to a dart map
  static Map<String, List<MarketDataMetadataSymbol>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<MarketDataMetadataSymbol>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = MarketDataMetadataSymbol.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
