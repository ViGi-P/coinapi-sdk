...
part 'model/market_data_metadata_asset.dart';
part 'model/market_data_metadata_chain.dart';
part 'model/market_data_metadata_exchange.dart';
part 'model/market_data_metadata_icon.dart';
part 'model/market_data_metadata_symbol.dart';
...
part 'model/v1_option_exchange_group.dart';
