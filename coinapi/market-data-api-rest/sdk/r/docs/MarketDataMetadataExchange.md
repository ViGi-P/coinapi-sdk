# openapi::MarketDataMetadataExchange
...
**icons** | [**array[MarketDataMetadataIcon]**](MarketDataMetadata.Icon.md) | Gets or sets the list of icons for the exchange. | [optional] [readonly] 
