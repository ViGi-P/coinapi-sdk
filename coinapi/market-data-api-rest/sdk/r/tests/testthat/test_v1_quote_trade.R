...
context("Test V1QuoteTrade")

model_instance <- V1QuoteTrade$new()
...
test_that("last_trade", {
  # tests for the property `last_trade` (V1LastTrade)

  # uncomment below to test the property
  #expect_equal(model.instance$`last_trade`, "EXPECTED_RESULT")
})
