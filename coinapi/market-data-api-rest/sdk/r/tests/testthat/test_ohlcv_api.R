...
test_that("V1OhlcvExchangesExchangeIdHistoryGet", {
  # tests for V1OhlcvExchangesExchangeIdHistoryGet
...
test_that("V1OhlcvSymbolIdHistoryGet", {
  # tests for V1OhlcvSymbolIdHistoryGet
  # base path: https://rest.coinapi.io
  # Historical data
...
test_that("V1OhlcvSymbolIdLatestGet", {
  # tests for V1OhlcvSymbolIdLatestGet
  # base path: https://rest.coinapi.io
  # Latest data
