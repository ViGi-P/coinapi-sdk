...
V1OrderBookBase <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return V1OrderBookBase as a base R list.
    #' @examples
    #' # convert array of V1OrderBookBase (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert V1OrderBookBase to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      V1OrderBookBaseObject <- list()
      if (!is.null(self$`symbol_id`)) {
        V1OrderBookBaseObject[["symbol_id"]] <-
          self$`symbol_id`
      }
      if (!is.null(self$`time_exchange`)) {
        V1OrderBookBaseObject[["time_exchange"]] <-
          self$`time_exchange`
      }
      if (!is.null(self$`time_coinapi`)) {
        V1OrderBookBaseObject[["time_coinapi"]] <-
          self$`time_coinapi`
      }
      if (!is.null(self$`asks`)) {
        V1OrderBookBaseObject[["asks"]] <-
          self$extractSimpleType(self$`asks`)
      }
      if (!is.null(self$`bids`)) {
        V1OrderBookBaseObject[["bids"]] <-
          self$extractSimpleType(self$`bids`)
      }
      return(V1OrderBookBaseObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of V1OrderBookBase
    #'
    #' @param input_json the JSON input
    #' @return the instance of V1OrderBookBase
    ...
    #' @return V1OrderBookBase in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to V1OrderBookBase and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of V1OrderBookBase
    toString = function() {
      self$toJSONString()
    },
...
# V1OrderBookBase$unlock()
#
## Below is an example to define the print function
# V1OrderBookBase$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# V1OrderBookBase$lock()
