#' Create a new ModelsExchangeTimeseriesItem
#'
#' @description
#' Represents a timeseries item with price and volume information.
#'
#' @docType class
#' @title ModelsExchangeTimeseriesItem
#' @description ModelsExchangeTimeseriesItem Class
...
#' @export
ModelsExchangeTimeseriesItem <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new ModelsExchangeTimeseriesItem class.
    #'
    ...
    initialize = function(`time_period_start` = NULL, `time_period_end` = NULL, `time_open` = NULL, `time_close` = NULL, `price_open` = NULL, `price_high` = NULL, `price_low` = NULL, `price_close` = NULL, `volume_traded` = NULL, `trades_count` = NULL, `symbol_id_exchange` = NULL, `symbol_id_coinapi` = NULL, ...) {
    ...
    #'
    #' @return ModelsExchangeTimeseriesItem as a base R list.
    #' @examples
    #' # convert array of ModelsExchangeTimeseriesItem (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ModelsExchangeTimeseriesItem to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      ModelsExchangeTimeseriesItemObject <- list()
      if (!is.null(self$`time_period_start`)) {
        ModelsExchangeTimeseriesItemObject[["time_period_start"]] <-
          self$`time_period_start`
      }
      if (!is.null(self$`time_period_end`)) {
        ModelsExchangeTimeseriesItemObject[["time_period_end"]] <-
          self$`time_period_end`
      }
      if (!is.null(self$`time_open`)) {
        ModelsExchangeTimeseriesItemObject[["time_open"]] <-
          self$`time_open`
      }
      if (!is.null(self$`time_close`)) {
        ModelsExchangeTimeseriesItemObject[["time_close"]] <-
          self$`time_close`
      }
      if (!is.null(self$`price_open`)) {
        ModelsExchangeTimeseriesItemObject[["price_open"]] <-
          self$`price_open`
      }
      if (!is.null(self$`price_high`)) {
        ModelsExchangeTimeseriesItemObject[["price_high"]] <-
          self$`price_high`
      }
      if (!is.null(self$`price_low`)) {
        ModelsExchangeTimeseriesItemObject[["price_low"]] <-
          self$`price_low`
      }
      if (!is.null(self$`price_close`)) {
        ModelsExchangeTimeseriesItemObject[["price_close"]] <-
          self$`price_close`
      }
      if (!is.null(self$`volume_traded`)) {
        ModelsExchangeTimeseriesItemObject[["volume_traded"]] <-
          self$`volume_traded`
      }
      if (!is.null(self$`trades_count`)) {
        ModelsExchangeTimeseriesItemObject[["trades_count"]] <-
          self$`trades_count`
      }
      if (!is.null(self$`symbol_id_exchange`)) {
        ModelsExchangeTimeseriesItemObject[["symbol_id_exchange"]] <-
          self$`symbol_id_exchange`
      }
      if (!is.null(self$`symbol_id_coinapi`)) {
        ModelsExchangeTimeseriesItemObject[["symbol_id_coinapi"]] <-
          self$`symbol_id_coinapi`
      }
      return(ModelsExchangeTimeseriesItemObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of ModelsExchangeTimeseriesItem
    #'
    #' @param input_json the JSON input
    #' @return the instance of ModelsExchangeTimeseriesItem
    ...
    #' @return ModelsExchangeTimeseriesItem in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to ModelsExchangeTimeseriesItem and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of ModelsExchangeTimeseriesItem
    toString = function() {
      self$toJSONString()
    },
...
# ModelsExchangeTimeseriesItem$unlock()
#
## Below is an example to define the print function
# ModelsExchangeTimeseriesItem$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ModelsExchangeTimeseriesItem$lock()
