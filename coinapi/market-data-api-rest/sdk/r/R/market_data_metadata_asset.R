#' Create a new MarketDataMetadataAsset
#'
#' @description
#' Represents an asset.
#'
#' @docType class
#' @title MarketDataMetadataAsset
#' @description MarketDataMetadataAsset Class
...
#' @export
MarketDataMetadataAsset <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new MarketDataMetadataAsset class.
    #'
    ...
    #'
    #' @return MarketDataMetadataAsset as a base R list.
    #' @examples
    #' # convert array of MarketDataMetadataAsset (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert MarketDataMetadataAsset to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      MarketDataMetadataAssetObject <- list()
      if (!is.null(self$`asset_id`)) {
        MarketDataMetadataAssetObject[["asset_id"]] <-
          self$`asset_id`
      }
      if (!is.null(self$`name`)) {
        MarketDataMetadataAssetObject[["name"]] <-
          self$`name`
      }
      if (!is.null(self$`type_is_crypto`)) {
        MarketDataMetadataAssetObject[["type_is_crypto"]] <-
          self$`type_is_crypto`
      }
      if (!is.null(self$`data_quote_start`)) {
        MarketDataMetadataAssetObject[["data_quote_start"]] <-
          self$`data_quote_start`
      }
      if (!is.null(self$`data_quote_end`)) {
        MarketDataMetadataAssetObject[["data_quote_end"]] <-
          self$`data_quote_end`
      }
      if (!is.null(self$`data_orderbook_start`)) {
        MarketDataMetadataAssetObject[["data_orderbook_start"]] <-
          self$`data_orderbook_start`
      }
      if (!is.null(self$`data_orderbook_end`)) {
        MarketDataMetadataAssetObject[["data_orderbook_end"]] <-
          self$`data_orderbook_end`
      }
      if (!is.null(self$`data_trade_start`)) {
        MarketDataMetadataAssetObject[["data_trade_start"]] <-
          self$`data_trade_start`
      }
      if (!is.null(self$`data_trade_end`)) {
        MarketDataMetadataAssetObject[["data_trade_end"]] <-
          self$`data_trade_end`
      }
      if (!is.null(self$`data_symbols_count`)) {
        MarketDataMetadataAssetObject[["data_symbols_count"]] <-
          self$`data_symbols_count`
      }
      if (!is.null(self$`volume_1hrs_usd`)) {
        MarketDataMetadataAssetObject[["volume_1hrs_usd"]] <-
          self$`volume_1hrs_usd`
      }
      if (!is.null(self$`volume_1day_usd`)) {
        MarketDataMetadataAssetObject[["volume_1day_usd"]] <-
          self$`volume_1day_usd`
      }
      if (!is.null(self$`volume_1mth_usd`)) {
        MarketDataMetadataAssetObject[["volume_1mth_usd"]] <-
          self$`volume_1mth_usd`
      }
      if (!is.null(self$`price_usd`)) {
        MarketDataMetadataAssetObject[["price_usd"]] <-
          self$`price_usd`
      }
      if (!is.null(self$`id_icon`)) {
        MarketDataMetadataAssetObject[["id_icon"]] <-
          self$`id_icon`
      }
      if (!is.null(self$`supply_current`)) {
        MarketDataMetadataAssetObject[["supply_current"]] <-
          self$`supply_current`
      }
      if (!is.null(self$`supply_total`)) {
        MarketDataMetadataAssetObject[["supply_total"]] <-
          self$`supply_total`
      }
      if (!is.null(self$`supply_max`)) {
        MarketDataMetadataAssetObject[["supply_max"]] <-
          self$`supply_max`
      }
      ...
      if (!is.null(self$`data_end`)) {
        MarketDataMetadataAssetObject[["data_end"]] <-
          self$`data_end`
      }
      return(MarketDataMetadataAssetObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of MarketDataMetadataAsset
    #'
    #' @param input_json the JSON input
    #' @return the instance of MarketDataMetadataAsset
    ...
    #' @return MarketDataMetadataAsset in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to MarketDataMetadataAsset and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of MarketDataMetadataAsset
    toString = function() {
      self$toJSONString()
    },
...
# MarketDataMetadataAsset$unlock()
#
## Below is an example to define the print function
# MarketDataMetadataAsset$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# MarketDataMetadataAsset$lock()
