#' Create a new MarketDataMetadataExchange
#'
#' @description
#' Represents an exchange.
#'
#' @docType class
#' @title MarketDataMetadataExchange
#' @description MarketDataMetadataExchange Class
...
#' @field icons Gets or sets the list of icons for the exchange. list(\link{MarketDataMetadataIcon}) [optional]
...
#' @export
MarketDataMetadataExchange <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new MarketDataMetadataExchange class.
    #'
    ...
    #'
    #' @return MarketDataMetadataExchange as a base R list.
    #' @examples
    #' # convert array of MarketDataMetadataExchange (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert MarketDataMetadataExchange to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      MarketDataMetadataExchangeObject <- list()
      if (!is.null(self$`exchange_id`)) {
        MarketDataMetadataExchangeObject[["exchange_id"]] <-
          self$`exchange_id`
      }
      if (!is.null(self$`website`)) {
        MarketDataMetadataExchangeObject[["website"]] <-
          self$`website`
      }
      if (!is.null(self$`name`)) {
        MarketDataMetadataExchangeObject[["name"]] <-
          self$`name`
      }
      if (!is.null(self$`data_start`)) {
        MarketDataMetadataExchangeObject[["data_start"]] <-
          self$`data_start`
      }
      if (!is.null(self$`data_end`)) {
        MarketDataMetadataExchangeObject[["data_end"]] <-
          self$`data_end`
      }
      if (!is.null(self$`data_quote_start`)) {
        MarketDataMetadataExchangeObject[["data_quote_start"]] <-
          self$`data_quote_start`
      }
      if (!is.null(self$`data_quote_end`)) {
        MarketDataMetadataExchangeObject[["data_quote_end"]] <-
          self$`data_quote_end`
      }
      if (!is.null(self$`data_orderbook_start`)) {
        MarketDataMetadataExchangeObject[["data_orderbook_start"]] <-
          self$`data_orderbook_start`
      }
      if (!is.null(self$`data_orderbook_end`)) {
        MarketDataMetadataExchangeObject[["data_orderbook_end"]] <-
          self$`data_orderbook_end`
      }
      if (!is.null(self$`data_trade_start`)) {
        MarketDataMetadataExchangeObject[["data_trade_start"]] <-
          self$`data_trade_start`
      }
      if (!is.null(self$`data_trade_end`)) {
        MarketDataMetadataExchangeObject[["data_trade_end"]] <-
          self$`data_trade_end`
      }
      if (!is.null(self$`data_trade_count`)) {
        MarketDataMetadataExchangeObject[["data_trade_count"]] <-
          self$`data_trade_count`
      }
      if (!is.null(self$`data_symbols_count`)) {
        MarketDataMetadataExchangeObject[["data_symbols_count"]] <-
          self$`data_symbols_count`
      }
      if (!is.null(self$`volume_1hrs_usd`)) {
        MarketDataMetadataExchangeObject[["volume_1hrs_usd"]] <-
          self$`volume_1hrs_usd`
      }
      if (!is.null(self$`volume_1day_usd`)) {
        MarketDataMetadataExchangeObject[["volume_1day_usd"]] <-
          self$`volume_1day_usd`
      }
      if (!is.null(self$`volume_1mth_usd`)) {
        MarketDataMetadataExchangeObject[["volume_1mth_usd"]] <-
          self$`volume_1mth_usd`
      }
      if (!is.null(self$`metric_id`)) {
        MarketDataMetadataExchangeObject[["metric_id"]] <-
          self$`metric_id`
      }
      if (!is.null(self$`icons`)) {
        MarketDataMetadataExchangeObject[["icons"]] <-
          self$extractSimpleType(self$`icons`)
      }
      if (!is.null(self$`rank`)) {
        MarketDataMetadataExchangeObject[["rank"]] <-
          self$`rank`
      }
      if (!is.null(self$`integration_status`)) {
        MarketDataMetadataExchangeObject[["integration_status"]] <-
          self$`integration_status`
      }
      return(MarketDataMetadataExchangeObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of MarketDataMetadataExchange
    #'
    #' @param input_json the JSON input
    #' @return the instance of MarketDataMetadataExchange
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`icons`)) {
        self$`icons` <- ApiClient$new()$deserializeObj(this_object$`icons`, "array[MarketDataMetadataIcon]", loadNamespace("openapi"))
      }
    ...
    #' @return MarketDataMetadataExchange in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to MarketDataMetadataExchange and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of MarketDataMetadataExchange
    toString = function() {
      self$toJSONString()
    },
...
# MarketDataMetadataExchange$unlock()
#
## Below is an example to define the print function
# MarketDataMetadataExchange$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# MarketDataMetadataExchange$lock()
