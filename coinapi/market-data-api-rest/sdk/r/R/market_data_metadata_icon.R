#' Create a new MarketDataMetadataIcon
#'
#' @description
#' Represents an icon.
#'
#' @docType class
#' @title MarketDataMetadataIcon
#' @description MarketDataMetadataIcon Class
...
#' @export
MarketDataMetadataIcon <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new MarketDataMetadataIcon class.
    #'
    ...
    #'
    #' @return MarketDataMetadataIcon as a base R list.
    #' @examples
    #' # convert array of MarketDataMetadataIcon (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert MarketDataMetadataIcon to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      MarketDataMetadataIconObject <- list()
      if (!is.null(self$`exchange_id`)) {
        MarketDataMetadataIconObject[["exchange_id"]] <-
          self$`exchange_id`
      }
      if (!is.null(self$`asset_id`)) {
        MarketDataMetadataIconObject[["asset_id"]] <-
          self$`asset_id`
      }
      if (!is.null(self$`url`)) {
        MarketDataMetadataIconObject[["url"]] <-
          self$`url`
      }
      return(MarketDataMetadataIconObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of MarketDataMetadataIcon
    #'
    #' @param input_json the JSON input
    #' @return the instance of MarketDataMetadataIcon
    ...
    #' @return MarketDataMetadataIcon in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to MarketDataMetadataIcon and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of MarketDataMetadataIcon
    toString = function() {
      self$toJSONString()
    },
...
# MarketDataMetadataIcon$unlock()
#
## Below is an example to define the print function
# MarketDataMetadataIcon$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# MarketDataMetadataIcon$lock()
