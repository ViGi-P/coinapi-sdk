...
#include "Models.TimeseriesPeriod.h"

using namespace std;
using namespace Tizen::ArtikCloud;

Models.TimeseriesPeriod::Models.TimeseriesPeriod()
{
	//__init();
}
...
void
Models.TimeseriesPeriod::__init()
{
...
void
Models.TimeseriesPeriod::__cleanup()
{
	//if(period_id != NULL) {
	//
	//delete period_id;
...
void
Models.TimeseriesPeriod::fromJson(char* jsonStr)
{
...
Models.TimeseriesPeriod::Models.TimeseriesPeriod(char* json)
{
	this->fromJson(json);
}

char*
Models.TimeseriesPeriod::toJson()
{
...
std::string
Models.TimeseriesPeriod::getPeriodId()
{
	return period_id;
}

void
Models.TimeseriesPeriod::setPeriodId(std::string  period_id)
{
	this->period_id = period_id;
}

int
Models.TimeseriesPeriod::getLengthSeconds()
{
	return length_seconds;
}

void
Models.TimeseriesPeriod::setLengthSeconds(int  length_seconds)
{
	this->length_seconds = length_seconds;
}

int
Models.TimeseriesPeriod::getLengthMonths()
{
	return length_months;
}

void
Models.TimeseriesPeriod::setLengthMonths(int  length_months)
{
	this->length_months = length_months;
}

int
Models.TimeseriesPeriod::getUnitCount()
{
	return unit_count;
}

void
Models.TimeseriesPeriod::setUnitCount(int  unit_count)
{
	this->unit_count = unit_count;
}

std::string
Models.TimeseriesPeriod::getUnitName()
{
	return unit_name;
}

void
Models.TimeseriesPeriod::setUnitName(std::string  unit_name)
{
	this->unit_name = unit_name;
}

std::string
Models.TimeseriesPeriod::getDisplayName()
{
	return display_name;
}

void
Models.TimeseriesPeriod::setDisplayName(std::string  display_name)
{
