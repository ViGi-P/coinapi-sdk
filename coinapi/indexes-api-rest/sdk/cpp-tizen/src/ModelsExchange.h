...
#ifndef _Models.Exchange_H_
#define _Models.Exchange_H_
...
class Models.Exchange : public Object {
public:
	/*! \brief Constructor.
	 */
	Models.Exchange();
	Models.Exchange(char* str);

	/*! \brief Destructor.
	 */
	virtual ~Models.Exchange();
