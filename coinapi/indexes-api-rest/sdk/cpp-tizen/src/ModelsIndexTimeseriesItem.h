/*
 * Models.IndexTimeseriesItem.h
 *
 * Represents a timeseries item with value information.
 */

#ifndef _Models.IndexTimeseriesItem_H_
#define _Models.IndexTimeseriesItem_H_
...
class Models.IndexTimeseriesItem : public Object {
public:
	/*! \brief Constructor.
	 */
	Models.IndexTimeseriesItem();
	Models.IndexTimeseriesItem(char* str);

	/*! \brief Destructor.
	 */
	virtual ~Models.IndexTimeseriesItem();
...
#endif /* _Models.IndexTimeseriesItem_H_ */
