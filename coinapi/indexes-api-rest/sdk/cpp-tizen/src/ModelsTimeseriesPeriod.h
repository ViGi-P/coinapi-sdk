/*
 * Models.TimeseriesPeriod.h
 *
 * Represents a timeseries period used in exchange rate data.
 */

#ifndef _Models.TimeseriesPeriod_H_
#define _Models.TimeseriesPeriod_H_
...
class Models.TimeseriesPeriod : public Object {
public:
	/*! \brief Constructor.
	 */
	Models.TimeseriesPeriod();
	Models.TimeseriesPeriod(char* str);

	/*! \brief Destructor.
	 */
	virtual ~Models.TimeseriesPeriod();
...
#endif /* _Models.TimeseriesPeriod_H_ */
