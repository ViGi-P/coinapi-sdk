...
static bool apiMetadataExchangesExchangeIdGetProcessor(MemoryStruct_s p_chunk, long code, char* errormsg, void* userData,
	void(* voidHandler)())
{
	void(* handler)(std::list<Models.Exchange>, Error, void* )
	= reinterpret_cast<void(*)(std::list<Models.Exchange>, Error, void* )> (voidHandler);
	
	JsonNode* pJson;
	char * data = p_chunk.memory;

	std::list<Models.Exchange> out;
