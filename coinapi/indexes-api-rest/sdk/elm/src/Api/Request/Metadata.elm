...
-}
apiMetadataExchangesExchangeIdGet : String -> String -> Api.Request (List Api.Data.ModelsExchange)
apiMetadataExchangesExchangeIdGet exchangeId_path auth_token =
    Api.request
        ...
        []
        Nothing
        (Json.Decode.list Api.Data.modelsExchangeDecoder)
...
-}
apiMetadataExchangesGet : Maybe String -> String -> Api.Request (List Api.Data.ModelsExchange)
