...
> []ModelsExchange ApiMetadataExchangesExchangeIdGet(ctx, exchangeId).Execute()
...
func main() {
	...
	// response from `ApiMetadataExchangesExchangeIdGet`: []ModelsExchange
...
[**[]ModelsExchange**](ModelsExchange.md)
...
> []ModelsExchange ApiMetadataExchangesGet(ctx).FilterExchangeId(filterExchangeId).Execute()
...
func main() {
	...
	// response from `ApiMetadataExchangesGet`: []ModelsExchange
