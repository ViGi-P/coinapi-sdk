...
func (r ApiV1MetadataPeriodsGetRequest) Execute() ([]ModelsTimeseriesPeriod, *http.Response, error) {
...
func (a *PeriodsAPIService) V1MetadataPeriodsGetExecute(r ApiV1MetadataPeriodsGetRequest) ([]ModelsTimeseriesPeriod, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  []ModelsTimeseriesPeriod
	)
