...
// checks if the ModelsIndexTimeseriesItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelsIndexTimeseriesItem{}

// ModelsIndexTimeseriesItem Represents a timeseries item with value information.
type ModelsIndexTimeseriesItem struct {
...
func NewModelsIndexTimeseriesItem() *ModelsIndexTimeseriesItem {
	this := ModelsIndexTimeseriesItem{}
	return &this
}
...
func (o *ModelsIndexTimeseriesItem) SetTimeOpenNil() {
	o.TimeOpen.Set(nil)
}
...
func (o *ModelsIndexTimeseriesItem) SetTimeCloseNil() {
	o.TimeClose.Set(nil)
}
...
func (o *ModelsIndexTimeseriesItem) SetValueOpenNil() {
	o.ValueOpen.Set(nil)
}
...
func (o *ModelsIndexTimeseriesItem) SetValueHighNil() {
	o.ValueHigh.Set(nil)
}
...
func (o *ModelsIndexTimeseriesItem) SetValueLowNil() {
	o.ValueLow.Set(nil)
}
...
func (o *ModelsIndexTimeseriesItem) SetValueCloseNil() {
...
func (o ModelsIndexTimeseriesItem) MarshalJSON() ([]byte, error) {
...
func (o ModelsIndexTimeseriesItem) ToMap() (map[string]interface{}, error) {
...
type NullableModelsIndexTimeseriesItem struct {
	value *ModelsIndexTimeseriesItem
	isSet bool
}

func (v NullableModelsIndexTimeseriesItem) Get() *ModelsIndexTimeseriesItem {
	return v.value
}

func (v *NullableModelsIndexTimeseriesItem) Set(val *ModelsIndexTimeseriesItem) {
	v.value = val
	v.isSet = true
}

func (v NullableModelsIndexTimeseriesItem) IsSet() bool {
	return v.isSet
}

func (v *NullableModelsIndexTimeseriesItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelsIndexTimeseriesItem(val *ModelsIndexTimeseriesItem) *NullableModelsIndexTimeseriesItem {
	return &NullableModelsIndexTimeseriesItem{value: val, isSet: true}
}

func (v NullableModelsIndexTimeseriesItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelsIndexTimeseriesItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
