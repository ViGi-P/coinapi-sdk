...
> kotlin.collections.List&lt;ModelsExchange&gt; apiMetadataExchangesExchangeIdGet(exchangeId)
...
try {
    val result : kotlin.collections.List<ModelsExchange> = apiInstance.apiMetadataExchangesExchangeIdGet(exchangeId)
    println(result)
...
[**kotlin.collections.List&lt;ModelsExchange&gt;**](ModelsExchange.md)
...
> kotlin.collections.List&lt;ModelsExchange&gt; apiMetadataExchangesGet(filterExchangeId)
...
try {
    val result : kotlin.collections.List<ModelsExchange> = apiInstance.apiMetadataExchangesGet(filterExchangeId)
    println(result)
} catch (e: ClientException) {
