# C API client for coinapi_indexes_rest_api
...
------------ | ------------- | ------------- | -------------
*IndexInputDataAPI* | [**IndexInputDataAPI_v1IndexdefInputDataIndexDefinitionIdAllGet**](docs/IndexInputDataAPI.md#IndexInputDataAPI_v1IndexdefInputDataIndexDefinitionIdAllGet) | **GET** /v1/indexdef/input-data/{index_definition_id}/all | Returns all data inputs for a specific index definition
*IndexInputDataAPI* | [**IndexInputDataAPI_v1IndexdefInputDataIndexDefinitionIdGet**](docs/IndexInputDataAPI.md#IndexInputDataAPI_v1IndexdefInputDataIndexDefinitionIdGet) | **GET** /v1/indexdef/input-data/{index_definition_id} | Returns data inputs for certain index definition and time
...
*MultiAssetWeightsAPI* | [**MultiAssetWeightsAPI_v1IndexdefMultiassetGet**](docs/MultiAssetWeightsAPI.md#MultiAssetWeightsAPI_v1IndexdefMultiassetGet) | **GET** /v1/indexdef/multiasset | Get all multi-asset weights
*MultiAssetWeightsAPI* | [**MultiAssetWeightsAPI_v1IndexdefMultiassetIndexIdGet**](docs/MultiAssetWeightsAPI.md#MultiAssetWeightsAPI_v1IndexdefMultiassetIndexIdGet) | **GET** /v1/indexdef/multiasset/{index_id} | Get multi-asset weights for specific index
...
## Documentation for Models
 ...
 - [models_exchange_t](docs/models_exchange.md)
 - [models_index_definition_input_data_t](docs/models_index_definition_input_data.md)
 ...
 - [models_timeseries_period_t](docs/models_timeseries_period.md)
