...
#include "MultiAssetWeightsAPI.h"
...
MultiAssetWeightsAPI_v1IndexdefMultiassetGet(apiClient_t *apiClient)
{
    ...
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *MultiAssetWeightsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        if(!cJSON_IsArray(MultiAssetWeightsAPIlocalVarJSON)) {
            return 0;//nonprimitive container
        }
        elementToReturn = list_createList();
        cJSON *VarJSON;
        cJSON_ArrayForEach(VarJSON, MultiAssetWeightsAPIlocalVarJSON)
        {
        ...
        cJSON_Delete( MultiAssetWeightsAPIlocalVarJSON);
