...
> List&lt;ModelsExchange&gt; apiMetadataExchangesExchangeIdGet(exchangeId)
...
try {
    List<ModelsExchange> result = apiInstance.apiMetadataExchangesExchangeIdGet(exchangeId);
...
[**List&lt;ModelsExchange&gt;**](ModelsExchange.md)
...
> List&lt;ModelsExchange&gt; apiMetadataExchangesGet(filterExchangeId)
...
try {
    List<ModelsExchange> result = apiInstance.apiMetadataExchangesGet(filterExchangeId);
    System.out.println(result);
} catch (ApiException e) {
