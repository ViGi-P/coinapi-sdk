...
package body .Clients is
   ...
   procedure V_1Indexdef_Input_Data_Index_Definition_Id_All_Get
      (Client : in out Client_Type;
       ...
       Result : out .Models.ModelsIndexDefinitionInputData_Type_Vectors.Vector) is
   ...
   procedure Api_Metadata_Exchanges_Exchange_Id_Get
      (Client : in out Client_Type;
       ...
       Result : out .Models.ModelsExchange_Type_Vectors.Vector) is
      URI   : Swagger.Clients.URI_Type;
      Reply : Swagger.Value_Type;
   begin
      Client.Set_Accept (Media_List_1);
   ...
   procedure V_1Metadata_Periods_Get
      (Client : in out Client_Type;
       Result : out .Models.ModelsTimeseriesPeriod_Type_Vectors.Vector) is
      URI   : Swagger.Clients.URI_Type;
      Reply : Swagger.Value_Type;
   begin
      Client.Set_Accept (Media_List_1);
