...
defmodule CoinAPIIndexesRESTAPI.Api.Metadata do
  ...
  - `{:ok, [%ModelsExchange{}, ...]}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec api_metadata_exchanges_exchange_id_get(Tesla.Env.client, String.t, keyword()) :: {:ok, [CoinAPIIndexesRESTAPI.Model.ModelsExchange.t]} | {:error, Tesla.Env.t}
  def api_metadata_exchanges_exchange_id_get(connection, exchange_id, _opts \\ []) do
    ...
    |> evaluate_response([
      {200, CoinAPIIndexesRESTAPI.Model.ModelsExchange}
    ])
  end
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec api_metadata_exchanges_get(Tesla.Env.client, keyword()) :: {:ok, [CoinAPIIndexesRESTAPI.Model.ModelsExchange.t]} | {:error, Tesla.Env.t}
