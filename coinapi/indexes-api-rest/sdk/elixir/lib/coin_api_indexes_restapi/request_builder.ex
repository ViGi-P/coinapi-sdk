...
defmodule CoinAPIIndexesRESTAPI.RequestBuilder do
  @moduledoc """
  ...
  defp decode(%Tesla.Env{body: body}, %{}) do
    CoinAPIIndexesRESTAPI.Deserializer.json_decode(body)
  end

  defp decode(%Tesla.Env{body: body}, module) do
    CoinAPIIndexesRESTAPI.Deserializer.json_decode(body, module)
  end
end
