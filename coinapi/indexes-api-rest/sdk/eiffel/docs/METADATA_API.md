...
> api_metadata_exchanges_exchange_id_get (exchange_id: STRING_32 ): detachable LIST [MODELS_EXCHANGE]
...
[**LIST [MODELS_EXCHANGE]**](Models.Exchange.md)
...
> api_metadata_exchanges_get (filter_exchange_id:  detachable STRING_32 ): detachable LIST [MODELS_EXCHANGE]
