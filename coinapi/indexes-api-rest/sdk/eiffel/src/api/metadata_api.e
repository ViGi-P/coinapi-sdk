...
feature -- API Access
	...
	api_metadata_exchanges_exchange_id_get (exchange_id: STRING_32): detachable LIST [MODELS_EXCHANGE]
		...
		do
			...
			elseif attached { LIST [MODELS_EXCHANGE] } l_response.data ({ LIST [MODELS_EXCHANGE] }) as l_data then
				Result := l_data
			else
	...
	api_metadata_exchanges_get (filter_exchange_id: STRING_32): detachable LIST [MODELS_EXCHANGE]
			-- List all exchanges
