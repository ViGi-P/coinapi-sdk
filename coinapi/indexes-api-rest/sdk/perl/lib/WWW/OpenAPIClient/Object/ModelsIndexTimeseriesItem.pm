...
#
package WWW::OpenAPIClient::Object::ModelsIndexTimeseriesItem;
...
__PACKAGE__->class_documentation({description => 'Represents a timeseries item with value information.',
