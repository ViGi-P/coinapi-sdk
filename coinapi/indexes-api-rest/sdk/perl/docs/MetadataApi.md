...
> ARRAY[ModelsExchange] api_metadata_exchanges_exchange_id_get(exchange_id => $exchange_id)
...
> ARRAY[ModelsExchange] api_metadata_exchanges_get(filter_exchange_id => $filter_exchange_id)
