...
WWW::OpenAPIClient::Role - a Moose role for the CoinAPI Indexes REST API
...
------------ | ------------- | ------------- | -------------
*IndexInputDataApi* | [**v1_indexdef_input_data_index_definition_id_all_get**](docs/IndexInputDataApi.md#v1_indexdef_input_data_index_definition_id_all_get) | **GET** /v1/indexdef/input-data/{index_definition_id}/all | Returns all data inputs for a specific index definition
*IndexInputDataApi* | [**v1_indexdef_input_data_index_definition_id_get**](docs/IndexInputDataApi.md#v1_indexdef_input_data_index_definition_id_get) | **GET** /v1/indexdef/input-data/{index_definition_id} | Returns data inputs for certain index definition and time
*IndexesApi* | [**v1_indexes_get**](docs/IndexesApi.md#v1_indexes_get) | **GET** /v1/indexes | List indexes
*IndexesApi* | [**v1_indexes_index_definition_id_current_snapshot_get**](docs/IndexesApi.md#v1_indexes_index_definition_id_current_snapshot_get) | **GET** /v1/indexes/{index_definition_id}/currentSnapshot | Current Index Values for index definition
*IndexesApi* | [**v1_indexes_index_definition_id_history_snapshot_get**](docs/IndexesApi.md#v1_indexes_index_definition_id_history_snapshot_get) | **GET** /v1/indexes/{index_definition_id}/historySnapshot | Historical Index Values for index definition
...
*MultiAssetWeightsApi* | [**v1_indexdef_multiasset_get**](docs/MultiAssetWeightsApi.md#v1_indexdef_multiasset_get) | **GET** /v1/indexdef/multiasset | Get all multi-asset weights
*MultiAssetWeightsApi* | [**v1_indexdef_multiasset_index_id_get**](docs/MultiAssetWeightsApi.md#v1_indexdef_multiasset_index_id_get) | **GET** /v1/indexdef/multiasset/{index_id} | Get multi-asset weights for specific index
...
# DOCUMENTATION FOR MODELS
 - [WWW::OpenAPIClient::Object::ModelsExchange](docs/ModelsExchange.md)
 - [WWW::OpenAPIClient::Object::ModelsIndexDefinitionInputData](docs/ModelsIndexDefinitionInputData.md)
 ...
 - [WWW::OpenAPIClient::Object::ModelsTimeseriesPeriod](docs/ModelsTimeseriesPeriod.md)
