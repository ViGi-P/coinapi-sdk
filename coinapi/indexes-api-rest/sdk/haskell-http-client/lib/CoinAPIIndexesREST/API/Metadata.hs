...
apiMetadataExchangesExchangeIdGet
  ...
  -> CoinAPIIndexesRESTRequest ApiMetadataExchangesExchangeIdGet MimeNoContent [ModelsExchange] accept
...
apiMetadataExchangesGet
  :: Accept accept -- ^ request accept ('MimeType')
  -> CoinAPIIndexesRESTRequest ApiMetadataExchangesGet MimeNoContent [ModelsExchange] accept
