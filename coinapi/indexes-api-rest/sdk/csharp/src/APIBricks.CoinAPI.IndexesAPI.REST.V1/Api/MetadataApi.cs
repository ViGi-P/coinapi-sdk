...
namespace APIBricks.CoinAPI.IndexesAPI.REST.V1.Api
{
    ...
    /// </summary>
    public interface IApiMetadataExchangesExchangeIdGetApiResponse : APIBricks.CoinAPI.IndexesAPI.REST.V1.Client.IApiResponse, IOk<List<ModelsExchange>?>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IApiMetadataExchangesGetApiResponse : APIBricks.CoinAPI.IndexesAPI.REST.V1.Client.IApiResponse, IOk<List<ModelsExchange>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    public sealed partial class MetadataApi : IMetadataApi
    {
            ...
            try
            {
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        ApiMetadataExchangesExchangeIdGetApiResponse apiResponseLocalVar;

                        switch ((int)httpResponseMessageLocalVar.StatusCode) {
                            default: {
                                string responseContentLocalVar = await httpResponseMessageLocalVar.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                                apiResponseLocalVar = new(apiResponseLoggerLocalVar, httpRequestMessageLocalVar, httpResponseMessageLocalVar, responseContentLocalVar, "/api/metadata/exchanges/{exchange_id}", requestedAtLocalVar, _jsonSerializerOptions);
        ...
        public partial class ApiMetadataExchangesExchangeIdGetApiResponse : APIBricks.CoinAPI.IndexesAPI.REST.V1.Client.ApiResponse, IApiMetadataExchangesExchangeIdGetApiResponse
        {
            ...
            /// </summary>
            /// <returns></returns>
            public List<ModelsExchange>? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<List<ModelsExchange>>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out List<ModelsExchange>? result)
            {
                result = null;
            ...
            try
            {
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        ApiMetadataExchangesGetApiResponse apiResponseLocalVar;

                        switch ((int)httpResponseMessageLocalVar.StatusCode) {
                            default: {
                                string responseContentLocalVar = await httpResponseMessageLocalVar.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                                apiResponseLocalVar = new(apiResponseLoggerLocalVar, httpRequestMessageLocalVar, httpResponseMessageLocalVar, responseContentLocalVar, "/api/metadata/exchanges", requestedAtLocalVar, _jsonSerializerOptions);
