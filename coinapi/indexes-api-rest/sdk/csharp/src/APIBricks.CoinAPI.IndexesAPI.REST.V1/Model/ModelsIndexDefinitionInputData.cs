...
namespace APIBricks.CoinAPI.IndexesAPI.REST.V1.Model
{
    ...
    /// </summary>
    public partial class ModelsIndexDefinitionInputData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ModelsIndexDefinitionInputData" /> class.
        /// </summary>
    ...
    /// <summary>
    /// A Json converter for type <see cref="ModelsIndexDefinitionInputData" />
    /// </summary>
    public class ModelsIndexDefinitionInputDataJsonConverter : JsonConverter<ModelsIndexDefinitionInputData>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="ModelsIndexDefinitionInputData" />
        /// </summary>
        ...
        public override ModelsIndexDefinitionInputData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (lastModificationTime.IsSet && lastModificationTime.Value == null)
                throw new ArgumentNullException(nameof(lastModificationTime), "Property is not nullable for class ModelsIndexDefinitionInputData.");

            return new ModelsIndexDefinitionInputData(exchangeId, exchangeSymbolId, baseAssetId, quoteAssetId, beginDate, endDate, status, statusInfo, lastModificationTime);
        }

        /// <summary>
        /// Serializes a <see cref="ModelsIndexDefinitionInputData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="modelsIndexDefinitionInputData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ModelsIndexDefinitionInputData modelsIndexDefinitionInputData, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, modelsIndexDefinitionInputData, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ModelsIndexDefinitionInputData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="modelsIndexDefinitionInputData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ModelsIndexDefinitionInputData modelsIndexDefinitionInputData, JsonSerializerOptions jsonSerializerOptions)
        {
            if (modelsIndexDefinitionInputData.ExchangeIdOption.IsSet)
                if (modelsIndexDefinitionInputData.ExchangeIdOption.Value != null)
                    writer.WriteString("exchangeId", modelsIndexDefinitionInputData.ExchangeId);
                else
                    writer.WriteNull("exchangeId");

            if (modelsIndexDefinitionInputData.ExchangeSymbolIdOption.IsSet)
                if (modelsIndexDefinitionInputData.ExchangeSymbolIdOption.Value != null)
                    writer.WriteString("exchangeSymbolId", modelsIndexDefinitionInputData.ExchangeSymbolId);
                else
                    writer.WriteNull("exchangeSymbolId");

            if (modelsIndexDefinitionInputData.BaseAssetIdOption.IsSet)
                if (modelsIndexDefinitionInputData.BaseAssetIdOption.Value != null)
                    writer.WriteString("baseAssetId", modelsIndexDefinitionInputData.BaseAssetId);
                else
                    writer.WriteNull("baseAssetId");

            if (modelsIndexDefinitionInputData.QuoteAssetIdOption.IsSet)
                if (modelsIndexDefinitionInputData.QuoteAssetIdOption.Value != null)
                    writer.WriteString("quoteAssetId", modelsIndexDefinitionInputData.QuoteAssetId);
                else
                    writer.WriteNull("quoteAssetId");

            if (modelsIndexDefinitionInputData.BeginDateOption.IsSet)
                if (modelsIndexDefinitionInputData.BeginDateOption.Value != null)
                    writer.WriteString("beginDate", modelsIndexDefinitionInputData.BeginDateOption.Value!.Value.ToString(BeginDateFormat));
                else
                    writer.WriteNull("beginDate");

            if (modelsIndexDefinitionInputData.EndDateOption.IsSet)
                if (modelsIndexDefinitionInputData.EndDateOption.Value != null)
                    writer.WriteString("endDate", modelsIndexDefinitionInputData.EndDateOption.Value!.Value.ToString(EndDateFormat));
                else
                    writer.WriteNull("endDate");

            if (modelsIndexDefinitionInputData.StatusOption.IsSet)
                if (modelsIndexDefinitionInputData.StatusOption.Value != null)
                    writer.WriteString("status", modelsIndexDefinitionInputData.Status);
                else
                    writer.WriteNull("status");

            if (modelsIndexDefinitionInputData.StatusInfoOption.IsSet)
                if (modelsIndexDefinitionInputData.StatusInfoOption.Value != null)
                    writer.WriteString("statusInfo", modelsIndexDefinitionInputData.StatusInfo);
                else
                    writer.WriteNull("statusInfo");

            if (modelsIndexDefinitionInputData.LastModificationTimeOption.IsSet)
                writer.WriteString("lastModificationTime", modelsIndexDefinitionInputData.LastModificationTimeOption.Value!.Value.ToString(LastModificationTimeFormat));
        }
    }
}
