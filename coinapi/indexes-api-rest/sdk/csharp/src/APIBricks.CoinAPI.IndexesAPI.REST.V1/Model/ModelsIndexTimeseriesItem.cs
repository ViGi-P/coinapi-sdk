...
namespace APIBricks.CoinAPI.IndexesAPI.REST.V1.Model
{
    ...
    /// </summary>
    public partial class ModelsIndexTimeseriesItem : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ModelsIndexTimeseriesItem" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public ModelsIndexTimeseriesItem(Option<DateTime?> timePeriodStart = default, Option<DateTime?> timePeriodEnd = default, Option<DateTime?> timeOpen = default, Option<DateTime?> timeClose = default, Option<double?> valueOpen = default, Option<double?> valueHigh = default, Option<double?> valueLow = default, Option<double?> valueClose = default, Option<long?> valueCount = default)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="ModelsIndexTimeseriesItem" />
    /// </summary>
    public class ModelsIndexTimeseriesItemJsonConverter : JsonConverter<ModelsIndexTimeseriesItem>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="ModelsIndexTimeseriesItem" />
        /// </summary>
        ...
        public override ModelsIndexTimeseriesItem Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (timePeriodStart.IsSet && timePeriodStart.Value == null)
                throw new ArgumentNullException(nameof(timePeriodStart), "Property is not nullable for class ModelsIndexTimeseriesItem.");

            if (timePeriodEnd.IsSet && timePeriodEnd.Value == null)
                throw new ArgumentNullException(nameof(timePeriodEnd), "Property is not nullable for class ModelsIndexTimeseriesItem.");

            if (valueCount.IsSet && valueCount.Value == null)
                throw new ArgumentNullException(nameof(valueCount), "Property is not nullable for class ModelsIndexTimeseriesItem.");

            return new ModelsIndexTimeseriesItem(timePeriodStart, timePeriodEnd, timeOpen, timeClose, valueOpen, valueHigh, valueLow, valueClose, valueCount);
        }

        /// <summary>
        /// Serializes a <see cref="ModelsIndexTimeseriesItem" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="modelsIndexTimeseriesItem"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ModelsIndexTimeseriesItem modelsIndexTimeseriesItem, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, modelsIndexTimeseriesItem, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ModelsIndexTimeseriesItem" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="modelsIndexTimeseriesItem"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ModelsIndexTimeseriesItem modelsIndexTimeseriesItem, JsonSerializerOptions jsonSerializerOptions)
        {
            if (modelsIndexTimeseriesItem.TimePeriodStartOption.IsSet)
                writer.WriteString("time_period_start", modelsIndexTimeseriesItem.TimePeriodStartOption.Value!.Value.ToString(TimePeriodStartFormat));

            if (modelsIndexTimeseriesItem.TimePeriodEndOption.IsSet)
                writer.WriteString("time_period_end", modelsIndexTimeseriesItem.TimePeriodEndOption.Value!.Value.ToString(TimePeriodEndFormat));

            if (modelsIndexTimeseriesItem.TimeOpenOption.IsSet)
                if (modelsIndexTimeseriesItem.TimeOpenOption.Value != null)
                    writer.WriteString("time_open", modelsIndexTimeseriesItem.TimeOpenOption.Value!.Value.ToString(TimeOpenFormat));
                else
                    writer.WriteNull("time_open");

            if (modelsIndexTimeseriesItem.TimeCloseOption.IsSet)
                if (modelsIndexTimeseriesItem.TimeCloseOption.Value != null)
                    writer.WriteString("time_close", modelsIndexTimeseriesItem.TimeCloseOption.Value!.Value.ToString(TimeCloseFormat));
                else
                    writer.WriteNull("time_close");

            if (modelsIndexTimeseriesItem.ValueOpenOption.IsSet)
                if (modelsIndexTimeseriesItem.ValueOpenOption.Value != null)
                    writer.WriteNumber("value_open", modelsIndexTimeseriesItem.ValueOpenOption.Value!.Value);
                else
                    writer.WriteNull("value_open");

            if (modelsIndexTimeseriesItem.ValueHighOption.IsSet)
                if (modelsIndexTimeseriesItem.ValueHighOption.Value != null)
                    writer.WriteNumber("value_high", modelsIndexTimeseriesItem.ValueHighOption.Value!.Value);
                else
                    writer.WriteNull("value_high");

            if (modelsIndexTimeseriesItem.ValueLowOption.IsSet)
                if (modelsIndexTimeseriesItem.ValueLowOption.Value != null)
                    writer.WriteNumber("value_low", modelsIndexTimeseriesItem.ValueLowOption.Value!.Value);
                else
                    writer.WriteNull("value_low");

            if (modelsIndexTimeseriesItem.ValueCloseOption.IsSet)
                if (modelsIndexTimeseriesItem.ValueCloseOption.Value != null)
                    writer.WriteNumber("value_close", modelsIndexTimeseriesItem.ValueCloseOption.Value!.Value);
                else
                    writer.WriteNull("value_close");

            if (modelsIndexTimeseriesItem.ValueCountOption.IsSet)
                writer.WriteNumber("value_count", modelsIndexTimeseriesItem.ValueCountOption.Value!.Value);
        }
    }
}
