...
namespace APIBricks.CoinAPI.IndexesAPI.REST.V1.Model
{
    ...
    /// </summary>
    public partial class ModelsTimeseriesPeriod : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ModelsTimeseriesPeriod" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public ModelsTimeseriesPeriod(Option<string?> periodId = default, Option<int?> lengthSeconds = default, Option<int?> lengthMonths = default, Option<int?> unitCount = default, Option<string?> unitName = default, Option<string?> displayName = default)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="ModelsTimeseriesPeriod" />
    /// </summary>
    public class ModelsTimeseriesPeriodJsonConverter : JsonConverter<ModelsTimeseriesPeriod>
    {
        /// <summary>
        /// Deserializes json to <see cref="ModelsTimeseriesPeriod" />
        /// </summary>
        ...
        public override ModelsTimeseriesPeriod Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (lengthSeconds.IsSet && lengthSeconds.Value == null)
                throw new ArgumentNullException(nameof(lengthSeconds), "Property is not nullable for class ModelsTimeseriesPeriod.");

            if (lengthMonths.IsSet && lengthMonths.Value == null)
                throw new ArgumentNullException(nameof(lengthMonths), "Property is not nullable for class ModelsTimeseriesPeriod.");

            return new ModelsTimeseriesPeriod(periodId, lengthSeconds, lengthMonths, unitCount, unitName, displayName);
        }

        /// <summary>
        /// Serializes a <see cref="ModelsTimeseriesPeriod" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="modelsTimeseriesPeriod"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ModelsTimeseriesPeriod modelsTimeseriesPeriod, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, modelsTimeseriesPeriod, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ModelsTimeseriesPeriod" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="modelsTimeseriesPeriod"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ModelsTimeseriesPeriod modelsTimeseriesPeriod, JsonSerializerOptions jsonSerializerOptions)
        {
            if (modelsTimeseriesPeriod.PeriodIdOption.IsSet)
                if (modelsTimeseriesPeriod.PeriodIdOption.Value != null)
                    writer.WriteString("period_id", modelsTimeseriesPeriod.PeriodId);
                else
                    writer.WriteNull("period_id");

            if (modelsTimeseriesPeriod.LengthSecondsOption.IsSet)
                writer.WriteNumber("length_seconds", modelsTimeseriesPeriod.LengthSecondsOption.Value!.Value);

            if (modelsTimeseriesPeriod.LengthMonthsOption.IsSet)
                writer.WriteNumber("length_months", modelsTimeseriesPeriod.LengthMonthsOption.Value!.Value);

            if (modelsTimeseriesPeriod.UnitCountOption.IsSet)
                if (modelsTimeseriesPeriod.UnitCountOption.Value != null)
                    writer.WriteNumber("unit_count", modelsTimeseriesPeriod.UnitCountOption.Value!.Value);
                else
                    writer.WriteNull("unit_count");

            if (modelsTimeseriesPeriod.UnitNameOption.IsSet)
                if (modelsTimeseriesPeriod.UnitNameOption.Value != null)
                    writer.WriteString("unit_name", modelsTimeseriesPeriod.UnitName);
                else
                    writer.WriteNull("unit_name");

            if (modelsTimeseriesPeriod.DisplayNameOption.IsSet)
                if (modelsTimeseriesPeriod.DisplayNameOption.Value != null)
                    writer.WriteString("display_name", modelsTimeseriesPeriod.DisplayName);
                else
