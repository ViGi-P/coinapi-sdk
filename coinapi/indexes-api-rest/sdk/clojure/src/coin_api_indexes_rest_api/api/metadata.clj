(ns coin-api-indexes-rest-api.api.metadata
...
(defn-spec api-metadata-exchanges-exchange-id-get (s/coll-of models/exchange-spec)
  "List all exchanges by exchange_id"
  [exchange_id string?]
  (let [res (:data (api-metadata-exchanges-exchange-id-get-with-http-info exchange_id))]
    (if (:decode-models *api-context*)
       (st/decode (s/coll-of models/exchange-spec) res st/string-transformer)
       res)))
...
(defn-spec api-metadata-exchanges-get (s/coll-of models/exchange-spec)
  "List all exchanges
  Get a detailed list of exchanges provided by the system.
