...
-export([openapi_models_index_value_component/0]).

-export([openapi_models_index_value_component/1]).
...
openapi_models_index_value_component() ->
    openapi_models_index_value_component([]).

openapi_models_index_value_component(Fields) ->
