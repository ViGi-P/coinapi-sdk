...
ModelsExchange<PSCustomObject>
#>

function Initialize-ModelsExchange {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ModelsExchange' | Write-Debug
...
Convert from JSON to ModelsExchange<PSCustomObject>
...
ModelsExchange<PSCustomObject>
#>
function ConvertFrom-JsonToModelsExchange {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ModelsExchange' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
