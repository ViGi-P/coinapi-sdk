...
ModelsIndexTimeseriesItem<PSCustomObject>
#>

function Initialize-ModelsIndexTimeseriesItem {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ModelsIndexTimeseriesItem' | Write-Debug
...
Convert from JSON to ModelsIndexTimeseriesItem<PSCustomObject>
...
ModelsIndexTimeseriesItem<PSCustomObject>
#>
function ConvertFrom-JsonToModelsIndexTimeseriesItem {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ModelsIndexTimeseriesItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
