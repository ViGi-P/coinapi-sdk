...
ModelsIndexMultiAssetWeight<PSCustomObject>
#>

function Initialize-ModelsIndexMultiAssetWeight {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ModelsIndexMultiAssetWeight' | Write-Debug
...
Convert from JSON to ModelsIndexMultiAssetWeight<PSCustomObject>
...
ModelsIndexMultiAssetWeight<PSCustomObject>
#>
function ConvertFrom-JsonToModelsIndexMultiAssetWeight {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ModelsIndexMultiAssetWeight' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
