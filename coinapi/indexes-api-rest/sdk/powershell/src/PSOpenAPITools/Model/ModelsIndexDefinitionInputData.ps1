...
ModelsIndexDefinitionInputData<PSCustomObject>
#>

function Initialize-ModelsIndexDefinitionInputData {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ModelsIndexDefinitionInputData' | Write-Debug
...
Convert from JSON to ModelsIndexDefinitionInputData<PSCustomObject>
...
ModelsIndexDefinitionInputData<PSCustomObject>
#>
function ConvertFrom-JsonToModelsIndexDefinitionInputData {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ModelsIndexDefinitionInputData' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
