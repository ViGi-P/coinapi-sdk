...
ModelsTimeseriesPeriod<PSCustomObject>
#>

function Initialize-ModelsTimeseriesPeriod {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ModelsTimeseriesPeriod' | Write-Debug
...
Convert from JSON to ModelsTimeseriesPeriod<PSCustomObject>
...
ModelsTimeseriesPeriod<PSCustomObject>
#>
function ConvertFrom-JsonToModelsTimeseriesPeriod {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ModelsTimeseriesPeriod' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ModelsTimeseriesPeriod
