...
json = "{}"
# create an instance of ModelsIndexTimeseriesItem from a JSON string
models_index_timeseries_item_instance = ModelsIndexTimeseriesItem.from_json(json)
# print the JSON string representation of the object
print(ModelsIndexTimeseriesItem.to_json())

# convert the object into a dict
models_index_timeseries_item_dict = models_index_timeseries_item_instance.to_dict()
# create an instance of ModelsIndexTimeseriesItem from a dict
models_index_timeseries_item_from_dict = ModelsIndexTimeseriesItem.from_dict(models_index_timeseries_item_dict)
```
