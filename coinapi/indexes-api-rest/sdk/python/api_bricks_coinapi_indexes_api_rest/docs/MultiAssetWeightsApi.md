# api_bricks_coinapi_indexes_api_rest.MultiAssetWeightsApi
...
with api_bricks_coinapi_indexes_api_rest.ApiClient(configuration) as api_client:
    ...
    api_instance = api_bricks_coinapi_indexes_api_rest.MultiAssetWeightsApi(api_client)

    try:
        # Get all multi-asset weights
        api_response = api_instance.v1_indexdef_multiasset_get()
        print("The response of MultiAssetWeightsApi->v1_indexdef_multiasset_get:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MultiAssetWeightsApi->v1_indexdef_multiasset_get: %s\n" % e)
```
...
with api_bricks_coinapi_indexes_api_rest.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of MultiAssetWeightsApi->v1_indexdef_multiasset_index_id_get:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MultiAssetWeightsApi->v1_indexdef_multiasset_index_id_get: %s\n" % e)
```
