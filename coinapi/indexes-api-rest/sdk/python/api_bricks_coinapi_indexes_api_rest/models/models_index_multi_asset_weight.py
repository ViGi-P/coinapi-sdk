...
class ModelsIndexMultiAssetWeight(BaseModel):
    """
    ModelsIndexMultiAssetWeight
    """ # noqa: E501
    index_id: Optional[StrictStr] = Field(default=None, alias="indexId")
    asset_id: Optional[StrictStr] = Field(default=None, alias="assetId")
    weight: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["indexId", "assetId", "weight"]
