...
------------ | ------------- | ------------- | -------------
*IndexInputDataApi* | [**v1_indexdef_input_data_index_definition_id_all_get**](api_bricks_coinapi_indexes_api_rest/docs/IndexInputDataApi.md#v1_indexdef_input_data_index_definition_id_all_get) | **GET** /v1/indexdef/input-data/{index_definition_id}/all | Returns all data inputs for a specific index definition
*IndexInputDataApi* | [**v1_indexdef_input_data_index_definition_id_get**](api_bricks_coinapi_indexes_api_rest/docs/IndexInputDataApi.md#v1_indexdef_input_data_index_definition_id_get) | **GET** /v1/indexdef/input-data/{index_definition_id} | Returns data inputs for certain index definition and time
...
*MultiAssetWeightsApi* | [**v1_indexdef_multiasset_get**](api_bricks_coinapi_indexes_api_rest/docs/MultiAssetWeightsApi.md#v1_indexdef_multiasset_get) | **GET** /v1/indexdef/multiasset | Get all multi-asset weights
*MultiAssetWeightsApi* | [**v1_indexdef_multiasset_index_id_get**](api_bricks_coinapi_indexes_api_rest/docs/MultiAssetWeightsApi.md#v1_indexdef_multiasset_index_id_get) | **GET** /v1/indexdef/multiasset/{index_id} | Get multi-asset weights for specific index
...
## Documentation For Models
 ...
 - [ModelsExchange](api_bricks_coinapi_indexes_api_rest/docs/ModelsExchange.md)
 - [ModelsIndexDefinitionInputData](api_bricks_coinapi_indexes_api_rest/docs/ModelsIndexDefinitionInputData.md)
 ...
 - [ModelsTimeseriesPeriod](api_bricks_coinapi_indexes_api_rest/docs/ModelsTimeseriesPeriod.md)
