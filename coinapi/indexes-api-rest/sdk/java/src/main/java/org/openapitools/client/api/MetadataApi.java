...
import org.openapitools.client.model.ModelsExchange;
...
public class MetadataApi {
     ...
     */
    public List<ModelsExchange> apiMetadataExchangesExchangeIdGet(@javax.annotation.Nonnull String exchangeId) throws ApiException {
        ApiResponse<List<ModelsExchange>> localVarResp = apiMetadataExchangesExchangeIdGetWithHttpInfo(exchangeId);
     ...
     * 
     * @param exchangeId The ID of the exchange. (required)
     * @return ApiResponse&lt;List&lt;ModelsExchange&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
     ...
     */
    public ApiResponse<List<ModelsExchange>> apiMetadataExchangesExchangeIdGetWithHttpInfo(@javax.annotation.Nonnull String exchangeId) throws ApiException {
        okhttp3.Call localVarCall = apiMetadataExchangesExchangeIdGetValidateBeforeCall(exchangeId, null);
        Type localVarReturnType = new TypeToken<List<ModelsExchange>>(){}.getType();
     ...
     */
    public okhttp3.Call apiMetadataExchangesExchangeIdGetAsync(@javax.annotation.Nonnull String exchangeId, final ApiCallback<List<ModelsExchange>> _callback) throws ApiException {
     ...
     */
    public List<ModelsExchange> apiMetadataExchangesGet(@javax.annotation.Nullable String filterExchangeId) throws ApiException {
        ApiResponse<List<ModelsExchange>> localVarResp = apiMetadataExchangesGetWithHttpInfo(filterExchangeId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<ModelsExchange>> apiMetadataExchangesGetWithHttpInfo(@javax.annotation.Nullable String filterExchangeId) throws ApiException {
     ...
     */
    public okhttp3.Call apiMetadataExchangesGetAsync(@javax.annotation.Nullable String filterExchangeId, final ApiCallback<List<ModelsExchange>> _callback) throws ApiException {
