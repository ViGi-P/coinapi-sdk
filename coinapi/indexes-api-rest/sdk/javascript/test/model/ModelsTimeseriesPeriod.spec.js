...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoinApiIndexesRestApi.ModelsTimeseriesPeriod();
  });
  ...
  describe('ModelsTimeseriesPeriod', function() {
    it('should create an instance of ModelsTimeseriesPeriod', function() {
      // uncomment below and update the code to test ModelsTimeseriesPeriod
      //var instance = new CoinApiIndexesRestApi.ModelsTimeseriesPeriod();
      //expect(instance).to.be.a(CoinApiIndexesRestApi.ModelsTimeseriesPeriod);
    });
