...
/**
 * The ModelsTimeseriesPeriod model module.
 * @module model/ModelsTimeseriesPeriod
 * @version v1
 */
class ModelsTimeseriesPeriod {
    /**
     * Constructs a new <code>ModelsTimeseriesPeriod</code>.
     * Represents a timeseries period used in exchange rate data.
     * @alias module:model/ModelsTimeseriesPeriod
     */
    constructor() { 
        
        ModelsTimeseriesPeriod.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ModelsTimeseriesPeriod</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ModelsTimeseriesPeriod} obj Optional instance to populate.
     * @return {module:model/ModelsTimeseriesPeriod} The populated <code>ModelsTimeseriesPeriod</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ModelsTimeseriesPeriod();
    ...
    /**
     * Validates the JSON data with respect to <code>ModelsTimeseriesPeriod</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ModelsTimeseriesPeriod</code>.
     */
 ...
 */
ModelsTimeseriesPeriod.prototype['period_id'] = undefined;

/**
 * Gets or sets the length of the period in seconds.
 * @member {Number} length_seconds
 */
ModelsTimeseriesPeriod.prototype['length_seconds'] = undefined;

/**
 * Gets or sets the length of the period in months.
 * @member {Number} length_months
 */
ModelsTimeseriesPeriod.prototype['length_months'] = undefined;

/**
 * Gets or sets the unit count.
 * @member {Number} unit_count
 */
ModelsTimeseriesPeriod.prototype['unit_count'] = undefined;

/**
 * Gets or sets the unit name.
 * @member {String} unit_name
 */
ModelsTimeseriesPeriod.prototype['unit_name'] = undefined;

/**
 * Gets or sets the display name of the timeseries period.
 * @member {String} display_name
 */
ModelsTimeseriesPeriod.prototype['display_name'] = undefined;
...
export default ModelsTimeseriesPeriod;
