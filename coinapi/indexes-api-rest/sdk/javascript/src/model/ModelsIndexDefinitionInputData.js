...
/**
 * The ModelsIndexDefinitionInputData model module.
 * @module model/ModelsIndexDefinitionInputData
 * @version v1
 */
class ModelsIndexDefinitionInputData {
    /**
     * Constructs a new <code>ModelsIndexDefinitionInputData</code>.
     * @alias module:model/ModelsIndexDefinitionInputData
     */
    constructor() { 
        
        ModelsIndexDefinitionInputData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ModelsIndexDefinitionInputData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ModelsIndexDefinitionInputData} obj Optional instance to populate.
     * @return {module:model/ModelsIndexDefinitionInputData} The populated <code>ModelsIndexDefinitionInputData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ModelsIndexDefinitionInputData();
    ...
    /**
     * Validates the JSON data with respect to <code>ModelsIndexDefinitionInputData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ModelsIndexDefinitionInputData</code>.
     */
 ...
 */
ModelsIndexDefinitionInputData.prototype['exchangeId'] = undefined;

/**
 * @member {String} exchangeSymbolId
 */
ModelsIndexDefinitionInputData.prototype['exchangeSymbolId'] = undefined;

/**
 * @member {String} baseAssetId
 */
ModelsIndexDefinitionInputData.prototype['baseAssetId'] = undefined;

/**
 * @member {String} quoteAssetId
 */
ModelsIndexDefinitionInputData.prototype['quoteAssetId'] = undefined;

/**
 * @member {Date} beginDate
 */
ModelsIndexDefinitionInputData.prototype['beginDate'] = undefined;

/**
 * @member {Date} endDate
 */
ModelsIndexDefinitionInputData.prototype['endDate'] = undefined;

/**
 * @member {String} status
 */
ModelsIndexDefinitionInputData.prototype['status'] = undefined;

/**
 * @member {String} statusInfo
 */
ModelsIndexDefinitionInputData.prototype['statusInfo'] = undefined;

/**
 * @member {Date} lastModificationTime
 */
ModelsIndexDefinitionInputData.prototype['lastModificationTime'] = undefined;
...
export default ModelsIndexDefinitionInputData;
