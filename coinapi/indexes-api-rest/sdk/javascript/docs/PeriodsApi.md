# CoinApiIndexesRestApi.PeriodsApi
...
> [ModelsTimeseriesPeriod] v1MetadataPeriodsGet()
...
let apiInstance = new CoinApiIndexesRestApi.PeriodsApi();
apiInstance.v1MetadataPeriodsGet((error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
[**[ModelsTimeseriesPeriod]**](ModelsTimeseriesPeriod.md)
