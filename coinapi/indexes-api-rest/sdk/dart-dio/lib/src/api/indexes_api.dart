...
class IndexesApi {
  ...
  const IndexesApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<IndexesIndexDefinitionInputData>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<IndexesIndexDefinitionInputData>>> v1IndexdefInputDataIndexDefinitionIdAllGet({ 
    ...
    BuiltList<IndexesIndexDefinitionInputData>? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BuiltList, [FullType(IndexesIndexDefinitionInputData)]),
      ) as BuiltList<IndexesIndexDefinitionInputData>;
    ...
    return Response<BuiltList<IndexesIndexDefinitionInputData>>(
      data: _responseData,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<IndexesIndexDefinitionSnapshotEntry>>> v1IndexdefInputDataIndexDefinitionIdGet({ 
    required String indexDefinitionId,
    DateTime? time,
  ...
  Future<Response<BuiltList<IndexesIndexMultiAssetWeight>>> v1IndexdefMultiassetGet({ 
    ...
    final _path = r'/v1/indexdef/multiasset';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<BuiltList<IndexesIndexMultiAssetWeight>>> v1IndexdefMultiassetIndexIdGet({ 
    ...
    final _path = r'/v1/indexdef/multiasset/{index_id}'.replaceAll('{' r'index_id' '}', encodeQueryParameter(_serializers, indexId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<BuiltList<IndexesIndexDefinitionSnapshotEntry>>> v1IndexesIndexDefinitionIdCurrentSnapshotGet({ 
    ...
    final _path = r'/v1/indexes/{index_definition_id}/currentSnapshot'.replaceAll('{' r'index_definition_id' '}', encodeQueryParameter(_serializers, indexDefinitionId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<BuiltList<IndexesIndexDefinitionSnapshotEntry>>> v1IndexesIndexDefinitionIdHistorySnapshotGet({ 
    ...
    final _path = r'/v1/indexes/{index_definition_id}/historySnapshot'.replaceAll('{' r'index_definition_id' '}', encodeQueryParameter(_serializers, indexDefinitionId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<IndexesIndexValue>> v1IndexesIndexIdCurrentGet({ 
    ...
    final _path = r'/v1/indexes/{index_id}/current'.replaceAll('{' r'index_id' '}', encodeQueryParameter(_serializers, indexId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<BuiltList<IndexesIndexValue>>> v1IndexesIndexIdHistoryGet({ 
    ...
    final _path = r'/v1/indexes/{index_id}/history'.replaceAll('{' r'index_id' '}', encodeQueryParameter(_serializers, indexId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<BuiltList<IndexesIndexTimeseriesItem>>> v1IndexesIndexIdTimeseriesGet({ 
    ...
    final _path = r'/v1/indexes/{index_id}/timeseries'.replaceAll('{' r'index_id' '}', encodeQueryParameter(_serializers, indexId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
