...
part 'models_index_definition_input_data.g.dart';
...
@BuiltValue()
abstract class ModelsIndexDefinitionInputData implements Built<ModelsIndexDefinitionInputData, ModelsIndexDefinitionInputDataBuilder> {
  ...
  ModelsIndexDefinitionInputData._();

  factory ModelsIndexDefinitionInputData([void updates(ModelsIndexDefinitionInputDataBuilder b)]) = _$ModelsIndexDefinitionInputData;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ModelsIndexDefinitionInputDataBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ModelsIndexDefinitionInputData> get serializer => _$ModelsIndexDefinitionInputDataSerializer();
}

class _$ModelsIndexDefinitionInputDataSerializer implements PrimitiveSerializer<ModelsIndexDefinitionInputData> {
  @override
  final Iterable<Type> types = const [ModelsIndexDefinitionInputData, _$ModelsIndexDefinitionInputData];

  @override
  final String wireName = r'ModelsIndexDefinitionInputData';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ModelsIndexDefinitionInputData object, {
  ...
  void _deserializeProperties(
    ...
    required ModelsIndexDefinitionInputDataBuilder result,
  ...
  @override
  ModelsIndexDefinitionInputData deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ModelsIndexDefinitionInputDataBuilder();
