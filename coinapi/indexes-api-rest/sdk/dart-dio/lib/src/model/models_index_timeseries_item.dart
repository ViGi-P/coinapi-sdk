...
part 'models_index_timeseries_item.g.dart';
...
@BuiltValue()
abstract class ModelsIndexTimeseriesItem implements Built<ModelsIndexTimeseriesItem, ModelsIndexTimeseriesItemBuilder> {
  ...
  ModelsIndexTimeseriesItem._();

  factory ModelsIndexTimeseriesItem([void updates(ModelsIndexTimeseriesItemBuilder b)]) = _$ModelsIndexTimeseriesItem;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ModelsIndexTimeseriesItemBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ModelsIndexTimeseriesItem> get serializer => _$ModelsIndexTimeseriesItemSerializer();
}

class _$ModelsIndexTimeseriesItemSerializer implements PrimitiveSerializer<ModelsIndexTimeseriesItem> {
  @override
  final Iterable<Type> types = const [ModelsIndexTimeseriesItem, _$ModelsIndexTimeseriesItem];

  @override
  final String wireName = r'ModelsIndexTimeseriesItem';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ModelsIndexTimeseriesItem object, {
  ...
  void _deserializeProperties(
    ...
    required ModelsIndexTimeseriesItemBuilder result,
  ...
  @override
  ModelsIndexTimeseriesItem deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ModelsIndexTimeseriesItemBuilder();
