...
part 'models_timeseries_period.g.dart';
...
@BuiltValue()
abstract class ModelsTimeseriesPeriod implements Built<ModelsTimeseriesPeriod, ModelsTimeseriesPeriodBuilder> {
  ...
  ModelsTimeseriesPeriod._();

  factory ModelsTimeseriesPeriod([void updates(ModelsTimeseriesPeriodBuilder b)]) = _$ModelsTimeseriesPeriod;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ModelsTimeseriesPeriodBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ModelsTimeseriesPeriod> get serializer => _$ModelsTimeseriesPeriodSerializer();
}

class _$ModelsTimeseriesPeriodSerializer implements PrimitiveSerializer<ModelsTimeseriesPeriod> {
  @override
  final Iterable<Type> types = const [ModelsTimeseriesPeriod, _$ModelsTimeseriesPeriod];

  @override
  final String wireName = r'ModelsTimeseriesPeriod';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ModelsTimeseriesPeriod object, {
  ...
  void _deserializeProperties(
    ...
    required ModelsTimeseriesPeriodBuilder result,
  ...
  @override
  ModelsTimeseriesPeriod deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ModelsTimeseriesPeriodBuilder();
