...
class ModelsIndexDefinitionInputData {
  /// Returns a new [ModelsIndexDefinitionInputData] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ModelsIndexDefinitionInputData &&
  ...
  @override
  String toString() => 'ModelsIndexDefinitionInputData[exchangeId=$exchangeId, exchangeSymbolId=$exchangeSymbolId, baseAssetId=$baseAssetId, quoteAssetId=$quoteAssetId, beginDate=$beginDate, endDate=$endDate, status=$status, statusInfo=$statusInfo, lastModificationTime=$lastModificationTime]';
  ...
  /// Returns a new [ModelsIndexDefinitionInputData] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ModelsIndexDefinitionInputData? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<ModelsIndexDefinitionInputData> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ModelsIndexDefinitionInputData>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ModelsIndexDefinitionInputData.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ModelsIndexDefinitionInputData> mapFromJson(dynamic json) {
    final map = <String, ModelsIndexDefinitionInputData>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ModelsIndexDefinitionInputData.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ModelsIndexDefinitionInputData-objects as value to a dart map
  static Map<String, List<ModelsIndexDefinitionInputData>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ModelsIndexDefinitionInputData>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ModelsIndexDefinitionInputData.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
