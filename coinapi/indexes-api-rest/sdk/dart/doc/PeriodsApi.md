...
> List<ModelsTimeseriesPeriod> v1MetadataPeriodsGet()
...
final api_instance = PeriodsApi();

try {
    final result = api_instance.v1MetadataPeriodsGet();
    print(result);
} catch (e) {
...
[**List<ModelsTimeseriesPeriod>**](ModelsTimeseriesPeriod.md)
