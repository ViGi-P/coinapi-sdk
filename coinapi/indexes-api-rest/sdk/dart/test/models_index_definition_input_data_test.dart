...
// tests for ModelsIndexDefinitionInputData
void main() {
  // final instance = ModelsIndexDefinitionInputData();

  group('test ModelsIndexDefinitionInputData', () {
    // String exchangeId
    ...
    test('to test the property `exchangeSymbolId`', () async {
      // TODO
    });
    ...
    // String statusInfo
    test('to test the property `statusInfo`', () async {
      // TODO
    });
