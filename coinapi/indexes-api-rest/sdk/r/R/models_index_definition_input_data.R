#' Create a new ModelsIndexDefinitionInputData
#'
#' @description
#' ModelsIndexDefinitionInputData Class
#'
#' @docType class
#' @title ModelsIndexDefinitionInputData
#' @description ModelsIndexDefinitionInputData Class
...
#' @export
ModelsIndexDefinitionInputData <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new ModelsIndexDefinitionInputData class.
    #'
    ...
    #'
    #' @return ModelsIndexDefinitionInputData as a base R list.
    #' @examples
    #' # convert array of ModelsIndexDefinitionInputData (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ModelsIndexDefinitionInputData to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      ModelsIndexDefinitionInputDataObject <- list()
      if (!is.null(self$`exchangeId`)) {
        ModelsIndexDefinitionInputDataObject[["exchangeId"]] <-
          self$`exchangeId`
      }
      if (!is.null(self$`exchangeSymbolId`)) {
        ModelsIndexDefinitionInputDataObject[["exchangeSymbolId"]] <-
          self$`exchangeSymbolId`
      }
      if (!is.null(self$`baseAssetId`)) {
        ModelsIndexDefinitionInputDataObject[["baseAssetId"]] <-
          self$`baseAssetId`
      }
      if (!is.null(self$`quoteAssetId`)) {
        ModelsIndexDefinitionInputDataObject[["quoteAssetId"]] <-
          self$`quoteAssetId`
      }
      if (!is.null(self$`beginDate`)) {
        ModelsIndexDefinitionInputDataObject[["beginDate"]] <-
          self$`beginDate`
      }
      if (!is.null(self$`endDate`)) {
        ModelsIndexDefinitionInputDataObject[["endDate"]] <-
          self$`endDate`
      }
      if (!is.null(self$`status`)) {
        ModelsIndexDefinitionInputDataObject[["status"]] <-
          self$`status`
      }
      if (!is.null(self$`statusInfo`)) {
        ModelsIndexDefinitionInputDataObject[["statusInfo"]] <-
          self$`statusInfo`
      }
      if (!is.null(self$`lastModificationTime`)) {
        ModelsIndexDefinitionInputDataObject[["lastModificationTime"]] <-
          self$`lastModificationTime`
      }
      return(ModelsIndexDefinitionInputDataObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of ModelsIndexDefinitionInputData
    #'
    #' @param input_json the JSON input
    #' @return the instance of ModelsIndexDefinitionInputData
    ...
    #' @return ModelsIndexDefinitionInputData in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to ModelsIndexDefinitionInputData and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of ModelsIndexDefinitionInputData
    toString = function() {
      self$toJSONString()
    },
...
# ModelsIndexDefinitionInputData$unlock()
#
## Below is an example to define the print function
# ModelsIndexDefinitionInputData$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ModelsIndexDefinitionInputData$lock()
