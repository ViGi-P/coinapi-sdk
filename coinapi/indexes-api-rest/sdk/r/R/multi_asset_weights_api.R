...
#'
#' @docType class
#' @title MultiAssetWeights operations
#' @description MultiAssetWeightsApi
...
#' @export
MultiAssetWeightsApi <- R6::R6Class(
  "MultiAssetWeightsApi",
  public = list(
    api_client = NULL,

    #' @description
    #' Initialize a new MultiAssetWeightsApi.
    #'
    ...
    V1IndexdefMultiassetIndexIdGetWithHttpInfo = function(index_id, data_file = NULL, ..., .parse = TRUE) {
      ...
      if (!missing(`index_id`) && is.null(`index_id`)) {
        stop("Invalid value for `index_id` when calling MultiAssetWeightsApi$V1IndexdefMultiassetIndexIdGet, `index_id` is not nullable")
      }
