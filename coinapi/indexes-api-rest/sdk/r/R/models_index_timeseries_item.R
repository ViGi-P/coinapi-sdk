#' Create a new ModelsIndexTimeseriesItem
#'
#' @description
#' Represents a timeseries item with value information.
#'
#' @docType class
#' @title ModelsIndexTimeseriesItem
#' @description ModelsIndexTimeseriesItem Class
...
#' @export
ModelsIndexTimeseriesItem <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new ModelsIndexTimeseriesItem class.
    #'
    ...
    #'
    #' @return ModelsIndexTimeseriesItem as a base R list.
    #' @examples
    #' # convert array of ModelsIndexTimeseriesItem (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ModelsIndexTimeseriesItem to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      ModelsIndexTimeseriesItemObject <- list()
      if (!is.null(self$`time_period_start`)) {
        ModelsIndexTimeseriesItemObject[["time_period_start"]] <-
          self$`time_period_start`
      }
      if (!is.null(self$`time_period_end`)) {
        ModelsIndexTimeseriesItemObject[["time_period_end"]] <-
          self$`time_period_end`
      }
      if (!is.null(self$`time_open`)) {
        ModelsIndexTimeseriesItemObject[["time_open"]] <-
          self$`time_open`
      }
      if (!is.null(self$`time_close`)) {
        ModelsIndexTimeseriesItemObject[["time_close"]] <-
          self$`time_close`
      }
      if (!is.null(self$`value_open`)) {
        ModelsIndexTimeseriesItemObject[["value_open"]] <-
          self$`value_open`
      }
      if (!is.null(self$`value_high`)) {
        ModelsIndexTimeseriesItemObject[["value_high"]] <-
          self$`value_high`
      }
      if (!is.null(self$`value_low`)) {
        ModelsIndexTimeseriesItemObject[["value_low"]] <-
          self$`value_low`
      }
      if (!is.null(self$`value_close`)) {
        ModelsIndexTimeseriesItemObject[["value_close"]] <-
          self$`value_close`
      }
      if (!is.null(self$`value_count`)) {
        ModelsIndexTimeseriesItemObject[["value_count"]] <-
          self$`value_count`
      }
      return(ModelsIndexTimeseriesItemObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of ModelsIndexTimeseriesItem
    #'
    #' @param input_json the JSON input
    #' @return the instance of ModelsIndexTimeseriesItem
    ...
    #' @return ModelsIndexTimeseriesItem in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to ModelsIndexTimeseriesItem and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of ModelsIndexTimeseriesItem
    toString = function() {
      self$toJSONString()
    },
...
# ModelsIndexTimeseriesItem$unlock()
#
## Below is an example to define the print function
# ModelsIndexTimeseriesItem$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ModelsIndexTimeseriesItem$lock()
