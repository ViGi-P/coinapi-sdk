#' Create a new ModelsTimeseriesPeriod
#'
#' @description
#' Represents a timeseries period used in exchange rate data.
#'
#' @docType class
#' @title ModelsTimeseriesPeriod
#' @description ModelsTimeseriesPeriod Class
...
#' @export
ModelsTimeseriesPeriod <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new ModelsTimeseriesPeriod class.
    #'
    ...
    #'
    #' @return ModelsTimeseriesPeriod as a base R list.
    #' @examples
    #' # convert array of ModelsTimeseriesPeriod (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ModelsTimeseriesPeriod to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      ModelsTimeseriesPeriodObject <- list()
      if (!is.null(self$`period_id`)) {
        ModelsTimeseriesPeriodObject[["period_id"]] <-
          self$`period_id`
      }
      if (!is.null(self$`length_seconds`)) {
        ModelsTimeseriesPeriodObject[["length_seconds"]] <-
          self$`length_seconds`
      }
      if (!is.null(self$`length_months`)) {
        ModelsTimeseriesPeriodObject[["length_months"]] <-
          self$`length_months`
      }
      if (!is.null(self$`unit_count`)) {
        ModelsTimeseriesPeriodObject[["unit_count"]] <-
          self$`unit_count`
      }
      if (!is.null(self$`unit_name`)) {
        ModelsTimeseriesPeriodObject[["unit_name"]] <-
          self$`unit_name`
      }
      if (!is.null(self$`display_name`)) {
        ModelsTimeseriesPeriodObject[["display_name"]] <-
          self$`display_name`
      }
      return(ModelsTimeseriesPeriodObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of ModelsTimeseriesPeriod
    #'
    #' @param input_json the JSON input
    #' @return the instance of ModelsTimeseriesPeriod
    ...
    #' @return ModelsTimeseriesPeriod in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to ModelsTimeseriesPeriod and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of ModelsTimeseriesPeriod
    toString = function() {
      self$toJSONString()
    },
...
# ModelsTimeseriesPeriod$unlock()
#
## Below is an example to define the print function
# ModelsTimeseriesPeriod$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ModelsTimeseriesPeriod$lock()
