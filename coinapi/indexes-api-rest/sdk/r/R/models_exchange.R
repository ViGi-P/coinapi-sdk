#' Create a new ModelsExchange
#'
#' @description
#' Represents an exchange.
#'
#' @docType class
#' @title ModelsExchange
#' @description ModelsExchange Class
...
ModelsExchange <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new ModelsExchange class.
    #'
    ...
    #'
    #' @return ModelsExchange as a base R list.
    #' @examples
    #' # convert array of ModelsExchange (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ModelsExchange to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      ModelsExchangeObject <- list()
      if (!is.null(self$`exchange_id`)) {
        ModelsExchangeObject[["exchange_id"]] <-
          self$`exchange_id`
      }
      if (!is.null(self$`website`)) {
        ModelsExchangeObject[["website"]] <-
          self$`website`
      }
      if (!is.null(self$`name`)) {
        ModelsExchangeObject[["name"]] <-
          self$`name`
      }
      return(ModelsExchangeObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of ModelsExchange
    #'
    #' @param input_json the JSON input
    #' @return the instance of ModelsExchange
    ...
    #' @return ModelsExchange in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to ModelsExchange and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of ModelsExchange
    toString = function() {
      self$toJSONString()
    },
...
# ModelsExchange$unlock()
#
## Below is an example to define the print function
# ModelsExchange$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
