...
> array[ModelsExchange] ApiMetadataExchangesExchangeIdGet(exchange_id)
...
[**array[ModelsExchange]**](Models.Exchange.md)
...
> array[ModelsExchange] ApiMetadataExchangesGet(filter_exchange_id = var.filter_exchange_id)
