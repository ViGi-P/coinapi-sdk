...
Use these endpoints to discover supported time periods for index time-series requests.
...
```php
v1MetadataPeriodsGet(): \OpenAPI\Client\Model\ModelsTimeseriesPeriod[]
```
...
[**\OpenAPI\Client\Model\ModelsTimeseriesPeriod[]**](../Model/ModelsTimeseriesPeriod.md)
