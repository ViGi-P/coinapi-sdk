...
Use these endpoints to discover supported exchanges used by index-related datasets.
...
```php
apiMetadataExchangesExchangeIdGet($exchange_id): \OpenAPI\Client\Model\ModelsExchange[]
```
...
[**\OpenAPI\Client\Model\ModelsExchange[]**](../Model/ModelsExchange.md)
...
```php
apiMetadataExchangesGet($filter_exchange_id): \OpenAPI\Client\Model\ModelsExchange[]
```
