...
> <Array<ModelsTimeseriesPeriod>> v1_metadata_periods_get
...
> <Array(<Array<ModelsTimeseriesPeriod>>, Integer, Hash)> v1_metadata_periods_get_with_http_info
...
begin
  ...
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <Array<ModelsTimeseriesPeriod>>
rescue OpenapiClient::ApiError => e
...
[**Array&lt;ModelsTimeseriesPeriod&gt;**](ModelsTimeseriesPeriod.md)
