...
> <Array<ModelsExchange>> api_metadata_exchanges_exchange_id_get(exchange_id)
...
> <Array(<Array<ModelsExchange>>, Integer, Hash)> api_metadata_exchanges_exchange_id_get_with_http_info(exchange_id)
...
[**Array&lt;ModelsExchange&gt;**](ModelsExchange.md)
...
> <Array<ModelsExchange>> api_metadata_exchanges_get(opts)
...
> <Array(<Array<ModelsExchange>>, Integer, Hash)> api_metadata_exchanges_get_with_http_info(opts)
