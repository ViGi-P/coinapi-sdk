...
module OpenapiClient
  class MetadataApi
    ...
    # @param exchange_id [String] The ID of the exchange.
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<ModelsExchange>, Integer, Hash)>] Array<ModelsExchange> data, response status code and response headers
    def api_metadata_exchanges_exchange_id_get_with_http_info(exchange_id, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'Array<ModelsExchange>'
