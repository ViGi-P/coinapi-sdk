...
public:
    ...
    pplx::task<std::vector<std::shared_ptr<Models_Exchange>>> apiMetadataExchangesExchangeIdGet(
    ...
    pplx::task<std::vector<std::shared_ptr<Models_Exchange>>> apiMetadataExchangesGet(
