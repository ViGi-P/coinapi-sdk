...
web::json::value Indexes_IndexMultiAssetWeight::toJson() const
{
    ...
    {   
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("indexId"))] = ModelBase::toJson(m_IndexId);
    }
    if(m_AssetIdIsSet)
    {   
...
void Indexes_IndexMultiAssetWeight::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_IndexIdIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("indexId")), m_IndexId));
    }
    if(m_AssetIdIsSet)
    {
