...
web::json::value Indexes_IndexValue::toJson() const
{
    ...
    {   
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("composition"))] = ModelBase::toJson(m_Composition);
    }
...
void Indexes_IndexValue::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_CompositionIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("composition")), m_Composition));
    }
}
