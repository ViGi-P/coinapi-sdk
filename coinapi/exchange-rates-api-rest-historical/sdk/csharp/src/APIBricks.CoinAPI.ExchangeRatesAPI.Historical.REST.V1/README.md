...
$properties = @(
    ...
    'packageName=APIBricks.CoinAPI.ExchangeRatesAPI.Historical.REST.V1',
    'packageTags=',
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            var api = host.Services.GetRequiredService<IExchangeRatesApi>();
            GetSpecificRateApiResponse apiResponse = await api.GetSpecificRateAsync("todo");
            V1ExchangeRate model = apiResponse.Ok();
        }
...
- How do I validate requests and process responses?
  Use the provided On and After methods in the Api class from the namespace APIBricks.CoinAPI.ExchangeRatesAPI.Historical.REST.V1.Rest.DefaultApi.
...
## Api Information
- appName: Exchange Rates Historical REST API
- appVersion: v1
...
- packageCopyright: No Copyright
- packageDescription: A library generated from a OpenAPI doc
- packageGuid: {2437FAF0-313E-4BA6-9762-8FC7BC1A9D12}
- packageName: APIBricks.CoinAPI.ExchangeRatesAPI.Historical.REST.V1
- packageTags: 
- packageTitle: OpenAPI Library
- packageVersion: 1.0.0
