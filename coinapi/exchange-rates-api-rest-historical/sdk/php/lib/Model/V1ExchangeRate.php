...
/**
 * V1ExchangeRate Class Doc Comment
 *
 * @category Class
 ...
 */
class V1ExchangeRate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'v1.ExchangeRate';
    ...
    */
     ...
     * Sets time
     *
     * @param \DateTime|null $time Gets or sets the time of the exchange rate.
     *
     * @return self
     */
     ...
     * Sets asset_id_base
     *
     * @param string|null $asset_id_base Gets or sets the base asset ID of the exchange rate.
     *
     * @return self
     */
     ...
     * Sets asset_id_quote
     *
     * @param string|null $asset_id_quote Gets or sets the quote asset ID of the exchange rate.
     *
     * @return self
     */
     ...
     * Sets rate
     *
     * @param float|null $rate Gets or sets the exchange rate value.
     *
     * @return self
     */
