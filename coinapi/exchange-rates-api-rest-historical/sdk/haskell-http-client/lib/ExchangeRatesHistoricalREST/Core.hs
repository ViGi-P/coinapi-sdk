...
module ExchangeRatesHistoricalREST.Core where
...
-- * ExchangeRatesHistoricalRESTConfig

-- |
data ExchangeRatesHistoricalRESTConfig = ExchangeRatesHistoricalRESTConfig
...
-- | display the config
instance P.Show ExchangeRatesHistoricalRESTConfig where
  show c =
    T.printf
...
-- | constructs a default ExchangeRatesHistoricalRESTConfig
--
-- configHost:
--
...
-- configUserAgent:
--
-- @"exchange-rates-historical-rest/0.1.0.0"@
--
newConfig :: IO ExchangeRatesHistoricalRESTConfig
newConfig = do
    logCxt <- initLogContext
    return $ ExchangeRatesHistoricalRESTConfig
        { configHost = "https://api-historical.exrates.coinapi.io"
        , configUserAgent = "exchange-rates-historical-rest/0.1.0.0"
...
addAuthMethod :: AuthMethod auth => ExchangeRatesHistoricalRESTConfig -> auth -> ExchangeRatesHistoricalRESTConfig
addAuthMethod config@ExchangeRatesHistoricalRESTConfig {configAuthMethods = as} a =
  config { configAuthMethods = AnyAuthMethod a : as}

-- | updates the config to use stdout logging
withStdoutLogging :: ExchangeRatesHistoricalRESTConfig -> IO ExchangeRatesHistoricalRESTConfig
...
withStderrLogging :: ExchangeRatesHistoricalRESTConfig -> IO ExchangeRatesHistoricalRESTConfig
...
withNoLogging :: ExchangeRatesHistoricalRESTConfig -> ExchangeRatesHistoricalRESTConfig
withNoLogging p = p { configLogExecWithContext =  runNullLogExec}

-- * ExchangeRatesHistoricalRESTRequest
...
data ExchangeRatesHistoricalRESTRequest req contentType res accept = ExchangeRatesHistoricalRESTRequest
  { rMethod  :: NH.Method   -- ^ Method of ExchangeRatesHistoricalRESTRequest
  , rUrlPath :: [BCL.ByteString] -- ^ Endpoint of ExchangeRatesHistoricalRESTRequest
  , rParams   :: Params -- ^ params of ExchangeRatesHistoricalRESTRequest
  , rAuthTypes :: [P.TypeRep] -- ^ types of auth methods
  }
  deriving (P.Show)

-- | 'rMethod' Lens
rMethodL :: Lens_' (ExchangeRatesHistoricalRESTRequest req contentType res accept) NH.Method
rMethodL f ExchangeRatesHistoricalRESTRequest{..} = (\rMethod -> ExchangeRatesHistoricalRESTRequest { rMethod, ..} ) <$> f rMethod
{-# INLINE rMethodL #-}

-- | 'rUrlPath' Lens
rUrlPathL :: Lens_' (ExchangeRatesHistoricalRESTRequest req contentType res accept) [BCL.ByteString]
rUrlPathL f ExchangeRatesHistoricalRESTRequest{..} = (\rUrlPath -> ExchangeRatesHistoricalRESTRequest { rUrlPath, ..} ) <$> f rUrlPath
{-# INLINE rUrlPathL #-}

-- | 'rParams' Lens
rParamsL :: Lens_' (ExchangeRatesHistoricalRESTRequest req contentType res accept) Params
rParamsL f ExchangeRatesHistoricalRESTRequest{..} = (\rParams -> ExchangeRatesHistoricalRESTRequest { rParams, ..} ) <$> f rParams
{-# INLINE rParamsL #-}

-- | 'rParams' Lens
rAuthTypesL :: Lens_' (ExchangeRatesHistoricalRESTRequest req contentType res accept) [P.TypeRep]
rAuthTypesL f ExchangeRatesHistoricalRESTRequest{..} = (\rAuthTypes -> ExchangeRatesHistoricalRESTRequest { rAuthTypes, ..} ) <$> f rAuthTypes
{-# INLINE rAuthTypesL #-}
...
class HasBodyParam req param where
  setBodyParam :: forall contentType res accept. (Consumes req contentType, MimeRender contentType param) => ExchangeRatesHistoricalRESTRequest req contentType res accept -> param -> ExchangeRatesHistoricalRESTRequest req contentType res accept
  setBodyParam req xs =
...
class HasOptionalParam req param where
  ...
  applyOptionalParam :: ExchangeRatesHistoricalRESTRequest req contentType res accept -> param -> ExchangeRatesHistoricalRESTRequest req contentType res accept
  applyOptionalParam = (-&-)
  {-# INLINE applyOptionalParam #-}

  -- | infix operator \/ alias for 'addOptionalParam'
  (-&-) :: ExchangeRatesHistoricalRESTRequest req contentType res accept -> param -> ExchangeRatesHistoricalRESTRequest req contentType res accept
  (-&-) = applyOptionalParam
  {-# INLINE (-&-) #-}
...
-- ** ExchangeRatesHistoricalRESTRequest Utils

_mkRequest :: NH.Method -- ^ Method
          -> [BCL.ByteString] -- ^ Endpoint
          -> ExchangeRatesHistoricalRESTRequest req contentType res accept -- ^ req: Request Type, res: Response Type
_mkRequest m u = ExchangeRatesHistoricalRESTRequest m u _mkParams []

_mkParams :: Params
_mkParams = Params [] [] ParamBodyNone

setHeader ::
     ExchangeRatesHistoricalRESTRequest req contentType res accept
  -> [NH.Header]
  -> ExchangeRatesHistoricalRESTRequest req contentType res accept
...
removeHeader :: ExchangeRatesHistoricalRESTRequest req contentType res accept -> [NH.HeaderName] -> ExchangeRatesHistoricalRESTRequest req contentType res accept
...
_setContentTypeHeader :: forall req contentType res accept. MimeType contentType => ExchangeRatesHistoricalRESTRequest req contentType res accept -> ExchangeRatesHistoricalRESTRequest req contentType res accept
_setContentTypeHeader req =
    case mimeType (P.Proxy :: P.Proxy contentType) of
        Just m -> req `setHeader` [("content-type", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["content-type"]

_setAcceptHeader :: forall req contentType res accept. MimeType accept => ExchangeRatesHistoricalRESTRequest req contentType res accept -> ExchangeRatesHistoricalRESTRequest req contentType res accept
...
addForm :: ExchangeRatesHistoricalRESTRequest req contentType res accept -> WH.Form -> ExchangeRatesHistoricalRESTRequest req contentType res accept
addForm req newform =
...
_addMultiFormPart :: ExchangeRatesHistoricalRESTRequest req contentType res accept -> NH.Part -> ExchangeRatesHistoricalRESTRequest req contentType res accept
...
_setBodyBS :: ExchangeRatesHistoricalRESTRequest req contentType res accept -> B.ByteString -> ExchangeRatesHistoricalRESTRequest req contentType res accept
_setBodyBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyB body)

_setBodyLBS :: ExchangeRatesHistoricalRESTRequest req contentType res accept -> BL.ByteString -> ExchangeRatesHistoricalRESTRequest req contentType res accept
_setBodyLBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyBL body)

_hasAuthType :: AuthMethod authMethod => ExchangeRatesHistoricalRESTRequest req contentType res accept -> P.Proxy authMethod -> ExchangeRatesHistoricalRESTRequest req contentType res accept
...
class P.Typeable a =>
  ...
  applyAuthMethod
    ...
    -> a
    -> ExchangeRatesHistoricalRESTRequest req contentType res accept
    -> IO (ExchangeRatesHistoricalRESTRequest req contentType res accept)
...
_applyAuthMethods
  ...
  -> ExchangeRatesHistoricalRESTConfig
  -> IO (ExchangeRatesHistoricalRESTRequest req contentType res accept)
_applyAuthMethods req config@(ExchangeRatesHistoricalRESTConfig {configAuthMethods = as}) =
  foldlM go req as
  where
