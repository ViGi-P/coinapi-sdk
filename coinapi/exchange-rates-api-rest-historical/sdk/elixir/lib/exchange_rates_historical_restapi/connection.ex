...
defmodule ExchangeRatesHistoricalRESTAPI.Connection do
  @moduledoc """
  Handle Tesla connections for ExchangeRatesHistoricalRESTAPI.

  Additional middleware can be set in the compile-time or runtime configuration:

      config :tesla, ExchangeRatesHistoricalRESTAPI.Connection,
        base_url: "https://api-historical.exrates.coinapi.io",
        adapter: Tesla.Adapter.Hackney

  The default base URL can also be set as:

      config :exchange_rates_historical_restapi,
        :base_url, "https://api-historical.exrates.coinapi.io"
  """

  @default_base_url Application.compile_env(
                      :exchange_rates_historical_restapi,
                      :base_url,
  ...
  @doc """
  Configure a ExchangeRatesHistoricalRESTAPI client.

  ### Parameters

  - `options`: an optional keyword list of ExchangeRatesHistoricalRESTAPI.Connection.options.
  ...
  def middleware(options \\ []) do
    base_url =
      Keyword.get(
        options,
        :base_url,
        Application.get_env(:exchange_rates_historical_restapi, :base_url, @default_base_url)
      )
    ...
    user_agent =
      Keyword.get(
        ...
        Keyword.get(
          tesla_options,
          :user_agent,
          "openapi-generator - ExchangeRatesHistoricalRESTAPI 1.0.0 - elixir"
        )
      )
