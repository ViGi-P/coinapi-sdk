...
defmodule ExchangeRatesHistoricalRESTAPI.RequestBuilder do
  @moduledoc """
  ...
  defp decode(%Tesla.Env{body: body}, %{}) do
    ExchangeRatesHistoricalRESTAPI.Deserializer.json_decode(body)
  end

  defp decode(%Tesla.Env{body: body}, module) do
    ExchangeRatesHistoricalRESTAPI.Deserializer.json_decode(body, module)
  end
end
