# Documentation for Exchange Rates Historical REST API v1 Tizen Client SDK
...
├── README.md                 \\This file
├── SDK                       \\Documentation for all classes in Exchange Rates Historical REST API Tizen Client SDK. See ./html/index.html
│   └── html
...
All URIs are relative to https://api-historical.exrates.coinapi.iohttps://api-historical.exrates.coinapi.io
