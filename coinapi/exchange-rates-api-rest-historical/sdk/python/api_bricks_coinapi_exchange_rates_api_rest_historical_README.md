# API Bricks CoinAPI Exchange Rates API REST Historical
No description provided (generated by Openapi Generator https://github.com/openapitools/openapi-generator)

The `api_bricks_coinapi_exchange_rates_api_rest_historical` package is automatically generated by the [OpenAPI Generator](https://openapi-generator.tech) project:
...
In your own code, to use this library to connect and interact with API Bricks CoinAPI Exchange Rates API REST Historical,
...
------------ | ------------- | ------------- | -------------
*ExchangeRatesApi* | [**get_specific_rate**](api_bricks_coinapi_exchange_rates_api_rest_historical/docs/ExchangeRatesApi.md#get_specific_rate) | **GET** /v1/exchangerate/{asset_id_base}/{asset_id_quote} | Get specific rate
*ExchangeRatesApi* | [**v1_exchangerate_asset_id_base_asset_id_quote_history_get**](api_bricks_coinapi_exchange_rates_api_rest_historical/docs/ExchangeRatesApi.md#v1_exchangerate_asset_id_base_asset_id_quote_history_get) | **GET** /v1/exchangerate/{asset_id_base}/{asset_id_quote}/history | Timeseries data
*ExchangeRatesApi* | [**v1_exchangerate_asset_id_base_get**](api_bricks_coinapi_exchange_rates_api_rest_historical/docs/ExchangeRatesApi.md#v1_exchangerate_asset_id_base_get) | **GET** /v1/exchangerate/{asset_id_base} | Get all current rates
*ExchangeRatesApi* | [**v1_exchangerate_history_periods_get**](api_bricks_coinapi_exchange_rates_api_rest_historical/docs/ExchangeRatesApi.md#v1_exchangerate_history_periods_get) | **GET** /v1/exchangerate/history/periods | Timeseries periods
*MetadataApi* | [**v1_assets_asset_id_get**](api_bricks_coinapi_exchange_rates_api_rest_historical/docs/MetadataApi.md#v1_assets_asset_id_get) | **GET** /v1/assets/{asset_id} | List all assets by asset ID
*MetadataApi* | [**v1_assets_get**](api_bricks_coinapi_exchange_rates_api_rest_historical/docs/MetadataApi.md#v1_assets_get) | **GET** /v1/assets | List all assets
*MetadataApi* | [**v1_assets_icons_size_get**](api_bricks_coinapi_exchange_rates_api_rest_historical/docs/MetadataApi.md#v1_assets_icons_size_get) | **GET** /v1/assets/icons/{size} | List all asset icons
...
## Documentation For Models
 ...
 - [V1TimeseriesPeriod](api_bricks_coinapi_exchange_rates_api_rest_historical/docs/V1TimeseriesPeriod.md)
