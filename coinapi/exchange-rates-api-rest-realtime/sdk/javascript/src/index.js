...
* <pre>
* var ExchangeRatesRealtimeRestApi = require('index'); // See note below*.
* var xxxSvc = new ExchangeRatesRealtimeRestApi.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new ExchangeRatesRealtimeRestApi.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new ExchangeRatesRealtimeRestApi.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new ExchangeRatesRealtimeRestApi.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
