# api_bricks_coinapi_exchange_rates_api_rest_realtime.RateLimitApi
...
with api_bricks_coinapi_exchange_rates_api_rest_realtime.ApiClient(configuration) as api_client:
    ...
    api_instance = api_bricks_coinapi_exchange_rates_api_rest_realtime.RateLimitApi(api_client)
