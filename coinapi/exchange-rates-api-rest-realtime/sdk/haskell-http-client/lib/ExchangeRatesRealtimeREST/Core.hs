...
module ExchangeRatesRealtimeREST.Core where
...
-- * ExchangeRatesRealtimeRESTConfig

-- |
data ExchangeRatesRealtimeRESTConfig = ExchangeRatesRealtimeRESTConfig
...
-- | display the config
instance P.Show ExchangeRatesRealtimeRESTConfig where
  show c =
    T.printf
...
-- | constructs a default ExchangeRatesRealtimeRESTConfig
--
-- configHost:
--
...
-- configUserAgent:
--
-- @"exchange-rates-realtime-rest/0.1.0.0"@
--
newConfig :: IO ExchangeRatesRealtimeRESTConfig
newConfig = do
    logCxt <- initLogContext
    return $ ExchangeRatesRealtimeRESTConfig
        { configHost = "https://api-realtime.exrates.coinapi.io"
        , configUserAgent = "exchange-rates-realtime-rest/0.1.0.0"
...
addAuthMethod :: AuthMethod auth => ExchangeRatesRealtimeRESTConfig -> auth -> ExchangeRatesRealtimeRESTConfig
addAuthMethod config@ExchangeRatesRealtimeRESTConfig {configAuthMethods = as} a =
  config { configAuthMethods = AnyAuthMethod a : as}

-- | updates the config to use stdout logging
withStdoutLogging :: ExchangeRatesRealtimeRESTConfig -> IO ExchangeRatesRealtimeRESTConfig
...
withStderrLogging :: ExchangeRatesRealtimeRESTConfig -> IO ExchangeRatesRealtimeRESTConfig
...
withNoLogging :: ExchangeRatesRealtimeRESTConfig -> ExchangeRatesRealtimeRESTConfig
withNoLogging p = p { configLogExecWithContext =  runNullLogExec}

-- * ExchangeRatesRealtimeRESTRequest
...
data ExchangeRatesRealtimeRESTRequest req contentType res accept = ExchangeRatesRealtimeRESTRequest
  { rMethod  :: NH.Method   -- ^ Method of ExchangeRatesRealtimeRESTRequest
  , rUrlPath :: [BCL.ByteString] -- ^ Endpoint of ExchangeRatesRealtimeRESTRequest
  , rParams   :: Params -- ^ params of ExchangeRatesRealtimeRESTRequest
  , rAuthTypes :: [P.TypeRep] -- ^ types of auth methods
  }
  deriving (P.Show)

-- | 'rMethod' Lens
rMethodL :: Lens_' (ExchangeRatesRealtimeRESTRequest req contentType res accept) NH.Method
rMethodL f ExchangeRatesRealtimeRESTRequest{..} = (\rMethod -> ExchangeRatesRealtimeRESTRequest { rMethod, ..} ) <$> f rMethod
{-# INLINE rMethodL #-}

-- | 'rUrlPath' Lens
rUrlPathL :: Lens_' (ExchangeRatesRealtimeRESTRequest req contentType res accept) [BCL.ByteString]
rUrlPathL f ExchangeRatesRealtimeRESTRequest{..} = (\rUrlPath -> ExchangeRatesRealtimeRESTRequest { rUrlPath, ..} ) <$> f rUrlPath
{-# INLINE rUrlPathL #-}

-- | 'rParams' Lens
rParamsL :: Lens_' (ExchangeRatesRealtimeRESTRequest req contentType res accept) Params
rParamsL f ExchangeRatesRealtimeRESTRequest{..} = (\rParams -> ExchangeRatesRealtimeRESTRequest { rParams, ..} ) <$> f rParams
{-# INLINE rParamsL #-}

-- | 'rParams' Lens
rAuthTypesL :: Lens_' (ExchangeRatesRealtimeRESTRequest req contentType res accept) [P.TypeRep]
rAuthTypesL f ExchangeRatesRealtimeRESTRequest{..} = (\rAuthTypes -> ExchangeRatesRealtimeRESTRequest { rAuthTypes, ..} ) <$> f rAuthTypes
{-# INLINE rAuthTypesL #-}
...
class HasBodyParam req param where
  setBodyParam :: forall contentType res accept. (Consumes req contentType, MimeRender contentType param) => ExchangeRatesRealtimeRESTRequest req contentType res accept -> param -> ExchangeRatesRealtimeRESTRequest req contentType res accept
  setBodyParam req xs =
...
class HasOptionalParam req param where
  ...
  applyOptionalParam :: ExchangeRatesRealtimeRESTRequest req contentType res accept -> param -> ExchangeRatesRealtimeRESTRequest req contentType res accept
  applyOptionalParam = (-&-)
  {-# INLINE applyOptionalParam #-}

  -- | infix operator \/ alias for 'addOptionalParam'
  (-&-) :: ExchangeRatesRealtimeRESTRequest req contentType res accept -> param -> ExchangeRatesRealtimeRESTRequest req contentType res accept
  (-&-) = applyOptionalParam
  {-# INLINE (-&-) #-}
...
-- ** ExchangeRatesRealtimeRESTRequest Utils

_mkRequest :: NH.Method -- ^ Method
          -> [BCL.ByteString] -- ^ Endpoint
          -> ExchangeRatesRealtimeRESTRequest req contentType res accept -- ^ req: Request Type, res: Response Type
_mkRequest m u = ExchangeRatesRealtimeRESTRequest m u _mkParams []

_mkParams :: Params
_mkParams = Params [] [] ParamBodyNone

setHeader ::
     ExchangeRatesRealtimeRESTRequest req contentType res accept
  -> [NH.Header]
  -> ExchangeRatesRealtimeRESTRequest req contentType res accept
...
removeHeader :: ExchangeRatesRealtimeRESTRequest req contentType res accept -> [NH.HeaderName] -> ExchangeRatesRealtimeRESTRequest req contentType res accept
...
_setContentTypeHeader :: forall req contentType res accept. MimeType contentType => ExchangeRatesRealtimeRESTRequest req contentType res accept -> ExchangeRatesRealtimeRESTRequest req contentType res accept
_setContentTypeHeader req =
    case mimeType (P.Proxy :: P.Proxy contentType) of
        Just m -> req `setHeader` [("content-type", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["content-type"]

_setAcceptHeader :: forall req contentType res accept. MimeType accept => ExchangeRatesRealtimeRESTRequest req contentType res accept -> ExchangeRatesRealtimeRESTRequest req contentType res accept
...
addForm :: ExchangeRatesRealtimeRESTRequest req contentType res accept -> WH.Form -> ExchangeRatesRealtimeRESTRequest req contentType res accept
addForm req newform =
...
_addMultiFormPart :: ExchangeRatesRealtimeRESTRequest req contentType res accept -> NH.Part -> ExchangeRatesRealtimeRESTRequest req contentType res accept
...
_setBodyBS :: ExchangeRatesRealtimeRESTRequest req contentType res accept -> B.ByteString -> ExchangeRatesRealtimeRESTRequest req contentType res accept
_setBodyBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyB body)

_setBodyLBS :: ExchangeRatesRealtimeRESTRequest req contentType res accept -> BL.ByteString -> ExchangeRatesRealtimeRESTRequest req contentType res accept
_setBodyLBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyBL body)

_hasAuthType :: AuthMethod authMethod => ExchangeRatesRealtimeRESTRequest req contentType res accept -> P.Proxy authMethod -> ExchangeRatesRealtimeRESTRequest req contentType res accept
...
class P.Typeable a =>
  ...
  applyAuthMethod
    ...
    -> a
    -> ExchangeRatesRealtimeRESTRequest req contentType res accept
    -> IO (ExchangeRatesRealtimeRESTRequest req contentType res accept)
...
_applyAuthMethods
  ...
  -> ExchangeRatesRealtimeRESTConfig
  -> IO (ExchangeRatesRealtimeRESTRequest req contentType res accept)
_applyAuthMethods req config@(ExchangeRatesRealtimeRESTConfig {configAuthMethods = as}) =
  foldlM go req as
  where
