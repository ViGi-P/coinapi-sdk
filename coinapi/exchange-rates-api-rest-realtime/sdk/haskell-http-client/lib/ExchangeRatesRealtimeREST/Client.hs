...
module ExchangeRatesRealtimeREST.Client where
...
dispatchLbs
  ...
  -> ExchangeRatesRealtimeRESTConfig -- ^ config
  -> ExchangeRatesRealtimeRESTRequest req contentType res accept -- ^ request
