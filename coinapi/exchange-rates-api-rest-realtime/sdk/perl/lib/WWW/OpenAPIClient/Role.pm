...
has version_info => ( is => 'ro',
                      isa => 'HashRef',
                      default => sub { {
                          app_name => 'Exchange Rates Realtime REST API',
                          app_version => 'v1',
...
WWW::OpenAPIClient::Role - a Moose role for the Exchange Rates Realtime REST API

=head2 Exchange Rates Realtime REST API version: v1
