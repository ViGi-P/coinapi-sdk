...
using OpenAPIClientUtils = APIBricks.CoinAPI.ExchangeRatesAPI.Realtime.REST.V1.Client.ClientUtils;
using APIBricks.CoinAPI.ExchangeRatesAPI.Realtime.REST.V1.Client;

namespace APIBricks.CoinAPI.ExchangeRatesAPI.Realtime.REST.V1.Model
{
    /// <summary>
