...
- How do I validate requests and process responses?
  Use the provided On and After methods in the Api class from the namespace APIBricks.CoinAPI.ExchangeRatesAPI.Realtime.REST.V1.Rest.DefaultApi.
...
## Api Information
- appName: Exchange Rates Realtime REST API
- appVersion: v1
...
- packageCopyright: No Copyright
- packageDescription: A library generated from a OpenAPI doc
- packageGuid: {9CBE5B1C-AD02-4592-B509-1FC169BEC641}
- packageName: APIBricks.CoinAPI.ExchangeRatesAPI.Realtime.REST.V1
- packageTags: 
- packageTitle: OpenAPI Library
- packageVersion: 1.0.0
