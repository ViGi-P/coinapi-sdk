...
defmodule ExchangeRatesRealtimeRESTAPI.RequestBuilder do
  @moduledoc """
  ...
  defp decode(%Tesla.Env{body: body}, %{}) do
    ExchangeRatesRealtimeRESTAPI.Deserializer.json_decode(body)
  end

  defp decode(%Tesla.Env{body: body}, module) do
    ExchangeRatesRealtimeRESTAPI.Deserializer.json_decode(body, module)
  end
end
