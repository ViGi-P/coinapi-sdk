...
#
# This is a Bash client for Exchange Rates Realtime REST API.
#
# LICENSE:
...
${BOLD}${WHITE}Exchange Rates Realtime REST API command line client (API version v1)${OFF}
...
echo -e "              \\t\\t\\t\\t(e.g. 'https://api-realtime.exrates.coinapi.io')"
...
print_about() {
    echo ""
    echo -e "${BOLD}${WHITE}Exchange Rates Realtime REST API command line client (API version v1)${OFF}"
    echo ""
...
print_version() {
    echo ""
    echo -e "${BOLD}Exchange Rates Realtime REST API command line client (API version v1)${OFF}"
    echo ""
}
