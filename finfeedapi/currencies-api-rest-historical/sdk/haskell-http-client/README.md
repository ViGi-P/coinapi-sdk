## OpenAPI Auto-Generated [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) Bindings to `FinFeedAPI Currencies Historical REST API`

The library in `lib` provides auto-generated-from-OpenAPI [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) bindings to the FinFeedAPI Currencies Historical REST API API.
...
| baseModule                      | Set the base module namespace                                                                                                 |          | FinFeedAPICurrenciesHistoricalREST                      |
| cabalPackage                    | Set the cabal package name, which consists of one or more alphanumeric words separated by hyphens                             |          | finfeedapi-currencies-historical-rest                    |
...
| configType                      | Set the name of the type used for configuration                                                                               |          | FinFeedAPICurrenciesHistoricalRESTConfig                      |
...
| requestType                     | Set the name of the type used to generate requests                                                                            |          | FinFeedAPICurrenciesHistoricalRESTRequest                     |
...
| MODULE              | NOTES                                               |
| ------------------- | --------------------------------------------------- |
| FinFeedAPICurrenciesHistoricalREST.Client    | use the "dispatch" functions to send requests       |
| FinFeedAPICurrenciesHistoricalREST.Core      | core functions, config and request types            |
| FinFeedAPICurrenciesHistoricalREST.API       | construct api requests                              |
| FinFeedAPICurrenciesHistoricalREST.Model     | describes api models                                |
| FinFeedAPICurrenciesHistoricalREST.MimeTypes | encoding/decoding MIME types (content-types/accept) |
| FinFeedAPICurrenciesHistoricalREST.ModelLens | lenses for model fields                             |
| FinFeedAPICurrenciesHistoricalREST.Logging   | logging functions and utils                         |
