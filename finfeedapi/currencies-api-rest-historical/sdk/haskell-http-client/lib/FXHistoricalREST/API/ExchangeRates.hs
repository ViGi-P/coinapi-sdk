...
module FXHistoricalREST.API.ExchangeRates where

import FXHistoricalREST.Core
import FXHistoricalREST.MimeTypes
import FXHistoricalREST.Model as M
...
getSpecificRate
  ...
  -> FXHistoricalRESTRequest GetSpecificRate MimeNoContent V1ExchangeRate accept
...
v1ExchangerateAssetIdBaseAssetIdQuoteHistoryGet
  ...
  -> FXHistoricalRESTRequest V1ExchangerateAssetIdBaseAssetIdQuoteHistoryGet MimeNoContent [V1ExchangeRatesTimeseriesItem] accept
...
v1ExchangerateAssetIdBaseGet
  :: Accept accept -- ^ request accept ('MimeType')
  -> AssetIdBase -- ^ "assetIdBase" -  Requested exchange rates base asset identifier (from the Metadata -> Assets)
  -> FXHistoricalRESTRequest V1ExchangerateAssetIdBaseGet MimeNoContent V1ExchangeRates accept
...
v1ExchangerateHistoryPeriodsGet
  :: Accept accept -- ^ request accept ('MimeType')
  -> FXHistoricalRESTRequest V1ExchangerateHistoryPeriodsGet MimeNoContent [V1TimeseriesPeriod] accept
