...
module FinFeedAPICurrenciesHistoricalREST.Client where
...
dispatchLbs
  ...
  -> FinFeedAPICurrenciesHistoricalRESTConfig -- ^ config
  -> FinFeedAPICurrenciesHistoricalRESTRequest req contentType res accept -- ^ request
...
runConfigLog
  :: P.MonadIO m
  => FinFeedAPICurrenciesHistoricalRESTConfig -> LogExec m a
runConfigLog config = configLogExecWithContext config (configLogContext config)

-- | Run a block using the configured logger instance (logs exceptions)
runConfigLogWithExceptions
  :: (E.MonadCatch m, P.MonadIO m)
  => T.Text -> FinFeedAPICurrenciesHistoricalRESTConfig -> LogExec m a
