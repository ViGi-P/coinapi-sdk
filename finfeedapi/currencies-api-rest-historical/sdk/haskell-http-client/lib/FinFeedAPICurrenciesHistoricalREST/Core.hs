...
module FinFeedAPICurrenciesHistoricalREST.Core where
...
-- * FinFeedAPICurrenciesHistoricalRESTConfig

-- |
data FinFeedAPICurrenciesHistoricalRESTConfig = FinFeedAPICurrenciesHistoricalRESTConfig
...
-- | display the config
instance P.Show FinFeedAPICurrenciesHistoricalRESTConfig where
  show c =
    T.printf
...
-- | constructs a default FinFeedAPICurrenciesHistoricalRESTConfig
--
-- configHost:
--
...
-- configUserAgent:
--
-- @"finfeedapi-currencies-historical-rest/0.1.0.0"@
--
newConfig :: IO FinFeedAPICurrenciesHistoricalRESTConfig
newConfig = do
    logCxt <- initLogContext
    return $ FinFeedAPICurrenciesHistoricalRESTConfig
        { configHost = "https://api-historical.fx.finfeedapi.com"
        , configUserAgent = "finfeedapi-currencies-historical-rest/0.1.0.0"
...
addAuthMethod :: AuthMethod auth => FinFeedAPICurrenciesHistoricalRESTConfig -> auth -> FinFeedAPICurrenciesHistoricalRESTConfig
addAuthMethod config@FinFeedAPICurrenciesHistoricalRESTConfig {configAuthMethods = as} a =
  config { configAuthMethods = AnyAuthMethod a : as}

-- | updates the config to use stdout logging
withStdoutLogging :: FinFeedAPICurrenciesHistoricalRESTConfig -> IO FinFeedAPICurrenciesHistoricalRESTConfig
...
withStderrLogging :: FinFeedAPICurrenciesHistoricalRESTConfig -> IO FinFeedAPICurrenciesHistoricalRESTConfig
...
withNoLogging :: FinFeedAPICurrenciesHistoricalRESTConfig -> FinFeedAPICurrenciesHistoricalRESTConfig
withNoLogging p = p { configLogExecWithContext =  runNullLogExec}

-- * FinFeedAPICurrenciesHistoricalRESTRequest
...
data FinFeedAPICurrenciesHistoricalRESTRequest req contentType res accept = FinFeedAPICurrenciesHistoricalRESTRequest
  { rMethod  :: NH.Method   -- ^ Method of FinFeedAPICurrenciesHistoricalRESTRequest
  , rUrlPath :: [BCL.ByteString] -- ^ Endpoint of FinFeedAPICurrenciesHistoricalRESTRequest
  , rParams   :: Params -- ^ params of FinFeedAPICurrenciesHistoricalRESTRequest
  , rAuthTypes :: [P.TypeRep] -- ^ types of auth methods
  }
  deriving (P.Show)

-- | 'rMethod' Lens
rMethodL :: Lens_' (FinFeedAPICurrenciesHistoricalRESTRequest req contentType res accept) NH.Method
rMethodL f FinFeedAPICurrenciesHistoricalRESTRequest{..} = (\rMethod -> FinFeedAPICurrenciesHistoricalRESTRequest { rMethod, ..} ) <$> f rMethod
{-# INLINE rMethodL #-}

-- | 'rUrlPath' Lens
rUrlPathL :: Lens_' (FinFeedAPICurrenciesHistoricalRESTRequest req contentType res accept) [BCL.ByteString]
rUrlPathL f FinFeedAPICurrenciesHistoricalRESTRequest{..} = (\rUrlPath -> FinFeedAPICurrenciesHistoricalRESTRequest { rUrlPath, ..} ) <$> f rUrlPath
{-# INLINE rUrlPathL #-}

-- | 'rParams' Lens
rParamsL :: Lens_' (FinFeedAPICurrenciesHistoricalRESTRequest req contentType res accept) Params
rParamsL f FinFeedAPICurrenciesHistoricalRESTRequest{..} = (\rParams -> FinFeedAPICurrenciesHistoricalRESTRequest { rParams, ..} ) <$> f rParams
{-# INLINE rParamsL #-}

-- | 'rParams' Lens
rAuthTypesL :: Lens_' (FinFeedAPICurrenciesHistoricalRESTRequest req contentType res accept) [P.TypeRep]
rAuthTypesL f FinFeedAPICurrenciesHistoricalRESTRequest{..} = (\rAuthTypes -> FinFeedAPICurrenciesHistoricalRESTRequest { rAuthTypes, ..} ) <$> f rAuthTypes
{-# INLINE rAuthTypesL #-}
...
class HasBodyParam req param where
  setBodyParam :: forall contentType res accept. (Consumes req contentType, MimeRender contentType param) => FinFeedAPICurrenciesHistoricalRESTRequest req contentType res accept -> param -> FinFeedAPICurrenciesHistoricalRESTRequest req contentType res accept
  setBodyParam req xs =
...
class HasOptionalParam req param where
  ...
  applyOptionalParam :: FinFeedAPICurrenciesHistoricalRESTRequest req contentType res accept -> param -> FinFeedAPICurrenciesHistoricalRESTRequest req contentType res accept
  applyOptionalParam = (-&-)
  {-# INLINE applyOptionalParam #-}

  -- | infix operator \/ alias for 'addOptionalParam'
  (-&-) :: FinFeedAPICurrenciesHistoricalRESTRequest req contentType res accept -> param -> FinFeedAPICurrenciesHistoricalRESTRequest req contentType res accept
  (-&-) = applyOptionalParam
  {-# INLINE (-&-) #-}
...
-- ** FinFeedAPICurrenciesHistoricalRESTRequest Utils

_mkRequest :: NH.Method -- ^ Method
          -> [BCL.ByteString] -- ^ Endpoint
          -> FinFeedAPICurrenciesHistoricalRESTRequest req contentType res accept -- ^ req: Request Type, res: Response Type
_mkRequest m u = FinFeedAPICurrenciesHistoricalRESTRequest m u _mkParams []

_mkParams :: Params
_mkParams = Params [] [] ParamBodyNone

setHeader ::
     FinFeedAPICurrenciesHistoricalRESTRequest req contentType res accept
  -> [NH.Header]
  -> FinFeedAPICurrenciesHistoricalRESTRequest req contentType res accept
...
removeHeader :: FinFeedAPICurrenciesHistoricalRESTRequest req contentType res accept -> [NH.HeaderName] -> FinFeedAPICurrenciesHistoricalRESTRequest req contentType res accept
...
_setContentTypeHeader :: forall req contentType res accept. MimeType contentType => FinFeedAPICurrenciesHistoricalRESTRequest req contentType res accept -> FinFeedAPICurrenciesHistoricalRESTRequest req contentType res accept
_setContentTypeHeader req =
    case mimeType (P.Proxy :: P.Proxy contentType) of
        Just m -> req `setHeader` [("content-type", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["content-type"]

_setAcceptHeader :: forall req contentType res accept. MimeType accept => FinFeedAPICurrenciesHistoricalRESTRequest req contentType res accept -> FinFeedAPICurrenciesHistoricalRESTRequest req contentType res accept
...
addForm :: FinFeedAPICurrenciesHistoricalRESTRequest req contentType res accept -> WH.Form -> FinFeedAPICurrenciesHistoricalRESTRequest req contentType res accept
addForm req newform =
...
_addMultiFormPart :: FinFeedAPICurrenciesHistoricalRESTRequest req contentType res accept -> NH.Part -> FinFeedAPICurrenciesHistoricalRESTRequest req contentType res accept
...
_setBodyBS :: FinFeedAPICurrenciesHistoricalRESTRequest req contentType res accept -> B.ByteString -> FinFeedAPICurrenciesHistoricalRESTRequest req contentType res accept
_setBodyBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyB body)

_setBodyLBS :: FinFeedAPICurrenciesHistoricalRESTRequest req contentType res accept -> BL.ByteString -> FinFeedAPICurrenciesHistoricalRESTRequest req contentType res accept
_setBodyLBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyBL body)

_hasAuthType :: AuthMethod authMethod => FinFeedAPICurrenciesHistoricalRESTRequest req contentType res accept -> P.Proxy authMethod -> FinFeedAPICurrenciesHistoricalRESTRequest req contentType res accept
...
class P.Typeable a =>
  ...
  applyAuthMethod
    ...
    -> a
    -> FinFeedAPICurrenciesHistoricalRESTRequest req contentType res accept
    -> IO (FinFeedAPICurrenciesHistoricalRESTRequest req contentType res accept)
...
_applyAuthMethods
  ...
  -> FinFeedAPICurrenciesHistoricalRESTConfig
  -> IO (FinFeedAPICurrenciesHistoricalRESTRequest req contentType res accept)
_applyAuthMethods req config@(FinFeedAPICurrenciesHistoricalRESTConfig {configAuthMethods = as}) =
  foldlM go req as
  where
