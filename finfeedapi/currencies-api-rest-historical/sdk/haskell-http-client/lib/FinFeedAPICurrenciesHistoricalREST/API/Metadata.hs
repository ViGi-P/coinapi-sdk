...
module FinFeedAPICurrenciesHistoricalREST.API.Metadata where
...
v1AssetsAssetIdGet
  ...
  -> FinFeedAPICurrenciesHistoricalRESTRequest V1AssetsAssetIdGet MimeNoContent [V1Asset] accept
...
v1AssetsGet
  :: Accept accept -- ^ request accept ('MimeType')
  -> FinFeedAPICurrenciesHistoricalRESTRequest V1AssetsGet MimeNoContent [V1Asset] accept
v1AssetsGet  _ =
...
v1AssetsIconsSizeGet
  ...
  -> FinFeedAPICurrenciesHistoricalRESTRequest V1AssetsIconsSizeGet MimeNoContent [V1Icon] accept
