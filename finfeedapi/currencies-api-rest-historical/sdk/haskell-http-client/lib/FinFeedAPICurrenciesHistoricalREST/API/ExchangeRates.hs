...
module FinFeedAPICurrenciesHistoricalREST.API.ExchangeRates where

import FinFeedAPICurrenciesHistoricalREST.Core
import FinFeedAPICurrenciesHistoricalREST.MimeTypes
import FinFeedAPICurrenciesHistoricalREST.Model as M
...
getSpecificRate
  ...
  -> FinFeedAPICurrenciesHistoricalRESTRequest GetSpecificRate MimeNoContent V1ExchangeRate accept
...
v1ExchangerateAssetIdBaseAssetIdQuoteHistoryGet
  ...
  -> FinFeedAPICurrenciesHistoricalRESTRequest V1ExchangerateAssetIdBaseAssetIdQuoteHistoryGet MimeNoContent [V1ExchangeRatesTimeseriesItem] accept
...
v1ExchangerateAssetIdBaseGet
  :: Accept accept -- ^ request accept ('MimeType')
  -> AssetIdBase -- ^ "assetIdBase" -  Requested exchange rates base asset identifier (from the Metadata -> Assets)
  -> FinFeedAPICurrenciesHistoricalRESTRequest V1ExchangerateAssetIdBaseGet MimeNoContent V1ExchangeRates accept
...
v1ExchangerateHistoryPeriodsGet
  :: Accept accept -- ^ request accept ('MimeType')
  -> FinFeedAPICurrenciesHistoricalRESTRequest V1ExchangerateHistoryPeriodsGet MimeNoContent [V1TimeseriesPeriod] accept
