...
/**
 * V1ExchangeRatesChainNetworkAddress Class Doc Comment
 *
 * @category Class
 ...
 */
class V1ExchangeRatesChainNetworkAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'v1.ExchangeRatesChainNetworkAddress';
     ...
     * Sets chain_id
     *
     * @param string|null $chain_id Gets or sets chain id
     *
     * @return self
     */
     ...
     * Sets network_id
     *
     * @param string|null $network_id Gets or sets network id
     *
     * @return self
     */
     ...
     * Sets address
     *
     * @param string|null $address Gets or sets chain address
     *
     * @return self
     */
