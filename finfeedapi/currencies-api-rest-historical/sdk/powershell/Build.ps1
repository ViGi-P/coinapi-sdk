...
$Manifest = @{
    ...
    Description = 'PSOpenAPITools - the PowerShell module for FinFeedAPI Currencies Historical REST API'

    ModuleVersion = '0.1.2'

    RootModule = 'PSOpenAPITools.psm1'
    Guid = '{644360A7-41C0-464F-A5A1-35FD7576D03B}' # Has to be static, otherwise each new build will be considered different module
