...
* <pre>
* var FinFeedApiCurrenciesHistoricalRestApi = require('index'); // See note below*.
* var xxxSvc = new FinFeedApiCurrenciesHistoricalRestApi.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new FinFeedApiCurrenciesHistoricalRestApi.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new FinFeedApiCurrenciesHistoricalRestApi.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new FinFeedApiCurrenciesHistoricalRestApi.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
