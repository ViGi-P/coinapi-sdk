...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FinFeedApiCurrenciesHistoricalRestApi.V1TimeseriesPeriod();
  });
  ...
  describe('V1TimeseriesPeriod', function() {
    it('should create an instance of V1TimeseriesPeriod', function() {
      ...
      //var instance = new FinFeedApiCurrenciesHistoricalRestApi.V1TimeseriesPeriod();
      //expect(instance).to.be.a(FinFeedApiCurrenciesHistoricalRestApi.V1TimeseriesPeriod);
    });
