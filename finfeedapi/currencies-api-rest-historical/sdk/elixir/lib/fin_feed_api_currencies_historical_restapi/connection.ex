...
defmodule FinFeedAPICurrenciesHistoricalRESTAPI.Connection do
  @moduledoc """
  Handle Tesla connections for FinFeedAPICurrenciesHistoricalRESTAPI.

  Additional middleware can be set in the compile-time or runtime configuration:

      config :tesla, FinFeedAPICurrenciesHistoricalRESTAPI.Connection,
        base_url: "https://api-historical.fx.finfeedapi.com",
        adapter: Tesla.Adapter.Hackney

  The default base URL can also be set as:

      config :fin_feed_api_currencies_historical_restapi,
        :base_url, "https://api-historical.fx.finfeedapi.com"
  """

  @default_base_url Application.compile_env(
                      :fin_feed_api_currencies_historical_restapi,
                      :base_url,
  ...
  @doc """
  Configure a FinFeedAPICurrenciesHistoricalRESTAPI client.

  ### Parameters

  - `options`: an optional keyword list of FinFeedAPICurrenciesHistoricalRESTAPI.Connection.options.
  ...
  def middleware(options \\ []) do
    base_url =
      Keyword.get(
        options,
        :base_url,
        Application.get_env(:fin_feed_api_currencies_historical_restapi, :base_url, @default_base_url)
      )
    ...
    user_agent =
      Keyword.get(
        ...
        Keyword.get(
          tesla_options,
          :user_agent,
          "openapi-generator - FinFeedAPICurrenciesHistoricalRESTAPI 1.0.0 - elixir"
        )
      )
