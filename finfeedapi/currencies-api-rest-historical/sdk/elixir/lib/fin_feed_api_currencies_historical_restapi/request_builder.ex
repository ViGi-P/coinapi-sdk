...
defmodule FinFeedAPICurrenciesHistoricalRESTAPI.RequestBuilder do
  @moduledoc """
  ...
  defp decode(%Tesla.Env{body: body}, %{}) do
    FinFeedAPICurrenciesHistoricalRESTAPI.Deserializer.json_decode(body)
  end

  defp decode(%Tesla.Env{body: body}, module) do
    FinFeedAPICurrenciesHistoricalRESTAPI.Deserializer.json_decode(body, module)
  end
end
