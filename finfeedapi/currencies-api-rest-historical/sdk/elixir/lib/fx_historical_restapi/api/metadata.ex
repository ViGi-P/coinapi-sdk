...
defmodule FXHistoricalRESTAPI.Api.Metadata do
  @moduledoc """
  ...
  """
  @spec v1_assets_asset_id_get(Tesla.Env.client, String.t, keyword()) :: {:ok, [FXHistoricalRESTAPI.Model.V1Asset.t]} | {:error, Tesla.Env.t}
  def v1_assets_asset_id_get(connection, asset_id, _opts \\ []) do
    ...
    |> evaluate_response([
      {200, FXHistoricalRESTAPI.Model.V1Asset}
    ])
  end
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec v1_assets_get(Tesla.Env.client, keyword()) :: {:ok, [FXHistoricalRESTAPI.Model.V1Asset.t]} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec v1_assets_icons_size_get(Tesla.Env.client, integer(), keyword()) :: {:ok, [FXHistoricalRESTAPI.Model.V1Icon.t]} | {:error, Tesla.Env.t}
  def v1_assets_icons_size_get(connection, size, _opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, FXHistoricalRESTAPI.Model.V1Icon}
    ])
  end
end
