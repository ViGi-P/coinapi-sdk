...
defmodule FXHistoricalRESTAPI.RequestBuilder do
  @moduledoc """
  ...
  defp decode(%Tesla.Env{body: body}, %{}) do
    FXHistoricalRESTAPI.Deserializer.json_decode(body)
  end

  defp decode(%Tesla.Env{body: body}, module) do
    FXHistoricalRESTAPI.Deserializer.json_decode(body, module)
  end
end
