...
defmodule FXHistoricalRESTAPI.Connection do
  ...
  @doc """
  Configure a FXHistoricalRESTAPI client.

  ### Parameters

  - `options`: an optional keyword list of FXHistoricalRESTAPI.Connection.options.
  ...
  def middleware(options \\ []) do
    base_url =
      Keyword.get(
        options,
        :base_url,
        Application.get_env(:fx_historical_restapi, :base_url, @default_base_url)
      )
    ...
    user_agent =
      Keyword.get(
        ...
        Keyword.get(
          tesla_options,
          :user_agent,
          "openapi-generator - FXHistoricalRESTAPI 1.0.0 - elixir"
        )
      )
