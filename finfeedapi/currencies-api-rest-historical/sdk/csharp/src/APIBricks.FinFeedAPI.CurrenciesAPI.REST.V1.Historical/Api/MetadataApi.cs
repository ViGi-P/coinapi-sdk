...
namespace APIBricks.FinFeedAPI.CurrenciesAPI.REST.V1.Historical.Api
{
    ...
    /// </summary>
    public interface IV1AssetsAssetIdGetApiResponse : APIBricks.FinFeedAPI.CurrenciesAPI.REST.V1.Historical.Client.IApiResponse, IOk<List<V1Asset>?>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IV1AssetsGetApiResponse : APIBricks.FinFeedAPI.CurrenciesAPI.REST.V1.Historical.Client.IApiResponse, IOk<List<V1Asset>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IV1AssetsIconsSizeGetApiResponse : APIBricks.FinFeedAPI.CurrenciesAPI.REST.V1.Historical.Client.IApiResponse, IOk<List<V1Icon>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    public sealed partial class MetadataApi : IMetadataApi
    {
        ...
        /// </summary>
        public partial class V1AssetsAssetIdGetApiResponse : APIBricks.FinFeedAPI.CurrenciesAPI.REST.V1.Historical.Client.ApiResponse, IV1AssetsAssetIdGetApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class V1AssetsGetApiResponse : APIBricks.FinFeedAPI.CurrenciesAPI.REST.V1.Historical.Client.ApiResponse, IV1AssetsGetApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class V1AssetsIconsSizeGetApiResponse : APIBricks.FinFeedAPI.CurrenciesAPI.REST.V1.Historical.Client.ApiResponse, IV1AssetsIconsSizeGetApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
