...
- How do I validate requests and process responses?
  Use the provided On and After methods in the Api class from the namespace APIBricks.FinFeedAPI.CurrenciesAPI.REST.V1.Historical.Rest.DefaultApi.
...
## Api Information
- appName: FX Historical REST API
- appVersion: v1
...
- packageCopyright: No Copyright
- packageDescription: A library generated from a OpenAPI doc
- packageGuid: {147D4A61-750F-469A-987F-FD01C1B049EF}
- packageName: APIBricks.FinFeedAPI.CurrenciesAPI.REST.V1.Historical
- packageTags: 
- packageTitle: OpenAPI Library
- packageVersion: 1.0.0
