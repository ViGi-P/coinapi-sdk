...
module OpenapiClient
  class ExchangeRatesApi
    ...
    # @param asset_id_quote [String] Requested exchange rates base asset identifier (from the Metadata -&gt; Assets)
    # @param [Hash] opts the optional parameters
    ...
    def v1_exchangerate_asset_id_base_asset_id_quote_history_get_with_http_info(asset_id_base, asset_id_quote, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ExchangeRatesApi.v1_exchangerate_asset_id_base_asset_id_quote_history_get ...'
      end
      # verify the required parameter 'asset_id_base' is set
      if @api_client.config.client_side_validation && asset_id_base.nil?
        fail ArgumentError, "Missing the required parameter 'asset_id_base' when calling ExchangeRatesApi.v1_exchangerate_asset_id_base_asset_id_quote_history_get"
      end
      # verify the required parameter 'asset_id_quote' is set
      if @api_client.config.client_side_validation && asset_id_quote.nil?
        fail ArgumentError, "Missing the required parameter 'asset_id_quote' when calling ExchangeRatesApi.v1_exchangerate_asset_id_base_asset_id_quote_history_get"
      end
      # resource path
      local_var_path = '/v1/exchangerate/{asset_id_base}/{asset_id_quote}/history'.sub('{' + 'asset_id_base' + '}', CGI.escape(asset_id_base.to_s)).sub('{' + 'asset_id_quote' + '}', CGI.escape(asset_id_quote.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'Array<V1ExchangeRatesTimeseriesItem>'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['APIKey']

      new_options = opts.merge(
        :operation => :"ExchangeRatesApi.v1_exchangerate_asset_id_base_asset_id_quote_history_get",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ExchangeRatesApi#v1_exchangerate_asset_id_base_asset_id_quote_history_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def v1_exchangerate_history_periods_get(opts = {})
      data, _status_code, _headers = v1_exchangerate_history_periods_get_with_http_info(opts)
      data
    end
    ...
    def v1_exchangerate_history_periods_get_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ExchangeRatesApi.v1_exchangerate_history_periods_get ...'
      end
      # resource path
      local_var_path = '/v1/exchangerate/history/periods'
      ...
      new_options = opts.merge(
        :operation => :"ExchangeRatesApi.v1_exchangerate_history_periods_get",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ExchangeRatesApi#v1_exchangerate_history_periods_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
