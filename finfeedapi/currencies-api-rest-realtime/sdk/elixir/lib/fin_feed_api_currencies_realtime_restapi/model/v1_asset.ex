...
defmodule FinFeedAPICurrenciesRealtimeRESTAPI.Model.V1Asset do
  ...
  @type t :: %__MODULE__{
    ...
    :chain_addresses => [FinFeedAPICurrenciesRealtimeRESTAPI.Model.V1ChainNetworkAddress.t] | nil,
  ...
  def decode(value) do
    value
     |> Deserializer.deserialize(:chain_addresses, :list, FinFeedAPICurrenciesRealtimeRESTAPI.Model.V1ChainNetworkAddress)
  end
end
