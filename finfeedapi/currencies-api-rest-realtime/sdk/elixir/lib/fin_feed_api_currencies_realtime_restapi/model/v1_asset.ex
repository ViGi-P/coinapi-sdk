...
defmodule FinFeedAPICurrenciesRealtimeRESTAPI.Model.V1Asset do
  @moduledoc """
  Represents an asset.
  """
  ...
  @type t :: %__MODULE__{
    ...
    :chain_addresses => [FinFeedAPICurrenciesRealtimeRESTAPI.Model.V1ExchangeRatesChainNetworkAddress.t] | nil,
  ...
  def decode(value) do
    value
     |> Deserializer.deserialize(:chain_addresses, :list, FinFeedAPICurrenciesRealtimeRESTAPI.Model.V1ExchangeRatesChainNetworkAddress)
  end
end
