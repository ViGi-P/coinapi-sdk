...
defmodule FinFeedAPICurrenciesRealtimeRESTAPI.RequestBuilder do
  @moduledoc """
  ...
  defp decode(%Tesla.Env{body: body}, %{}) do
    FinFeedAPICurrenciesRealtimeRESTAPI.Deserializer.json_decode(body)
  end

  defp decode(%Tesla.Env{body: body}, module) do
    FinFeedAPICurrenciesRealtimeRESTAPI.Deserializer.json_decode(body, module)
  end
end
