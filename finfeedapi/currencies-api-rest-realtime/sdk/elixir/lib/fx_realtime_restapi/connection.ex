...
defmodule FXRealtimeRESTAPI.Connection do
  ...
  @doc """
  Configure a FXRealtimeRESTAPI client.

  ### Parameters

  - `options`: an optional keyword list of FXRealtimeRESTAPI.Connection.options.
  ...
  def middleware(options \\ []) do
    base_url =
      Keyword.get(
        options,
        :base_url,
        Application.get_env(:fx_realtime_restapi, :base_url, @default_base_url)
      )
    ...
    user_agent =
      Keyword.get(
        ...
        Keyword.get(
          tesla_options,
          :user_agent,
          "openapi-generator - FXRealtimeRESTAPI 1.0.0 - elixir"
        )
      )
