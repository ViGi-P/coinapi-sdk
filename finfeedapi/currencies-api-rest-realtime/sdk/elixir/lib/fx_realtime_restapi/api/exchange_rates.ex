...
defmodule FXRealtimeRESTAPI.Api.ExchangeRates do
  @moduledoc """
  ...
  - `{:ok, FXRealtimeRESTAPI.Model.V1ExchangeRate.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_specific_rate(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, FXRealtimeRESTAPI.Model.V1ExchangeRate.t} | {:error, Tesla.Env.t}
  def get_specific_rate(connection, asset_id_base, asset_id_quote, _opts \\ []) do
    ...
    |> evaluate_response([
      {200, FXRealtimeRESTAPI.Model.V1ExchangeRate}
    ])
  end
  ...
  - `{:ok, FXRealtimeRESTAPI.Model.V1ExchangeRates.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec v1_exchangerate_asset_id_base_get(Tesla.Env.client, String.t, keyword()) :: {:ok, FXRealtimeRESTAPI.Model.V1ExchangeRates.t} | {:error, Tesla.Env.t}
  def v1_exchangerate_asset_id_base_get(connection, asset_id_base, opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, FXRealtimeRESTAPI.Model.V1ExchangeRates}
    ])
  end
end
