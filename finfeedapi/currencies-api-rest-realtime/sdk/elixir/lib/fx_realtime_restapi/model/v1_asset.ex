...
defmodule FXRealtimeRESTAPI.Model.V1Asset do
  @moduledoc """
  Represents an asset.
  """
  ...
  @type t :: %__MODULE__{
    ...
    :chain_addresses => [FXRealtimeRESTAPI.Model.V1ChainNetworkAddress.t] | nil,
    :data_start => String.t | nil,
    :data_end => String.t | nil
  }

  alias FXRealtimeRESTAPI.Deserializer

  def decode(value) do
    value
     |> Deserializer.deserialize(:chain_addresses, :list, FXRealtimeRESTAPI.Model.V1ChainNetworkAddress)
  end
end
