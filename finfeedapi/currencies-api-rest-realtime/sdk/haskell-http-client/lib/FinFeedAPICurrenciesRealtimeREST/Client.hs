...
module FinFeedAPICurrenciesRealtimeREST.Client where
...
dispatchLbs
  ...
  -> FinFeedAPICurrenciesRealtimeRESTConfig -- ^ config
  -> FinFeedAPICurrenciesRealtimeRESTRequest req contentType res accept -- ^ request
...
runConfigLog
  :: P.MonadIO m
  => FinFeedAPICurrenciesRealtimeRESTConfig -> LogExec m a
runConfigLog config = configLogExecWithContext config (configLogContext config)

-- | Run a block using the configured logger instance (logs exceptions)
runConfigLogWithExceptions
  :: (E.MonadCatch m, P.MonadIO m)
  => T.Text -> FinFeedAPICurrenciesRealtimeRESTConfig -> LogExec m a
