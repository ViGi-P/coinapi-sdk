...
module FinFeedAPICurrenciesRealtimeREST.Core where
...
-- * FinFeedAPICurrenciesRealtimeRESTConfig

-- |
data FinFeedAPICurrenciesRealtimeRESTConfig = FinFeedAPICurrenciesRealtimeRESTConfig
...
-- | display the config
instance P.Show FinFeedAPICurrenciesRealtimeRESTConfig where
  show c =
    T.printf
...
-- | constructs a default FinFeedAPICurrenciesRealtimeRESTConfig
--
-- configHost:
--
...
-- configUserAgent:
--
-- @"finfeedapi-currencies-realtime-rest/0.1.0.0"@
--
newConfig :: IO FinFeedAPICurrenciesRealtimeRESTConfig
newConfig = do
    logCxt <- initLogContext
    return $ FinFeedAPICurrenciesRealtimeRESTConfig
        { configHost = "https://api-realtime.fx.finfeedapi.com"
        , configUserAgent = "finfeedapi-currencies-realtime-rest/0.1.0.0"
...
addAuthMethod :: AuthMethod auth => FinFeedAPICurrenciesRealtimeRESTConfig -> auth -> FinFeedAPICurrenciesRealtimeRESTConfig
addAuthMethod config@FinFeedAPICurrenciesRealtimeRESTConfig {configAuthMethods = as} a =
  config { configAuthMethods = AnyAuthMethod a : as}

-- | updates the config to use stdout logging
withStdoutLogging :: FinFeedAPICurrenciesRealtimeRESTConfig -> IO FinFeedAPICurrenciesRealtimeRESTConfig
...
withStderrLogging :: FinFeedAPICurrenciesRealtimeRESTConfig -> IO FinFeedAPICurrenciesRealtimeRESTConfig
...
withNoLogging :: FinFeedAPICurrenciesRealtimeRESTConfig -> FinFeedAPICurrenciesRealtimeRESTConfig
withNoLogging p = p { configLogExecWithContext =  runNullLogExec}

-- * FinFeedAPICurrenciesRealtimeRESTRequest
...
data FinFeedAPICurrenciesRealtimeRESTRequest req contentType res accept = FinFeedAPICurrenciesRealtimeRESTRequest
  { rMethod  :: NH.Method   -- ^ Method of FinFeedAPICurrenciesRealtimeRESTRequest
  , rUrlPath :: [BCL.ByteString] -- ^ Endpoint of FinFeedAPICurrenciesRealtimeRESTRequest
  , rParams   :: Params -- ^ params of FinFeedAPICurrenciesRealtimeRESTRequest
  , rAuthTypes :: [P.TypeRep] -- ^ types of auth methods
  }
  deriving (P.Show)

-- | 'rMethod' Lens
rMethodL :: Lens_' (FinFeedAPICurrenciesRealtimeRESTRequest req contentType res accept) NH.Method
rMethodL f FinFeedAPICurrenciesRealtimeRESTRequest{..} = (\rMethod -> FinFeedAPICurrenciesRealtimeRESTRequest { rMethod, ..} ) <$> f rMethod
{-# INLINE rMethodL #-}

-- | 'rUrlPath' Lens
rUrlPathL :: Lens_' (FinFeedAPICurrenciesRealtimeRESTRequest req contentType res accept) [BCL.ByteString]
rUrlPathL f FinFeedAPICurrenciesRealtimeRESTRequest{..} = (\rUrlPath -> FinFeedAPICurrenciesRealtimeRESTRequest { rUrlPath, ..} ) <$> f rUrlPath
{-# INLINE rUrlPathL #-}

-- | 'rParams' Lens
rParamsL :: Lens_' (FinFeedAPICurrenciesRealtimeRESTRequest req contentType res accept) Params
rParamsL f FinFeedAPICurrenciesRealtimeRESTRequest{..} = (\rParams -> FinFeedAPICurrenciesRealtimeRESTRequest { rParams, ..} ) <$> f rParams
{-# INLINE rParamsL #-}

-- | 'rParams' Lens
rAuthTypesL :: Lens_' (FinFeedAPICurrenciesRealtimeRESTRequest req contentType res accept) [P.TypeRep]
rAuthTypesL f FinFeedAPICurrenciesRealtimeRESTRequest{..} = (\rAuthTypes -> FinFeedAPICurrenciesRealtimeRESTRequest { rAuthTypes, ..} ) <$> f rAuthTypes
{-# INLINE rAuthTypesL #-}
...
class HasBodyParam req param where
  setBodyParam :: forall contentType res accept. (Consumes req contentType, MimeRender contentType param) => FinFeedAPICurrenciesRealtimeRESTRequest req contentType res accept -> param -> FinFeedAPICurrenciesRealtimeRESTRequest req contentType res accept
  setBodyParam req xs =
...
class HasOptionalParam req param where
  ...
  applyOptionalParam :: FinFeedAPICurrenciesRealtimeRESTRequest req contentType res accept -> param -> FinFeedAPICurrenciesRealtimeRESTRequest req contentType res accept
  applyOptionalParam = (-&-)
  {-# INLINE applyOptionalParam #-}

  -- | infix operator \/ alias for 'addOptionalParam'
  (-&-) :: FinFeedAPICurrenciesRealtimeRESTRequest req contentType res accept -> param -> FinFeedAPICurrenciesRealtimeRESTRequest req contentType res accept
  (-&-) = applyOptionalParam
  {-# INLINE (-&-) #-}
...
-- ** FinFeedAPICurrenciesRealtimeRESTRequest Utils

_mkRequest :: NH.Method -- ^ Method
          -> [BCL.ByteString] -- ^ Endpoint
          -> FinFeedAPICurrenciesRealtimeRESTRequest req contentType res accept -- ^ req: Request Type, res: Response Type
_mkRequest m u = FinFeedAPICurrenciesRealtimeRESTRequest m u _mkParams []

_mkParams :: Params
_mkParams = Params [] [] ParamBodyNone

setHeader ::
     FinFeedAPICurrenciesRealtimeRESTRequest req contentType res accept
  -> [NH.Header]
  -> FinFeedAPICurrenciesRealtimeRESTRequest req contentType res accept
...
removeHeader :: FinFeedAPICurrenciesRealtimeRESTRequest req contentType res accept -> [NH.HeaderName] -> FinFeedAPICurrenciesRealtimeRESTRequest req contentType res accept
...
_setContentTypeHeader :: forall req contentType res accept. MimeType contentType => FinFeedAPICurrenciesRealtimeRESTRequest req contentType res accept -> FinFeedAPICurrenciesRealtimeRESTRequest req contentType res accept
_setContentTypeHeader req =
    case mimeType (P.Proxy :: P.Proxy contentType) of
        Just m -> req `setHeader` [("content-type", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["content-type"]

_setAcceptHeader :: forall req contentType res accept. MimeType accept => FinFeedAPICurrenciesRealtimeRESTRequest req contentType res accept -> FinFeedAPICurrenciesRealtimeRESTRequest req contentType res accept
...
addForm :: FinFeedAPICurrenciesRealtimeRESTRequest req contentType res accept -> WH.Form -> FinFeedAPICurrenciesRealtimeRESTRequest req contentType res accept
addForm req newform =
...
_addMultiFormPart :: FinFeedAPICurrenciesRealtimeRESTRequest req contentType res accept -> NH.Part -> FinFeedAPICurrenciesRealtimeRESTRequest req contentType res accept
...
_setBodyBS :: FinFeedAPICurrenciesRealtimeRESTRequest req contentType res accept -> B.ByteString -> FinFeedAPICurrenciesRealtimeRESTRequest req contentType res accept
_setBodyBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyB body)

_setBodyLBS :: FinFeedAPICurrenciesRealtimeRESTRequest req contentType res accept -> BL.ByteString -> FinFeedAPICurrenciesRealtimeRESTRequest req contentType res accept
_setBodyLBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyBL body)

_hasAuthType :: AuthMethod authMethod => FinFeedAPICurrenciesRealtimeRESTRequest req contentType res accept -> P.Proxy authMethod -> FinFeedAPICurrenciesRealtimeRESTRequest req contentType res accept
...
class P.Typeable a =>
  ...
  applyAuthMethod
    ...
    -> a
    -> FinFeedAPICurrenciesRealtimeRESTRequest req contentType res accept
    -> IO (FinFeedAPICurrenciesRealtimeRESTRequest req contentType res accept)
...
_applyAuthMethods
  ...
  -> FinFeedAPICurrenciesRealtimeRESTConfig
  -> IO (FinFeedAPICurrenciesRealtimeRESTRequest req contentType res accept)
_applyAuthMethods req config@(FinFeedAPICurrenciesRealtimeRESTConfig {configAuthMethods = as}) =
  foldlM go req as
  where
