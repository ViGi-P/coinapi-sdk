...
module FinFeedAPICurrenciesRealtimeREST.API.ExchangeRates where
...
getSpecificRate
  ...
  -> FinFeedAPICurrenciesRealtimeRESTRequest GetSpecificRate MimeNoContent V1ExchangeRate accept
...
v1ExchangerateAssetIdBaseGet
  ...
  -> FinFeedAPICurrenciesRealtimeRESTRequest V1ExchangerateAssetIdBaseGet MimeNoContent V1ExchangeRates accept
