...
module FinFeedAPICurrenciesRealtimeREST.API.Metadata where
...
v1AssetsAssetIdGet
  ...
  -> FinFeedAPICurrenciesRealtimeRESTRequest V1AssetsAssetIdGet MimeNoContent [V1Asset] accept
...
v1AssetsGet
  :: Accept accept -- ^ request accept ('MimeType')
  -> FinFeedAPICurrenciesRealtimeRESTRequest V1AssetsGet MimeNoContent [V1Asset] accept
v1AssetsGet  _ =
...
v1AssetsIconsSizeGet
  ...
  -> FinFeedAPICurrenciesRealtimeRESTRequest V1AssetsIconsSizeGet MimeNoContent [V1Icon] accept
