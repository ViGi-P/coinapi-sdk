/*
 * V1.ExchangeRatesChainNetworkAddress.h
 *
 * Contains information about assets&#39; chain network addresses
 */

#ifndef _V1.ExchangeRatesChainNetworkAddress_H_
#define _V1.ExchangeRatesChainNetworkAddress_H_
...
class V1.ExchangeRatesChainNetworkAddress : public Object {
public:
	/*! \brief Constructor.
	 */
	V1.ExchangeRatesChainNetworkAddress();
	V1.ExchangeRatesChainNetworkAddress(char* str);

	/*! \brief Destructor.
	 */
	virtual ~V1.ExchangeRatesChainNetworkAddress();
...
#endif /* _V1.ExchangeRatesChainNetworkAddress_H_ */
