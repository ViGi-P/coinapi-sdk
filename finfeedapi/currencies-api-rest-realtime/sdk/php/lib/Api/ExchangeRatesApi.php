...
class ExchangeRatesApi
{
     ...
     */
    public function getSpecificRate($asset_id_base, $asset_id_quote, string $contentType = self::contentTypes['getSpecificRate'][0])
    {
        list($response) = $this->getSpecificRateWithHttpInfo($asset_id_base, $asset_id_quote, $contentType);
        return $response;
    }
     ...
     */
    public function getSpecificRateWithHttpInfo($asset_id_base, $asset_id_quote, string $contentType = self::contentTypes['getSpecificRate'][0])
    {
        $request = $this->getSpecificRateRequest($asset_id_base, $asset_id_quote, $contentType);
     ...
     */
    public function getSpecificRateAsync($asset_id_base, $asset_id_quote, string $contentType = self::contentTypes['getSpecificRate'][0])
    {
        return $this->getSpecificRateAsyncWithHttpInfo($asset_id_base, $asset_id_quote, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSpecificRateAsyncWithHttpInfo($asset_id_base, $asset_id_quote, string $contentType = self::contentTypes['getSpecificRate'][0])
    {
     ...
     */
    public function getSpecificRateRequest($asset_id_base, $asset_id_quote, string $contentType = self::contentTypes['getSpecificRate'][0])
    {
     ...
     */
    public function v1ExchangerateAssetIdBaseGet($asset_id_base, $filter_asset_id = null, $invert = false, string $contentType = self::contentTypes['v1ExchangerateAssetIdBaseGet'][0])
    {
        list($response) = $this->v1ExchangerateAssetIdBaseGetWithHttpInfo($asset_id_base, $filter_asset_id, $invert, $contentType);
        return $response;
    }
     ...
     */
    public function v1ExchangerateAssetIdBaseGetWithHttpInfo($asset_id_base, $filter_asset_id = null, $invert = false, string $contentType = self::contentTypes['v1ExchangerateAssetIdBaseGet'][0])
    {
        $request = $this->v1ExchangerateAssetIdBaseGetRequest($asset_id_base, $filter_asset_id, $invert, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v1ExchangerateAssetIdBaseGetAsync($asset_id_base, $filter_asset_id = null, $invert = false, string $contentType = self::contentTypes['v1ExchangerateAssetIdBaseGet'][0])
    {
        return $this->v1ExchangerateAssetIdBaseGetAsyncWithHttpInfo($asset_id_base, $filter_asset_id, $invert, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v1ExchangerateAssetIdBaseGetAsyncWithHttpInfo($asset_id_base, $filter_asset_id = null, $invert = false, string $contentType = self::contentTypes['v1ExchangerateAssetIdBaseGet'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function v1ExchangerateAssetIdBaseGetRequest($asset_id_base, $filter_asset_id = null, $invert = false, string $contentType = self::contentTypes['v1ExchangerateAssetIdBaseGet'][0])
    {
