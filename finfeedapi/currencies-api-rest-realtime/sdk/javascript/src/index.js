...
* <pre>
* var FxRealtimeRestApi = require('index'); // See note below*.
* var xxxSvc = new FxRealtimeRestApi.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new FxRealtimeRestApi.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new FxRealtimeRestApi.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new FxRealtimeRestApi.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
