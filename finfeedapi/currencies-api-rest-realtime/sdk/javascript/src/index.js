...
* <pre>
* var FinFeedApiCurrenciesRealtimeRestApi = require('index'); // See note below*.
* var xxxSvc = new FinFeedApiCurrenciesRealtimeRestApi.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new FinFeedApiCurrenciesRealtimeRestApi.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new FinFeedApiCurrenciesRealtimeRestApi.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new FinFeedApiCurrenciesRealtimeRestApi.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
