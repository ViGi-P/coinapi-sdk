...
has version_info => ( is => 'ro',
                      isa => 'HashRef',
                      default => sub { {
                          app_name => 'FinFeedAPI Currencies Realtime REST API',
                          app_version => 'v1',
...
WWW::OpenAPIClient::Role - a Moose role for the FinFeedAPI Currencies Realtime REST API

=head2 FinFeedAPI Currencies Realtime REST API version: v1
