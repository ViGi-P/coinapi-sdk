...
package body .Models is
   ...
   procedure Serialize (Into  : in out Swagger.Streams.Output_Stream'Class;
                        Name  : in String;
                        Value : in .Models.V1ExchangeRatesChainNetworkAddress_Type) is
   begin
      Into.Start_Entity (Name);
   ...
   procedure Serialize (Into  : in out Swagger.Streams.Output_Stream'Class;
                        Name  : in String;
                        Value : in V1ExchangeRatesChainNetworkAddress_Type_Vectors.Vector) is
   begin
      Into.Start_Array (Name);
      for Item of Value loop
         Serialize (Into, "", Item);
   ...
   procedure Deserialize (From  : in Swagger.Value_Type;
                          Name  : in String;
                          Value : out .Models.V1ExchangeRatesChainNetworkAddress_Type) is
      Object : Swagger.Value_Type;
   begin
      Swagger.Streams.Deserialize (From, Name, Object);
   ...
   procedure Deserialize (From  : in Swagger.Value_Type;
                          Name  : in String;
                          Value : in out V1ExchangeRatesChainNetworkAddress_Type_Vectors.Vector) is
      List : Swagger.Value_Array_Type;
      Item : .Models.V1ExchangeRatesChainNetworkAddress_Type;
   begin
      Value.Clear;
      Swagger.Streams.Deserialize (From, Name, List);
      for Data of List loop
