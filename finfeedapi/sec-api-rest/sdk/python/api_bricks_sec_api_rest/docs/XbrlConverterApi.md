# api_bricks_sec_api_rest.XbrlConverterApi

All URIs are relative to *https://api.sec.finfeedapi.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**v1_xbrl_converter_get**](XbrlConverterApi.md#v1_xbrl_converter_get) | **GET** /v1/xbrl-converter | Convert XBRL data to JSON format
...
with api_bricks_sec_api_rest.ApiClient(configuration) as api_client:
    ...
    api_instance = api_bricks_sec_api_rest.XbrlConverterApi(api_client)
    ...
    try:
        ...
        print("The response of XbrlConverterApi->v1_xbrl_converter_get:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling XbrlConverterApi->v1_xbrl_converter_get: %s\n" % e)
```
