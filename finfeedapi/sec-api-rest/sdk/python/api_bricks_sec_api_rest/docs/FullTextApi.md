# api_bricks_sec_api_rest.FullTextApi
...
with api_bricks_sec_api_rest.ApiClient(configuration) as api_client:
    ...
    api_instance = api_bricks_sec_api_rest.FullTextApi(api_client)
    ...
    try:
        ...
        print("The response of FullTextApi->v1_full_text_get:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FullTextApi->v1_full_text_get: %s\n" % e)
```
