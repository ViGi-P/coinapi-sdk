# api_bricks_sec_api_rest.ExtractorApi
...
with api_bricks_sec_api_rest.ApiClient(configuration) as api_client:
    ...
    api_instance = api_bricks_sec_api_rest.ExtractorApi(api_client)
    ...
    try:
        ...
        print("The response of ExtractorApi->v1_extractor_get:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ExtractorApi->v1_extractor_get: %s\n" % e)
```
...
with api_bricks_sec_api_rest.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ExtractorApi->v1_extractor_item_get:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ExtractorApi->v1_extractor_item_get: %s\n" % e)
```
