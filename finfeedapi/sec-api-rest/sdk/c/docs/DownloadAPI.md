...
------------- | ------------- | -------------
[**DownloadAPI_v1DownloadGet**](DownloadAPI.md#DownloadAPI_v1DownloadGet) | **GET** /v1/download | Download file from SEC EDGAR archive


# **DownloadAPI_v1DownloadGet**
```c
...
//
void DownloadAPI_v1DownloadGet(apiClient_t *apiClient, char *accession_no, char *file_name);
```
