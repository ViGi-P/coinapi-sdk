#ifndef _FullTextManager_H_
#define _FullTextManager_H_
 ...
 * \param pageSize Number of results per page (default: 100, max: 200). Always applied; omit to use defaults.
