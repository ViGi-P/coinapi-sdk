#ifndef _XbrlConverterManager_H_
#define _XbrlConverterManager_H_
...
/** \addtogroup XbrlConverter XbrlConverter
 * \ingroup Operations
 *  @{
 */
class XbrlConverterManager {
public:
	XbrlConverterManager();
	virtual ~XbrlConverterManager();

/*! \brief Convert XBRL data to JSON format. *Synchronous*
 *
 ...
 * \param userData The user data to be passed to the callback function.
 */
bool v1XbrlConverterGetAsync(char * accessToken,
	std::string htmUrl, std::string xbrlUrl, std::string accessionNo, 
	void(* handler)(std::map<std::string,std::string>, Error, void* )
	, void* userData);
