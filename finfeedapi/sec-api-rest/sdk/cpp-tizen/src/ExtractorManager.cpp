...
static gboolean __ExtractorManagerresponseHandler(gpointer data)
{
...
static gpointer __ExtractorManagerthreadFunc(gpointer data)
{
	RequestInfo *request = static_cast<RequestInfo*>(data);
	...
	g_idle_add(__ExtractorManagerresponseHandler, static_cast<gpointer>(request));
	...
	, void* userData, bool isAsync)
{
	...
	if(!isAsync){
		NetClient::easycurl(ExtractorManager::getBasePath(), url, myhttpmethod, queryParams,
		...
		requestInfo = new(nothrow) RequestInfo (ExtractorManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg, userData, reinterpret_cast<void(*)()>(handler), v1ExtractorGetProcessor);;
		if(requestInfo == NULL)
			return false;

		thread = g_thread_new(NULL, __ExtractorManagerthreadFunc, static_cast<gpointer>(requestInfo));
		return true;
	}
}
...
bool ExtractorManager::v1ExtractorGetAsync(char * accessToken,
	std::string accessionNumber, DTO.ExtractorType type, 
	void(* handler)(std::map<string,string>, Error, void* )
	, void* userData)
{
...
bool ExtractorManager::v1ExtractorGetSync(char * accessToken,
	std::string accessionNumber, DTO.ExtractorType type, 
	void(* handler)(std::map<string,string>, Error, void* )
	, void* userData)
{
...
bool ExtractorManager::v1ExtractorItemGetAsync(char * accessToken,
	std::string accessionNumber, std::string itemNumber, DTO.ExtractorType type, 
	void(* handler)(std::string, Error, void* )
	, void* userData)
{
...
bool ExtractorManager::v1ExtractorItemGetSync(char * accessToken,
	std::string accessionNumber, std::string itemNumber, DTO.ExtractorType type, 
	void(* handler)(std::string, Error, void* )
	, void* userData)
{
