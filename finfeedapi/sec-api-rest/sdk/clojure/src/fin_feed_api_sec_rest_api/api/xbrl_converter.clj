(ns fin-feed-api-sec-rest-api.api.xbrl-converter
...
(defn-spec v1-xbrl-converter-get-with-http-info any?
...
```"
  ([] (v1-xbrl-converter-get-with-http-info nil))
  ([{:keys [htm-url xbrl-url accession-no]} (s/map-of keyword? any?)]
   (call-api "/v1/xbrl-converter" :get
             {:path-params   {}
              :header-params {}
              :query-params  {"htm-url" htm-url "xbrl-url" xbrl-url "accession-no" accession-no }
              :form-params   {}
              :content-types []
              :accepts       ["application/json"]
              :auth-names    ["APIKey" "JWT"]})))

(defn-spec v1-xbrl-converter-get (s/map-of string? any-type-spec)
  "Convert XBRL data to JSON format
  Converts XBRL data to JSON format using one of three possible input methods.
...
```"
  ([] (v1-xbrl-converter-get nil))
  ([optional-params any?]
   (let [res (:data (v1-xbrl-converter-get-with-http-info optional-params))]
