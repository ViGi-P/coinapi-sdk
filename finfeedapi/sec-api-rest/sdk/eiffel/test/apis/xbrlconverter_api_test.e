note
    description: "API tests for XBRLCONVERTER_API"
    date: "$Date$"
    revision: "$Revision$"


class XBRLCONVERTER_API_TEST
...
feature {NONE} -- Implementation
    ...
    api: XBRLCONVERTER_API
            -- Create an object instance of `XBRLCONVERTER_API'.
        once
            create { XBRLCONVERTER_API } Result
        end
