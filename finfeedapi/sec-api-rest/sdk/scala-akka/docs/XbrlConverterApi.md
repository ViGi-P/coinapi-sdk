...
[**v1XbrlConverterGetWithHttpInfo**](XbrlConverterApi.md#v1XbrlConverterGetWithHttpInfo) | **GET** /v1/xbrl-converter | Convert XBRL data to JSON format
...
object Example extends App {
    ...
    val apiInstance = XbrlConverterApi("https://api.sec.finfeedapi.com")
