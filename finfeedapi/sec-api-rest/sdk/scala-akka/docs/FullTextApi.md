...
[**v1FullTextGetWithHttpInfo**](FullTextApi.md#v1FullTextGetWithHttpInfo) | **GET** /v1/full-text | Full-text search of SEC filing documents
...
object Example extends App {
    ...
    val apiInstance = FullTextApi("https://api.sec.finfeedapi.com")
