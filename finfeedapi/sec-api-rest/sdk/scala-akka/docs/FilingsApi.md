...
[**v1FilingsGetWithHttpInfo**](FilingsApi.md#v1FilingsGetWithHttpInfo) | **GET** /v1/filings | Query SEC filing metadata
...
object Example extends App {
    ...
    val apiInstance = FilingsApi("https://api.sec.finfeedapi.com")
