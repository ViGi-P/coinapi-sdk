...
object XbrlConverterApi {

  def apply(baseUrl: String = "https://api.sec.finfeedapi.com") = new XbrlConverterApi(baseUrl)
}

class XbrlConverterApi(baseUrl: String) {
   ...
   */
  def v1XbrlConverterGet(htmUrl: Option[String] = None, xbrlUrl: Option[String] = None, accessionNo: Option[String] = None)(implicit apiKey: ApiKeyValue, bearerToken: BearerToken): ApiRequest[Map[String, AnyType]] =
    ApiRequest[Map[String, AnyType]](ApiMethods.GET, baseUrl, "/v1/xbrl-converter", "application/json")
      .withApiKey(apiKey, "Authorization", HEADER)
      .withCredentials(bearerToken).withQueryParam("htm-url", htmUrl)
