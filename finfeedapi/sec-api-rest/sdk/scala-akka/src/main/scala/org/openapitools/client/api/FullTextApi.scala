...
object FullTextApi {
  ...
  def apply(baseUrl: String = "https://api.sec.finfeedapi.com") = new FullTextApi(baseUrl)
}

class FullTextApi(baseUrl: String) {
