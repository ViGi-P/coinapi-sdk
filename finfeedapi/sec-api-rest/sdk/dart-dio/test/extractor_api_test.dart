...
/// tests for ExtractorApi
void main() {
  final instance = Openapi().getExtractorApi();
  ...
  group(ExtractorApi, () {
    ...
    //
    //Future<BuiltMap<String, JsonObject>> v1ExtractorGet(String accessionNumber, { DTOExtractorType type }) async
