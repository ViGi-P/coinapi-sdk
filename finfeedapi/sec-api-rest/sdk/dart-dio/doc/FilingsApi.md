...
final api = Openapi().getFilingsApi();
...
final int pageSize = 56; // int | Number of results per page (default: 50, max: 200). Always applied; omit to use defaults.
...
try {
    ...
    print('Exception when calling FilingsApi->v1FilingsGet: $e\n');
}
```
