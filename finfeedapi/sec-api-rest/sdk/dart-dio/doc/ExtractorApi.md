...
final api = Openapi().getExtractorApi();
...
try {
    ...
    print('Exception when calling ExtractorApi->v1ExtractorGet: $e\n');
}
```
...
try {
    ...
    print('Exception when calling ExtractorApi->v1ExtractorItemGet: $e\n');
}
```
