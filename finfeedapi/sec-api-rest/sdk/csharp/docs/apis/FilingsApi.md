# APIBricks.FinFeedAPI.SECAPI.REST.V1.Api.FilingsApi
...
namespace Example
{
    public class V1FilingsGetExample
    {
        public static void Main()
        {
            ...
            var pageSize = 56;  // int | Number of results per page (default: 50, max: 200). Always applied; omit to use defaults. (optional) 
            var pageNumber = 56;  // int | Page number to retrieve (default: 1). Always applied; omit to use defaults. (optional) 
            ...
            {
                Debug.Print("Exception when calling FilingsApi.V1FilingsGet: " + e.Message);
...
{
    Debug.Print("Exception when calling FilingsApi.V1FilingsGetWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
