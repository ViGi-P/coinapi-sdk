# APIBricks.FinFeedAPI.SECAPI.REST.V1.Api.ExtractorApi
...
namespace Example
{
    public class V1ExtractorGetExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new ExtractorApi(config);
            ...
            {
                Debug.Print("Exception when calling ExtractorApi.V1ExtractorGet: " + e.Message);
...
{
    Debug.Print("Exception when calling ExtractorApi.V1ExtractorGetWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class V1ExtractorItemGetExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling ExtractorApi.V1ExtractorItemGet: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling ExtractorApi.V1ExtractorItemGetWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
