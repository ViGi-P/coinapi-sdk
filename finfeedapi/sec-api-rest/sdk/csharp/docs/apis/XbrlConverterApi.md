# APIBricks.FinFeedAPI.SECAPI.REST.V1.Api.XbrlConverterApi
...
namespace Example
{
    public class V1XbrlConverterGetExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new XbrlConverterApi(config);
            ...
            {
                Debug.Print("Exception when calling XbrlConverterApi.V1XbrlConverterGet: " + e.Message);
...
{
    Debug.Print("Exception when calling XbrlConverterApi.V1XbrlConverterGetWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
