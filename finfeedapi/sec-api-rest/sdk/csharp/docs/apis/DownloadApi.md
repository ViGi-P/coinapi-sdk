# APIBricks.FinFeedAPI.SECAPI.REST.V1.Api.DownloadApi

All URIs are relative to *https://api.sec.finfeedapi.com*

| Method | HTTP request | Description |
|--------|--------------|-------------|
| [**V1DownloadGet**](DownloadApi.md#v1downloadget) | **GET** /v1/download | Download file from SEC EDGAR archive |
...
namespace Example
{
    public class V1DownloadGetExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling DownloadApi.V1DownloadGet: " + e.Message);
...
{
    Debug.Print("Exception when calling DownloadApi.V1DownloadGetWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
