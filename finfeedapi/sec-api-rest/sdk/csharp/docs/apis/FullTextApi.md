# APIBricks.FinFeedAPI.SECAPI.REST.V1.Api.FullTextApi
...
namespace Example
{
    public class V1FullTextGetExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new FullTextApi(config);
            ...
            var pageSize = 56;  // int | Number of results per page (default: 100, max: 200). Always applied; omit to use defaults. (optional) 
            ...
            {
                Debug.Print("Exception when calling FullTextApi.V1FullTextGet: " + e.Message);
...
{
    Debug.Print("Exception when calling FullTextApi.V1FullTextGetWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
