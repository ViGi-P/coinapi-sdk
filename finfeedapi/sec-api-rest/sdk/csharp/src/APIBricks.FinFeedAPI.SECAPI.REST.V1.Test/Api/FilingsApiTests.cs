...
{
    /// <summary>
    ///  Class for testing FilingsApi
    /// </summary>
    public sealed class FilingsApiTests : ApiTestsBase
    {
        private readonly IFilingsApi _instance;

        public FilingsApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<IFilingsApi>();
        }
