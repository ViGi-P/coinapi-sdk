...
namespace APIBricks.FinFeedAPI.SECAPI.REST.V1.Api
{
    ...
    /// </summary>
    public interface IExtractorApi : IApi
    {
        /// <summary>
        /// The class containing the events
        /// </summary>
        ExtractorApiEvents Events { get; }
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public class ExtractorApiEvents
    {
        /// <summary>
        ...
        internal void ExecuteOnV1ExtractorGet(ExtractorApi.V1ExtractorGetApiResponse apiResponse)
        {
        ...
        internal void ExecuteOnV1ExtractorItemGet(ExtractorApi.V1ExtractorItemGetApiResponse apiResponse)
        {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public sealed partial class ExtractorApi : IExtractorApi
    {
        ...
        /// The logger
        /// </summary>
        public ILogger<ExtractorApi> Logger { get; }
        ...
        /// The class containing the events
        /// </summary>
        public ExtractorApiEvents Events { get; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ExtractorApi"/> class.
        /// </summary>
        /// <returns></returns>
        public ExtractorApi(ILogger<ExtractorApi> logger, ILoggerFactory loggerFactory, HttpClient httpClient, JsonSerializerOptionsProvider jsonSerializerOptionsProvider, ExtractorApiEvents extractorApiEvents,
            TokenProvider<ApiKeyToken> apiKeyProvider,
            TokenProvider<BearerToken> bearerTokenProvider)
        {
            _jsonSerializerOptions = jsonSerializerOptionsProvider.Options;
            LoggerFactory = loggerFactory;
            Logger = LoggerFactory.CreateLogger<ExtractorApi>();
            HttpClient = httpClient;
            Events = extractorApiEvents;
