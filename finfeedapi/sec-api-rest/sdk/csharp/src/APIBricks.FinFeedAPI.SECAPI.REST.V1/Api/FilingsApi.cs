...
namespace APIBricks.FinFeedAPI.SECAPI.REST.V1.Api
{
    ...
    /// </summary>
    public interface IFilingsApi : IApi
    {
        /// <summary>
        /// The class containing the events
        /// </summary>
        FilingsApiEvents Events { get; }
    ...
    public class FilingsApiEvents
    {
        ...
        internal void ExecuteOnV1FilingsGet(FilingsApi.V1FilingsGetApiResponse apiResponse)
        {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public sealed partial class FilingsApi : IFilingsApi
    {
        ...
        /// The logger
        /// </summary>
        public ILogger<FilingsApi> Logger { get; }
        ...
        /// The class containing the events
        /// </summary>
        public FilingsApiEvents Events { get; }
        ...
        /// </summary>
        /// <returns></returns>
        public FilingsApi(ILogger<FilingsApi> logger, ILoggerFactory loggerFactory, HttpClient httpClient, JsonSerializerOptionsProvider jsonSerializerOptionsProvider, FilingsApiEvents filingsApiEvents,
            TokenProvider<ApiKeyToken> apiKeyProvider,
            TokenProvider<BearerToken> bearerTokenProvider)
        {
            _jsonSerializerOptions = jsonSerializerOptionsProvider.Options;
            LoggerFactory = loggerFactory;
            Logger = LoggerFactory.CreateLogger<FilingsApi>();
            HttpClient = httpClient;
            Events = filingsApiEvents;
