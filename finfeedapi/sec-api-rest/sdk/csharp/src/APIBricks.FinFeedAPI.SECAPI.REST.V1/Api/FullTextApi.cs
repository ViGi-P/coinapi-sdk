...
namespace APIBricks.FinFeedAPI.SECAPI.REST.V1.Api
{
    ...
    /// </summary>
    public interface IFullTextApi : IApi
    {
        /// <summary>
        /// The class containing the events
        /// </summary>
        FullTextApiEvents Events { get; }
        ...
        /// <param name="pageSize">Number of results per page (default: 100, max: 200). Always applied; omit to use defaults. (optional)</param>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public class FullTextApiEvents
    {
        /// <summary>
        ...
        internal void ExecuteOnV1FullTextGet(FullTextApi.V1FullTextGetApiResponse apiResponse)
        {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public sealed partial class FullTextApi : IFullTextApi
    {
        ...
        /// The logger
        /// </summary>
        public ILogger<FullTextApi> Logger { get; }
        ...
        /// The class containing the events
        /// </summary>
        public FullTextApiEvents Events { get; }
        ...
        /// </summary>
        /// <returns></returns>
        public FullTextApi(ILogger<FullTextApi> logger, ILoggerFactory loggerFactory, HttpClient httpClient, JsonSerializerOptionsProvider jsonSerializerOptionsProvider, FullTextApiEvents fullTextApiEvents,
            TokenProvider<ApiKeyToken> apiKeyProvider,
            TokenProvider<BearerToken> bearerTokenProvider)
        {
            _jsonSerializerOptions = jsonSerializerOptionsProvider.Options;
            LoggerFactory = loggerFactory;
            Logger = LoggerFactory.CreateLogger<FullTextApi>();
            HttpClient = httpClient;
            Events = fullTextApiEvents;
