# PSOpenAPITools.PSOpenAPITools\Api.FullTextApi

All URIs are relative to *https://api.sec.finfeedapi.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**Invoke-V1FullTextGet**](FullTextApi.md#Invoke-V1FullTextGet) | **GET** /v1/full-text | Full-text search of SEC filing documents
...
$PageSize = 56 # Int32 | Number of results per page (default: 100, max: 200). Always applied; omit to use defaults. (optional)
$PageNumber = 56 # Int32 | Page number to retrieve (default: 1). Always applied; omit to use defaults. (optional)
 ...
 **PageSize** | **Int32**| Number of results per page (default: 100, max: 200). Always applied; omit to use defaults. | [optional] 
 **PageNumber** | **Int32**| Page number to retrieve (default: 1). Always applied; omit to use defaults. | [optional] 
