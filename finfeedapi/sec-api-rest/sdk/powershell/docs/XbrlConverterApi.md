# PSOpenAPITools.PSOpenAPITools\Api.XbrlConverterApi

All URIs are relative to *https://api.sec.finfeedapi.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**Invoke-V1XbrlConverterGet**](XbrlConverterApi.md#Invoke-V1XbrlConverterGet) | **GET** /v1/xbrl-converter | Convert XBRL data to JSON format
