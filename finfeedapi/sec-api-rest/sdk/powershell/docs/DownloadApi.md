# PSOpenAPITools.PSOpenAPITools\Api.DownloadApi

All URIs are relative to *https://api.sec.finfeedapi.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**Invoke-V1DownloadGet**](DownloadApi.md#Invoke-V1DownloadGet) | **GET** /v1/download | Download file from SEC EDGAR archive
