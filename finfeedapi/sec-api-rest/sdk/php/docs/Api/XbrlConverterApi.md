# OpenAPI\Client\XbrlConverterApi
...
$apiInstance = new OpenAPI\Client\Api\XbrlConverterApi(
...
try {
    ...
    echo 'Exception when calling XbrlConverterApi->v1XbrlConverterGet: ', $e->getMessage(), PHP_EOL;
}
```
