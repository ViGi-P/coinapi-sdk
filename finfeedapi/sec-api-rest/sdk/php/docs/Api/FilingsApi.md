...
$apiInstance = new OpenAPI\Client\Api\FilingsApi(
...
$page_size = 56; // int | Number of results per page (default: 50, max: 200). Always applied; omit to use defaults.
...
try {
    ...
    echo 'Exception when calling FilingsApi->v1FilingsGet: ', $e->getMessage(), PHP_EOL;
}
```
