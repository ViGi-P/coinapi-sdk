...
$apiInstance = new OpenAPI\Client\Api\ExtractorApi(
...
try {
    ...
    echo 'Exception when calling ExtractorApi->v1ExtractorGet: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ExtractorApi->v1ExtractorItemGet: ', $e->getMessage(), PHP_EOL;
}
```
