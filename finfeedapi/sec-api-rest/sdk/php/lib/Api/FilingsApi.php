...
class FilingsApi
{
     ...
     * @param  int|null $page_size Number of results per page (default: 50, max: 200). Always applied; omit to use defaults. (optional)
    ...
    public function v1FilingsGetRequest($cik = null, $ticker = null, $form_type = null, $filling_date_start = null, $filling_date_end = null, $report_date_start = null, $report_date_end = null, $items_contain = null, $page_size = null, $page_number = null, $sort_by = null, $sort_order = 'desc', string $contentType = self::contentTypes['v1FilingsGet'][0])
    {
        ...
        if ($filling_date_start !== null && !preg_match("/^\\d{4}-\\d{2}-\\d{2}$/", $filling_date_start)) {
            throw new \InvalidArgumentException("invalid value for \"filling_date_start\" when calling FilingsApi.v1FilingsGet, must conform to the pattern /^\\d{4}-\\d{2}-\\d{2}$/.");
        }
        
        if ($filling_date_end !== null && !preg_match("/^\\d{4}-\\d{2}-\\d{2}$/", $filling_date_end)) {
            throw new \InvalidArgumentException("invalid value for \"filling_date_end\" when calling FilingsApi.v1FilingsGet, must conform to the pattern /^\\d{4}-\\d{2}-\\d{2}$/.");
        }
        
        if ($report_date_start !== null && !preg_match("/^\\d{4}-\\d{2}-\\d{2}$/", $report_date_start)) {
            throw new \InvalidArgumentException("invalid value for \"report_date_start\" when calling FilingsApi.v1FilingsGet, must conform to the pattern /^\\d{4}-\\d{2}-\\d{2}$/.");
        }
        
        if ($report_date_end !== null && !preg_match("/^\\d{4}-\\d{2}-\\d{2}$/", $report_date_end)) {
            throw new \InvalidArgumentException("invalid value for \"report_date_end\" when calling FilingsApi.v1FilingsGet, must conform to the pattern /^\\d{4}-\\d{2}-\\d{2}$/.");
        }
        

        if ($page_size !== null && $page_size > 200) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling FilingsApi.v1FilingsGet, must be smaller than or equal to 200.');
        }
        if ($page_size !== null && $page_size < 1) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling FilingsApi.v1FilingsGet, must be bigger than or equal to 1.');
        }
        
        if ($page_number !== null && $page_number > 2147483647) {
            throw new \InvalidArgumentException('invalid value for "$page_number" when calling FilingsApi.v1FilingsGet, must be smaller than or equal to 2147483647.');
        }
        if ($page_number !== null && $page_number < 1) {
            throw new \InvalidArgumentException('invalid value for "$page_number" when calling FilingsApi.v1FilingsGet, must be bigger than or equal to 1.');
        }
        

        if ($sort_order !== null && !preg_match("/^(asc|desc)$/", $sort_order)) {
            throw new \InvalidArgumentException("invalid value for \"sort_order\" when calling FilingsApi.v1FilingsGet, must conform to the pattern /^(asc|desc)$/.");
        }
