/**
 * @fileoverview AUTOMATICALLY GENERATED service for API.Client.FilingsApi.
...
goog.provide('API.Client.FilingsApi');
 ...
 * @struct
 */
API.Client.FilingsApi = function($http, $httpParamSerializer, $injector) {
  /** @private {!string} */
  this.basePath_ = $injector.has('FilingsApiBasePath') ?
                   /** @type {!string} */ ($injector.get('FilingsApiBasePath')) :
                   'https://api.sec.finfeedapi.com';

  /** @private {!Object<string, string>} */
  this.defaultHeaders_ = $injector.has('FilingsApiDefaultHeaders') ?
                   /** @type {!Object<string, string>} */ (
                       $injector.get('FilingsApiDefaultHeaders')) :
                   {};
...
API.Client.FilingsApi.$inject = ['$http', '$httpParamSerializer', '$injector'];
 ...
 * @param {!number=} opt_pageSize Number of results per page (default: 50, max: 200). Always applied; omit to use defaults.
 ...
 */
API.Client.FilingsApi.prototype.v1FilingsGet = function(opt_cik, opt_ticker, opt_formType, opt_fillingDateStart, opt_fillingDateEnd, opt_reportDateStart, opt_reportDateEnd, opt_itemsContain, opt_pageSize, opt_pageNumber, opt_sortBy, opt_sortOrder, opt_extraHttpRequestParams) {
  /** @const {string} */
