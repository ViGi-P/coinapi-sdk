/**
 * @fileoverview AUTOMATICALLY GENERATED service for API.Client.ExtractorApi.
...
goog.provide('API.Client.ExtractorApi');
 ...
 * @struct
 */
API.Client.ExtractorApi = function($http, $httpParamSerializer, $injector) {
  /** @private {!string} */
  this.basePath_ = $injector.has('ExtractorApiBasePath') ?
                   /** @type {!string} */ ($injector.get('ExtractorApiBasePath')) :
                   'https://api.sec.finfeedapi.com';

  /** @private {!Object<string, string>} */
  this.defaultHeaders_ = $injector.has('ExtractorApiDefaultHeaders') ?
                   /** @type {!Object<string, string>} */ (
                       $injector.get('ExtractorApiDefaultHeaders')) :
                   {};
...
API.Client.ExtractorApi.$inject = ['$http', '$httpParamSerializer', '$injector'];
 ...
 */
API.Client.ExtractorApi.prototype.v1ExtractorGet = function(accessionNumber, opt_type, opt_extraHttpRequestParams) {
  /** @const {string} */
 ...
 */
API.Client.ExtractorApi.prototype.v1ExtractorItemGet = function(accessionNumber, itemNumber, opt_type, opt_extraHttpRequestParams) {
  /** @const {string} */
