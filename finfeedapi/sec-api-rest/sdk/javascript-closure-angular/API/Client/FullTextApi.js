/**
 * @fileoverview AUTOMATICALLY GENERATED service for API.Client.FullTextApi.
...
goog.provide('API.Client.FullTextApi');
 ...
 * @struct
 */
API.Client.FullTextApi = function($http, $httpParamSerializer, $injector) {
  /** @private {!string} */
  this.basePath_ = $injector.has('FullTextApiBasePath') ?
                   /** @type {!string} */ ($injector.get('FullTextApiBasePath')) :
                   'https://api.sec.finfeedapi.com';

  /** @private {!Object<string, string>} */
  this.defaultHeaders_ = $injector.has('FullTextApiDefaultHeaders') ?
                   /** @type {!Object<string, string>} */ (
                       $injector.get('FullTextApiDefaultHeaders')) :
                   {};
...
API.Client.FullTextApi.$inject = ['$http', '$httpParamSerializer', '$injector'];
 ...
 */
API.Client.FullTextApi.prototype.v1FullTextGet = function(opt_formType, opt_fillingDateStart, opt_fillingDateEnd, opt_textContains, opt_textNotContain, opt_pageSize, opt_pageNumber, opt_sortBy, opt_sortOrder, opt_extraHttpRequestParams) {
  /** @const {string} */
