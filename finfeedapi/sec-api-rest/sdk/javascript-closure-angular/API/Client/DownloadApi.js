/**
 * @fileoverview AUTOMATICALLY GENERATED service for API.Client.DownloadApi.
...
goog.provide('API.Client.DownloadApi');
 ...
 * @struct
 */
API.Client.DownloadApi = function($http, $httpParamSerializer, $injector) {
  /** @private {!string} */
  this.basePath_ = $injector.has('DownloadApiBasePath') ?
                   /** @type {!string} */ ($injector.get('DownloadApiBasePath')) :
                   'https://api.sec.finfeedapi.com';

  /** @private {!Object<string, string>} */
  this.defaultHeaders_ = $injector.has('DownloadApiDefaultHeaders') ?
                   /** @type {!Object<string, string>} */ (
                       $injector.get('DownloadApiDefaultHeaders')) :
                   {};
...
API.Client.DownloadApi.$inject = ['$http', '$httpParamSerializer', '$injector'];
 ...
 */
API.Client.DownloadApi.prototype.v1DownloadGet = function(accessionNo, fileName, opt_extraHttpRequestParams) {
  /** @const {string} */
