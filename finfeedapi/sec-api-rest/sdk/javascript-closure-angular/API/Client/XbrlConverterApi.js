/**
 * @fileoverview AUTOMATICALLY GENERATED service for API.Client.XbrlConverterApi.
...
goog.provide('API.Client.XbrlConverterApi');
 ...
 * @struct
 */
API.Client.XbrlConverterApi = function($http, $httpParamSerializer, $injector) {
  /** @private {!string} */
  this.basePath_ = $injector.has('XbrlConverterApiBasePath') ?
                   /** @type {!string} */ ($injector.get('XbrlConverterApiBasePath')) :
                   'https://api.sec.finfeedapi.com';

  /** @private {!Object<string, string>} */
  this.defaultHeaders_ = $injector.has('XbrlConverterApiDefaultHeaders') ?
                   /** @type {!Object<string, string>} */ (
                       $injector.get('XbrlConverterApiDefaultHeaders')) :
                   {};
...
API.Client.XbrlConverterApi.$inject = ['$http', '$httpParamSerializer', '$injector'];
 ...
 */
API.Client.XbrlConverterApi.prototype.v1XbrlConverterGet = function(opt_htmUrl, opt_xbrlUrl, opt_accessionNo, opt_extraHttpRequestParams) {
  /** @const {string} */
