# WWW::OpenAPIClient::ExtractorApi

## Load the API package
```perl
use WWW::OpenAPIClient::Object::ExtractorApi;
```
...
my $api_instance = WWW::OpenAPIClient::ExtractorApi->new(
...
if ($@) {
    warn "Exception when calling ExtractorApi->v1_extractor_get: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExtractorApi->v1_extractor_item_get: $@\n";
}
```
