# WWW::OpenAPIClient::FullTextApi

## Load the API package
```perl
use WWW::OpenAPIClient::Object::FullTextApi;
```
...
my $api_instance = WWW::OpenAPIClient::FullTextApi->new(
...
my $page_size = 56; # int | Number of results per page (default: 100, max: 200). Always applied; omit to use defaults.
my $page_number = 56; # int | Page number to retrieve (default: 1). Always applied; omit to use defaults.
...
if ($@) {
    warn "Exception when calling FullTextApi->v1_full_text_get: $@\n";
}
```
