# WWW::OpenAPIClient::FilingsApi

## Load the API package
```perl
use WWW::OpenAPIClient::Object::FilingsApi;
```
...
my $api_instance = WWW::OpenAPIClient::FilingsApi->new(
...
my $page_size = 56; # int | Number of results per page (default: 50, max: 200). Always applied; omit to use defaults.
...
if ($@) {
    warn "Exception when calling FilingsApi->v1_filings_get: $@\n";
}
```
