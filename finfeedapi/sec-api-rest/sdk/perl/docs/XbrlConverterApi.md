# WWW::OpenAPIClient::XbrlConverterApi

## Load the API package
```perl
use WWW::OpenAPIClient::Object::XbrlConverterApi;
```
...
my $api_instance = WWW::OpenAPIClient::XbrlConverterApi->new(
...
if ($@) {
    warn "Exception when calling XbrlConverterApi->v1_xbrl_converter_get: $@\n";
}
```
