...
try {
    ...
    println("4xx response calling FullTextApi#v1FullTextGet")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling FullTextApi#v1FullTextGet")
    e.printStackTrace()
}
```
...
| **pageSize** | **kotlin.Int**| Number of results per page (default: 100, max: 200). Always applied; omit to use defaults. | [optional] |
