...
val apiInstance = XbrlConverterApi()
...
try {
    ...
    println("4xx response calling XbrlConverterApi#v1XbrlConverterGet")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling XbrlConverterApi#v1XbrlConverterGet")
    e.printStackTrace()
}
```
