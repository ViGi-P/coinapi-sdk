...
try {
    ...
    println("4xx response calling ExtractorApi#v1ExtractorGet")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling ExtractorApi#v1ExtractorGet")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling ExtractorApi#v1ExtractorItemGet")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling ExtractorApi#v1ExtractorItemGet")
    e.printStackTrace()
}
```
