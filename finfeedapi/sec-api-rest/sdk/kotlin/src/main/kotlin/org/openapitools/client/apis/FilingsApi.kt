...
class FilingsApi(basePath: kotlin.String = defaultBasePath, client: Call.Factory = ApiClient.defaultClient) : ApiClient(basePath, client) {
    companion object {
        @JvmStatic
     ...
     * @param pageSize Number of results per page (default: 50, max: 200). Always applied; omit to use defaults. (optional)
