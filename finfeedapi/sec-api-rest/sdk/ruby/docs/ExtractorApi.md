# OpenapiClient::ExtractorApi

All URIs are relative to *https://api.sec.finfeedapi.com*

| Method | HTTP request | Description |
| ------ | ------------ | ----------- |
| [**v1_extractor_get**](ExtractorApi.md#v1_extractor_get) | **GET** /v1/extractor | Extract and classify SEC filing content |
| [**v1_extractor_item_get**](ExtractorApi.md#v1_extractor_item_get) | **GET** /v1/extractor/item | Extract specific item content from SEC filing |
...
api_instance = OpenapiClient::ExtractorApi.new
...
begin
  ...
  puts "Error when calling ExtractorApi->v1_extractor_get: #{e}"
end
```
...
begin
  ...
  puts "Error when calling ExtractorApi->v1_extractor_get_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling ExtractorApi->v1_extractor_item_get: #{e}"
end
```
...
begin
  ...
  puts "Error when calling ExtractorApi->v1_extractor_item_get_with_http_info: #{e}"
end
```
