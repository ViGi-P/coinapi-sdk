# OpenapiClient::XbrlConverterApi
...
api_instance = OpenapiClient::XbrlConverterApi.new
opts = {
...
begin
  ...
  puts "Error when calling XbrlConverterApi->v1_xbrl_converter_get: #{e}"
end
```
...
begin
  ...
  puts "Error when calling XbrlConverterApi->v1_xbrl_converter_get_with_http_info: #{e}"
end
```
