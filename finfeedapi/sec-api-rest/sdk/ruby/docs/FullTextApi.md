# OpenapiClient::FullTextApi

All URIs are relative to *https://api.sec.finfeedapi.com*

| Method | HTTP request | Description |
| ------ | ------------ | ----------- |
| [**v1_full_text_get**](FullTextApi.md#v1_full_text_get) | **GET** /v1/full-text | Full-text search of SEC filing documents |
...
opts = {
  ...
  page_size: 56, # Integer | Number of results per page (default: 100, max: 200). Always applied; omit to use defaults.
...
begin
  ...
  puts "Error when calling FullTextApi->v1_full_text_get: #{e}"
end
```
...
begin
  ...
  puts "Error when calling FullTextApi->v1_full_text_get_with_http_info: #{e}"
end
```
