# OpenapiClient::DownloadApi

All URIs are relative to *https://api.sec.finfeedapi.com*

| Method | HTTP request | Description |
| ------ | ------------ | ----------- |
| [**v1_download_get**](DownloadApi.md#v1_download_get) | **GET** /v1/download | Download file from SEC EDGAR archive |
...
begin
  ...
  puts "Error when calling DownloadApi->v1_download_get: #{e}"
end
```
...
begin
  ...
  puts "Error when calling DownloadApi->v1_download_get_with_http_info: #{e}"
end
```
