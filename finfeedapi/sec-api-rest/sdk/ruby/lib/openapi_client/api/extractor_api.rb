  ...
  class ExtractorApi
    ...
    def v1_extractor_get_with_http_info(accession_number, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ExtractorApi.v1_extractor_get ...'
      end
      # verify the required parameter 'accession_number' is set
      if @api_client.config.client_side_validation && accession_number.nil?
        fail ArgumentError, "Missing the required parameter 'accession_number' when calling ExtractorApi.v1_extractor_get"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"ExtractorApi.v1_extractor_get",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ExtractorApi#v1_extractor_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def v1_extractor_item_get_with_http_info(accession_number, item_number, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ExtractorApi.v1_extractor_item_get ...'
      end
      # verify the required parameter 'accession_number' is set
      if @api_client.config.client_side_validation && accession_number.nil?
        fail ArgumentError, "Missing the required parameter 'accession_number' when calling ExtractorApi.v1_extractor_item_get"
      end
      # verify the required parameter 'item_number' is set
      if @api_client.config.client_side_validation && item_number.nil?
        fail ArgumentError, "Missing the required parameter 'item_number' when calling ExtractorApi.v1_extractor_item_get"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"ExtractorApi.v1_extractor_item_get",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ExtractorApi#v1_extractor_item_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
