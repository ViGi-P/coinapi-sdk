  ...
  class FullTextApi
    ...
    def v1_full_text_get_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FullTextApi.v1_full_text_get ...'
      end
      ...
      if @api_client.config.client_side_validation && !opts[:'filling_date_start'].nil? && opts[:'filling_date_start'] !~ pattern
        fail ArgumentError, "invalid value for 'opts[:\"filling_date_start\"]' when calling FullTextApi.v1_full_text_get, must conform to the pattern #{pattern}."
      end
      ...
      if @api_client.config.client_side_validation && !opts[:'sort_by'].nil? && opts[:'sort_by'] !~ pattern
        fail ArgumentError, "invalid value for 'opts[:\"sort_by\"]' when calling FullTextApi.v1_full_text_get, must conform to the pattern #{pattern}."
      end

      pattern = Regexp.new(/^(asc|desc)$/)
      if @api_client.config.client_side_validation && !opts[:'sort_order'].nil? && opts[:'sort_order'] !~ pattern
        fail ArgumentError, "invalid value for 'opts[:\"sort_order\"]' when calling FullTextApi.v1_full_text_get, must conform to the pattern #{pattern}."
      end
      ...
      new_options = opts.merge(
        :operation => :"FullTextApi.v1_full_text_get",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FullTextApi#v1_full_text_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
