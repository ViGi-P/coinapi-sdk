...
# Unit tests for OpenapiClient::FilingsApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'FilingsApi' do
  before do
  ...
  describe 'test an instance of FilingsApi' do
    it 'should create an instance of FilingsApi' do
      expect(@api_instance).to be_instance_of(OpenapiClient::FilingsApi)
    end
  end
