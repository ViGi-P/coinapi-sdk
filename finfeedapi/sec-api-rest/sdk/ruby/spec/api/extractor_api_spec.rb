...
# Unit tests for OpenapiClient::ExtractorApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ExtractorApi' do
  before do
  ...
  describe 'test an instance of ExtractorApi' do
    it 'should create an instance of ExtractorApi' do
      expect(@api_instance).to be_instance_of(OpenapiClient::ExtractorApi)
    end
  end
