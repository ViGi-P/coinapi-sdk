  ...
  public = list(
    ...
    V1FilingsGetWithHttpInfo = function(cik = NULL, ticker = NULL, form_type = NULL, filling_date_start = NULL, filling_date_end = NULL, report_date_start = NULL, report_date_end = NULL, items_contain = NULL, page_size = NULL, page_number = NULL, sort_by = NULL, sort_order = "desc", data_file = NULL, ...) {
      ...
      if (!str_detect(`filling_date_start`, "^\\d{4}-\\d{2}-\\d{2}$")) {
        stop("Invalid value for `filling_date_start` when calling FilingsApi$V1FilingsGet, must conform to the pattern ^\\d{4}-\\d{2}-\\d{2}$.")
      }

      if (!str_detect(`filling_date_end`, "^\\d{4}-\\d{2}-\\d{2}$")) {
        stop("Invalid value for `filling_date_end` when calling FilingsApi$V1FilingsGet, must conform to the pattern ^\\d{4}-\\d{2}-\\d{2}$.")
      }

      if (!str_detect(`report_date_start`, "^\\d{4}-\\d{2}-\\d{2}$")) {
        stop("Invalid value for `report_date_start` when calling FilingsApi$V1FilingsGet, must conform to the pattern ^\\d{4}-\\d{2}-\\d{2}$.")
      }

      if (!str_detect(`report_date_end`, "^\\d{4}-\\d{2}-\\d{2}$")) {
        stop("Invalid value for `report_date_end` when calling FilingsApi$V1FilingsGet, must conform to the pattern ^\\d{4}-\\d{2}-\\d{2}$.")
      }


      if (`page_size` > 200) {
        stop("Invalid value for `page_size` when calling FilingsApi$V1FilingsGet, must be smaller than or equal to 200.")
      }
      if (`page_size` < 1) {
        stop("Invalid value for `page_size` when calling FilingsApi$V1FilingsGet, must be bigger than or equal to 1.")
      }

      if (`page_number` > 2147483647) {
        stop("Invalid value for `page_number` when calling FilingsApi$V1FilingsGet, must be smaller than or equal to 2147483647.")
      }
      if (`page_number` < 1) {
        stop("Invalid value for `page_number` when calling FilingsApi$V1FilingsGet, must be bigger than or equal to 1.")
      }


      if (!str_detect(`sort_order`, "^(asc|desc)$")) {
        stop("Invalid value for `sort_order` when calling FilingsApi$V1FilingsGet, must conform to the pattern ^(asc|desc)$.")
      }
