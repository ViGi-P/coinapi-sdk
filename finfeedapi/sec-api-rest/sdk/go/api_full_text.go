...
// FullTextAPIService FullTextAPI service
type FullTextAPIService service

type ApiV1FullTextGetRequest struct {
	ctx context.Context
	ApiService *FullTextAPIService
	formType *string
...
*/
func (a *FullTextAPIService) V1FullTextGet(ctx context.Context) ApiV1FullTextGetRequest {
	return ApiV1FullTextGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *FullTextAPIService) V1FullTextGetExecute(r ApiV1FullTextGetRequest) ([]DTOSecFilingResultDto, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "FullTextAPIService.V1FullTextGet")
	if err != nil {
