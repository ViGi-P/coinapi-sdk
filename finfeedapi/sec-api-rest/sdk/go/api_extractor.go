...
// ExtractorAPIService ExtractorAPI service
type ExtractorAPIService service

type ApiV1ExtractorGetRequest struct {
	ctx context.Context
	ApiService *ExtractorAPIService
...
*/
func (a *ExtractorAPIService) V1ExtractorGet(ctx context.Context) ApiV1ExtractorGetRequest {
	return ApiV1ExtractorGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *ExtractorAPIService) V1ExtractorGetExecute(r ApiV1ExtractorGetRequest) (map[string]interface{}, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ExtractorAPIService.V1ExtractorGet")
	if err != nil {
...
*/
func (a *ExtractorAPIService) V1ExtractorItemGet(ctx context.Context) ApiV1ExtractorItemGetRequest {
	return ApiV1ExtractorItemGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return string
func (a *ExtractorAPIService) V1ExtractorItemGetExecute(r ApiV1ExtractorItemGetRequest) (string, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ExtractorAPIService.V1ExtractorItemGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
