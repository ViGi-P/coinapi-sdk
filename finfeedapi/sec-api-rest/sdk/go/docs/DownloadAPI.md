...
func main() {
	...
	r, err := apiClient.DownloadAPI.V1DownloadGet(context.Background()).AccessionNo(accessionNo).FileName(fileName).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `DownloadAPI.V1DownloadGet``: %v\n", err)
