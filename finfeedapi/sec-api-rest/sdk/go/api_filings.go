...
*/
func (a *FilingsAPIService) V1FilingsGet(ctx context.Context) ApiV1FilingsGetRequest {
	return ApiV1FilingsGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *FilingsAPIService) V1FilingsGetExecute(r ApiV1FilingsGetRequest) ([]DTOFilingMetadataDto, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "FilingsAPIService.V1FilingsGet")
	if err != nil {
