...
*/
func (a *DownloadAPIService) V1DownloadGet(ctx context.Context) ApiV1DownloadGetRequest {
	return ApiV1DownloadGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *DownloadAPIService) V1DownloadGetExecute(r ApiV1DownloadGetRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DownloadAPIService.V1DownloadGet")
	if err != nil {
