...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_FullTextApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_FullTextApi_H_
...
public:
    ...
    explicit FullTextApi( std::shared_ptr<const ApiClient> apiClient );
    ...
    /// <param name="pageSize">Number of results per page (default: 100, max: 200). Always applied; omit to use defaults. (optional, default to 0)</param>
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_FullTextApi_H_ */
