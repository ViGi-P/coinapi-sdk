...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_FilingsApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_FilingsApi_H_
...
public:
    ...
    explicit FilingsApi( std::shared_ptr<const ApiClient> apiClient );
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_FilingsApi_H_ */
