...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_ExtractorApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_ExtractorApi_H_
...
public:
    ...
    explicit ExtractorApi( std::shared_ptr<const ApiClient> apiClient );

    virtual ~ExtractorApi();
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_ExtractorApi_H_ */
