...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_XbrlConverterApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_XbrlConverterApi_H_
...
public:
    ...
    explicit XbrlConverterApi( std::shared_ptr<const ApiClient> apiClient );

    virtual ~XbrlConverterApi();
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_XbrlConverterApi_H_ */
