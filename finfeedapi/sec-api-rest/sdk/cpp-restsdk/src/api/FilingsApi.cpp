...
#include "CppRestOpenAPIClient/api/FilingsApi.h"
...
FilingsApi::FilingsApi( std::shared_ptr<const ApiClient> apiClient )
...
pplx::task<std::vector<std::shared_ptr<DTO_FilingMetadataDto>>> FilingsApi::v1FilingsGet(boost::optional<int64_t> cik, boost::optional<utility::string_t> ticker, boost::optional<utility::string_t> formType, boost::optional<utility::string_t> fillingDateStart, boost::optional<utility::string_t> fillingDateEnd, boost::optional<utility::string_t> reportDateStart, boost::optional<utility::string_t> reportDateEnd, boost::optional<utility::string_t> itemsContain, boost::optional<int32_t> pageSize, boost::optional<int32_t> pageNumber, boost::optional<std::shared_ptr<DTO_FilingSortBy>> sortBy, boost::optional<utility::string_t> sortOrder) const
{
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("FilingsApi->v1FilingsGet does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("FilingsApi->v1FilingsGet does not consume any supported media type"));
    }
