...
module Api.Request.Filings exposing
    ( v1FilingsGet
    )
...
-}
v1FilingsGet : Maybe Int -> Maybe String -> Maybe String -> Maybe String -> Maybe String -> Maybe String -> Maybe String -> Maybe String -> Maybe Int -> Maybe Int -> Maybe DTOFilingSortBy -> Maybe String -> String -> Api.Request (List Api.Data.DTOFilingMetadataDto)
v1FilingsGet cik_query ticker_query formType_query fillingDateStart_query fillingDateEnd_query reportDateStart_query reportDateEnd_query itemsContain_query pageSize_query pageNumber_query sortBy_query sortOrder_query auth_token =
    Api.request
        "GET"
        "/v1/filings"
        []
