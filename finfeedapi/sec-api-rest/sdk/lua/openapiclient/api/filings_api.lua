...
local filings_api = {}
local filings_api_mt = {
	__name = "filings_api";
	__index = filings_api;
}

local function new_filings_api(authority, basePath, schemes)
	local schemes_map = {}
...
function filings_api:v1_filings_get(cik, ticker, form_type, filling_date_start, filling_date_end, report_date_start, report_date_end, items_contain, page_size, page_number, sort_by, sort_order)
