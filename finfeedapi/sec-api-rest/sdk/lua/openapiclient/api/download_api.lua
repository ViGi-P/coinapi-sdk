...
local download_api = {}
local download_api_mt = {
	__name = "download_api";
	__index = download_api;
}

local function new_download_api(authority, basePath, schemes)
	local schemes_map = {}
...
function download_api:v1_download_get(accession_no, file_name)
