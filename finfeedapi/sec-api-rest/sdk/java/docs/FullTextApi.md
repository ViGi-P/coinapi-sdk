...
public class Example {
  public static void main(String[] args) {
    ...
    FullTextApi apiInstance = new FullTextApi(defaultClient);
    ...
    Integer pageSize = 56; // Integer | Number of results per page (default: 100, max: 200). Always applied; omit to use defaults.
...
| **pageSize** | **Integer**| Number of results per page (default: 100, max: 200). Always applied; omit to use defaults. | [optional] |
