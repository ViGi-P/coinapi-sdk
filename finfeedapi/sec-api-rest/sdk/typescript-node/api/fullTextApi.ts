...
export enum FullTextApiApiKeys {
    APIKey,
}

export class FullTextApi {
    ...
    public setApiKey(key: FullTextApiApiKeys, value: string) {
        (this.authentications as any)[FullTextApiApiKeys[key]].apiKey = value;
    }
