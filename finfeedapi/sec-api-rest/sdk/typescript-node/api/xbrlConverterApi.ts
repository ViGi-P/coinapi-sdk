...
export enum XbrlConverterApiApiKeys {
    APIKey,
}

export class XbrlConverterApi {
    ...
    public setApiKey(key: XbrlConverterApiApiKeys, value: string) {
        (this.authentications as any)[XbrlConverterApiApiKeys[key]].apiKey = value;
    }
