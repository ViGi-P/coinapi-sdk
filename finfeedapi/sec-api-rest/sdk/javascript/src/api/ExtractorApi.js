...
/**
* Extractor service.
* @module api/ExtractorApi
* @version v1
*/
export default class ExtractorApi {

    /**
    * Constructs a new ExtractorApi. 
    * @alias module:api/ExtractorApi
    * @class
    ...
    */
     ...
     * @callback module:api/ExtractorApi~v1ExtractorGetCallback
     ...
     * @param {module:api/ExtractorApi~v1ExtractorGetCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/ExtractorApi~v1ExtractorItemGetCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/DTOExtractorType} [type] Result type (text or html, default: text)
     * @param {module:api/ExtractorApi~v1ExtractorItemGetCallback} callback The callback function, accepting three arguments: error, data, response
