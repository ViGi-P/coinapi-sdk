...
/**
* XbrlConverter service.
* @module api/XbrlConverterApi
* @version v1
*/
export default class XbrlConverterApi {

    /**
    * Constructs a new XbrlConverterApi. 
    * @alias module:api/XbrlConverterApi
    * @class
    ...
    */
     ...
     * @callback module:api/XbrlConverterApi~v1XbrlConverterGetCallback
     ...
     * @param {module:api/XbrlConverterApi~v1XbrlConverterGetCallback} callback The callback function, accepting three arguments: error, data, response
