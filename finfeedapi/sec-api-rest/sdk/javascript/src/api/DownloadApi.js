...
export default class DownloadApi {
    ...
    */
     ...
     * @callback module:api/DownloadApi~v1DownloadGetCallback
     ...
     * @param {module:api/DownloadApi~v1DownloadGetCallback} callback The callback function, accepting three arguments: error, data, response
     */
