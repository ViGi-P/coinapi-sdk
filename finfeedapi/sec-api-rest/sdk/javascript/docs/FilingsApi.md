# FinFeedApiSecRestApi.FilingsApi
...
let apiInstance = new FinFeedApiSecRestApi.FilingsApi();
let opts = {
  ...
  'pageSize': 56, // Number | Number of results per page (default: 50, max: 200). Always applied; omit to use defaults.
  'pageNumber': 56, // Number | Page number to retrieve (default: 1). Always applied; omit to use defaults.
 ...
 **pageSize** | **Number**| Number of results per page (default: 50, max: 200). Always applied; omit to use defaults. | [optional] 
 **pageNumber** | **Number**| Page number to retrieve (default: 1). Always applied; omit to use defaults. | [optional] 
