# FinFeedApiSecRestApi.FullTextApi
...
let apiInstance = new FinFeedApiSecRestApi.FullTextApi();
let opts = {
  ...
  'pageSize': 56, // Number | Number of results per page (default: 100, max: 200). Always applied; omit to use defaults.
 ...
 **pageSize** | **Number**| Number of results per page (default: 100, max: 200). Always applied; omit to use defaults. | [optional] 
