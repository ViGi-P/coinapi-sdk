# fin_feed_api_sec_rest_api

FinFeedApiSecRestApi - JavaScript client for fin_feed_api_sec_rest_api
...
```shell
npm install fin_feed_api_sec_rest_api --save
```
...
To use the link you just defined in your project, switch to the directory you want to use your fin_feed_api_sec_rest_api from, and run:
...
```javascript
var FinFeedApiSecRestApi = require('fin_feed_api_sec_rest_api');

var defaultClient = FinFeedApiSecRestApi.ApiClient.instance;
...
## Documentation for Models
 ...
 - [FinFeedApiSecRestApi.DTOExtractorType](docs/DTOExtractorType.md)
 - [FinFeedApiSecRestApi.DTOFilingMetadataDto](docs/DTOFilingMetadataDto.md)
 - [FinFeedApiSecRestApi.DTOFilingSortBy](docs/DTOFilingSortBy.md)
 - [FinFeedApiSecRestApi.DTOSecFilingResultDto](docs/DTOSecFilingResultDto.md)
 - [FinFeedApiSecRestApi.MvcProblemDetails](docs/MvcProblemDetails.md)
 - [FinFeedApiSecRestApi.MvcValidationProblemDetails](docs/MvcValidationProblemDetails.md)
