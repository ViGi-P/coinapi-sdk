...
module FinFeedAPISECREST.API.Extractor where
...
v1ExtractorGet
  ...
  -> FinFeedAPISECRESTRequest V1ExtractorGet MimeNoContent ((Map.Map String AnyType)) MimeJSON
...
v1ExtractorItemGet
  ...
  -> FinFeedAPISECRESTRequest V1ExtractorItemGet MimeNoContent Text MimeJSON
