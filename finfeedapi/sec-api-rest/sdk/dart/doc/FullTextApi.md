...
final api_instance = FullTextApi();
...
final pageSize = 56; // int | Number of results per page (default: 100, max: 200). Always applied; omit to use defaults.
...
try {
    ...
    print('Exception when calling FullTextApi->v1FullTextGet: $e\n');
}
```
