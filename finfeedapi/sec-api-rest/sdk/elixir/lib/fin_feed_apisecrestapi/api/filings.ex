...
defmodule FinFeedAPISECRESTAPI.Api.Filings do
  @moduledoc """
  API calls for all endpoints tagged `Filings`.
  """
  ...
  """
  @spec v1_filings_get(Tesla.Env.client, keyword()) :: {:ok, FinFeedAPISECRESTAPI.Model.MvcValidationProblemDetails.t} | {:ok, FinFeedAPISECRESTAPI.Model.MvcProblemDetails.t} | {:ok, [FinFeedAPISECRESTAPI.Model.DtoFilingMetadataDto.t]} | {:error, Tesla.Env.t}
  def v1_filings_get(connection, opts \\ []) do
    ...
    |> evaluate_response([
      {200, FinFeedAPISECRESTAPI.Model.DtoFilingMetadataDto},
