...
defmodule FinFeedAPISECRESTAPI.Api.XbrlConverter do
  @moduledoc """
  API calls for all endpoints tagged `XbrlConverter`.
  """
  ...
  """
  @spec v1_xbrl_converter_get(Tesla.Env.client, keyword()) :: {:ok, nil} | {:ok, %{optional(String.t) => any()}} | {:ok, FinFeedAPISECRESTAPI.Model.MvcValidationProblemDetails.t} | {:ok, FinFeedAPISECRESTAPI.Model.MvcProblemDetails.t} | {:error, Tesla.Env.t}
