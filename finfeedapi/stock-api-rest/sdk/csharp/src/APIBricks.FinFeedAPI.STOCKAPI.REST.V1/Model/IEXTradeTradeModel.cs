...
namespace APIBricks.FinFeedAPI.STOCKAPI.REST.V1.Model
{
    ...
    /// </summary>
    public partial class IEXTradeTradeModel : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IEXTradeTradeModel" /> class.
        /// </summary>
        ...
        public bool? IsTradeBreak { get { return this.IsTradeBreakOption.Value; } set { this.IsTradeBreakOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="IEXTradeTradeModel" />
    /// </summary>
    public partial class IEXTradeTradeModelJsonConverter : JsonConverter<IEXTradeTradeModel>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="IEXTradeTradeModelJsonConverter" /> class.
        /// </summary>
        public IEXTradeTradeModelJsonConverter()
        {
            OnCreated();
        }
        ...
        /// <summary>
        /// Deserializes json to <see cref="IEXTradeTradeModel" />
        /// </summary>
        ...
        public override IEXTradeTradeModel Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
        ...
        /// <summary>
        /// Serializes a <see cref="IEXTradeTradeModel" />
        /// </summary>
        ...
        public override void Write(Utf8JsonWriter writer, IEXTradeTradeModel iEXTradeTradeModel, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, iEXTradeTradeModel, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="IEXTradeTradeModel" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="iEXTradeTradeModel"></param>
        /// <param name="jsonSerializerOptions"></param>
        ...
        public void WriteProperties(Utf8JsonWriter writer, IEXTradeTradeModel iEXTradeTradeModel, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (iEXTradeTradeModel.SymbolOption.IsSet)
                if (iEXTradeTradeModel.SymbolOption.Value != null)
                    writer.WriteString("symbol", iEXTradeTradeModel.Symbol);
                else
                    writer.WriteNull("symbol");

            if (iEXTradeTradeModel.TimestampNanosOption.IsSet)
                writer.WriteNumber("timestamp_nanos", iEXTradeTradeModel.TimestampNanosOption.Value!.Value);

            if (iEXTradeTradeModel.TimestampOption.IsSet)
                writer.WriteString("timestamp", iEXTradeTradeModel.TimestampOption.Value!.Value.ToString(TimestampFormat));

            if (iEXTradeTradeModel.SizeOption.IsSet)
                writer.WriteNumber("size", iEXTradeTradeModel.SizeOption.Value!.Value);

            if (iEXTradeTradeModel.PriceOption.IsSet)
                writer.WriteNumber("price", iEXTradeTradeModel.PriceOption.Value!.Value);

            if (iEXTradeTradeModel.TradeIdOption.IsSet)
                writer.WriteNumber("trade_id", iEXTradeTradeModel.TradeIdOption.Value!.Value);

            if (iEXTradeTradeModel.IsIntermarketSweepOption.IsSet)
                writer.WriteBoolean("is_intermarket_sweep", iEXTradeTradeModel.IsIntermarketSweepOption.Value!.Value);

            if (iEXTradeTradeModel.IsExtendedHoursTradeOption.IsSet)
                writer.WriteBoolean("is_extended_hours_trade", iEXTradeTradeModel.IsExtendedHoursTradeOption.Value!.Value);

            if (iEXTradeTradeModel.IsOddLotTradeOption.IsSet)
                writer.WriteBoolean("is_odd_lot_trade", iEXTradeTradeModel.IsOddLotTradeOption.Value!.Value);

            if (iEXTradeTradeModel.IsTradeThroughExemptOption.IsSet)
                writer.WriteBoolean("is_trade_through_exempt", iEXTradeTradeModel.IsTradeThroughExemptOption.Value!.Value);

            if (iEXTradeTradeModel.IsSinglePriceCrossTradeOption.IsSet)
                writer.WriteBoolean("is_single_price_cross_trade", iEXTradeTradeModel.IsSinglePriceCrossTradeOption.Value!.Value);
        }
    }
}
