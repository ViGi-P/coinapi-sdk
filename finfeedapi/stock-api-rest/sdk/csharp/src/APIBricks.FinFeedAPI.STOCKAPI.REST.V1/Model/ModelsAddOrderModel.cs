...
namespace APIBricks.FinFeedAPI.STOCKAPI.REST.V1.Model
{
    ...
    /// </summary>
    public partial class ModelsAddOrderModel : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ModelsAddOrderModel" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public ModelsAddOrderModel(Option<string?> symbol = default, Option<long?> timestampNanos = default, Option<DateTime?> timestamp = default, Option<bool?> isSideBuy = default, Option<int?> size = default, Option<double?> price = default, Option<long?> orderId = default)
        {
            SymbolOption = symbol;
        ...
        public long? OrderId { get { return this.OrderIdOption.Value; } set { this.OrderIdOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="ModelsAddOrderModel" />
    /// </summary>
    public partial class ModelsAddOrderModelJsonConverter : JsonConverter<ModelsAddOrderModel>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="ModelsAddOrderModelJsonConverter" /> class.
        /// </summary>
        public ModelsAddOrderModelJsonConverter()
        {
            OnCreated();
        }
        ...
        /// <summary>
        /// Deserializes json to <see cref="ModelsAddOrderModel" />
        /// </summary>
        ...
        public override ModelsAddOrderModel Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
        ...
        /// <summary>
        /// Serializes a <see cref="ModelsAddOrderModel" />
        /// </summary>
        ...
        public override void Write(Utf8JsonWriter writer, ModelsAddOrderModel modelsAddOrderModel, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, modelsAddOrderModel, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ModelsAddOrderModel" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="modelsAddOrderModel"></param>
        /// <param name="jsonSerializerOptions"></param>
        ...
        public void WriteProperties(Utf8JsonWriter writer, ModelsAddOrderModel modelsAddOrderModel, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (modelsAddOrderModel.TimestampNanosOption.IsSet)
                writer.WriteNumber("timestamp_nanos", modelsAddOrderModel.TimestampNanosOption.Value!.Value);

            if (modelsAddOrderModel.TimestampOption.IsSet)
                writer.WriteString("timestamp", modelsAddOrderModel.TimestampOption.Value!.Value.ToString(TimestampFormat));

            if (modelsAddOrderModel.IsSideBuyOption.IsSet)
                writer.WriteBoolean("is_side_buy", modelsAddOrderModel.IsSideBuyOption.Value!.Value);

            if (modelsAddOrderModel.SizeOption.IsSet)
                writer.WriteNumber("size", modelsAddOrderModel.SizeOption.Value!.Value);

            if (modelsAddOrderModel.PriceOption.IsSet)
                writer.WriteNumber("price", modelsAddOrderModel.PriceOption.Value!.Value);

            if (modelsAddOrderModel.OrderIdOption.IsSet)
                writer.WriteNumber("order_id", modelsAddOrderModel.OrderIdOption.Value!.Value);
        }
    }
}
