...
namespace APIBricks.FinFeedAPI.STOCKAPI.REST.V1.Model
{
    ...
    /// </summary>
    public partial class ModelsClearBookModel : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ModelsClearBookModel" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public ModelsClearBookModel(Option<string?> symbol = default, Option<long?> timestampNanos = default, Option<DateTime?> timestamp = default)
        {
            SymbolOption = symbol;
    ...
    /// <summary>
    /// A Json converter for type <see cref="ModelsClearBookModel" />
    /// </summary>
    public partial class ModelsClearBookModelJsonConverter : JsonConverter<ModelsClearBookModel>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="ModelsClearBookModelJsonConverter" /> class.
        /// </summary>
        public ModelsClearBookModelJsonConverter()
        {
            OnCreated();
        }
        ...
        /// <summary>
        /// Deserializes json to <see cref="ModelsClearBookModel" />
        /// </summary>
        ...
        public override ModelsClearBookModel Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
        ...
        /// <summary>
        /// Serializes a <see cref="ModelsClearBookModel" />
        /// </summary>
        ...
        public override void Write(Utf8JsonWriter writer, ModelsClearBookModel modelsClearBookModel, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, modelsClearBookModel, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ModelsClearBookModel" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="modelsClearBookModel"></param>
        /// <param name="jsonSerializerOptions"></param>
        ...
        public void WriteProperties(Utf8JsonWriter writer, ModelsClearBookModel modelsClearBookModel, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (modelsClearBookModel.TimestampNanosOption.IsSet)
                writer.WriteNumber("timestamp_nanos", modelsClearBookModel.TimestampNanosOption.Value!.Value);

            if (modelsClearBookModel.TimestampOption.IsSet)
                writer.WriteString("timestamp", modelsClearBookModel.TimestampOption.Value!.Value.ToString(TimestampFormat));
        }
    }
}
