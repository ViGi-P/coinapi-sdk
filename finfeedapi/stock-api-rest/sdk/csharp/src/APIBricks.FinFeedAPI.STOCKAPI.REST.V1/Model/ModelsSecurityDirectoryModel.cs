...
namespace APIBricks.FinFeedAPI.STOCKAPI.REST.V1.Model
{
    ...
    /// </summary>
    public partial class ModelsSecurityDirectoryModel : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ModelsSecurityDirectoryModel" /> class.
        /// </summary>
        ...
        public int? Flags { get { return this.FlagsOption.Value; } set { this.FlagsOption = new(value); } }
        ...
        public int? RoundLotSize { get { return this.RoundLotSizeOption.Value; } set { this.RoundLotSizeOption = new(value); } }
        ...
        public double? AdjustedPocPrice { get { return this.AdjustedPocPriceOption.Value; } set { this.AdjustedPocPriceOption = new(value); } }
        ...
        public int? LuldTier { get { return this.LuldTierOption.Value; } set { this.LuldTierOption = new(value); } }
        ...
        public string? LuldTierCode { get { return this.LuldTierCodeOption.Value; } set { this.LuldTierCodeOption = new(value); } }
        ...
        public string? LuldTierText { get { return this.LuldTierTextOption.Value; } set { this.LuldTierTextOption = new(value); } }
        ...
        public bool? IsLuldTierNotApplicable { get { return this.IsLuldTierNotApplicableOption.Value; } set { this.IsLuldTierNotApplicableOption = new(value); } }
        ...
        public bool? IsLuldTier1 { get { return this.IsLuldTier1Option.Value; } set { this.IsLuldTier1Option = new(value); } }
        ...
        public bool? IsLuldTier2 { get { return this.IsLuldTier2Option.Value; } set { this.IsLuldTier2Option = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="ModelsSecurityDirectoryModel" />
    /// </summary>
    public partial class ModelsSecurityDirectoryModelJsonConverter : JsonConverter<ModelsSecurityDirectoryModel>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="ModelsSecurityDirectoryModelJsonConverter" /> class.
        /// </summary>
        public ModelsSecurityDirectoryModelJsonConverter()
        {
            OnCreated();
        }
        ...
        /// <summary>
        /// Deserializes json to <see cref="ModelsSecurityDirectoryModel" />
        /// </summary>
        ...
        public override ModelsSecurityDirectoryModel Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
        ...
        /// <summary>
        /// Serializes a <see cref="ModelsSecurityDirectoryModel" />
        /// </summary>
        ...
        public override void Write(Utf8JsonWriter writer, ModelsSecurityDirectoryModel modelsSecurityDirectoryModel, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, modelsSecurityDirectoryModel, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ModelsSecurityDirectoryModel" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="modelsSecurityDirectoryModel"></param>
        /// <param name="jsonSerializerOptions"></param>
        ...
        public void WriteProperties(Utf8JsonWriter writer, ModelsSecurityDirectoryModel modelsSecurityDirectoryModel, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (modelsSecurityDirectoryModel.TimestampNanosOption.IsSet)
                writer.WriteNumber("timestamp_nanos", modelsSecurityDirectoryModel.TimestampNanosOption.Value!.Value);

            if (modelsSecurityDirectoryModel.TimestampOption.IsSet)
                writer.WriteString("timestamp", modelsSecurityDirectoryModel.TimestampOption.Value!.Value.ToString(TimestampFormat));

            if (modelsSecurityDirectoryModel.FlagsOption.IsSet)
                writer.WriteNumber("flags", modelsSecurityDirectoryModel.FlagsOption.Value!.Value);

            if (modelsSecurityDirectoryModel.RoundLotSizeOption.IsSet)
                writer.WriteNumber("round_lot_size", modelsSecurityDirectoryModel.RoundLotSizeOption.Value!.Value);

            if (modelsSecurityDirectoryModel.AdjustedPocPriceOption.IsSet)
                writer.WriteNumber("adjusted_poc_price", modelsSecurityDirectoryModel.AdjustedPocPriceOption.Value!.Value);

            if (modelsSecurityDirectoryModel.LuldTierOption.IsSet)
                writer.WriteNumber("luld_tier", modelsSecurityDirectoryModel.LuldTierOption.Value!.Value);

            if (modelsSecurityDirectoryModel.LuldTierCodeOption.IsSet)
                if (modelsSecurityDirectoryModel.LuldTierCodeOption.Value != null)
                    writer.WriteString("luld_tier_code", modelsSecurityDirectoryModel.LuldTierCode);
                else
                    writer.WriteNull("luld_tier_code");

            if (modelsSecurityDirectoryModel.LuldTierTextOption.IsSet)
                if (modelsSecurityDirectoryModel.LuldTierTextOption.Value != null)
                    writer.WriteString("luld_tier_text", modelsSecurityDirectoryModel.LuldTierText);
                else
                    writer.WriteNull("luld_tier_text");

            if (modelsSecurityDirectoryModel.IsLuldTierNotApplicableOption.IsSet)
                writer.WriteBoolean("is_luld_tier_not_applicable", modelsSecurityDirectoryModel.IsLuldTierNotApplicableOption.Value!.Value);

            if (modelsSecurityDirectoryModel.IsLuldTier1Option.IsSet)
                writer.WriteBoolean("is_luld_tier1", modelsSecurityDirectoryModel.IsLuldTier1Option.Value!.Value);

            if (modelsSecurityDirectoryModel.IsLuldTier2Option.IsSet)
                writer.WriteBoolean("is_luld_tier2", modelsSecurityDirectoryModel.IsLuldTier2Option.Value!.Value);
        }
    }
}
