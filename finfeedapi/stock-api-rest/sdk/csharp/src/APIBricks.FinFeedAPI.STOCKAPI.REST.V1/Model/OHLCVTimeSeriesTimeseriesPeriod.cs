...
namespace APIBricks.FinFeedAPI.STOCKAPI.REST.V1.Model
{
    ...
    /// </summary>
    public partial class OHLCVTimeSeriesTimeseriesPeriod : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OHLCVTimeSeriesTimeseriesPeriod" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public OHLCVTimeSeriesTimeseriesPeriod(Option<string?> periodId = default, Option<int?> lengthSeconds = default, Option<int?> lengthMonths = default, Option<int?> unitCount = default, Option<string?> unitName = default, Option<string?> displayName = default)
        {
    ...
    public class OHLCVTimeSeriesTimeseriesPeriodJsonConverter : JsonConverter<OHLCVTimeSeriesTimeseriesPeriod>
    {
        ...
        public override OHLCVTimeSeriesTimeseriesPeriod Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
        ...
        /// <summary>
        /// Serializes a <see cref="OHLCVTimeSeriesTimeseriesPeriod" />
        /// </summary>
        ...
        public override void Write(Utf8JsonWriter writer, OHLCVTimeSeriesTimeseriesPeriod oHLCVTimeSeriesTimeseriesPeriod, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, oHLCVTimeSeriesTimeseriesPeriod, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="OHLCVTimeSeriesTimeseriesPeriod" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="oHLCVTimeSeriesTimeseriesPeriod"></param>
        /// <param name="jsonSerializerOptions"></param>
        ...
        public void WriteProperties(Utf8JsonWriter writer, OHLCVTimeSeriesTimeseriesPeriod oHLCVTimeSeriesTimeseriesPeriod, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (oHLCVTimeSeriesTimeseriesPeriod.LengthSecondsOption.IsSet)
                writer.WriteNumber("length_seconds", oHLCVTimeSeriesTimeseriesPeriod.LengthSecondsOption.Value!.Value);

            if (oHLCVTimeSeriesTimeseriesPeriod.LengthMonthsOption.IsSet)
                writer.WriteNumber("length_months", oHLCVTimeSeriesTimeseriesPeriod.LengthMonthsOption.Value!.Value);

            if (oHLCVTimeSeriesTimeseriesPeriod.UnitCountOption.IsSet)
                if (oHLCVTimeSeriesTimeseriesPeriod.UnitCountOption.Value != null)
                    writer.WriteNumber("unit_count", oHLCVTimeSeriesTimeseriesPeriod.UnitCountOption.Value!.Value);
                else
                    writer.WriteNull("unit_count");

            if (oHLCVTimeSeriesTimeseriesPeriod.UnitNameOption.IsSet)
                if (oHLCVTimeSeriesTimeseriesPeriod.UnitNameOption.Value != null)
                    writer.WriteString("unit_name", oHLCVTimeSeriesTimeseriesPeriod.UnitName);
                else
                    writer.WriteNull("unit_name");

            if (oHLCVTimeSeriesTimeseriesPeriod.DisplayNameOption.IsSet)
                if (oHLCVTimeSeriesTimeseriesPeriod.DisplayNameOption.Value != null)
                    writer.WriteString("display_name", oHLCVTimeSeriesTimeseriesPeriod.DisplayName);
                else
