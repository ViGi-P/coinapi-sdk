...
namespace APIBricks.FinFeedAPI.STOCKAPI.REST.V1.Model
{
    ...
    /// </summary>
    public partial class ModelsExecutedOrderModel : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ModelsExecutedOrderModel" /> class.
        /// </summary>
        ...
        public int? SaleConditionFlags { get { return this.SaleConditionFlagsOption.Value; } set { this.SaleConditionFlagsOption = new(value); } }
        ...
        public bool? IsIntermarketSweep { get { return this.IsIntermarketSweepOption.Value; } set { this.IsIntermarketSweepOption = new(value); } }
        ...
        public bool? IsExtendedHoursTrade { get { return this.IsExtendedHoursTradeOption.Value; } set { this.IsExtendedHoursTradeOption = new(value); } }
        ...
        public bool? IsOddLotTrade { get { return this.IsOddLotTradeOption.Value; } set { this.IsOddLotTradeOption = new(value); } }
        ...
        public bool? IsTradeThroughExempt { get { return this.IsTradeThroughExemptOption.Value; } set { this.IsTradeThroughExemptOption = new(value); } }
        ...
        public bool? IsSinglePriceCrossTrade { get { return this.IsSinglePriceCrossTradeOption.Value; } set { this.IsSinglePriceCrossTradeOption = new(value); } }
        ...
        public long? TradeId { get { return this.TradeIdOption.Value; } set { this.TradeIdOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="ModelsExecutedOrderModel" />
    /// </summary>
    public partial class ModelsExecutedOrderModelJsonConverter : JsonConverter<ModelsExecutedOrderModel>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="ModelsExecutedOrderModelJsonConverter" /> class.
        /// </summary>
        public ModelsExecutedOrderModelJsonConverter()
        {
            OnCreated();
        }
        ...
        /// <summary>
        /// Deserializes json to <see cref="ModelsExecutedOrderModel" />
        /// </summary>
        ...
        public override ModelsExecutedOrderModel Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
        ...
        /// <summary>
        /// Serializes a <see cref="ModelsExecutedOrderModel" />
        /// </summary>
        ...
        public override void Write(Utf8JsonWriter writer, ModelsExecutedOrderModel modelsExecutedOrderModel, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, modelsExecutedOrderModel, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ModelsExecutedOrderModel" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="modelsExecutedOrderModel"></param>
        /// <param name="jsonSerializerOptions"></param>
        ...
        public void WriteProperties(Utf8JsonWriter writer, ModelsExecutedOrderModel modelsExecutedOrderModel, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (modelsExecutedOrderModel.TimestampNanosOption.IsSet)
                writer.WriteNumber("timestamp_nanos", modelsExecutedOrderModel.TimestampNanosOption.Value!.Value);

            if (modelsExecutedOrderModel.TimestampOption.IsSet)
                writer.WriteString("timestamp", modelsExecutedOrderModel.TimestampOption.Value!.Value.ToString(TimestampFormat));

            if (modelsExecutedOrderModel.OrderIdReferenceOption.IsSet)
                writer.WriteNumber("order_id_reference", modelsExecutedOrderModel.OrderIdReferenceOption.Value!.Value);

            if (modelsExecutedOrderModel.SaleConditionFlagsOption.IsSet)
                writer.WriteNumber("sale_condition_flags", modelsExecutedOrderModel.SaleConditionFlagsOption.Value!.Value);

            if (modelsExecutedOrderModel.IsIntermarketSweepOption.IsSet)
                writer.WriteBoolean("is_intermarket_sweep", modelsExecutedOrderModel.IsIntermarketSweepOption.Value!.Value);

            if (modelsExecutedOrderModel.IsExtendedHoursTradeOption.IsSet)
                writer.WriteBoolean("is_extended_hours_trade", modelsExecutedOrderModel.IsExtendedHoursTradeOption.Value!.Value);

            if (modelsExecutedOrderModel.IsOddLotTradeOption.IsSet)
                writer.WriteBoolean("is_odd_lot_trade", modelsExecutedOrderModel.IsOddLotTradeOption.Value!.Value);

            if (modelsExecutedOrderModel.IsTradeThroughExemptOption.IsSet)
                writer.WriteBoolean("is_trade_through_exempt", modelsExecutedOrderModel.IsTradeThroughExemptOption.Value!.Value);

            if (modelsExecutedOrderModel.IsSinglePriceCrossTradeOption.IsSet)
                writer.WriteBoolean("is_single_price_cross_trade", modelsExecutedOrderModel.IsSinglePriceCrossTradeOption.Value!.Value);

            if (modelsExecutedOrderModel.SizeOption.IsSet)
                writer.WriteNumber("size", modelsExecutedOrderModel.SizeOption.Value!.Value);

            if (modelsExecutedOrderModel.PriceOption.IsSet)
                writer.WriteNumber("price", modelsExecutedOrderModel.PriceOption.Value!.Value);

            if (modelsExecutedOrderModel.TradeIdOption.IsSet)
                writer.WriteNumber("trade_id", modelsExecutedOrderModel.TradeIdOption.Value!.Value);
        }
    }
}
