...
namespace APIBricks.FinFeedAPI.STOCKAPI.REST.V1.Model
{
    ...
    /// </summary>
    public partial class ModelsOfficialPriceModel : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ModelsOfficialPriceModel" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public ModelsOfficialPriceModel(Option<string?> symbol = default, Option<long?> timestampNanos = default, Option<DateTime?> timestamp = default, Option<int?> priceType = default, Option<string?> priceTypeCode = default, Option<string?> priceTypeText = default, Option<bool?> isPriceTypeOpening = default, Option<bool?> isPriceTypeClosing = default, Option<double?> officialPrice = default)
        {
            SymbolOption = symbol;
        ...
        public int? PriceType { get { return this.PriceTypeOption.Value; } set { this.PriceTypeOption = new(value); } }
        ...
        public string? PriceTypeCode { get { return this.PriceTypeCodeOption.Value; } set { this.PriceTypeCodeOption = new(value); } }
        ...
        public string? PriceTypeText { get { return this.PriceTypeTextOption.Value; } set { this.PriceTypeTextOption = new(value); } }
        ...
        public bool? IsPriceTypeOpening { get { return this.IsPriceTypeOpeningOption.Value; } set { this.IsPriceTypeOpeningOption = new(value); } }
        ...
        public bool? IsPriceTypeClosing { get { return this.IsPriceTypeClosingOption.Value; } set { this.IsPriceTypeClosingOption = new(value); } }
        ...
        public double? OfficialPrice { get { return this.OfficialPriceOption.Value; } set { this.OfficialPriceOption = new(value); } }
    ...
    public class ModelsOfficialPriceModelJsonConverter : JsonConverter<ModelsOfficialPriceModel>
    {
        ...
        public override ModelsOfficialPriceModel Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
        ...
        /// <summary>
        /// Serializes a <see cref="ModelsOfficialPriceModel" />
        /// </summary>
        ...
        public override void Write(Utf8JsonWriter writer, ModelsOfficialPriceModel modelsOfficialPriceModel, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, modelsOfficialPriceModel, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ModelsOfficialPriceModel" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="modelsOfficialPriceModel"></param>
        /// <param name="jsonSerializerOptions"></param>
        ...
        public void WriteProperties(Utf8JsonWriter writer, ModelsOfficialPriceModel modelsOfficialPriceModel, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (modelsOfficialPriceModel.TimestampNanosOption.IsSet)
                writer.WriteNumber("timestamp_nanos", modelsOfficialPriceModel.TimestampNanosOption.Value!.Value);

            if (modelsOfficialPriceModel.TimestampOption.IsSet)
                writer.WriteString("timestamp", modelsOfficialPriceModel.TimestampOption.Value!.Value.ToString(TimestampFormat));

            if (modelsOfficialPriceModel.PriceTypeOption.IsSet)
                writer.WriteNumber("price_type", modelsOfficialPriceModel.PriceTypeOption.Value!.Value);

            if (modelsOfficialPriceModel.PriceTypeCodeOption.IsSet)
                if (modelsOfficialPriceModel.PriceTypeCodeOption.Value != null)
                    writer.WriteString("price_type_code", modelsOfficialPriceModel.PriceTypeCode);
                else
                    writer.WriteNull("price_type_code");

            if (modelsOfficialPriceModel.PriceTypeTextOption.IsSet)
                if (modelsOfficialPriceModel.PriceTypeTextOption.Value != null)
                    writer.WriteString("price_type_text", modelsOfficialPriceModel.PriceTypeText);
                else
                    writer.WriteNull("price_type_text");

            if (modelsOfficialPriceModel.IsPriceTypeOpeningOption.IsSet)
                writer.WriteBoolean("is_price_type_opening", modelsOfficialPriceModel.IsPriceTypeOpeningOption.Value!.Value);

            if (modelsOfficialPriceModel.IsPriceTypeClosingOption.IsSet)
                writer.WriteBoolean("is_price_type_closing", modelsOfficialPriceModel.IsPriceTypeClosingOption.Value!.Value);

            if (modelsOfficialPriceModel.OfficialPriceOption.IsSet)
                writer.WriteNumber("official_price", modelsOfficialPriceModel.OfficialPriceOption.Value!.Value);
        }
    }
}
