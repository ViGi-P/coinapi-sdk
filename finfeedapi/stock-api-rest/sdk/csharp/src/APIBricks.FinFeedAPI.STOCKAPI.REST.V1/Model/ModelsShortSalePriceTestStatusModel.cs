...
namespace APIBricks.FinFeedAPI.STOCKAPI.REST.V1.Model
{
    ...
    /// </summary>
    public partial class ModelsShortSalePriceTestStatusModel : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ModelsShortSalePriceTestStatusModel" /> class.
        /// </summary>
        ...
        public int? ShortSalePriceTestStatus { get { return this.ShortSalePriceTestStatusOption.Value; } set { this.ShortSalePriceTestStatusOption = new(value); } }
        ...
        public string? ShortSalePriceTestStatusCode { get { return this.ShortSalePriceTestStatusCodeOption.Value; } set { this.ShortSalePriceTestStatusCodeOption = new(value); } }
        ...
        public string? ShortSalePriceTestStatusText { get { return this.ShortSalePriceTestStatusTextOption.Value; } set { this.ShortSalePriceTestStatusTextOption = new(value); } }
        ...
        public bool? IsShortSalePriceTestNotInEffect { get { return this.IsShortSalePriceTestNotInEffectOption.Value; } set { this.IsShortSalePriceTestNotInEffectOption = new(value); } }
        ...
        public bool? IsShortSalePriceTestInEffect { get { return this.IsShortSalePriceTestInEffectOption.Value; } set { this.IsShortSalePriceTestInEffectOption = new(value); } }
        ...
        public int? Detail { get { return this.DetailOption.Value; } set { this.DetailOption = new(value); } }
        ...
        public string? DetailCode { get { return this.DetailCodeOption.Value; } set { this.DetailCodeOption = new(value); } }
        ...
        public string? DetailText { get { return this.DetailTextOption.Value; } set { this.DetailTextOption = new(value); } }
        ...
        public bool? IsDetailNoPriceTest { get { return this.IsDetailNoPriceTestOption.Value; } set { this.IsDetailNoPriceTestOption = new(value); } }
        ...
        public bool? IsDetailActivated { get { return this.IsDetailActivatedOption.Value; } set { this.IsDetailActivatedOption = new(value); } }
        ...
        public bool? IsDetailContinued { get { return this.IsDetailContinuedOption.Value; } set { this.IsDetailContinuedOption = new(value); } }
        ...
        public bool? IsDetailDeactivated { get { return this.IsDetailDeactivatedOption.Value; } set { this.IsDetailDeactivatedOption = new(value); } }
        ...
        public bool? IsDetailNotAvailable { get { return this.IsDetailNotAvailableOption.Value; } set { this.IsDetailNotAvailableOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="ModelsShortSalePriceTestStatusModel" />
    /// </summary>
    public partial class ModelsShortSalePriceTestStatusModelJsonConverter : JsonConverter<ModelsShortSalePriceTestStatusModel>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="ModelsShortSalePriceTestStatusModelJsonConverter" /> class.
        /// </summary>
        public ModelsShortSalePriceTestStatusModelJsonConverter()
        {
            OnCreated();
        }
        ...
        /// <summary>
        /// Deserializes json to <see cref="ModelsShortSalePriceTestStatusModel" />
        /// </summary>
        ...
        public override ModelsShortSalePriceTestStatusModel Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
        ...
        /// <summary>
        /// Serializes a <see cref="ModelsShortSalePriceTestStatusModel" />
        /// </summary>
        ...
        public override void Write(Utf8JsonWriter writer, ModelsShortSalePriceTestStatusModel modelsShortSalePriceTestStatusModel, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, modelsShortSalePriceTestStatusModel, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ModelsShortSalePriceTestStatusModel" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="modelsShortSalePriceTestStatusModel"></param>
        /// <param name="jsonSerializerOptions"></param>
        ...
        public void WriteProperties(Utf8JsonWriter writer, ModelsShortSalePriceTestStatusModel modelsShortSalePriceTestStatusModel, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (modelsShortSalePriceTestStatusModel.TimestampNanosOption.IsSet)
                writer.WriteNumber("timestamp_nanos", modelsShortSalePriceTestStatusModel.TimestampNanosOption.Value!.Value);

            if (modelsShortSalePriceTestStatusModel.TimestampOption.IsSet)
                writer.WriteString("timestamp", modelsShortSalePriceTestStatusModel.TimestampOption.Value!.Value.ToString(TimestampFormat));

            if (modelsShortSalePriceTestStatusModel.ShortSalePriceTestStatusOption.IsSet)
                writer.WriteNumber("short_sale_price_test_status", modelsShortSalePriceTestStatusModel.ShortSalePriceTestStatusOption.Value!.Value);

            if (modelsShortSalePriceTestStatusModel.ShortSalePriceTestStatusCodeOption.IsSet)
                if (modelsShortSalePriceTestStatusModel.ShortSalePriceTestStatusCodeOption.Value != null)
                    writer.WriteString("short_sale_price_test_status_code", modelsShortSalePriceTestStatusModel.ShortSalePriceTestStatusCode);
                else
                    writer.WriteNull("short_sale_price_test_status_code");

            if (modelsShortSalePriceTestStatusModel.ShortSalePriceTestStatusTextOption.IsSet)
                if (modelsShortSalePriceTestStatusModel.ShortSalePriceTestStatusTextOption.Value != null)
                    writer.WriteString("short_sale_price_test_status_text", modelsShortSalePriceTestStatusModel.ShortSalePriceTestStatusText);
                else
                    writer.WriteNull("short_sale_price_test_status_text");

            if (modelsShortSalePriceTestStatusModel.IsShortSalePriceTestNotInEffectOption.IsSet)
                writer.WriteBoolean("is_short_sale_price_test_not_in_effect", modelsShortSalePriceTestStatusModel.IsShortSalePriceTestNotInEffectOption.Value!.Value);

            if (modelsShortSalePriceTestStatusModel.IsShortSalePriceTestInEffectOption.IsSet)
                writer.WriteBoolean("is_short_sale_price_test_in_effect", modelsShortSalePriceTestStatusModel.IsShortSalePriceTestInEffectOption.Value!.Value);

            if (modelsShortSalePriceTestStatusModel.DetailOption.IsSet)
                writer.WriteNumber("detail", modelsShortSalePriceTestStatusModel.DetailOption.Value!.Value);

            if (modelsShortSalePriceTestStatusModel.DetailCodeOption.IsSet)
                if (modelsShortSalePriceTestStatusModel.DetailCodeOption.Value != null)
                    writer.WriteString("detail_code", modelsShortSalePriceTestStatusModel.DetailCode);
                else
                    writer.WriteNull("detail_code");

            if (modelsShortSalePriceTestStatusModel.DetailTextOption.IsSet)
                if (modelsShortSalePriceTestStatusModel.DetailTextOption.Value != null)
                    writer.WriteString("detail_text", modelsShortSalePriceTestStatusModel.DetailText);
                else
                    writer.WriteNull("detail_text");

            if (modelsShortSalePriceTestStatusModel.IsDetailNoPriceTestOption.IsSet)
                writer.WriteBoolean("is_detail_no_price_test", modelsShortSalePriceTestStatusModel.IsDetailNoPriceTestOption.Value!.Value);

            if (modelsShortSalePriceTestStatusModel.IsDetailActivatedOption.IsSet)
                writer.WriteBoolean("is_detail_activated", modelsShortSalePriceTestStatusModel.IsDetailActivatedOption.Value!.Value);

            if (modelsShortSalePriceTestStatusModel.IsDetailContinuedOption.IsSet)
                writer.WriteBoolean("is_detail_continued", modelsShortSalePriceTestStatusModel.IsDetailContinuedOption.Value!.Value);

            if (modelsShortSalePriceTestStatusModel.IsDetailDeactivatedOption.IsSet)
                writer.WriteBoolean("is_detail_deactivated", modelsShortSalePriceTestStatusModel.IsDetailDeactivatedOption.Value!.Value);

            if (modelsShortSalePriceTestStatusModel.IsDetailNotAvailableOption.IsSet)
                writer.WriteBoolean("is_detail_not_available", modelsShortSalePriceTestStatusModel.IsDetailNotAvailableOption.Value!.Value);
        }
    }
}
