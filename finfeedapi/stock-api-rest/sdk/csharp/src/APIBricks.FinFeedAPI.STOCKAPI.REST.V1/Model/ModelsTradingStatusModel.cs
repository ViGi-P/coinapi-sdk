...
namespace APIBricks.FinFeedAPI.STOCKAPI.REST.V1.Model
{
    ...
    /// </summary>
    public partial class ModelsTradingStatusModel : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ModelsTradingStatusModel" /> class.
        /// </summary>
        ...
        public bool? IsTradingLive { get { return this.IsTradingLiveOption.Value; } set { this.IsTradingLiveOption = new(value); } }
        ...
        public bool? IsTradingHalted { get { return this.IsTradingHaltedOption.Value; } set { this.IsTradingHaltedOption = new(value); } }
        ...
        public bool? IsTradingInOrderAcceptancePeriod { get { return this.IsTradingInOrderAcceptancePeriodOption.Value; } set { this.IsTradingInOrderAcceptancePeriodOption = new(value); } }
        ...
        public bool? IsTradingPaused { get { return this.IsTradingPausedOption.Value; } set { this.IsTradingPausedOption = new(value); } }
        ...
        public bool? IsReasonHaltNewsPending { get { return this.IsReasonHaltNewsPendingOption.Value; } set { this.IsReasonHaltNewsPendingOption = new(value); } }
        ...
        public bool? IsReasonIpoNotYetTrading { get { return this.IsReasonIpoNotYetTradingOption.Value; } set { this.IsReasonIpoNotYetTradingOption = new(value); } }
        ...
        public bool? IsReasonIpoDeferred { get { return this.IsReasonIpoDeferredOption.Value; } set { this.IsReasonIpoDeferredOption = new(value); } }
        ...
        public bool? IsReasonHaltNewsDissemination { get { return this.IsReasonHaltNewsDisseminationOption.Value; } set { this.IsReasonHaltNewsDisseminationOption = new(value); } }
        ...
        public bool? IsReasonIpoOrderAcceptancePeriod { get { return this.IsReasonIpoOrderAcceptancePeriodOption.Value; } set { this.IsReasonIpoOrderAcceptancePeriodOption = new(value); } }
        ...
        public bool? IsReasonIpoPreLaunchPeriod { get { return this.IsReasonIpoPreLaunchPeriodOption.Value; } set { this.IsReasonIpoPreLaunchPeriodOption = new(value); } }
        ...
        public bool? IsReasonMarketWideCircuitBreakerLevel1 { get { return this.IsReasonMarketWideCircuitBreakerLevel1Option.Value; } set { this.IsReasonMarketWideCircuitBreakerLevel1Option = new(value); } }
        ...
        public bool? IsReasonMarketWideCircuitBreakerLevel2 { get { return this.IsReasonMarketWideCircuitBreakerLevel2Option.Value; } set { this.IsReasonMarketWideCircuitBreakerLevel2Option = new(value); } }
        ...
        public bool? IsReasonMarketWideCircuitBreakerLevel3 { get { return this.IsReasonMarketWideCircuitBreakerLevel3Option.Value; } set { this.IsReasonMarketWideCircuitBreakerLevel3Option = new(value); } }
        ...
        public bool? IsReasonNotApplicable { get { return this.IsReasonNotApplicableOption.Value; } set { this.IsReasonNotApplicableOption = new(value); } }
        ...
        public bool? IsReasonNotAvailable { get { return this.IsReasonNotAvailableOption.Value; } set { this.IsReasonNotAvailableOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="ModelsTradingStatusModel" />
    /// </summary>
    public partial class ModelsTradingStatusModelJsonConverter : JsonConverter<ModelsTradingStatusModel>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="ModelsTradingStatusModelJsonConverter" /> class.
        /// </summary>
        public ModelsTradingStatusModelJsonConverter()
        {
            OnCreated();
        }
        ...
        /// <summary>
        /// Deserializes json to <see cref="ModelsTradingStatusModel" />
        /// </summary>
        ...
        public override ModelsTradingStatusModel Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
        ...
        /// <summary>
        /// Serializes a <see cref="ModelsTradingStatusModel" />
        /// </summary>
        ...
        public override void Write(Utf8JsonWriter writer, ModelsTradingStatusModel modelsTradingStatusModel, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, modelsTradingStatusModel, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ModelsTradingStatusModel" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="modelsTradingStatusModel"></param>
        /// <param name="jsonSerializerOptions"></param>
        ...
        public void WriteProperties(Utf8JsonWriter writer, ModelsTradingStatusModel modelsTradingStatusModel, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (modelsTradingStatusModel.TimestampNanosOption.IsSet)
                writer.WriteNumber("timestamp_nanos", modelsTradingStatusModel.TimestampNanosOption.Value!.Value);

            if (modelsTradingStatusModel.TimestampOption.IsSet)
                writer.WriteString("timestamp", modelsTradingStatusModel.TimestampOption.Value!.Value.ToString(TimestampFormat));

            if (modelsTradingStatusModel.IsTradingLiveOption.IsSet)
                writer.WriteBoolean("is_trading_live", modelsTradingStatusModel.IsTradingLiveOption.Value!.Value);

            if (modelsTradingStatusModel.IsTradingHaltedOption.IsSet)
                writer.WriteBoolean("is_trading_halted", modelsTradingStatusModel.IsTradingHaltedOption.Value!.Value);

            if (modelsTradingStatusModel.IsTradingInOrderAcceptancePeriodOption.IsSet)
                writer.WriteBoolean("is_trading_in_order_acceptance_period", modelsTradingStatusModel.IsTradingInOrderAcceptancePeriodOption.Value!.Value);

            if (modelsTradingStatusModel.IsTradingPausedOption.IsSet)
                writer.WriteBoolean("is_trading_paused", modelsTradingStatusModel.IsTradingPausedOption.Value!.Value);

            if (modelsTradingStatusModel.IsReasonHaltNewsPendingOption.IsSet)
                writer.WriteBoolean("is_reason_halt_news_pending", modelsTradingStatusModel.IsReasonHaltNewsPendingOption.Value!.Value);

            if (modelsTradingStatusModel.IsReasonIpoNotYetTradingOption.IsSet)
                writer.WriteBoolean("is_reason_ipo_not_yet_trading", modelsTradingStatusModel.IsReasonIpoNotYetTradingOption.Value!.Value);

            if (modelsTradingStatusModel.IsReasonIpoDeferredOption.IsSet)
                writer.WriteBoolean("is_reason_ipo_deferred", modelsTradingStatusModel.IsReasonIpoDeferredOption.Value!.Value);

            if (modelsTradingStatusModel.IsReasonHaltNewsDisseminationOption.IsSet)
                writer.WriteBoolean("is_reason_halt_news_dissemination", modelsTradingStatusModel.IsReasonHaltNewsDisseminationOption.Value!.Value);

            if (modelsTradingStatusModel.IsReasonIpoOrderAcceptancePeriodOption.IsSet)
                writer.WriteBoolean("is_reason_ipo_order_acceptance_period", modelsTradingStatusModel.IsReasonIpoOrderAcceptancePeriodOption.Value!.Value);

            if (modelsTradingStatusModel.IsReasonIpoPreLaunchPeriodOption.IsSet)
                writer.WriteBoolean("is_reason_ipo_pre_launch_period", modelsTradingStatusModel.IsReasonIpoPreLaunchPeriodOption.Value!.Value);

            if (modelsTradingStatusModel.IsReasonMarketWideCircuitBreakerLevel1Option.IsSet)
                writer.WriteBoolean("is_reason_market_wide_circuit_breaker_level1", modelsTradingStatusModel.IsReasonMarketWideCircuitBreakerLevel1Option.Value!.Value);

            if (modelsTradingStatusModel.IsReasonMarketWideCircuitBreakerLevel2Option.IsSet)
                writer.WriteBoolean("is_reason_market_wide_circuit_breaker_level2", modelsTradingStatusModel.IsReasonMarketWideCircuitBreakerLevel2Option.Value!.Value);

            if (modelsTradingStatusModel.IsReasonMarketWideCircuitBreakerLevel3Option.IsSet)
                writer.WriteBoolean("is_reason_market_wide_circuit_breaker_level3", modelsTradingStatusModel.IsReasonMarketWideCircuitBreakerLevel3Option.Value!.Value);

            if (modelsTradingStatusModel.IsReasonNotApplicableOption.IsSet)
                writer.WriteBoolean("is_reason_not_applicable", modelsTradingStatusModel.IsReasonNotApplicableOption.Value!.Value);

            if (modelsTradingStatusModel.IsReasonNotAvailableOption.IsSet)
                writer.WriteBoolean("is_reason_not_available", modelsTradingStatusModel.IsReasonNotAvailableOption.Value!.Value);
        }
    }
}
