...
import 'package:openapi/src/api/native_iex_api.dart';
import 'package:openapi/src/api/ohlcv_api.dart';

class Openapi {
  static const String basePath = r'https://api-historical.stock.finfeedapi.com';
  ...
  /// Get NativeIEXApi instance, base route and serializer can be overridden by a given but be careful,
  /// by doing that all interceptors will not be executed
  NativeIEXApi getNativeIEXApi() {
    return NativeIEXApi(dio, serializers);
  }
