...
part 'ohlcv_time_series_exchange_timeseries_item.g.dart';
...
/// * [symbolIdExchange] 
@BuiltValue()
abstract class OHLCVTimeSeriesExchangeTimeseriesItem implements Built<OHLCVTimeSeriesExchangeTimeseriesItem, OHLCVTimeSeriesExchangeTimeseriesItemBuilder> {
  ...
  OHLCVTimeSeriesExchangeTimeseriesItem._();

  factory OHLCVTimeSeriesExchangeTimeseriesItem([void updates(OHLCVTimeSeriesExchangeTimeseriesItemBuilder b)]) = _$OHLCVTimeSeriesExchangeTimeseriesItem;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(OHLCVTimeSeriesExchangeTimeseriesItemBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<OHLCVTimeSeriesExchangeTimeseriesItem> get serializer => _$OHLCVTimeSeriesExchangeTimeseriesItemSerializer();
}

class _$OHLCVTimeSeriesExchangeTimeseriesItemSerializer implements PrimitiveSerializer<OHLCVTimeSeriesExchangeTimeseriesItem> {
  @override
  final Iterable<Type> types = const [OHLCVTimeSeriesExchangeTimeseriesItem, _$OHLCVTimeSeriesExchangeTimeseriesItem];

  @override
  final String wireName = r'OHLCVTimeSeriesExchangeTimeseriesItem';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    OHLCVTimeSeriesExchangeTimeseriesItem object, {
  ...
  void _deserializeProperties(
    ...
    required OHLCVTimeSeriesExchangeTimeseriesItemBuilder result,
  ...
  @override
  OHLCVTimeSeriesExchangeTimeseriesItem deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = OHLCVTimeSeriesExchangeTimeseriesItemBuilder();
