...
class OhlcvApi {
  ...
  Future<Response<BuiltList<OHLCVTimeSeriesExchangeTimeseriesItem>>> v1OhlcvExchangeExchangeIdHistoryGet({ 
    ...
    final _path = r'/v1/ohlcv/exchange/{exchange_id}/history'.replaceAll('{' r'exchange_id' '}', encodeQueryParameter(_serializers, exchangeId, const FullType(String)).toString());
  ...
  Future<Response<BuiltList<OHLCVTimeSeriesTimeseriesItem>>> v1OhlcvExchangeSymbolExchangeIdSymbolIdHistoryGet({ 
    ...
    final _path = r'/v1/ohlcv/exchange-symbol/{exchange_id}/{symbol_id}/history'.replaceAll('{' r'exchange_id' '}', encodeQueryParameter(_serializers, exchangeId, const FullType(String)).toString()).replaceAll('{' r'symbol_id' '}', encodeQueryParameter(_serializers, symbolId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<BuiltList<OHLCVTimeSeriesTimeseriesItem>>> v1OhlcvExchangeSymbolExchangeIdSymbolIdLatestGet({ 
    ...
    final _path = r'/v1/ohlcv/exchange-symbol/{exchange_id}/{symbol_id}/latest'.replaceAll('{' r'exchange_id' '}', encodeQueryParameter(_serializers, exchangeId, const FullType(String)).toString()).replaceAll('{' r'symbol_id' '}', encodeQueryParameter(_serializers, symbolId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
