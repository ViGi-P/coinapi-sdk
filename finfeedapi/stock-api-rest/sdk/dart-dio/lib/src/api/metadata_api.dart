...
class MetadataApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<FinFeedAPIExchangeModel>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<FinFeedAPIExchangeModel>>> v1ExchangesGet({ 
    ...
    BuiltList<FinFeedAPIExchangeModel>? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BuiltList, [FullType(FinFeedAPIExchangeModel)]),
      ) as BuiltList<FinFeedAPIExchangeModel>;
    ...
    return Response<BuiltList<FinFeedAPIExchangeModel>>(
      data: _responseData,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<FinFeedAPISymbolModel>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<FinFeedAPISymbolModel>>> v1SymbolsExchangeIdGet({ 
    ...
    BuiltList<FinFeedAPISymbolModel>? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BuiltList, [FullType(FinFeedAPISymbolModel)]),
      ) as BuiltList<FinFeedAPISymbolModel>;
    ...
    return Response<BuiltList<FinFeedAPISymbolModel>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
