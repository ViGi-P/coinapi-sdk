...
// tests for ModelsModifyOrderModel
void main() {
  final instance = ModelsModifyOrderModelBuilder();
  // TODO add properties to the builder and call build()

  group(ModelsModifyOrderModel, () {
    // The stock symbol
    // String symbol
    ...
    test('to test the property `isPriorityReset`', () async {
      // TODO
    });
