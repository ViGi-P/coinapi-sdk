...
// tests for IEXPriceLevelUpdatePriceLevelUpdateModel
void main() {
  final instance = IEXPriceLevelUpdatePriceLevelUpdateModelBuilder();
  // TODO add properties to the builder and call build()

  group(IEXPriceLevelUpdatePriceLevelUpdateModel, () {
    // The stock symbol
    // String symbol
