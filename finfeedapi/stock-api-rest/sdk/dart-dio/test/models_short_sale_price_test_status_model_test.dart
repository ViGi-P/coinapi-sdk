...
// tests for ModelsShortSalePriceTestStatusModel
void main() {
  final instance = ModelsShortSalePriceTestStatusModelBuilder();
  // TODO add properties to the builder and call build()

  group(ModelsShortSalePriceTestStatusModel, () {
    // The stock symbol
    // String symbol
