...
> BuiltList<FinFeedAPISymbolModel> v1SymbolsExchangeIdGet(exchangeId, filterSymbolId, limit, page)
...
final int limit = 56; // int | Maximum number of symbols to return (1-10000, default 100)
final int page = 56; // int | Page number (1-based, default 1)

try {
    final response = api.v1SymbolsExchangeIdGet(exchangeId, filterSymbolId, limit, page);
    print(response);
} on DioException catch (e) {
