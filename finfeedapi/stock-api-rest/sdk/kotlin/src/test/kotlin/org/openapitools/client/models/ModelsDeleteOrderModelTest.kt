...
class ModelsDeleteOrderModelTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of ModelsDeleteOrderModel
        //val modelInstance = ModelsDeleteOrderModel()
        ...
        // to test the property `timestamp` - Time when the order was deleted as DateTime
