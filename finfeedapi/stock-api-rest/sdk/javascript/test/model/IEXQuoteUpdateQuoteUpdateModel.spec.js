...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FinFeedApiStockRestApi.IEXQuoteUpdateQuoteUpdateModel();
  });
  ...
  describe('IEXQuoteUpdateQuoteUpdateModel', function() {
    it('should create an instance of IEXQuoteUpdateQuoteUpdateModel', function() {
      // uncomment below and update the code to test IEXQuoteUpdateQuoteUpdateModel
      //var instance = new FinFeedApiStockRestApi.IEXQuoteUpdateQuoteUpdateModel();
      //expect(instance).to.be.a(FinFeedApiStockRestApi.IEXQuoteUpdateQuoteUpdateModel);
    });
