...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FinFeedApiStockRestApi.OHLCVTimeSeriesTimeseriesPeriod();
  });
  ...
  describe('OHLCVTimeSeriesTimeseriesPeriod', function() {
    it('should create an instance of OHLCVTimeSeriesTimeseriesPeriod', function() {
      // uncomment below and update the code to test OHLCVTimeSeriesTimeseriesPeriod
      //var instance = new FinFeedApiStockRestApi.OHLCVTimeSeriesTimeseriesPeriod();
      //expect(instance).to.be.a(FinFeedApiStockRestApi.OHLCVTimeSeriesTimeseriesPeriod);
    });
