...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FinFeedApiStockRestApi.ModelsSecurityDirectoryModel();
  });
  ...
  describe('ModelsSecurityDirectoryModel', function() {
    it('should create an instance of ModelsSecurityDirectoryModel', function() {
      // uncomment below and update the code to test ModelsSecurityDirectoryModel
      //var instance = new FinFeedApiStockRestApi.ModelsSecurityDirectoryModel();
      //expect(instance).to.be.a(FinFeedApiStockRestApi.ModelsSecurityDirectoryModel);
    });
