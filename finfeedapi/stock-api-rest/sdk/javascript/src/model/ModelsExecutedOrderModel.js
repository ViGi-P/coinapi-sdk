...
/**
 * The ModelsExecutedOrderModel model module.
 * @module model/ModelsExecutedOrderModel
 * @version v1
 */
class ModelsExecutedOrderModel {
    /**
     * Constructs a new <code>ModelsExecutedOrderModel</code>.
     * Represents the response DTO for order executed information
     * @alias module:model/ModelsExecutedOrderModel
     */
    constructor() { 
        
        ModelsExecutedOrderModel.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ModelsExecutedOrderModel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ModelsExecutedOrderModel} obj Optional instance to populate.
     * @return {module:model/ModelsExecutedOrderModel} The populated <code>ModelsExecutedOrderModel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ModelsExecutedOrderModel();
    ...
    /**
     * Validates the JSON data with respect to <code>ModelsExecutedOrderModel</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ModelsExecutedOrderModel</code>.
     */
 ...
 */
ModelsExecutedOrderModel.prototype['symbol'] = undefined;

/**
 * Original timestamp in nanoseconds since epoch
 * @member {Number} timestamp_nanos
 */
ModelsExecutedOrderModel.prototype['timestamp_nanos'] = undefined;

/**
 * Time when the order was executed as DateTime
 * @member {Date} timestamp
 */
ModelsExecutedOrderModel.prototype['timestamp'] = undefined;

/**
 * Order identifier reference
 * @member {Number} order_id_reference
 */
ModelsExecutedOrderModel.prototype['order_id_reference'] = undefined;

/**
 * Sale condition flags for the execution as byte value
 * @member {Number} sale_condition_flags
 */
ModelsExecutedOrderModel.prototype['sale_condition_flags'] = undefined;
 ...
 */
ModelsExecutedOrderModel.prototype['is_intermarket_sweep'] = undefined;
 ...
 */
ModelsExecutedOrderModel.prototype['is_extended_hours_trade'] = undefined;

/**
 * Bit 5 (Mask 0x20): Odd Lot Flag True: Odd Lot Trade False: Round or Mixed Lot Trade
 * @member {Boolean} is_odd_lot_trade
 */
ModelsExecutedOrderModel.prototype['is_odd_lot_trade'] = undefined;
 ...
 */
ModelsExecutedOrderModel.prototype['is_trade_through_exempt'] = undefined;
 ...
 */
ModelsExecutedOrderModel.prototype['is_single_price_cross_trade'] = undefined;

/**
 * Trade volume in number of shares
 * @member {Number} size
 */
ModelsExecutedOrderModel.prototype['size'] = undefined;

/**
 * Execution price as decimal
 * @member {Number} price
 */
ModelsExecutedOrderModel.prototype['price'] = undefined;

/**
 * IEX trade identifier
 * @member {Number} trade_id
 */
ModelsExecutedOrderModel.prototype['trade_id'] = undefined;
...
export default ModelsExecutedOrderModel;
