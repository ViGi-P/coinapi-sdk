...
/**
 * The ModelsShortSalePriceTestStatusModel model module.
 * @module model/ModelsShortSalePriceTestStatusModel
 * @version v1
 */
class ModelsShortSalePriceTestStatusModel {
    /**
     * Constructs a new <code>ModelsShortSalePriceTestStatusModel</code>.
     * Represents the response DTO for short sale price test status information
     * @alias module:model/ModelsShortSalePriceTestStatusModel
     */
    constructor() { 
        
        ModelsShortSalePriceTestStatusModel.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ModelsShortSalePriceTestStatusModel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ModelsShortSalePriceTestStatusModel} obj Optional instance to populate.
     * @return {module:model/ModelsShortSalePriceTestStatusModel} The populated <code>ModelsShortSalePriceTestStatusModel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ModelsShortSalePriceTestStatusModel();
    ...
    /**
     * Validates the JSON data with respect to <code>ModelsShortSalePriceTestStatusModel</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ModelsShortSalePriceTestStatusModel</code>.
     */
 ...
 */
ModelsShortSalePriceTestStatusModel.prototype['symbol'] = undefined;

/**
 * Original timestamp in nanoseconds since epoch
 * @member {Number} timestamp_nanos
 */
ModelsShortSalePriceTestStatusModel.prototype['timestamp_nanos'] = undefined;

/**
 * Time when the short sale price test status was recorded as DateTime
 * @member {Date} timestamp
 */
ModelsShortSalePriceTestStatusModel.prototype['timestamp'] = undefined;

/**
 * Short sale price test status as byte value
 * @member {Number} short_sale_price_test_status
 */
ModelsShortSalePriceTestStatusModel.prototype['short_sale_price_test_status'] = undefined;

/**
 * Short sale price test status as hex string
 * @member {String} short_sale_price_test_status_code
 */
ModelsShortSalePriceTestStatusModel.prototype['short_sale_price_test_status_code'] = undefined;

/**
 * Human-readable description of the short sale price test status
 * @member {String} short_sale_price_test_status_text
 */
ModelsShortSalePriceTestStatusModel.prototype['short_sale_price_test_status_text'] = undefined;

/**
 * Indicates if the short sale price test is not in effect
 * @member {Boolean} is_short_sale_price_test_not_in_effect
 */
ModelsShortSalePriceTestStatusModel.prototype['is_short_sale_price_test_not_in_effect'] = undefined;

/**
 * Indicates if the short sale price test is in effect
 * @member {Boolean} is_short_sale_price_test_in_effect
 */
ModelsShortSalePriceTestStatusModel.prototype['is_short_sale_price_test_in_effect'] = undefined;

/**
 * Detail of the short sale price test as byte value
 * @member {Number} detail
 */
ModelsShortSalePriceTestStatusModel.prototype['detail'] = undefined;

/**
 * Detail of the short sale price test as character string
 * @member {String} detail_code
 */
ModelsShortSalePriceTestStatusModel.prototype['detail_code'] = undefined;

/**
 * Human-readable description of the short sale price test detail
 * @member {String} detail_text
 */
ModelsShortSalePriceTestStatusModel.prototype['detail_text'] = undefined;

/**
 * Indicates if there is no price test in place
 * @member {Boolean} is_detail_no_price_test
 */
ModelsShortSalePriceTestStatusModel.prototype['is_detail_no_price_test'] = undefined;
 ...
 */
ModelsShortSalePriceTestStatusModel.prototype['is_detail_activated'] = undefined;

/**
 * Indicates if the short sale price test restriction remains in effect from prior day
 * @member {Boolean} is_detail_continued
 */
ModelsShortSalePriceTestStatusModel.prototype['is_detail_continued'] = undefined;

/**
 * Indicates if the short sale price test restriction is deactivated
 * @member {Boolean} is_detail_deactivated
 */
ModelsShortSalePriceTestStatusModel.prototype['is_detail_deactivated'] = undefined;

/**
 * Indicates if the detail is not available
 * @member {Boolean} is_detail_not_available
 */
ModelsShortSalePriceTestStatusModel.prototype['is_detail_not_available'] = undefined;
...
export default ModelsShortSalePriceTestStatusModel;
