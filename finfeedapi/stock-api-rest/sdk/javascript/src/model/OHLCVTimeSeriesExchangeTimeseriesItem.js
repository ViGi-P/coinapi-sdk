...
/**
 * The OHLCVTimeSeriesExchangeTimeseriesItem model module.
 * @module model/OHLCVTimeSeriesExchangeTimeseriesItem
 * @version v1
 */
class OHLCVTimeSeriesExchangeTimeseriesItem {
    /**
     * Constructs a new <code>OHLCVTimeSeriesExchangeTimeseriesItem</code>.
     * Represents a timeseries item with price and volume information.
     * @alias module:model/OHLCVTimeSeriesExchangeTimeseriesItem
     */
    constructor() { 
        
        OHLCVTimeSeriesExchangeTimeseriesItem.initialize(this);
    }
    ...
    /**
     * Constructs a <code>OHLCVTimeSeriesExchangeTimeseriesItem</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OHLCVTimeSeriesExchangeTimeseriesItem} obj Optional instance to populate.
     * @return {module:model/OHLCVTimeSeriesExchangeTimeseriesItem} The populated <code>OHLCVTimeSeriesExchangeTimeseriesItem</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OHLCVTimeSeriesExchangeTimeseriesItem();
    ...
    /**
     * Validates the JSON data with respect to <code>OHLCVTimeSeriesExchangeTimeseriesItem</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OHLCVTimeSeriesExchangeTimeseriesItem</code>.
     */
 ...
 */
OHLCVTimeSeriesExchangeTimeseriesItem.prototype['time_period_start'] = undefined;

/**
 * Gets or sets the end time of the time period.
 * @member {Date} time_period_end
 */
OHLCVTimeSeriesExchangeTimeseriesItem.prototype['time_period_end'] = undefined;

/**
 * Gets or sets the time when the price opened.
 * @member {Date} time_open
 */
OHLCVTimeSeriesExchangeTimeseriesItem.prototype['time_open'] = undefined;

/**
 * Gets or sets the time when the price closed.
 * @member {Date} time_close
 */
OHLCVTimeSeriesExchangeTimeseriesItem.prototype['time_close'] = undefined;

/**
 * Gets or sets the opening price.
 * @member {Number} price_open
 */
OHLCVTimeSeriesExchangeTimeseriesItem.prototype['price_open'] = undefined;

/**
 * Gets or sets the highest price during the time period.
 * @member {Number} price_high
 */
OHLCVTimeSeriesExchangeTimeseriesItem.prototype['price_high'] = undefined;

/**
 * Gets or sets the lowest price during the time period.
 * @member {Number} price_low
 */
OHLCVTimeSeriesExchangeTimeseriesItem.prototype['price_low'] = undefined;

/**
 * Gets or sets the closing price.
 * @member {Number} price_close
 */
OHLCVTimeSeriesExchangeTimeseriesItem.prototype['price_close'] = undefined;

/**
 * Gets or sets the total volume traded during the time period.
 * @member {Number} volume_traded
 */
OHLCVTimeSeriesExchangeTimeseriesItem.prototype['volume_traded'] = undefined;

/**
 * Gets or sets the number of trades executed during the time period.
 * @member {Number} trades_count
 */
OHLCVTimeSeriesExchangeTimeseriesItem.prototype['trades_count'] = undefined;

/**
 * @member {String} symbol_id_exchange
 */
OHLCVTimeSeriesExchangeTimeseriesItem.prototype['symbol_id_exchange'] = undefined;
...
export default OHLCVTimeSeriesExchangeTimeseriesItem;
