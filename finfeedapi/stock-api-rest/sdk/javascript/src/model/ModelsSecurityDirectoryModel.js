...
/**
 * The ModelsSecurityDirectoryModel model module.
 * @module model/ModelsSecurityDirectoryModel
 * @version v1
 */
class ModelsSecurityDirectoryModel {
    /**
     * Constructs a new <code>ModelsSecurityDirectoryModel</code>.
     * Represents the response DTO for security directory information
     * @alias module:model/ModelsSecurityDirectoryModel
     */
    constructor() { 
        
        ModelsSecurityDirectoryModel.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ModelsSecurityDirectoryModel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ModelsSecurityDirectoryModel} obj Optional instance to populate.
     * @return {module:model/ModelsSecurityDirectoryModel} The populated <code>ModelsSecurityDirectoryModel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ModelsSecurityDirectoryModel();
    ...
    /**
     * Validates the JSON data with respect to <code>ModelsSecurityDirectoryModel</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ModelsSecurityDirectoryModel</code>.
     */
 ...
 */
ModelsSecurityDirectoryModel.prototype['symbol'] = undefined;

/**
 * Original timestamp in nanoseconds since epoch
 * @member {Number} timestamp_nanos
 */
ModelsSecurityDirectoryModel.prototype['timestamp_nanos'] = undefined;

/**
 * Time when the security directory information was recorded as DateTime
 * @member {Date} timestamp
 */
ModelsSecurityDirectoryModel.prototype['timestamp'] = undefined;

/**
 * Flags for the security
 * @member {Number} flags
 */
ModelsSecurityDirectoryModel.prototype['flags'] = undefined;

/**
 * Number of shares that represent a round lot
 * @member {Number} round_lot_size
 */
ModelsSecurityDirectoryModel.prototype['round_lot_size'] = undefined;

/**
 * Adjusted previous official closing price as decimal
 * @member {Number} adjusted_poc_price
 */
ModelsSecurityDirectoryModel.prototype['adjusted_poc_price'] = undefined;

/**
 * LULD tier as byte value
 * @member {Number} luld_tier
 */
ModelsSecurityDirectoryModel.prototype['luld_tier'] = undefined;

/**
 * LULD tier as numeric string
 * @member {String} luld_tier_code
 */
ModelsSecurityDirectoryModel.prototype['luld_tier_code'] = undefined;

/**
 * Human-readable description of the LULD tier
 * @member {String} luld_tier_text
 */
ModelsSecurityDirectoryModel.prototype['luld_tier_text'] = undefined;

/**
 * Indicates if LULD Tier is 'Not applicable' (0x0).
 * @member {Boolean} is_luld_tier_not_applicable
 */
ModelsSecurityDirectoryModel.prototype['is_luld_tier_not_applicable'] = undefined;

/**
 * Indicates if LULD Tier is 'Tier 1 NMS Stock' (0x1).
 * @member {Boolean} is_luld_tier1
 */
ModelsSecurityDirectoryModel.prototype['is_luld_tier1'] = undefined;

/**
 * Indicates if LULD Tier is 'Tier 2 NMS Stock' (0x2).
 * @member {Boolean} is_luld_tier2
 */
ModelsSecurityDirectoryModel.prototype['is_luld_tier2'] = undefined;
...
export default ModelsSecurityDirectoryModel;
