...
/**
 * The IEXTradeTradeModel model module.
 * @module model/IEXTradeTradeModel
 * @version v1
 */
class IEXTradeTradeModel {
    /**
     * Constructs a new <code>IEXTradeTradeModel</code>.
     * Represents the response DTO for a single trade event (report or break).
     * @alias module:model/IEXTradeTradeModel
     */
    constructor() { 
        
        IEXTradeTradeModel.initialize(this);
    }
    ...
    /**
     * Constructs a <code>IEXTradeTradeModel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IEXTradeTradeModel} obj Optional instance to populate.
     * @return {module:model/IEXTradeTradeModel} The populated <code>IEXTradeTradeModel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IEXTradeTradeModel();
    ...
    /**
     * Validates the JSON data with respect to <code>IEXTradeTradeModel</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IEXTradeTradeModel</code>.
     */
 ...
 */
IEXTradeTradeModel.prototype['is_trade_break'] = undefined;

/**
 * The stock symbol.
 * @member {String} symbol
 */
IEXTradeTradeModel.prototype['symbol'] = undefined;

/**
 * Original timestamp in nanoseconds since epoch.
 * @member {Number} timestamp_nanos
 */
IEXTradeTradeModel.prototype['timestamp_nanos'] = undefined;

/**
 * Time when the event was recorded as DateTime (UTC).
 * @member {Date} timestamp
 */
IEXTradeTradeModel.prototype['timestamp'] = undefined;

/**
 * Trade volume (or break volume) in number of shares.
 * @member {Number} size
 */
IEXTradeTradeModel.prototype['size'] = undefined;

/**
 * Trade price (or break price) as decimal.
 * @member {Number} price
 */
IEXTradeTradeModel.prototype['price'] = undefined;

/**
 * IEX trade identifier (same for report and its corresponding break).
 * @member {Number} trade_id
 */
IEXTradeTradeModel.prototype['trade_id'] = undefined;
 ...
 */
IEXTradeTradeModel.prototype['is_intermarket_sweep'] = undefined;
 ...
 */
IEXTradeTradeModel.prototype['is_extended_hours_trade'] = undefined;

/**
 * Bit 5 (Mask 0x20): Odd Lot Flag. True: Odd Lot Trade. False: Round or Mixed Lot Trade.
 * @member {Boolean} is_odd_lot_trade
 */
IEXTradeTradeModel.prototype['is_odd_lot_trade'] = undefined;
 ...
 */
IEXTradeTradeModel.prototype['is_trade_through_exempt'] = undefined;
 ...
 */
IEXTradeTradeModel.prototype['is_single_price_cross_trade'] = undefined;
...
export default IEXTradeTradeModel;
