...
/**
 * The IEXSystemEventSystemEventModel model module.
 * @module model/IEXSystemEventSystemEventModel
 * @version v1
 */
class IEXSystemEventSystemEventModel {
    /**
     * Constructs a new <code>IEXSystemEventSystemEventModel</code>.
     * Represents the response DTO for system event information
     * @alias module:model/IEXSystemEventSystemEventModel
     */
    constructor() { 
        
        IEXSystemEventSystemEventModel.initialize(this);
    }
    ...
    /**
     * Constructs a <code>IEXSystemEventSystemEventModel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IEXSystemEventSystemEventModel} obj Optional instance to populate.
     * @return {module:model/IEXSystemEventSystemEventModel} The populated <code>IEXSystemEventSystemEventModel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IEXSystemEventSystemEventModel();
    ...
    /**
     * Validates the JSON data with respect to <code>IEXSystemEventSystemEventModel</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IEXSystemEventSystemEventModel</code>.
     */
 ...
 */
IEXSystemEventSystemEventModel.prototype['timestamp_nanos'] = undefined;

/**
 * Time when the system event was recorded as DateTime
 * @member {Date} timestamp
 */
IEXSystemEventSystemEventModel.prototype['timestamp'] = undefined;

/**
 * System event as byte value
 * @member {Number} system_event
 */
IEXSystemEventSystemEventModel.prototype['system_event'] = undefined;

/**
 * System event as string
 * @member {String} system_event_code
 */
IEXSystemEventSystemEventModel.prototype['system_event_code'] = undefined;

/**
 * Human-readable description of the system event
 * @member {String} system_event_text
 */
IEXSystemEventSystemEventModel.prototype['system_event_text'] = undefined;
 ...
 */
IEXSystemEventSystemEventModel.prototype['is_system_event_start_of_messages'] = undefined;
 ...
 */
IEXSystemEventSystemEventModel.prototype['is_system_event_start_of_system_hours'] = undefined;
 ...
 */
IEXSystemEventSystemEventModel.prototype['is_system_event_start_of_regular_market_hours'] = undefined;
 ...
 */
IEXSystemEventSystemEventModel.prototype['is_system_event_end_of_regular_market_hours'] = undefined;
 ...
 */
IEXSystemEventSystemEventModel.prototype['is_system_event_end_of_system_hours'] = undefined;
 ...
 */
IEXSystemEventSystemEventModel.prototype['is_system_event_end_of_messages'] = undefined;
...
export default IEXSystemEventSystemEventModel;
