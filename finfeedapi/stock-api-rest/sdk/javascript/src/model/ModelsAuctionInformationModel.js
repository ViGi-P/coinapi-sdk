...
/**
 * The ModelsAuctionInformationModel model module.
 * @module model/ModelsAuctionInformationModel
 * @version v1
 */
class ModelsAuctionInformationModel {
    /**
     * Constructs a new <code>ModelsAuctionInformationModel</code>.
     * Represents the response DTO for auction information
     * @alias module:model/ModelsAuctionInformationModel
     */
    constructor() { 
        
        ModelsAuctionInformationModel.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ModelsAuctionInformationModel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ModelsAuctionInformationModel} obj Optional instance to populate.
     * @return {module:model/ModelsAuctionInformationModel} The populated <code>ModelsAuctionInformationModel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ModelsAuctionInformationModel();
    ...
    /**
     * Validates the JSON data with respect to <code>ModelsAuctionInformationModel</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ModelsAuctionInformationModel</code>.
     */
...
export default ModelsAuctionInformationModel;
