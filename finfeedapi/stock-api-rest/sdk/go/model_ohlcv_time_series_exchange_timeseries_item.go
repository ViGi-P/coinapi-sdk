...
// checks if the OHLCVTimeSeriesExchangeTimeseriesItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OHLCVTimeSeriesExchangeTimeseriesItem{}

// OHLCVTimeSeriesExchangeTimeseriesItem Represents a timeseries item with price and volume information.
type OHLCVTimeSeriesExchangeTimeseriesItem struct {
...
func NewOHLCVTimeSeriesExchangeTimeseriesItem() *OHLCVTimeSeriesExchangeTimeseriesItem {
	this := OHLCVTimeSeriesExchangeTimeseriesItem{}
	return &this
}
...
func (o *OHLCVTimeSeriesExchangeTimeseriesItem) SetTimeOpenNil() {
	o.TimeOpen.Set(nil)
}
...
func (o *OHLCVTimeSeriesExchangeTimeseriesItem) SetTimeCloseNil() {
	o.TimeClose.Set(nil)
}
...
func (o *OHLCVTimeSeriesExchangeTimeseriesItem) SetPriceOpenNil() {
	o.PriceOpen.Set(nil)
}
...
func (o *OHLCVTimeSeriesExchangeTimeseriesItem) SetPriceHighNil() {
	o.PriceHigh.Set(nil)
}
...
func (o *OHLCVTimeSeriesExchangeTimeseriesItem) SetPriceLowNil() {
	o.PriceLow.Set(nil)
}
...
func (o *OHLCVTimeSeriesExchangeTimeseriesItem) SetPriceCloseNil() {
...
func (o *OHLCVTimeSeriesExchangeTimeseriesItem) SetSymbolIdExchangeNil() {
...
func (o OHLCVTimeSeriesExchangeTimeseriesItem) MarshalJSON() ([]byte, error) {
...
func (o OHLCVTimeSeriesExchangeTimeseriesItem) ToMap() (map[string]interface{}, error) {
...
type NullableOHLCVTimeSeriesExchangeTimeseriesItem struct {
	value *OHLCVTimeSeriesExchangeTimeseriesItem
	isSet bool
}

func (v NullableOHLCVTimeSeriesExchangeTimeseriesItem) Get() *OHLCVTimeSeriesExchangeTimeseriesItem {
	return v.value
}

func (v *NullableOHLCVTimeSeriesExchangeTimeseriesItem) Set(val *OHLCVTimeSeriesExchangeTimeseriesItem) {
	v.value = val
	v.isSet = true
}

func (v NullableOHLCVTimeSeriesExchangeTimeseriesItem) IsSet() bool {
	return v.isSet
}

func (v *NullableOHLCVTimeSeriesExchangeTimeseriesItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOHLCVTimeSeriesExchangeTimeseriesItem(val *OHLCVTimeSeriesExchangeTimeseriesItem) *NullableOHLCVTimeSeriesExchangeTimeseriesItem {
	return &NullableOHLCVTimeSeriesExchangeTimeseriesItem{value: val, isSet: true}
}

func (v NullableOHLCVTimeSeriesExchangeTimeseriesItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOHLCVTimeSeriesExchangeTimeseriesItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
