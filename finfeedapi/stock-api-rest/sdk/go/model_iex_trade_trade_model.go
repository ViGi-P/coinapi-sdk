...
// checks if the IEXTradeTradeModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IEXTradeTradeModel{}

// IEXTradeTradeModel Represents the response DTO for a single trade event (report or break).
type IEXTradeTradeModel struct {
...
func (o *IEXTradeTradeModel) SetSymbolNil() {
	o.Symbol.Set(nil)
}
...
func (o IEXTradeTradeModel) MarshalJSON() ([]byte, error) {
...
func (o IEXTradeTradeModel) ToMap() (map[string]interface{}, error) {
...
type NullableIEXTradeTradeModel struct {
	value *IEXTradeTradeModel
	isSet bool
}

func (v NullableIEXTradeTradeModel) Get() *IEXTradeTradeModel {
	return v.value
}

func (v *NullableIEXTradeTradeModel) Set(val *IEXTradeTradeModel) {
	v.value = val
	v.isSet = true
}

func (v NullableIEXTradeTradeModel) IsSet() bool {
	return v.isSet
}

func (v *NullableIEXTradeTradeModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIEXTradeTradeModel(val *IEXTradeTradeModel) *NullableIEXTradeTradeModel {
	return &NullableIEXTradeTradeModel{value: val, isSet: true}
}

func (v NullableIEXTradeTradeModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIEXTradeTradeModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
