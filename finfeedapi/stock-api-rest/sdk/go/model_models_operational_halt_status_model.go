...
// checks if the ModelsOperationalHaltStatusModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelsOperationalHaltStatusModel{}

// ModelsOperationalHaltStatusModel Represents the response DTO for operational halt status information
type ModelsOperationalHaltStatusModel struct {
	// The stock symbol
...
func NewModelsOperationalHaltStatusModel() *ModelsOperationalHaltStatusModel {
	this := ModelsOperationalHaltStatusModel{}
	return &this
}
...
func (o *ModelsOperationalHaltStatusModel) SetSymbolNil() {
	o.Symbol.Set(nil)
}
...
func (o *ModelsOperationalHaltStatusModel) SetOperationalHaltStatusCodeNil() {
...
func (o *ModelsOperationalHaltStatusModel) SetOperationalHaltStatusTextNil() {
...
func (o ModelsOperationalHaltStatusModel) MarshalJSON() ([]byte, error) {
...
func (o ModelsOperationalHaltStatusModel) ToMap() (map[string]interface{}, error) {
...
type NullableModelsOperationalHaltStatusModel struct {
	value *ModelsOperationalHaltStatusModel
	isSet bool
}

func (v NullableModelsOperationalHaltStatusModel) Get() *ModelsOperationalHaltStatusModel {
	return v.value
}

func (v *NullableModelsOperationalHaltStatusModel) Set(val *ModelsOperationalHaltStatusModel) {
	v.value = val
	v.isSet = true
}

func (v NullableModelsOperationalHaltStatusModel) IsSet() bool {
	return v.isSet
}

func (v *NullableModelsOperationalHaltStatusModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelsOperationalHaltStatusModel(val *ModelsOperationalHaltStatusModel) *NullableModelsOperationalHaltStatusModel {
	return &NullableModelsOperationalHaltStatusModel{value: val, isSet: true}
}

func (v NullableModelsOperationalHaltStatusModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelsOperationalHaltStatusModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
