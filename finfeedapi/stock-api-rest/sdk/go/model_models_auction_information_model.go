...
// checks if the ModelsAuctionInformationModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelsAuctionInformationModel{}

// ModelsAuctionInformationModel Represents the response DTO for auction information
type ModelsAuctionInformationModel struct {
	// The stock symbol
...
func NewModelsAuctionInformationModel() *ModelsAuctionInformationModel {
	this := ModelsAuctionInformationModel{}
	return &this
}
...
func (o *ModelsAuctionInformationModel) SetSymbolNil() {
	o.Symbol.Set(nil)
}
...
func (o *ModelsAuctionInformationModel) SetAuctionTypeCodeNil() {
...
func (o *ModelsAuctionInformationModel) SetAuctionTypeTextNil() {
...
func (o *ModelsAuctionInformationModel) SetImbalanceSideCodeNil() {
...
func (o *ModelsAuctionInformationModel) SetImbalanceSideTextNil() {
...
func (o ModelsAuctionInformationModel) MarshalJSON() ([]byte, error) {
...
func (o ModelsAuctionInformationModel) ToMap() (map[string]interface{}, error) {
...
type NullableModelsAuctionInformationModel struct {
	value *ModelsAuctionInformationModel
	isSet bool
}

func (v NullableModelsAuctionInformationModel) Get() *ModelsAuctionInformationModel {
	return v.value
}

func (v *NullableModelsAuctionInformationModel) Set(val *ModelsAuctionInformationModel) {
	v.value = val
	v.isSet = true
}

func (v NullableModelsAuctionInformationModel) IsSet() bool {
	return v.isSet
}

func (v *NullableModelsAuctionInformationModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelsAuctionInformationModel(val *ModelsAuctionInformationModel) *NullableModelsAuctionInformationModel {
	return &NullableModelsAuctionInformationModel{value: val, isSet: true}
}

func (v NullableModelsAuctionInformationModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelsAuctionInformationModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
