...
// checks if the ModelsExecutedOrderModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelsExecutedOrderModel{}

// ModelsExecutedOrderModel Represents the response DTO for order executed information
type ModelsExecutedOrderModel struct {
	// The stock symbol
...
func (o *ModelsExecutedOrderModel) SetSymbolNil() {
	o.Symbol.Set(nil)
}
...
func (o ModelsExecutedOrderModel) MarshalJSON() ([]byte, error) {
...
func (o ModelsExecutedOrderModel) ToMap() (map[string]interface{}, error) {
...
type NullableModelsExecutedOrderModel struct {
	value *ModelsExecutedOrderModel
	isSet bool
}

func (v NullableModelsExecutedOrderModel) Get() *ModelsExecutedOrderModel {
	return v.value
}

func (v *NullableModelsExecutedOrderModel) Set(val *ModelsExecutedOrderModel) {
	v.value = val
	v.isSet = true
}

func (v NullableModelsExecutedOrderModel) IsSet() bool {
	return v.isSet
}

func (v *NullableModelsExecutedOrderModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelsExecutedOrderModel(val *ModelsExecutedOrderModel) *NullableModelsExecutedOrderModel {
	return &NullableModelsExecutedOrderModel{value: val, isSet: true}
}

func (v NullableModelsExecutedOrderModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelsExecutedOrderModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
