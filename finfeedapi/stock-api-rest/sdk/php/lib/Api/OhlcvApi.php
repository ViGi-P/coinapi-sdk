...
class OhlcvApi
{
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\OpenAPI\Client\Model\OHLCVTimeSeriesExchangeTimeseriesItem[]',
                        $request,
                        $response,
                    );
            }
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\OHLCVTimeSeriesTimeseriesItem[]
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\OHLCVTimeSeriesTimeseriesItem[], HTTP status code, HTTP response headers (array of strings)
     */
    public function v1OhlcvExchangeSymbolExchangeIdSymbolIdHistoryGetWithHttpInfo($exchange_id, $symbol_id, $period_id, $time_start = null, $time_end = null, $limit = 100, string $contentType = self::contentTypes['v1OhlcvExchangeSymbolExchangeIdSymbolIdHistoryGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\OpenAPI\Client\Model\OHLCVTimeSeriesTimeseriesItem[]',
                        $request,
                        $response,
                    );
            }
    ...
    {
        $returnType = '\OpenAPI\Client\Model\OHLCVTimeSeriesTimeseriesItem[]';
        $request = $this->v1OhlcvExchangeSymbolExchangeIdSymbolIdHistoryGetRequest($exchange_id, $symbol_id, $period_id, $time_start, $time_end, $limit, $contentType);
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\OHLCVTimeSeriesTimeseriesPeriod[]
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\OHLCVTimeSeriesTimeseriesPeriod[], HTTP status code, HTTP response headers (array of strings)
     */
    public function v1OhlcvPeriodsGetWithHttpInfo(string $contentType = self::contentTypes['v1OhlcvPeriodsGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\OpenAPI\Client\Model\OHLCVTimeSeriesTimeseriesPeriod[]',
                        $request,
                        $response,
                    );
            }
    ...
    {
        $returnType = '\OpenAPI\Client\Model\OHLCVTimeSeriesTimeseriesPeriod[]';
        $request = $this->v1OhlcvPeriodsGetRequest($contentType);
