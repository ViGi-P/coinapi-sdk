...
/**
 * Level3AddOrderModel Class Doc Comment
 *
 * @category Class
 ...
 */
class Level3AddOrderModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Level3.AddOrderModel';
    ...
    */
     ...
     * Sets timestamp
     *
     * @param \DateTime|null $timestamp Time when the order was added as DateTime (UTC)
     *
     * @return self
     */
     ...
     * Sets is_side_buy
     *
     * @param bool|null $is_side_buy Indicates if this is a Buy order ('8'/0x38).
     *
     * @return self
     */
     ...
     * Sets size
     *
     * @param int|null $size Quoted size in number of shares
     *
     * @return self
     */
