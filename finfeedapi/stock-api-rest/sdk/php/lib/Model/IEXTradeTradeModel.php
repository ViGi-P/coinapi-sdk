...
/**
 * IEXTradeTradeModel Class Doc Comment
 *
 * @category Class
 ...
 */
class IEXTradeTradeModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'IEXTrade.TradeModel';
    ...
    protected static $setters = [
        'is_trade_break' => 'setIsTradeBreak',
        'symbol' => 'setSymbol',
    ...
    protected static $getters = [
        'is_trade_break' => 'getIsTradeBreak',
        'symbol' => 'getSymbol',
    ...
    {
        $this->setIfExists('is_trade_break', $data ?? [], null);
     ...
     * @return bool|null
     */
    public function getIsTradeBreak()
    {
        return $this->container['is_trade_break'];
    }

    /**
     * Sets is_trade_break
     *
     * @param bool|null $is_trade_break Indicates if this record represents a trade break (true) or a trade report (false).
     *
     * @return self
     */
    public function setIsTradeBreak($is_trade_break)
    {
        if (is_null($is_trade_break)) {
            throw new \InvalidArgumentException('non-nullable is_trade_break cannot be null');
        }
        $this->container['is_trade_break'] = $is_trade_break;
     ...
     * Sets timestamp
     *
     * @param \DateTime|null $timestamp Time when the event was recorded as DateTime (UTC).
     *
     * @return self
     */
     ...
     * Sets size
     *
     * @param int|null $size Trade volume (or break volume) in number of shares.
     *
     * @return self
     */
     ...
     * Sets price
     *
     * @param float|null $price Trade price (or break price) as decimal.
     *
     * @return self
     */
     ...
     * Sets trade_id
     *
     * @param int|null $trade_id IEX trade identifier (same for report and its corresponding break).
     *
     * @return self
     */
