...
/**
 * OHLCVTimeSeriesTimeseriesPeriod Class Doc Comment
 *
 * @category Class
 ...
 */
class OHLCVTimeSeriesTimeseriesPeriod implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'OHLCVTimeSeries.TimeseriesPeriod';
    ...
    protected static $setters = [
        ...
        'length_seconds' => 'setLengthSeconds',
        'length_months' => 'setLengthMonths',
    ...
    protected static $getters = [
        ...
        'length_seconds' => 'getLengthSeconds',
        'length_months' => 'getLengthMonths',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('length_seconds', $data ?? [], null);
        $this->setIfExists('length_months', $data ?? [], null);
    ...
    {
        return $this->container['length_seconds'];
    }
    ...
    {
        if (is_null($length_seconds)) {
            throw new \InvalidArgumentException('non-nullable length_seconds cannot be null');
        }
        $this->container['length_seconds'] = $length_seconds;
     ...
     * @return int|null
     */
    public function getLengthMonths()
    {
        return $this->container['length_months'];
    }
     ...
     * @return self
     */
    public function setLengthMonths($length_months)
    {
        if (is_null($length_months)) {
            throw new \InvalidArgumentException('non-nullable length_months cannot be null');
        }
        $this->container['length_months'] = $length_months;
