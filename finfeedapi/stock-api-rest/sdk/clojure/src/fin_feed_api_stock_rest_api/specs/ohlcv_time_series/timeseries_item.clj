(ns fin-feed-api-stock-rest-api.specs.ohlcv-time-series/timeseries-item
...
(def ohlcv-time-series/timeseries-item-data
  {
...
(def ohlcv-time-series/timeseries-item-spec
  (ds/spec
    {:name ::ohlcv-time-series/timeseries-item
     :spec ohlcv-time-series/timeseries-item-data}))
