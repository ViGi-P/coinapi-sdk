(ns fin-feed-api-stock-rest-api.specs.models/trading-status-model
...
(def models/trading-status-model-data
  {
...
(def models/trading-status-model-spec
  (ds/spec
    {:name ::models/trading-status-model
     :spec models/trading-status-model-data}))
