(ns fin-feed-api-stock-rest-api.specs.models/auction-information-model
...
(def models/auction-information-model-data
  {
...
(def models/auction-information-model-spec
  (ds/spec
    {:name ::models/auction-information-model
     :spec models/auction-information-model-data}))
