(ns fin-feed-api-stock-rest-api.specs.models/operational-halt-status-model
...
(def models/operational-halt-status-model-data
  {
...
(def models/operational-halt-status-model-spec
  (ds/spec
    {:name ::models/operational-halt-status-model
     :spec models/operational-halt-status-model-data}))
