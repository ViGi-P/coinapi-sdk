(ns fin-feed-api-stock-rest-api.specs.models/short-sale-price-test-status-model
...
(def models/short-sale-price-test-status-model-data
  {
...
(def models/short-sale-price-test-status-model-spec
  (ds/spec
    {:name ::models/short-sale-price-test-status-model
     :spec models/short-sale-price-test-status-model-data}))
