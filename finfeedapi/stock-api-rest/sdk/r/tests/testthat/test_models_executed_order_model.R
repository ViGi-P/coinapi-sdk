...
context("Test ModelsExecutedOrderModel")

model_instance <- ModelsExecutedOrderModel$new()
...
test_that("sale_condition_flags", {
  # tests for the property `sale_condition_flags` (integer)
  # Sale condition flags for the execution as byte value

  # uncomment below to test the property
  #expect_equal(model.instance$`sale_condition_flags`, "EXPECTED_RESULT")
})
