#' Create a new IEXPriceLevelUpdatePriceLevelUpdateModel
#'
#' @description
#' Represents the response DTO for price level update information
#'
#' @docType class
#' @title IEXPriceLevelUpdatePriceLevelUpdateModel
#' @description IEXPriceLevelUpdatePriceLevelUpdateModel Class
...
#' @export
IEXPriceLevelUpdatePriceLevelUpdateModel <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new IEXPriceLevelUpdatePriceLevelUpdateModel class.
    #'
    ...
    #'
    #' @return IEXPriceLevelUpdatePriceLevelUpdateModel as a base R list.
    #' @examples
    #' # convert array of IEXPriceLevelUpdatePriceLevelUpdateModel (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert IEXPriceLevelUpdatePriceLevelUpdateModel to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      IEXPriceLevelUpdatePriceLevelUpdateModelObject <- list()
      if (!is.null(self$`symbol`)) {
        IEXPriceLevelUpdatePriceLevelUpdateModelObject[["symbol"]] <-
          self$`symbol`
      }
      if (!is.null(self$`timestamp_nanos`)) {
        IEXPriceLevelUpdatePriceLevelUpdateModelObject[["timestamp_nanos"]] <-
          self$`timestamp_nanos`
      }
      if (!is.null(self$`timestamp`)) {
        IEXPriceLevelUpdatePriceLevelUpdateModelObject[["timestamp"]] <-
          self$`timestamp`
      }
      if (!is.null(self$`is_side_buy`)) {
        IEXPriceLevelUpdatePriceLevelUpdateModelObject[["is_side_buy"]] <-
          self$`is_side_buy`
      }
      if (!is.null(self$`is_event_processing_complete`)) {
        IEXPriceLevelUpdatePriceLevelUpdateModelObject[["is_event_processing_complete"]] <-
          self$`is_event_processing_complete`
      }
      if (!is.null(self$`size`)) {
        IEXPriceLevelUpdatePriceLevelUpdateModelObject[["size"]] <-
          self$`size`
      }
      if (!is.null(self$`price`)) {
        IEXPriceLevelUpdatePriceLevelUpdateModelObject[["price"]] <-
          self$`price`
      }
      return(IEXPriceLevelUpdatePriceLevelUpdateModelObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of IEXPriceLevelUpdatePriceLevelUpdateModel
    #'
    #' @param input_json the JSON input
    #' @return the instance of IEXPriceLevelUpdatePriceLevelUpdateModel
    ...
    #' @return IEXPriceLevelUpdatePriceLevelUpdateModel in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to IEXPriceLevelUpdatePriceLevelUpdateModel and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of IEXPriceLevelUpdatePriceLevelUpdateModel
    toString = function() {
      self$toJSONString()
    },
...
# IEXPriceLevelUpdatePriceLevelUpdateModel$unlock()
#
## Below is an example to define the print function
# IEXPriceLevelUpdatePriceLevelUpdateModel$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# IEXPriceLevelUpdatePriceLevelUpdateModel$lock()
