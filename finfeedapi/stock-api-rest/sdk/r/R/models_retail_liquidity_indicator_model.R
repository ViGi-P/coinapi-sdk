#' Create a new ModelsRetailLiquidityIndicatorModel
#'
#' @description
#' Represents the response DTO for retail liquidity indicator information
#'
#' @docType class
#' @title ModelsRetailLiquidityIndicatorModel
#' @description ModelsRetailLiquidityIndicatorModel Class
...
#' @export
ModelsRetailLiquidityIndicatorModel <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new ModelsRetailLiquidityIndicatorModel class.
    #'
    ...
    #'
    #' @return ModelsRetailLiquidityIndicatorModel as a base R list.
    #' @examples
    #' # convert array of ModelsRetailLiquidityIndicatorModel (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ModelsRetailLiquidityIndicatorModel to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      ModelsRetailLiquidityIndicatorModelObject <- list()
      if (!is.null(self$`symbol`)) {
        ModelsRetailLiquidityIndicatorModelObject[["symbol"]] <-
          self$`symbol`
      }
      if (!is.null(self$`timestamp_nanos`)) {
        ModelsRetailLiquidityIndicatorModelObject[["timestamp_nanos"]] <-
          self$`timestamp_nanos`
      }
      if (!is.null(self$`timestamp`)) {
        ModelsRetailLiquidityIndicatorModelObject[["timestamp"]] <-
          self$`timestamp`
      }
      if (!is.null(self$`retail_liquidity_indicator`)) {
        ModelsRetailLiquidityIndicatorModelObject[["retail_liquidity_indicator"]] <-
          self$`retail_liquidity_indicator`
      }
      if (!is.null(self$`retail_liquidity_indicator_code`)) {
        ModelsRetailLiquidityIndicatorModelObject[["retail_liquidity_indicator_code"]] <-
          self$`retail_liquidity_indicator_code`
      }
      if (!is.null(self$`retail_liquidity_indicator_text`)) {
        ModelsRetailLiquidityIndicatorModelObject[["retail_liquidity_indicator_text"]] <-
          self$`retail_liquidity_indicator_text`
      }
      if (!is.null(self$`is_retail_indicator_not_applicable`)) {
        ModelsRetailLiquidityIndicatorModelObject[["is_retail_indicator_not_applicable"]] <-
          self$`is_retail_indicator_not_applicable`
      }
      if (!is.null(self$`is_retail_indicator_buy_interest`)) {
        ModelsRetailLiquidityIndicatorModelObject[["is_retail_indicator_buy_interest"]] <-
          self$`is_retail_indicator_buy_interest`
      }
      if (!is.null(self$`is_retail_indicator_sell_interest`)) {
        ModelsRetailLiquidityIndicatorModelObject[["is_retail_indicator_sell_interest"]] <-
          self$`is_retail_indicator_sell_interest`
      }
      if (!is.null(self$`is_retail_indicator_buy_and_sell_interest`)) {
        ModelsRetailLiquidityIndicatorModelObject[["is_retail_indicator_buy_and_sell_interest"]] <-
          self$`is_retail_indicator_buy_and_sell_interest`
      }
      return(ModelsRetailLiquidityIndicatorModelObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of ModelsRetailLiquidityIndicatorModel
    #'
    #' @param input_json the JSON input
    #' @return the instance of ModelsRetailLiquidityIndicatorModel
    ...
    #' @return ModelsRetailLiquidityIndicatorModel in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to ModelsRetailLiquidityIndicatorModel and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of ModelsRetailLiquidityIndicatorModel
    toString = function() {
      self$toJSONString()
    },
...
# ModelsRetailLiquidityIndicatorModel$unlock()
#
## Below is an example to define the print function
# ModelsRetailLiquidityIndicatorModel$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ModelsRetailLiquidityIndicatorModel$lock()
