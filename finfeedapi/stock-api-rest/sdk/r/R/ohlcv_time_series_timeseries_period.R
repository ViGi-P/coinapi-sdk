#' Create a new OHLCVTimeSeriesTimeseriesPeriod
#'
#' @description
#' Represents a timeseries period used in exchange rate data.
#'
#' @docType class
#' @title OHLCVTimeSeriesTimeseriesPeriod
#' @description OHLCVTimeSeriesTimeseriesPeriod Class
...
#' @export
OHLCVTimeSeriesTimeseriesPeriod <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new OHLCVTimeSeriesTimeseriesPeriod class.
    #'
    ...
    #'
    #' @return OHLCVTimeSeriesTimeseriesPeriod as a base R list.
    #' @examples
    #' # convert array of OHLCVTimeSeriesTimeseriesPeriod (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert OHLCVTimeSeriesTimeseriesPeriod to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      OHLCVTimeSeriesTimeseriesPeriodObject <- list()
      if (!is.null(self$`period_id`)) {
        OHLCVTimeSeriesTimeseriesPeriodObject[["period_id"]] <-
          self$`period_id`
      }
      if (!is.null(self$`length_seconds`)) {
        OHLCVTimeSeriesTimeseriesPeriodObject[["length_seconds"]] <-
          self$`length_seconds`
      }
      if (!is.null(self$`length_months`)) {
        OHLCVTimeSeriesTimeseriesPeriodObject[["length_months"]] <-
          self$`length_months`
      }
      if (!is.null(self$`unit_count`)) {
        OHLCVTimeSeriesTimeseriesPeriodObject[["unit_count"]] <-
          self$`unit_count`
      }
      if (!is.null(self$`unit_name`)) {
        OHLCVTimeSeriesTimeseriesPeriodObject[["unit_name"]] <-
          self$`unit_name`
      }
      if (!is.null(self$`display_name`)) {
        OHLCVTimeSeriesTimeseriesPeriodObject[["display_name"]] <-
          self$`display_name`
      }
      return(OHLCVTimeSeriesTimeseriesPeriodObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of OHLCVTimeSeriesTimeseriesPeriod
    #'
    #' @param input_json the JSON input
    #' @return the instance of OHLCVTimeSeriesTimeseriesPeriod
    ...
    #' @return OHLCVTimeSeriesTimeseriesPeriod in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to OHLCVTimeSeriesTimeseriesPeriod and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of OHLCVTimeSeriesTimeseriesPeriod
    toString = function() {
      self$toJSONString()
    },
...
# OHLCVTimeSeriesTimeseriesPeriod$unlock()
#
## Below is an example to define the print function
# OHLCVTimeSeriesTimeseriesPeriod$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# OHLCVTimeSeriesTimeseriesPeriod$lock()
