#' Create a new IEXTradeTradeModel
#'
#' @description
#' Represents the response DTO for a single trade event (report or break).
#'
#' @docType class
#' @title IEXTradeTradeModel
#' @description IEXTradeTradeModel Class
...
IEXTradeTradeModel <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new IEXTradeTradeModel class.
    #'
    ...
    #'
    #' @return IEXTradeTradeModel as a base R list.
    #' @examples
    #' # convert array of IEXTradeTradeModel (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert IEXTradeTradeModel to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      IEXTradeTradeModelObject <- list()
      if (!is.null(self$`is_trade_break`)) {
        IEXTradeTradeModelObject[["is_trade_break"]] <-
          self$`is_trade_break`
      }
      if (!is.null(self$`symbol`)) {
        IEXTradeTradeModelObject[["symbol"]] <-
          self$`symbol`
      }
      if (!is.null(self$`timestamp_nanos`)) {
        IEXTradeTradeModelObject[["timestamp_nanos"]] <-
          self$`timestamp_nanos`
      }
      if (!is.null(self$`timestamp`)) {
        IEXTradeTradeModelObject[["timestamp"]] <-
          self$`timestamp`
      }
      if (!is.null(self$`size`)) {
        IEXTradeTradeModelObject[["size"]] <-
          self$`size`
      }
      if (!is.null(self$`price`)) {
        IEXTradeTradeModelObject[["price"]] <-
          self$`price`
      }
      if (!is.null(self$`trade_id`)) {
        IEXTradeTradeModelObject[["trade_id"]] <-
          self$`trade_id`
      }
      if (!is.null(self$`is_intermarket_sweep`)) {
        IEXTradeTradeModelObject[["is_intermarket_sweep"]] <-
          self$`is_intermarket_sweep`
      }
      if (!is.null(self$`is_extended_hours_trade`)) {
        IEXTradeTradeModelObject[["is_extended_hours_trade"]] <-
          self$`is_extended_hours_trade`
      }
      if (!is.null(self$`is_odd_lot_trade`)) {
        IEXTradeTradeModelObject[["is_odd_lot_trade"]] <-
          self$`is_odd_lot_trade`
      }
      if (!is.null(self$`is_trade_through_exempt`)) {
        IEXTradeTradeModelObject[["is_trade_through_exempt"]] <-
          self$`is_trade_through_exempt`
      }
      if (!is.null(self$`is_single_price_cross_trade`)) {
        IEXTradeTradeModelObject[["is_single_price_cross_trade"]] <-
          self$`is_single_price_cross_trade`
      }
      return(IEXTradeTradeModelObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of IEXTradeTradeModel
    #'
    #' @param input_json the JSON input
    #' @return the instance of IEXTradeTradeModel
    ...
    #' @return IEXTradeTradeModel in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to IEXTradeTradeModel and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of IEXTradeTradeModel
    toString = function() {
      self$toJSONString()
    },
...
# IEXTradeTradeModel$unlock()
#
## Below is an example to define the print function
# IEXTradeTradeModel$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# IEXTradeTradeModel$lock()
