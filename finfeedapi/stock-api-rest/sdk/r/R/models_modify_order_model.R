#' Create a new ModelsModifyOrderModel
#'
#' @description
#' Represents the response DTO for order modify information
#'
#' @docType class
#' @title ModelsModifyOrderModel
#' @description ModelsModifyOrderModel Class
...
#' @export
ModelsModifyOrderModel <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new ModelsModifyOrderModel class.
    #'
    ...
    #'
    #' @return ModelsModifyOrderModel as a base R list.
    #' @examples
    #' # convert array of ModelsModifyOrderModel (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ModelsModifyOrderModel to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      ModelsModifyOrderModelObject <- list()
      if (!is.null(self$`symbol`)) {
        ModelsModifyOrderModelObject[["symbol"]] <-
          self$`symbol`
      }
      if (!is.null(self$`timestamp_nanos`)) {
        ModelsModifyOrderModelObject[["timestamp_nanos"]] <-
          self$`timestamp_nanos`
      }
      if (!is.null(self$`timestamp`)) {
        ModelsModifyOrderModelObject[["timestamp"]] <-
          self$`timestamp`
      }
      if (!is.null(self$`order_id_reference`)) {
        ModelsModifyOrderModelObject[["order_id_reference"]] <-
          self$`order_id_reference`
      }
      if (!is.null(self$`is_priority_reset`)) {
        ModelsModifyOrderModelObject[["is_priority_reset"]] <-
          self$`is_priority_reset`
      }
      if (!is.null(self$`size`)) {
        ModelsModifyOrderModelObject[["size"]] <-
          self$`size`
      }
      if (!is.null(self$`price`)) {
        ModelsModifyOrderModelObject[["price"]] <-
          self$`price`
      }
      return(ModelsModifyOrderModelObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of ModelsModifyOrderModel
    #'
    #' @param input_json the JSON input
    #' @return the instance of ModelsModifyOrderModel
    ...
    #' @return ModelsModifyOrderModel in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to ModelsModifyOrderModel and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of ModelsModifyOrderModel
    toString = function() {
      self$toJSONString()
    },
...
# ModelsModifyOrderModel$unlock()
#
## Below is an example to define the print function
# ModelsModifyOrderModel$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ModelsModifyOrderModel$lock()
