#' Create a new ModelsShortSalePriceTestStatusModel
#'
#' @description
#' Represents the response DTO for short sale price test status information
#'
#' @docType class
#' @title ModelsShortSalePriceTestStatusModel
#' @description ModelsShortSalePriceTestStatusModel Class
...
#' @export
ModelsShortSalePriceTestStatusModel <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new ModelsShortSalePriceTestStatusModel class.
    #'
    ...
    #'
    #' @return ModelsShortSalePriceTestStatusModel as a base R list.
    #' @examples
    #' # convert array of ModelsShortSalePriceTestStatusModel (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ModelsShortSalePriceTestStatusModel to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      ModelsShortSalePriceTestStatusModelObject <- list()
      if (!is.null(self$`symbol`)) {
        ModelsShortSalePriceTestStatusModelObject[["symbol"]] <-
          self$`symbol`
      }
      if (!is.null(self$`timestamp_nanos`)) {
        ModelsShortSalePriceTestStatusModelObject[["timestamp_nanos"]] <-
          self$`timestamp_nanos`
      }
      if (!is.null(self$`timestamp`)) {
        ModelsShortSalePriceTestStatusModelObject[["timestamp"]] <-
          self$`timestamp`
      }
      if (!is.null(self$`short_sale_price_test_status`)) {
        ModelsShortSalePriceTestStatusModelObject[["short_sale_price_test_status"]] <-
          self$`short_sale_price_test_status`
      }
      if (!is.null(self$`short_sale_price_test_status_code`)) {
        ModelsShortSalePriceTestStatusModelObject[["short_sale_price_test_status_code"]] <-
          self$`short_sale_price_test_status_code`
      }
      if (!is.null(self$`short_sale_price_test_status_text`)) {
        ModelsShortSalePriceTestStatusModelObject[["short_sale_price_test_status_text"]] <-
          self$`short_sale_price_test_status_text`
      }
      if (!is.null(self$`is_short_sale_price_test_not_in_effect`)) {
        ModelsShortSalePriceTestStatusModelObject[["is_short_sale_price_test_not_in_effect"]] <-
          self$`is_short_sale_price_test_not_in_effect`
      }
      if (!is.null(self$`is_short_sale_price_test_in_effect`)) {
        ModelsShortSalePriceTestStatusModelObject[["is_short_sale_price_test_in_effect"]] <-
          self$`is_short_sale_price_test_in_effect`
      }
      if (!is.null(self$`detail`)) {
        ModelsShortSalePriceTestStatusModelObject[["detail"]] <-
          self$`detail`
      }
      if (!is.null(self$`detail_code`)) {
        ModelsShortSalePriceTestStatusModelObject[["detail_code"]] <-
          self$`detail_code`
      }
      if (!is.null(self$`detail_text`)) {
        ModelsShortSalePriceTestStatusModelObject[["detail_text"]] <-
          self$`detail_text`
      }
      if (!is.null(self$`is_detail_no_price_test`)) {
        ModelsShortSalePriceTestStatusModelObject[["is_detail_no_price_test"]] <-
          self$`is_detail_no_price_test`
      }
      if (!is.null(self$`is_detail_activated`)) {
        ModelsShortSalePriceTestStatusModelObject[["is_detail_activated"]] <-
          self$`is_detail_activated`
      }
      if (!is.null(self$`is_detail_continued`)) {
        ModelsShortSalePriceTestStatusModelObject[["is_detail_continued"]] <-
          self$`is_detail_continued`
      }
      if (!is.null(self$`is_detail_deactivated`)) {
        ModelsShortSalePriceTestStatusModelObject[["is_detail_deactivated"]] <-
          self$`is_detail_deactivated`
      }
      if (!is.null(self$`is_detail_not_available`)) {
        ModelsShortSalePriceTestStatusModelObject[["is_detail_not_available"]] <-
          self$`is_detail_not_available`
      }
      return(ModelsShortSalePriceTestStatusModelObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of ModelsShortSalePriceTestStatusModel
    #'
    #' @param input_json the JSON input
    #' @return the instance of ModelsShortSalePriceTestStatusModel
    ...
    #' @return ModelsShortSalePriceTestStatusModel in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to ModelsShortSalePriceTestStatusModel and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of ModelsShortSalePriceTestStatusModel
    toString = function() {
      self$toJSONString()
    },
...
# ModelsShortSalePriceTestStatusModel$unlock()
#
## Below is an example to define the print function
# ModelsShortSalePriceTestStatusModel$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ModelsShortSalePriceTestStatusModel$lock()
