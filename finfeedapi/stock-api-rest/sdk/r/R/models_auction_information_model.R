#' Create a new ModelsAuctionInformationModel
#'
#' @description
#' Represents the response DTO for auction information
#'
#' @docType class
#' @title ModelsAuctionInformationModel
#' @description ModelsAuctionInformationModel Class
...
#' @export
ModelsAuctionInformationModel <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new ModelsAuctionInformationModel class.
    #'
    ...
    #'
    #' @return ModelsAuctionInformationModel as a base R list.
    #' @examples
    #' # convert array of ModelsAuctionInformationModel (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ModelsAuctionInformationModel to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      ModelsAuctionInformationModelObject <- list()
      if (!is.null(self$`symbol`)) {
        ModelsAuctionInformationModelObject[["symbol"]] <-
          self$`symbol`
      }
      if (!is.null(self$`timestamp_nanos`)) {
        ModelsAuctionInformationModelObject[["timestamp_nanos"]] <-
          self$`timestamp_nanos`
      }
      if (!is.null(self$`timestamp`)) {
        ModelsAuctionInformationModelObject[["timestamp"]] <-
          self$`timestamp`
      }
      if (!is.null(self$`auction_type`)) {
        ModelsAuctionInformationModelObject[["auction_type"]] <-
          self$`auction_type`
      }
      if (!is.null(self$`auction_type_code`)) {
        ModelsAuctionInformationModelObject[["auction_type_code"]] <-
          self$`auction_type_code`
      }
      if (!is.null(self$`auction_type_text`)) {
        ModelsAuctionInformationModelObject[["auction_type_text"]] <-
          self$`auction_type_text`
      }
      if (!is.null(self$`is_auction_type_opening`)) {
        ModelsAuctionInformationModelObject[["is_auction_type_opening"]] <-
          self$`is_auction_type_opening`
      }
      if (!is.null(self$`is_auction_type_closing`)) {
        ModelsAuctionInformationModelObject[["is_auction_type_closing"]] <-
          self$`is_auction_type_closing`
      }
      if (!is.null(self$`is_auction_type_ipo`)) {
        ModelsAuctionInformationModelObject[["is_auction_type_ipo"]] <-
          self$`is_auction_type_ipo`
      }
      if (!is.null(self$`is_auction_type_halt`)) {
        ModelsAuctionInformationModelObject[["is_auction_type_halt"]] <-
          self$`is_auction_type_halt`
      }
      if (!is.null(self$`is_auction_type_volatility`)) {
        ModelsAuctionInformationModelObject[["is_auction_type_volatility"]] <-
          self$`is_auction_type_volatility`
      }
      if (!is.null(self$`paired_shares`)) {
        ModelsAuctionInformationModelObject[["paired_shares"]] <-
          self$`paired_shares`
      }
      if (!is.null(self$`reference_price`)) {
        ModelsAuctionInformationModelObject[["reference_price"]] <-
          self$`reference_price`
      }
      if (!is.null(self$`indicative_clearing_price`)) {
        ModelsAuctionInformationModelObject[["indicative_clearing_price"]] <-
          self$`indicative_clearing_price`
      }
      if (!is.null(self$`imbalance_shares`)) {
        ModelsAuctionInformationModelObject[["imbalance_shares"]] <-
          self$`imbalance_shares`
      }
      if (!is.null(self$`imbalance_side`)) {
        ModelsAuctionInformationModelObject[["imbalance_side"]] <-
          self$`imbalance_side`
      }
      if (!is.null(self$`imbalance_side_code`)) {
        ModelsAuctionInformationModelObject[["imbalance_side_code"]] <-
          self$`imbalance_side_code`
      }
      if (!is.null(self$`imbalance_side_text`)) {
        ModelsAuctionInformationModelObject[["imbalance_side_text"]] <-
          self$`imbalance_side_text`
      }
      if (!is.null(self$`is_imbalance_side_buy`)) {
        ModelsAuctionInformationModelObject[["is_imbalance_side_buy"]] <-
          self$`is_imbalance_side_buy`
      }
      if (!is.null(self$`is_imbalance_side_sell`)) {
        ModelsAuctionInformationModelObject[["is_imbalance_side_sell"]] <-
          self$`is_imbalance_side_sell`
      }
      if (!is.null(self$`is_imbalance_side_none`)) {
        ModelsAuctionInformationModelObject[["is_imbalance_side_none"]] <-
          self$`is_imbalance_side_none`
      }
      if (!is.null(self$`extension_number`)) {
        ModelsAuctionInformationModelObject[["extension_number"]] <-
          self$`extension_number`
      }
      if (!is.null(self$`scheduled_auction_time_seconds`)) {
        ModelsAuctionInformationModelObject[["scheduled_auction_time_seconds"]] <-
          self$`scheduled_auction_time_seconds`
      }
      if (!is.null(self$`scheduled_auction_time`)) {
        ModelsAuctionInformationModelObject[["scheduled_auction_time"]] <-
          self$`scheduled_auction_time`
      }
      if (!is.null(self$`auction_book_clearing_price`)) {
        ModelsAuctionInformationModelObject[["auction_book_clearing_price"]] <-
          self$`auction_book_clearing_price`
      }
      if (!is.null(self$`collar_reference_price`)) {
        ModelsAuctionInformationModelObject[["collar_reference_price"]] <-
          self$`collar_reference_price`
      }
      if (!is.null(self$`lower_auction_collar`)) {
        ModelsAuctionInformationModelObject[["lower_auction_collar"]] <-
          self$`lower_auction_collar`
      }
      if (!is.null(self$`upper_auction_collar`)) {
        ModelsAuctionInformationModelObject[["upper_auction_collar"]] <-
          self$`upper_auction_collar`
      }
      return(ModelsAuctionInformationModelObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of ModelsAuctionInformationModel
    #'
    #' @param input_json the JSON input
    #' @return the instance of ModelsAuctionInformationModel
    ...
    #' @return ModelsAuctionInformationModel in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to ModelsAuctionInformationModel and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of ModelsAuctionInformationModel
    toString = function() {
      self$toJSONString()
    },
...
# ModelsAuctionInformationModel$unlock()
#
## Below is an example to define the print function
# ModelsAuctionInformationModel$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ModelsAuctionInformationModel$lock()
