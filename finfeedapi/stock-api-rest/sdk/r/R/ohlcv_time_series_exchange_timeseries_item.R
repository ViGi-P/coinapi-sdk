#' Create a new OHLCVTimeSeriesExchangeTimeseriesItem
#'
#' @description
#' Represents a timeseries item with price and volume information.
#'
#' @docType class
#' @title OHLCVTimeSeriesExchangeTimeseriesItem
#' @description OHLCVTimeSeriesExchangeTimeseriesItem Class
...
#' @export
OHLCVTimeSeriesExchangeTimeseriesItem <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new OHLCVTimeSeriesExchangeTimeseriesItem class.
    #'
    ...
    #'
    #' @return OHLCVTimeSeriesExchangeTimeseriesItem as a base R list.
    #' @examples
    #' # convert array of OHLCVTimeSeriesExchangeTimeseriesItem (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert OHLCVTimeSeriesExchangeTimeseriesItem to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      OHLCVTimeSeriesExchangeTimeseriesItemObject <- list()
      if (!is.null(self$`time_period_start`)) {
        OHLCVTimeSeriesExchangeTimeseriesItemObject[["time_period_start"]] <-
          self$`time_period_start`
      }
      if (!is.null(self$`time_period_end`)) {
        OHLCVTimeSeriesExchangeTimeseriesItemObject[["time_period_end"]] <-
          self$`time_period_end`
      }
      if (!is.null(self$`time_open`)) {
        OHLCVTimeSeriesExchangeTimeseriesItemObject[["time_open"]] <-
          self$`time_open`
      }
      if (!is.null(self$`time_close`)) {
        OHLCVTimeSeriesExchangeTimeseriesItemObject[["time_close"]] <-
          self$`time_close`
      }
      if (!is.null(self$`price_open`)) {
        OHLCVTimeSeriesExchangeTimeseriesItemObject[["price_open"]] <-
          self$`price_open`
      }
      if (!is.null(self$`price_high`)) {
        OHLCVTimeSeriesExchangeTimeseriesItemObject[["price_high"]] <-
          self$`price_high`
      }
      if (!is.null(self$`price_low`)) {
        OHLCVTimeSeriesExchangeTimeseriesItemObject[["price_low"]] <-
          self$`price_low`
      }
      if (!is.null(self$`price_close`)) {
        OHLCVTimeSeriesExchangeTimeseriesItemObject[["price_close"]] <-
          self$`price_close`
      }
      if (!is.null(self$`volume_traded`)) {
        OHLCVTimeSeriesExchangeTimeseriesItemObject[["volume_traded"]] <-
          self$`volume_traded`
      }
      if (!is.null(self$`trades_count`)) {
        OHLCVTimeSeriesExchangeTimeseriesItemObject[["trades_count"]] <-
          self$`trades_count`
      }
      if (!is.null(self$`symbol_id_exchange`)) {
        OHLCVTimeSeriesExchangeTimeseriesItemObject[["symbol_id_exchange"]] <-
          self$`symbol_id_exchange`
      }
      return(OHLCVTimeSeriesExchangeTimeseriesItemObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of OHLCVTimeSeriesExchangeTimeseriesItem
    #'
    #' @param input_json the JSON input
    #' @return the instance of OHLCVTimeSeriesExchangeTimeseriesItem
    ...
    #' @return OHLCVTimeSeriesExchangeTimeseriesItem in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to OHLCVTimeSeriesExchangeTimeseriesItem and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of OHLCVTimeSeriesExchangeTimeseriesItem
    toString = function() {
      self$toJSONString()
    },
...
# OHLCVTimeSeriesExchangeTimeseriesItem$unlock()
#
## Below is an example to define the print function
# OHLCVTimeSeriesExchangeTimeseriesItem$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# OHLCVTimeSeriesExchangeTimeseriesItem$lock()
