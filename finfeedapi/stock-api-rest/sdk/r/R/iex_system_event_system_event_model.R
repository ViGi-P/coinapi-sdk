#' Create a new IEXSystemEventSystemEventModel
#'
#' @description
#' Represents the response DTO for system event information
#'
#' @docType class
#' @title IEXSystemEventSystemEventModel
#' @description IEXSystemEventSystemEventModel Class
...
#' @export
IEXSystemEventSystemEventModel <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new IEXSystemEventSystemEventModel class.
    #'
    ...
    #'
    #' @return IEXSystemEventSystemEventModel as a base R list.
    #' @examples
    #' # convert array of IEXSystemEventSystemEventModel (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert IEXSystemEventSystemEventModel to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      IEXSystemEventSystemEventModelObject <- list()
      if (!is.null(self$`timestamp_nanos`)) {
        IEXSystemEventSystemEventModelObject[["timestamp_nanos"]] <-
          self$`timestamp_nanos`
      }
      if (!is.null(self$`timestamp`)) {
        IEXSystemEventSystemEventModelObject[["timestamp"]] <-
          self$`timestamp`
      }
      if (!is.null(self$`system_event`)) {
        IEXSystemEventSystemEventModelObject[["system_event"]] <-
          self$`system_event`
      }
      if (!is.null(self$`system_event_code`)) {
        IEXSystemEventSystemEventModelObject[["system_event_code"]] <-
          self$`system_event_code`
      }
      if (!is.null(self$`system_event_text`)) {
        IEXSystemEventSystemEventModelObject[["system_event_text"]] <-
          self$`system_event_text`
      }
      if (!is.null(self$`is_system_event_start_of_messages`)) {
        IEXSystemEventSystemEventModelObject[["is_system_event_start_of_messages"]] <-
          self$`is_system_event_start_of_messages`
      }
      if (!is.null(self$`is_system_event_start_of_system_hours`)) {
        IEXSystemEventSystemEventModelObject[["is_system_event_start_of_system_hours"]] <-
          self$`is_system_event_start_of_system_hours`
      }
      if (!is.null(self$`is_system_event_start_of_regular_market_hours`)) {
        IEXSystemEventSystemEventModelObject[["is_system_event_start_of_regular_market_hours"]] <-
          self$`is_system_event_start_of_regular_market_hours`
      }
      if (!is.null(self$`is_system_event_end_of_regular_market_hours`)) {
        IEXSystemEventSystemEventModelObject[["is_system_event_end_of_regular_market_hours"]] <-
          self$`is_system_event_end_of_regular_market_hours`
      }
      if (!is.null(self$`is_system_event_end_of_system_hours`)) {
        IEXSystemEventSystemEventModelObject[["is_system_event_end_of_system_hours"]] <-
          self$`is_system_event_end_of_system_hours`
      }
      if (!is.null(self$`is_system_event_end_of_messages`)) {
        IEXSystemEventSystemEventModelObject[["is_system_event_end_of_messages"]] <-
          self$`is_system_event_end_of_messages`
      }
      return(IEXSystemEventSystemEventModelObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of IEXSystemEventSystemEventModel
    #'
    #' @param input_json the JSON input
    #' @return the instance of IEXSystemEventSystemEventModel
    ...
    #' @return IEXSystemEventSystemEventModel in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to IEXSystemEventSystemEventModel and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of IEXSystemEventSystemEventModel
    toString = function() {
      self$toJSONString()
    },
...
# IEXSystemEventSystemEventModel$unlock()
#
## Below is an example to define the print function
# IEXSystemEventSystemEventModel$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# IEXSystemEventSystemEventModel$lock()
