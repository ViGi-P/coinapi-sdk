#' Create a new ModelsSecurityDirectoryModel
#'
#' @description
#' Represents the response DTO for security directory information
#'
#' @docType class
#' @title ModelsSecurityDirectoryModel
#' @description ModelsSecurityDirectoryModel Class
...
#' @export
ModelsSecurityDirectoryModel <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new ModelsSecurityDirectoryModel class.
    #'
    ...
    #'
    #' @return ModelsSecurityDirectoryModel as a base R list.
    #' @examples
    #' # convert array of ModelsSecurityDirectoryModel (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ModelsSecurityDirectoryModel to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      ModelsSecurityDirectoryModelObject <- list()
      if (!is.null(self$`symbol`)) {
        ModelsSecurityDirectoryModelObject[["symbol"]] <-
          self$`symbol`
      }
      if (!is.null(self$`timestamp_nanos`)) {
        ModelsSecurityDirectoryModelObject[["timestamp_nanos"]] <-
          self$`timestamp_nanos`
      }
      if (!is.null(self$`timestamp`)) {
        ModelsSecurityDirectoryModelObject[["timestamp"]] <-
          self$`timestamp`
      }
      if (!is.null(self$`flags`)) {
        ModelsSecurityDirectoryModelObject[["flags"]] <-
          self$`flags`
      }
      if (!is.null(self$`round_lot_size`)) {
        ModelsSecurityDirectoryModelObject[["round_lot_size"]] <-
          self$`round_lot_size`
      }
      if (!is.null(self$`adjusted_poc_price`)) {
        ModelsSecurityDirectoryModelObject[["adjusted_poc_price"]] <-
          self$`adjusted_poc_price`
      }
      if (!is.null(self$`luld_tier`)) {
        ModelsSecurityDirectoryModelObject[["luld_tier"]] <-
          self$`luld_tier`
      }
      if (!is.null(self$`luld_tier_code`)) {
        ModelsSecurityDirectoryModelObject[["luld_tier_code"]] <-
          self$`luld_tier_code`
      }
      if (!is.null(self$`luld_tier_text`)) {
        ModelsSecurityDirectoryModelObject[["luld_tier_text"]] <-
          self$`luld_tier_text`
      }
      if (!is.null(self$`is_luld_tier_not_applicable`)) {
        ModelsSecurityDirectoryModelObject[["is_luld_tier_not_applicable"]] <-
          self$`is_luld_tier_not_applicable`
      }
      if (!is.null(self$`is_luld_tier1`)) {
        ModelsSecurityDirectoryModelObject[["is_luld_tier1"]] <-
          self$`is_luld_tier1`
      }
      if (!is.null(self$`is_luld_tier2`)) {
        ModelsSecurityDirectoryModelObject[["is_luld_tier2"]] <-
          self$`is_luld_tier2`
      }
      return(ModelsSecurityDirectoryModelObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of ModelsSecurityDirectoryModel
    #'
    #' @param input_json the JSON input
    #' @return the instance of ModelsSecurityDirectoryModel
    ...
    #' @return ModelsSecurityDirectoryModel in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to ModelsSecurityDirectoryModel and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of ModelsSecurityDirectoryModel
    toString = function() {
      self$toJSONString()
    },
...
# ModelsSecurityDirectoryModel$unlock()
#
## Below is an example to define the print function
# ModelsSecurityDirectoryModel$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ModelsSecurityDirectoryModel$lock()
