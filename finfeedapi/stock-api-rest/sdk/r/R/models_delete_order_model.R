#' Create a new ModelsDeleteOrderModel
#'
#' @description
#' Represents the response DTO for order delete information
#'
#' @docType class
#' @title ModelsDeleteOrderModel
#' @description ModelsDeleteOrderModel Class
...
#' @export
ModelsDeleteOrderModel <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new ModelsDeleteOrderModel class.
    #'
    ...
    #'
    #' @return ModelsDeleteOrderModel as a base R list.
    #' @examples
    #' # convert array of ModelsDeleteOrderModel (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ModelsDeleteOrderModel to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      ModelsDeleteOrderModelObject <- list()
      if (!is.null(self$`symbol`)) {
        ModelsDeleteOrderModelObject[["symbol"]] <-
          self$`symbol`
      }
      if (!is.null(self$`timestamp_nanos`)) {
        ModelsDeleteOrderModelObject[["timestamp_nanos"]] <-
          self$`timestamp_nanos`
      }
      if (!is.null(self$`timestamp`)) {
        ModelsDeleteOrderModelObject[["timestamp"]] <-
          self$`timestamp`
      }
      if (!is.null(self$`order_id_reference`)) {
        ModelsDeleteOrderModelObject[["order_id_reference"]] <-
          self$`order_id_reference`
      }
      return(ModelsDeleteOrderModelObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of ModelsDeleteOrderModel
    #'
    #' @param input_json the JSON input
    #' @return the instance of ModelsDeleteOrderModel
    ...
    #' @return ModelsDeleteOrderModel in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to ModelsDeleteOrderModel and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of ModelsDeleteOrderModel
    toString = function() {
      self$toJSONString()
    },
...
# ModelsDeleteOrderModel$unlock()
#
## Below is an example to define the print function
# ModelsDeleteOrderModel$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ModelsDeleteOrderModel$lock()
