#' Create a new OHLCVTimeSeriesTimeseriesItem
#'
#' @description
#' Represents a timeseries item with price and volume information.
#'
#' @docType class
#' @title OHLCVTimeSeriesTimeseriesItem
#' @description OHLCVTimeSeriesTimeseriesItem Class
...
#' @export
OHLCVTimeSeriesTimeseriesItem <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new OHLCVTimeSeriesTimeseriesItem class.
    #'
    ...
    #'
    #' @return OHLCVTimeSeriesTimeseriesItem as a base R list.
    #' @examples
    #' # convert array of OHLCVTimeSeriesTimeseriesItem (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert OHLCVTimeSeriesTimeseriesItem to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      OHLCVTimeSeriesTimeseriesItemObject <- list()
      if (!is.null(self$`time_period_start`)) {
        OHLCVTimeSeriesTimeseriesItemObject[["time_period_start"]] <-
          self$`time_period_start`
      }
      if (!is.null(self$`time_period_end`)) {
        OHLCVTimeSeriesTimeseriesItemObject[["time_period_end"]] <-
          self$`time_period_end`
      }
      if (!is.null(self$`time_open`)) {
        OHLCVTimeSeriesTimeseriesItemObject[["time_open"]] <-
          self$`time_open`
      }
      if (!is.null(self$`time_close`)) {
        OHLCVTimeSeriesTimeseriesItemObject[["time_close"]] <-
          self$`time_close`
      }
      if (!is.null(self$`price_open`)) {
        OHLCVTimeSeriesTimeseriesItemObject[["price_open"]] <-
          self$`price_open`
      }
      if (!is.null(self$`price_high`)) {
        OHLCVTimeSeriesTimeseriesItemObject[["price_high"]] <-
          self$`price_high`
      }
      if (!is.null(self$`price_low`)) {
        OHLCVTimeSeriesTimeseriesItemObject[["price_low"]] <-
          self$`price_low`
      }
      if (!is.null(self$`price_close`)) {
        OHLCVTimeSeriesTimeseriesItemObject[["price_close"]] <-
          self$`price_close`
      }
      if (!is.null(self$`volume_traded`)) {
        OHLCVTimeSeriesTimeseriesItemObject[["volume_traded"]] <-
          self$`volume_traded`
      }
      if (!is.null(self$`trades_count`)) {
        OHLCVTimeSeriesTimeseriesItemObject[["trades_count"]] <-
          self$`trades_count`
      }
      return(OHLCVTimeSeriesTimeseriesItemObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of OHLCVTimeSeriesTimeseriesItem
    #'
    #' @param input_json the JSON input
    #' @return the instance of OHLCVTimeSeriesTimeseriesItem
    ...
    #' @return OHLCVTimeSeriesTimeseriesItem in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to OHLCVTimeSeriesTimeseriesItem and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of OHLCVTimeSeriesTimeseriesItem
    toString = function() {
      self$toJSONString()
    },
...
# OHLCVTimeSeriesTimeseriesItem$unlock()
#
## Below is an example to define the print function
# OHLCVTimeSeriesTimeseriesItem$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# OHLCVTimeSeriesTimeseriesItem$lock()
