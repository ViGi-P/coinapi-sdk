#' Create a new ModelsOfficialPriceModel
#'
#' @description
#' Represents the response DTO for official price information
#'
#' @docType class
#' @title ModelsOfficialPriceModel
#' @description ModelsOfficialPriceModel Class
...
#' @export
ModelsOfficialPriceModel <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new ModelsOfficialPriceModel class.
    #'
    ...
    #'
    #' @return ModelsOfficialPriceModel as a base R list.
    #' @examples
    #' # convert array of ModelsOfficialPriceModel (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ModelsOfficialPriceModel to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      ModelsOfficialPriceModelObject <- list()
      if (!is.null(self$`symbol`)) {
        ModelsOfficialPriceModelObject[["symbol"]] <-
          self$`symbol`
      }
      if (!is.null(self$`timestamp_nanos`)) {
        ModelsOfficialPriceModelObject[["timestamp_nanos"]] <-
          self$`timestamp_nanos`
      }
      if (!is.null(self$`timestamp`)) {
        ModelsOfficialPriceModelObject[["timestamp"]] <-
          self$`timestamp`
      }
      if (!is.null(self$`price_type`)) {
        ModelsOfficialPriceModelObject[["price_type"]] <-
          self$`price_type`
      }
      if (!is.null(self$`price_type_code`)) {
        ModelsOfficialPriceModelObject[["price_type_code"]] <-
          self$`price_type_code`
      }
      if (!is.null(self$`price_type_text`)) {
        ModelsOfficialPriceModelObject[["price_type_text"]] <-
          self$`price_type_text`
      }
      if (!is.null(self$`is_price_type_opening`)) {
        ModelsOfficialPriceModelObject[["is_price_type_opening"]] <-
          self$`is_price_type_opening`
      }
      if (!is.null(self$`is_price_type_closing`)) {
        ModelsOfficialPriceModelObject[["is_price_type_closing"]] <-
          self$`is_price_type_closing`
      }
      if (!is.null(self$`official_price`)) {
        ModelsOfficialPriceModelObject[["official_price"]] <-
          self$`official_price`
      }
      return(ModelsOfficialPriceModelObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of ModelsOfficialPriceModel
    #'
    #' @param input_json the JSON input
    #' @return the instance of ModelsOfficialPriceModel
    ...
    #' @return ModelsOfficialPriceModel in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to ModelsOfficialPriceModel and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of ModelsOfficialPriceModel
    toString = function() {
      self$toJSONString()
    },
...
# ModelsOfficialPriceModel$unlock()
#
## Below is an example to define the print function
# ModelsOfficialPriceModel$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ModelsOfficialPriceModel$lock()
