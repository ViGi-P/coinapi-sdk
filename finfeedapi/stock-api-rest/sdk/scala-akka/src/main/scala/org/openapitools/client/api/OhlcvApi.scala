...
class OhlcvApi(baseUrl: String) {
   ...
   */
  def v1OhlcvExchangeSymbolExchangeIdSymbolIdHistoryGet(exchangeId: String, symbolId: String, periodId: String, timeStart: Option[String] = None, timeEnd: Option[String] = None, limit: Option[Int] = None)(implicit apiKey: ApiKeyValue, bearerToken: BearerToken): ApiRequest[Seq[TimeseriesItem]] =
   ...
   * @param limit Amount of items to return (mininum is 1, maximum is 100000, default value is 100, if the parameter is used then every 100 output items are counted as one request)
   */
  def v1OhlcvExchangeSymbolExchangeIdSymbolIdLatestGet(exchangeId: String, symbolId: String, periodId: String, limit: Option[Int] = None)(implicit apiKey: ApiKeyValue, bearerToken: BearerToken): ApiRequest[Seq[TimeseriesItem]] =
