...
-spec v1_ohlcv_exchange_exchange_id_history_get(ctx:ctx(), binary(), binary(), binary(), binary(), maps:map()) -> {ok, [openapi_o_hlcv_time_series_exchange_timeseries_item:openapi_o_hlcv_time_series_exchange_timeseries_item()], openapi_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), openapi_utils:response_info()}.
...
-spec v1_ohlcv_exchange_symbol_exchange_id_symbol_id_history_get(ctx:ctx(), binary(), binary(), binary(), maps:map()) -> {ok, [openapi_o_hlcv_time_series_timeseries_item:openapi_o_hlcv_time_series_timeseries_item()], openapi_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), openapi_utils:response_info()}.
...
-spec v1_ohlcv_exchange_symbol_exchange_id_symbol_id_latest_get(ctx:ctx(), binary(), binary(), binary()) -> {ok, [openapi_o_hlcv_time_series_timeseries_item:openapi_o_hlcv_time_series_timeseries_item()], openapi_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), openapi_utils:response_info()}.
v1_ohlcv_exchange_symbol_exchange_id_symbol_id_latest_get(Ctx, ExchangeId, SymbolId, PeriodId) ->
    v1_ohlcv_exchange_symbol_exchange_id_symbol_id_latest_get(Ctx, ExchangeId, SymbolId, PeriodId, #{}).

-spec v1_ohlcv_exchange_symbol_exchange_id_symbol_id_latest_get(ctx:ctx(), binary(), binary(), binary(), maps:map()) -> {ok, [openapi_o_hlcv_time_series_timeseries_item:openapi_o_hlcv_time_series_timeseries_item()], openapi_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), openapi_utils:response_info()}.
...
-spec v1_ohlcv_periods_get(ctx:ctx()) -> {ok, [openapi_o_hlcv_time_series_timeseries_period:openapi_o_hlcv_time_series_timeseries_period()], openapi_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), openapi_utils:response_info()}.
v1_ohlcv_periods_get(Ctx) ->
    v1_ohlcv_periods_get(Ctx, #{}).

-spec v1_ohlcv_periods_get(ctx:ctx(), maps:map()) -> {ok, [openapi_o_hlcv_time_series_timeseries_period:openapi_o_hlcv_time_series_timeseries_period()], openapi_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), openapi_utils:response_info()}.
