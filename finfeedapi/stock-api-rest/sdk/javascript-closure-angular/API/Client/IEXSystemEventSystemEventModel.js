goog.provide('API.Client.IEXSystemEvent.SystemEventModel');

/**
 * Represents the response DTO for system event information
 * @record
 */
API.Client.IEXSystemEventSystemEventModel = function() {}
 ...
 * @export
 */
API.Client.IEXSystemEventSystemEventModel.prototype.timestampNanos;
 ...
 * @export
 */
API.Client.IEXSystemEventSystemEventModel.prototype.timestamp;
 ...
 * @export
 */
API.Client.IEXSystemEventSystemEventModel.prototype.systemEvent;
 ...
 * @export
 */
API.Client.IEXSystemEventSystemEventModel.prototype.systemEventCode;
 ...
 * @export
 */
API.Client.IEXSystemEventSystemEventModel.prototype.systemEventText;
 ...
 * @export
 */
API.Client.IEXSystemEventSystemEventModel.prototype.isSystemEventStartOfMessages;
 ...
 * @export
 */
API.Client.IEXSystemEventSystemEventModel.prototype.isSystemEventStartOfSystemHours;
 ...
 * @export
 */
API.Client.IEXSystemEventSystemEventModel.prototype.isSystemEventStartOfRegularMarketHours;
 ...
 * @export
 */
API.Client.IEXSystemEventSystemEventModel.prototype.isSystemEventEndOfRegularMarketHours;
 ...
 * @export
 */
API.Client.IEXSystemEventSystemEventModel.prototype.isSystemEventEndOfSystemHours;
 ...
 * @export
 */
API.Client.IEXSystemEventSystemEventModel.prototype.isSystemEventEndOfMessages;
