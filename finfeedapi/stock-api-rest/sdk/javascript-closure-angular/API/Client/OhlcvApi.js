...
goog.require('API.Client.OHLCVTimeSeries.ExchangeTimeseriesItem');
goog.require('API.Client.OHLCVTimeSeries.TimeseriesItem');
goog.require('API.Client.OHLCVTimeSeries.TimeseriesPeriod');
 ...
 * @param {!angular.$http.Config=} opt_extraHttpRequestParams Extra HTTP parameters to send.
 * @return {!angular.$q.Promise<!Array<!API.Client.OHLCVTimeSeries.TimeseriesItem>>}
 */
 ...
 * @param {!angular.$http.Config=} opt_extraHttpRequestParams Extra HTTP parameters to send.
 * @return {!angular.$q.Promise<!Array<!API.Client.OHLCVTimeSeries.TimeseriesPeriod>>}
 */
