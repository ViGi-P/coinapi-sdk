...
sub v1_ohlcv_exchange_exchange_id_history_get {
    ...
    unless (exists $args{'exchange_id'}) {
      croak("Missing the required parameter 'exchange_id' when calling v1_ohlcv_exchange_exchange_id_history_get");
    }

    # verify the required parameter 'period_id' is set
    unless (exists $args{'period_id'}) {
      croak("Missing the required parameter 'period_id' when calling v1_ohlcv_exchange_exchange_id_history_get");
    }

    # verify the required parameter 'time_start' is set
    unless (exists $args{'time_start'}) {
      croak("Missing the required parameter 'time_start' when calling v1_ohlcv_exchange_exchange_id_history_get");
    }

    # verify the required parameter 'time_end' is set
    unless (exists $args{'time_end'}) {
      croak("Missing the required parameter 'time_end' when calling v1_ohlcv_exchange_exchange_id_history_get");
    }

    # parse inputs
    my $_resource_path = '/v1/ohlcv/exchange/{exchange_id}/history';
...
sub v1_ohlcv_exchange_symbol_exchange_id_symbol_id_history_get {
    ...
    # verify the required parameter 'exchange_id' is set
    unless (exists $args{'exchange_id'}) {
      croak("Missing the required parameter 'exchange_id' when calling v1_ohlcv_exchange_symbol_exchange_id_symbol_id_history_get");
    }

    # verify the required parameter 'symbol_id' is set
    unless (exists $args{'symbol_id'}) {
      croak("Missing the required parameter 'symbol_id' when calling v1_ohlcv_exchange_symbol_exchange_id_symbol_id_history_get");
    }

    # verify the required parameter 'period_id' is set
    unless (exists $args{'period_id'}) {
      croak("Missing the required parameter 'period_id' when calling v1_ohlcv_exchange_symbol_exchange_id_symbol_id_history_get");
    }

    # parse inputs
    my $_resource_path = '/v1/ohlcv/exchange-symbol/{exchange_id}/{symbol_id}/history';
...
sub v1_ohlcv_exchange_symbol_exchange_id_symbol_id_latest_get {
    ...
    # verify the required parameter 'exchange_id' is set
    unless (exists $args{'exchange_id'}) {
      croak("Missing the required parameter 'exchange_id' when calling v1_ohlcv_exchange_symbol_exchange_id_symbol_id_latest_get");
    }

    # verify the required parameter 'symbol_id' is set
    unless (exists $args{'symbol_id'}) {
      croak("Missing the required parameter 'symbol_id' when calling v1_ohlcv_exchange_symbol_exchange_id_symbol_id_latest_get");
    }

    # verify the required parameter 'period_id' is set
    unless (exists $args{'period_id'}) {
      croak("Missing the required parameter 'period_id' when calling v1_ohlcv_exchange_symbol_exchange_id_symbol_id_latest_get");
    }

    # parse inputs
    my $_resource_path = '/v1/ohlcv/exchange-symbol/{exchange_id}/{symbol_id}/latest';
