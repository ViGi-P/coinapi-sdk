...
#
package WWW::OpenAPIClient::Object::ModelsSecurityDirectoryModel;
...
__PACKAGE__->class_documentation({description => 'Represents the response DTO for security directory information',
...
__PACKAGE__->method_documentation({
    ...
    'is_luld_tier_not_applicable' => {
        datatype => 'boolean',
        base_name => 'is_luld_tier_not_applicable',
