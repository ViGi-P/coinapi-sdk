...
#
package WWW::OpenAPIClient::Object::ModelsDeleteOrderModel;
...
__PACKAGE__->class_documentation({description => 'Represents the response DTO for order delete information',
