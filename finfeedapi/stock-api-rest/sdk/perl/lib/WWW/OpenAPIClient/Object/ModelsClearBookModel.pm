...
#
package WWW::OpenAPIClient::Object::ModelsClearBookModel;
...
__PACKAGE__->class_documentation({description => 'Represents the response DTO for clear book information',
