...
#
package WWW::OpenAPIClient::Object::ModelsOperationalHaltStatusModel;
...
__PACKAGE__->class_documentation({description => 'Represents the response DTO for operational halt status information',
...
__PACKAGE__->method_documentation({
    ...
    'operational_halt_status_code' => {
        datatype => 'string',
        base_name => 'operational_halt_status_code',
    ...
    'operational_halt_status_text' => {
        datatype => 'string',
        base_name => 'operational_halt_status_text',
    ...
    'is_operationally_halted' => {
        datatype => 'boolean',
        base_name => 'is_operationally_halted',
    ...
    'is_not_operationally_halted' => {
        datatype => 'boolean',
        base_name => 'is_not_operationally_halted',
