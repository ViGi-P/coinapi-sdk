...
#
package WWW::OpenAPIClient::Object::ModelsRetailLiquidityIndicatorModel;
...
__PACKAGE__->class_documentation({description => 'Represents the response DTO for retail liquidity indicator information',
...
__PACKAGE__->method_documentation({
    ...
    'retail_liquidity_indicator_code' => {
        datatype => 'string',
        base_name => 'retail_liquidity_indicator_code',
    ...
    'retail_liquidity_indicator_text' => {
        datatype => 'string',
        base_name => 'retail_liquidity_indicator_text',
    ...
    'is_retail_indicator_not_applicable' => {
        datatype => 'boolean',
        base_name => 'is_retail_indicator_not_applicable',
    ...
    'is_retail_indicator_buy_interest' => {
        datatype => 'boolean',
        base_name => 'is_retail_indicator_buy_interest',
    ...
    'is_retail_indicator_sell_interest' => {
        datatype => 'boolean',
        base_name => 'is_retail_indicator_sell_interest',
    ...
    'is_retail_indicator_buy_and_sell_interest' => {
        datatype => 'boolean',
        base_name => 'is_retail_indicator_buy_and_sell_interest',
