...
#
package WWW::OpenAPIClient::Object::ModelsShortSalePriceTestStatusModel;
...
__PACKAGE__->class_documentation({description => 'Represents the response DTO for short sale price test status information',
...
__PACKAGE__->method_documentation({
    ...
    'short_sale_price_test_status' => {
        datatype => 'int',
        base_name => 'short_sale_price_test_status',
    ...
    'short_sale_price_test_status_code' => {
        datatype => 'string',
        base_name => 'short_sale_price_test_status_code',
    ...
    'short_sale_price_test_status_text' => {
        datatype => 'string',
        base_name => 'short_sale_price_test_status_text',
    ...
    'is_short_sale_price_test_not_in_effect' => {
        datatype => 'boolean',
        base_name => 'is_short_sale_price_test_not_in_effect',
    ...
    'is_short_sale_price_test_in_effect' => {
        datatype => 'boolean',
        base_name => 'is_short_sale_price_test_in_effect',
    ...
    'is_detail_no_price_test' => {
        datatype => 'boolean',
        base_name => 'is_detail_no_price_test',
    ...
    'is_detail_deactivated' => {
        datatype => 'boolean',
        base_name => 'is_detail_deactivated',
    ...
    'is_detail_not_available' => {
        datatype => 'boolean',
        base_name => 'is_detail_not_available',
