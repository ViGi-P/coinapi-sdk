...
#
package WWW::OpenAPIClient::Object::OHLCVTimeSeriesTimeseriesPeriod;
...
__PACKAGE__->class_documentation({description => 'Represents a timeseries period used in exchange rate data.',
