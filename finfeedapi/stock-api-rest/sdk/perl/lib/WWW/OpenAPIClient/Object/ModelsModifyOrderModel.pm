...
#
package WWW::OpenAPIClient::Object::ModelsModifyOrderModel;
...
__PACKAGE__->class_documentation({description => 'Represents the response DTO for order modify information',
