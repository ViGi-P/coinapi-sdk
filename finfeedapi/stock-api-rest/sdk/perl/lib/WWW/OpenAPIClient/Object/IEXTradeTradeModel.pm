...
#
package WWW::OpenAPIClient::Object::IEXTradeTradeModel;
...
__PACKAGE__->class_documentation({description => 'Represents the response DTO for a single trade event (report or break).',
