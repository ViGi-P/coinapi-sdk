...
#
package WWW::OpenAPIClient::Object::ModelsOfficialPriceModel;
...
__PACKAGE__->class_documentation({description => 'Represents the response DTO for official price information',
...
__PACKAGE__->method_documentation({
    ...
    'is_price_type_opening' => {
        datatype => 'boolean',
        base_name => 'is_price_type_opening',
    ...
    'is_price_type_closing' => {
        datatype => 'boolean',
        base_name => 'is_price_type_closing',
