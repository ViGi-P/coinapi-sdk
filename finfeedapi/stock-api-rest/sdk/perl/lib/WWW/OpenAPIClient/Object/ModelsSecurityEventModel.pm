...
#
package WWW::OpenAPIClient::Object::ModelsSecurityEventModel;
...
__PACKAGE__->class_documentation({description => 'Represents the response DTO for security event information',
...
__PACKAGE__->method_documentation({
    ...
    'is_opening_process_complete' => {
        datatype => 'boolean',
        base_name => 'is_opening_process_complete',
    ...
    'is_closing_process_complete' => {
        datatype => 'boolean',
        base_name => 'is_closing_process_complete',
