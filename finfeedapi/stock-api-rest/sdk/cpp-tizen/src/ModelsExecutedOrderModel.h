/*
 * Models.ExecutedOrderModel.h
 *
 * Represents the response DTO for order executed information
 */

#ifndef _Models.ExecutedOrderModel_H_
#define _Models.ExecutedOrderModel_H_
...
class Models.ExecutedOrderModel : public Object {
public:
	/*! \brief Constructor.
	 */
	Models.ExecutedOrderModel();
	Models.ExecutedOrderModel(char* str);

	/*! \brief Destructor.
	 */
	virtual ~Models.ExecutedOrderModel();
...
#endif /* _Models.ExecutedOrderModel_H_ */
