/*
 * Models.SecurityEventModel.h
 *
 * Represents the response DTO for security event information
 */

#ifndef _Models.SecurityEventModel_H_
#define _Models.SecurityEventModel_H_
...
class Models.SecurityEventModel : public Object {
public:
	/*! \brief Constructor.
	 */
	Models.SecurityEventModel();
	Models.SecurityEventModel(char* str);

	/*! \brief Destructor.
	 */
	virtual ~Models.SecurityEventModel();
...
#endif /* _Models.SecurityEventModel_H_ */
