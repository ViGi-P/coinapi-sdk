...
OHLCVTimeSeries.TimeseriesItem::OHLCVTimeSeries.TimeseriesItem()
{
	//__init();
}
...
void
OHLCVTimeSeries.TimeseriesItem::__init()
{
...
void
OHLCVTimeSeries.TimeseriesItem::__cleanup()
{
...
void
OHLCVTimeSeries.TimeseriesItem::fromJson(char* jsonStr)
{
...
OHLCVTimeSeries.TimeseriesItem::OHLCVTimeSeries.TimeseriesItem(char* json)
{
	this->fromJson(json);
}

char*
OHLCVTimeSeries.TimeseriesItem::toJson()
{
...
std::string
OHLCVTimeSeries.TimeseriesItem::getTimePeriodStart()
{
	return time_period_start;
}

void
OHLCVTimeSeries.TimeseriesItem::setTimePeriodStart(std::string  time_period_start)
{
	this->time_period_start = time_period_start;
}

std::string
OHLCVTimeSeries.TimeseriesItem::getTimePeriodEnd()
{
	return time_period_end;
}

void
OHLCVTimeSeries.TimeseriesItem::setTimePeriodEnd(std::string  time_period_end)
{
	this->time_period_end = time_period_end;
}

std::string
OHLCVTimeSeries.TimeseriesItem::getTimeOpen()
{
	return time_open;
}

void
OHLCVTimeSeries.TimeseriesItem::setTimeOpen(std::string  time_open)
{
	this->time_open = time_open;
}

std::string
OHLCVTimeSeries.TimeseriesItem::getTimeClose()
{
	return time_close;
}

void
OHLCVTimeSeries.TimeseriesItem::setTimeClose(std::string  time_close)
{
	this->time_close = time_close;
}

double
OHLCVTimeSeries.TimeseriesItem::getPriceOpen()
{
	return price_open;
}

void
OHLCVTimeSeries.TimeseriesItem::setPriceOpen(double  price_open)
{
	this->price_open = price_open;
}

double
OHLCVTimeSeries.TimeseriesItem::getPriceHigh()
{
	return price_high;
}

void
OHLCVTimeSeries.TimeseriesItem::setPriceHigh(double  price_high)
{
	this->price_high = price_high;
}

double
OHLCVTimeSeries.TimeseriesItem::getPriceLow()
{
	return price_low;
}

void
OHLCVTimeSeries.TimeseriesItem::setPriceLow(double  price_low)
{
	this->price_low = price_low;
}

double
OHLCVTimeSeries.TimeseriesItem::getPriceClose()
{
	return price_close;
}

void
OHLCVTimeSeries.TimeseriesItem::setPriceClose(double  price_close)
{
	this->price_close = price_close;
}

double
OHLCVTimeSeries.TimeseriesItem::getVolumeTraded()
{
	return volume_traded;
}

void
OHLCVTimeSeries.TimeseriesItem::setVolumeTraded(double  volume_traded)
{
	this->volume_traded = volume_traded;
}

long long
OHLCVTimeSeries.TimeseriesItem::getTradesCount()
{
	return trades_count;
}

void
OHLCVTimeSeries.TimeseriesItem::setTradesCount(long long  trades_count)
{
