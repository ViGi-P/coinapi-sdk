...
Models.OperationalHaltStatusModel::Models.OperationalHaltStatusModel()
{
	//__init();
}
...
void
Models.OperationalHaltStatusModel::__init()
{
	//symbol = std::string();
...
void
Models.OperationalHaltStatusModel::__cleanup()
{
	//if(symbol != NULL) {
	//
	//delete symbol;
...
void
Models.OperationalHaltStatusModel::fromJson(char* jsonStr)
{
...
Models.OperationalHaltStatusModel::Models.OperationalHaltStatusModel(char* json)
{
	this->fromJson(json);
}

char*
Models.OperationalHaltStatusModel::toJson()
{
...
std::string
Models.OperationalHaltStatusModel::getSymbol()
{
	return symbol;
}

void
Models.OperationalHaltStatusModel::setSymbol(std::string  symbol)
{
	this->symbol = symbol;
}

long long
Models.OperationalHaltStatusModel::getTimestampNanos()
{
	return timestamp_nanos;
}

void
Models.OperationalHaltStatusModel::setTimestampNanos(long long  timestamp_nanos)
{
	this->timestamp_nanos = timestamp_nanos;
}

std::string
Models.OperationalHaltStatusModel::getTimestamp()
{
	return timestamp;
}

void
Models.OperationalHaltStatusModel::setTimestamp(std::string  timestamp)
{
...
void
Models.OperationalHaltStatusModel::setOperationalHaltStatus(int  operational_halt_status)
{
	this->operational_halt_status = operational_halt_status;
}

std::string
Models.OperationalHaltStatusModel::getOperationalHaltStatusCode()
{
	return operational_halt_status_code;
}

void
Models.OperationalHaltStatusModel::setOperationalHaltStatusCode(std::string  operational_halt_status_code)
{
	this->operational_halt_status_code = operational_halt_status_code;
}

std::string
Models.OperationalHaltStatusModel::getOperationalHaltStatusText()
{
	return operational_halt_status_text;
}

void
Models.OperationalHaltStatusModel::setOperationalHaltStatusText(std::string  operational_halt_status_text)
{
	this->operational_halt_status_text = operational_halt_status_text;
}

bool
Models.OperationalHaltStatusModel::getIsOperationallyHalted()
{
	return is_operationally_halted;
}

void
Models.OperationalHaltStatusModel::setIsOperationallyHalted(bool  is_operationally_halted)
{
	this->is_operationally_halted = is_operationally_halted;
}

bool
Models.OperationalHaltStatusModel::getIsNotOperationallyHalted()
{
	return is_not_operationally_halted;
}

void
Models.OperationalHaltStatusModel::setIsNotOperationallyHalted(bool  is_not_operationally_halted)
{
