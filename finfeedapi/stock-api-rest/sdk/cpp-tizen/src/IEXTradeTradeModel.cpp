...
IEXTrade.TradeModel::IEXTrade.TradeModel()
{
	//__init();
}
...
void
IEXTrade.TradeModel::fromJson(char* jsonStr)
{
...
IEXTrade.TradeModel::IEXTrade.TradeModel(char* json)
{
	this->fromJson(json);
}

char*
IEXTrade.TradeModel::toJson()
{
...
bool
IEXTrade.TradeModel::getIsTradeBreak()
{
	return is_trade_break;
}

void
IEXTrade.TradeModel::setIsTradeBreak(bool  is_trade_break)
{
	this->is_trade_break = is_trade_break;
}

std::string
IEXTrade.TradeModel::getSymbol()
{
	return symbol;
}

void
IEXTrade.TradeModel::setSymbol(std::string  symbol)
{
	this->symbol = symbol;
}

long long
IEXTrade.TradeModel::getTimestampNanos()
{
	return timestamp_nanos;
}

void
IEXTrade.TradeModel::setTimestampNanos(long long  timestamp_nanos)
{
	this->timestamp_nanos = timestamp_nanos;
}

std::string
IEXTrade.TradeModel::getTimestamp()
{
	return timestamp;
}

void
IEXTrade.TradeModel::setTimestamp(std::string  timestamp)
{
	this->timestamp = timestamp;
}

int
IEXTrade.TradeModel::getSize()
{
	return size;
}

void
IEXTrade.TradeModel::setSize(int  size)
{
	this->size = size;
}

double
IEXTrade.TradeModel::getPrice()
{
	return price;
}

void
IEXTrade.TradeModel::setPrice(double  price)
{
	this->price = price;
}

long long
IEXTrade.TradeModel::getTradeId()
{
	return trade_id;
}

void
IEXTrade.TradeModel::setTradeId(long long  trade_id)
{
	this->trade_id = trade_id;
}

bool
IEXTrade.TradeModel::getIsIntermarketSweep()
{
	return is_intermarket_sweep;
}

void
IEXTrade.TradeModel::setIsIntermarketSweep(bool  is_intermarket_sweep)
{
	this->is_intermarket_sweep = is_intermarket_sweep;
}

bool
IEXTrade.TradeModel::getIsExtendedHoursTrade()
{
	return is_extended_hours_trade;
}

void
IEXTrade.TradeModel::setIsExtendedHoursTrade(bool  is_extended_hours_trade)
{
	this->is_extended_hours_trade = is_extended_hours_trade;
}

bool
IEXTrade.TradeModel::getIsOddLotTrade()
{
	return is_odd_lot_trade;
}

void
IEXTrade.TradeModel::setIsOddLotTrade(bool  is_odd_lot_trade)
{
	this->is_odd_lot_trade = is_odd_lot_trade;
}

bool
IEXTrade.TradeModel::getIsTradeThroughExempt()
{
	return is_trade_through_exempt;
}

void
IEXTrade.TradeModel::setIsTradeThroughExempt(bool  is_trade_through_exempt)
{
	this->is_trade_through_exempt = is_trade_through_exempt;
}

bool
IEXTrade.TradeModel::getIsSinglePriceCrossTrade()
{
	return is_single_price_cross_trade;
}

void
IEXTrade.TradeModel::setIsSinglePriceCrossTrade(bool  is_single_price_cross_trade)
{
