/*
 * Models.SecurityDirectoryModel.h
 *
 * Represents the response DTO for security directory information
 */

#ifndef _Models.SecurityDirectoryModel_H_
#define _Models.SecurityDirectoryModel_H_
...
class Models.SecurityDirectoryModel : public Object {
public:
	/*! \brief Constructor.
	 */
	Models.SecurityDirectoryModel();
	Models.SecurityDirectoryModel(char* str);

	/*! \brief Destructor.
	 */
	virtual ~Models.SecurityDirectoryModel();
...
#endif /* _Models.SecurityDirectoryModel_H_ */
