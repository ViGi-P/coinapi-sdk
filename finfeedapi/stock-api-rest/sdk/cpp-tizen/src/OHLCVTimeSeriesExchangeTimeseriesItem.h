/*
 * OHLCVTimeSeries.ExchangeTimeseriesItem.h
 *
 * Represents a timeseries item with price and volume information.
 */

#ifndef _OHLCVTimeSeries.ExchangeTimeseriesItem_H_
#define _OHLCVTimeSeries.ExchangeTimeseriesItem_H_
...
class OHLCVTimeSeries.ExchangeTimeseriesItem : public Object {
public:
	/*! \brief Constructor.
	 */
	OHLCVTimeSeries.ExchangeTimeseriesItem();
	OHLCVTimeSeries.ExchangeTimeseriesItem(char* str);

	/*! \brief Destructor.
	 */
	virtual ~OHLCVTimeSeries.ExchangeTimeseriesItem();
...
#endif /* _OHLCVTimeSeries.ExchangeTimeseriesItem_H_ */
