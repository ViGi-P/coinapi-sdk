/*
 * Models.DeleteOrderModel.h
 *
 * Represents the response DTO for order delete information
 */

#ifndef _Models.DeleteOrderModel_H_
#define _Models.DeleteOrderModel_H_
...
class Models.DeleteOrderModel : public Object {
public:
	/*! \brief Constructor.
	 */
	Models.DeleteOrderModel();
	Models.DeleteOrderModel(char* str);

	/*! \brief Destructor.
	 */
	virtual ~Models.DeleteOrderModel();
...
#endif /* _Models.DeleteOrderModel_H_ */
