/*
 * Models.AddOrderModel.h
 *
 * Represents the response DTO for add order information
 */

#ifndef _Models.AddOrderModel_H_
#define _Models.AddOrderModel_H_
...
class Models.AddOrderModel : public Object {
public:
	/*! \brief Constructor.
	 */
	Models.AddOrderModel();
	Models.AddOrderModel(char* str);

	/*! \brief Destructor.
	 */
	virtual ~Models.AddOrderModel();
...
#endif /* _Models.AddOrderModel_H_ */
