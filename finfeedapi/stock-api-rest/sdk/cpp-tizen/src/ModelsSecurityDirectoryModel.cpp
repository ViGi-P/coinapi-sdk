...
Models.SecurityDirectoryModel::Models.SecurityDirectoryModel()
{
	//__init();
}
...
void
Models.SecurityDirectoryModel::__init()
{
	//symbol = std::string();
...
void
Models.SecurityDirectoryModel::__cleanup()
{
	//if(symbol != NULL) {
	//
	//delete symbol;
...
void
Models.SecurityDirectoryModel::fromJson(char* jsonStr)
{
...
Models.SecurityDirectoryModel::Models.SecurityDirectoryModel(char* json)
{
	this->fromJson(json);
}

char*
Models.SecurityDirectoryModel::toJson()
{
...
std::string
Models.SecurityDirectoryModel::getSymbol()
{
	return symbol;
}

void
Models.SecurityDirectoryModel::setSymbol(std::string  symbol)
{
	this->symbol = symbol;
}

long long
Models.SecurityDirectoryModel::getTimestampNanos()
{
	return timestamp_nanos;
}

void
Models.SecurityDirectoryModel::setTimestampNanos(long long  timestamp_nanos)
{
	this->timestamp_nanos = timestamp_nanos;
}

std::string
Models.SecurityDirectoryModel::getTimestamp()
{
	return timestamp;
}

void
Models.SecurityDirectoryModel::setTimestamp(std::string  timestamp)
{
	this->timestamp = timestamp;
}

int
Models.SecurityDirectoryModel::getFlags()
{
	return flags;
}

void
Models.SecurityDirectoryModel::setFlags(int  flags)
{
	this->flags = flags;
}

int
Models.SecurityDirectoryModel::getRoundLotSize()
{
	return round_lot_size;
}

void
Models.SecurityDirectoryModel::setRoundLotSize(int  round_lot_size)
{
	this->round_lot_size = round_lot_size;
}

double
Models.SecurityDirectoryModel::getAdjustedPocPrice()
{
	return adjusted_poc_price;
}

void
Models.SecurityDirectoryModel::setAdjustedPocPrice(double  adjusted_poc_price)
{
	this->adjusted_poc_price = adjusted_poc_price;
}

int
Models.SecurityDirectoryModel::getLuldTier()
{
	return luld_tier;
}

void
Models.SecurityDirectoryModel::setLuldTier(int  luld_tier)
{
	this->luld_tier = luld_tier;
}

std::string
Models.SecurityDirectoryModel::getLuldTierCode()
{
	return luld_tier_code;
}

void
Models.SecurityDirectoryModel::setLuldTierCode(std::string  luld_tier_code)
{
	this->luld_tier_code = luld_tier_code;
}

std::string
Models.SecurityDirectoryModel::getLuldTierText()
{
	return luld_tier_text;
}

void
Models.SecurityDirectoryModel::setLuldTierText(std::string  luld_tier_text)
{
	this->luld_tier_text = luld_tier_text;
}

bool
Models.SecurityDirectoryModel::getIsLuldTierNotApplicable()
{
	return is_luld_tier_not_applicable;
}

void
Models.SecurityDirectoryModel::setIsLuldTierNotApplicable(bool  is_luld_tier_not_applicable)
{
	this->is_luld_tier_not_applicable = is_luld_tier_not_applicable;
}

bool
Models.SecurityDirectoryModel::getIsLuldTier1()
{
	return is_luld_tier1;
}

void
Models.SecurityDirectoryModel::setIsLuldTier1(bool  is_luld_tier1)
{
	this->is_luld_tier1 = is_luld_tier1;
}

bool
Models.SecurityDirectoryModel::getIsLuldTier2()
{
	return is_luld_tier2;
}

void
Models.SecurityDirectoryModel::setIsLuldTier2(bool  is_luld_tier2)
{
