/*
 * OHLCVTimeSeries.TimeseriesPeriod.h
 *
 * Represents a timeseries period used in exchange rate data.
 */

#ifndef _OHLCVTimeSeries.TimeseriesPeriod_H_
#define _OHLCVTimeSeries.TimeseriesPeriod_H_
...
class OHLCVTimeSeries.TimeseriesPeriod : public Object {
public:
	/*! \brief Constructor.
	 */
	OHLCVTimeSeries.TimeseriesPeriod();
	OHLCVTimeSeries.TimeseriesPeriod(char* str);

	/*! \brief Destructor.
	 */
	virtual ~OHLCVTimeSeries.TimeseriesPeriod();
...
#endif /* _OHLCVTimeSeries.TimeseriesPeriod_H_ */
