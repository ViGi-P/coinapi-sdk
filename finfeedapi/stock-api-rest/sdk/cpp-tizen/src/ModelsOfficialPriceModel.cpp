...
Models.OfficialPriceModel::Models.OfficialPriceModel()
{
	//__init();
}
...
void
Models.OfficialPriceModel::__init()
{
	//symbol = std::string();
...
void
Models.OfficialPriceModel::__cleanup()
{
	//if(symbol != NULL) {
	//
	//delete symbol;
...
void
Models.OfficialPriceModel::fromJson(char* jsonStr)
{
...
Models.OfficialPriceModel::Models.OfficialPriceModel(char* json)
{
	this->fromJson(json);
}

char*
Models.OfficialPriceModel::toJson()
{
...
std::string
Models.OfficialPriceModel::getSymbol()
{
	return symbol;
}

void
Models.OfficialPriceModel::setSymbol(std::string  symbol)
{
	this->symbol = symbol;
}

long long
Models.OfficialPriceModel::getTimestampNanos()
{
	return timestamp_nanos;
}

void
Models.OfficialPriceModel::setTimestampNanos(long long  timestamp_nanos)
{
	this->timestamp_nanos = timestamp_nanos;
}

std::string
Models.OfficialPriceModel::getTimestamp()
{
	return timestamp;
}

void
Models.OfficialPriceModel::setTimestamp(std::string  timestamp)
{
	this->timestamp = timestamp;
}

int
Models.OfficialPriceModel::getPriceType()
{
	return price_type;
}

void
Models.OfficialPriceModel::setPriceType(int  price_type)
{
	this->price_type = price_type;
}

std::string
Models.OfficialPriceModel::getPriceTypeCode()
{
	return price_type_code;
}

void
Models.OfficialPriceModel::setPriceTypeCode(std::string  price_type_code)
{
	this->price_type_code = price_type_code;
}

std::string
Models.OfficialPriceModel::getPriceTypeText()
{
	return price_type_text;
}

void
Models.OfficialPriceModel::setPriceTypeText(std::string  price_type_text)
{
	this->price_type_text = price_type_text;
}

bool
Models.OfficialPriceModel::getIsPriceTypeOpening()
{
	return is_price_type_opening;
}

void
Models.OfficialPriceModel::setIsPriceTypeOpening(bool  is_price_type_opening)
{
	this->is_price_type_opening = is_price_type_opening;
}

bool
Models.OfficialPriceModel::getIsPriceTypeClosing()
{
	return is_price_type_closing;
}

void
Models.OfficialPriceModel::setIsPriceTypeClosing(bool  is_price_type_closing)
{
...
void
Models.OfficialPriceModel::setOfficialPrice(double  official_price)
{
