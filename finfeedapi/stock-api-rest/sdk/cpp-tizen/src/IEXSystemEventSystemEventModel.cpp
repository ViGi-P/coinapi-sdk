...
IEXSystemEvent.SystemEventModel::IEXSystemEvent.SystemEventModel()
{
	//__init();
}
...
void
IEXSystemEvent.SystemEventModel::__init()
{
...
void
IEXSystemEvent.SystemEventModel::__cleanup()
{
...
void
IEXSystemEvent.SystemEventModel::fromJson(char* jsonStr)
{
...
IEXSystemEvent.SystemEventModel::IEXSystemEvent.SystemEventModel(char* json)
{
	this->fromJson(json);
}

char*
IEXSystemEvent.SystemEventModel::toJson()
{
...
long long
IEXSystemEvent.SystemEventModel::getTimestampNanos()
{
	return timestamp_nanos;
}

void
IEXSystemEvent.SystemEventModel::setTimestampNanos(long long  timestamp_nanos)
{
	this->timestamp_nanos = timestamp_nanos;
}

std::string
IEXSystemEvent.SystemEventModel::getTimestamp()
{
	return timestamp;
}

void
IEXSystemEvent.SystemEventModel::setTimestamp(std::string  timestamp)
{
...
void
IEXSystemEvent.SystemEventModel::setSystemEvent(int  system_event)
{
	this->system_event = system_event;
}

std::string
IEXSystemEvent.SystemEventModel::getSystemEventCode()
{
	return system_event_code;
}

void
IEXSystemEvent.SystemEventModel::setSystemEventCode(std::string  system_event_code)
{
	this->system_event_code = system_event_code;
}

std::string
IEXSystemEvent.SystemEventModel::getSystemEventText()
{
	return system_event_text;
}

void
IEXSystemEvent.SystemEventModel::setSystemEventText(std::string  system_event_text)
{
	this->system_event_text = system_event_text;
}

bool
IEXSystemEvent.SystemEventModel::getIsSystemEventStartOfMessages()
{
	return is_system_event_start_of_messages;
}

void
IEXSystemEvent.SystemEventModel::setIsSystemEventStartOfMessages(bool  is_system_event_start_of_messages)
{
	this->is_system_event_start_of_messages = is_system_event_start_of_messages;
}

bool
IEXSystemEvent.SystemEventModel::getIsSystemEventStartOfSystemHours()
{
	return is_system_event_start_of_system_hours;
}

void
IEXSystemEvent.SystemEventModel::setIsSystemEventStartOfSystemHours(bool  is_system_event_start_of_system_hours)
{
	this->is_system_event_start_of_system_hours = is_system_event_start_of_system_hours;
}

bool
IEXSystemEvent.SystemEventModel::getIsSystemEventStartOfRegularMarketHours()
{
	return is_system_event_start_of_regular_market_hours;
}

void
IEXSystemEvent.SystemEventModel::setIsSystemEventStartOfRegularMarketHours(bool  is_system_event_start_of_regular_market_hours)
{
	this->is_system_event_start_of_regular_market_hours = is_system_event_start_of_regular_market_hours;
}

bool
IEXSystemEvent.SystemEventModel::getIsSystemEventEndOfRegularMarketHours()
{
	return is_system_event_end_of_regular_market_hours;
}

void
IEXSystemEvent.SystemEventModel::setIsSystemEventEndOfRegularMarketHours(bool  is_system_event_end_of_regular_market_hours)
{
	this->is_system_event_end_of_regular_market_hours = is_system_event_end_of_regular_market_hours;
}

bool
IEXSystemEvent.SystemEventModel::getIsSystemEventEndOfSystemHours()
{
	return is_system_event_end_of_system_hours;
}

void
IEXSystemEvent.SystemEventModel::setIsSystemEventEndOfSystemHours(bool  is_system_event_end_of_system_hours)
{
	this->is_system_event_end_of_system_hours = is_system_event_end_of_system_hours;
}

bool
IEXSystemEvent.SystemEventModel::getIsSystemEventEndOfMessages()
{
	return is_system_event_end_of_messages;
}

void
IEXSystemEvent.SystemEventModel::setIsSystemEventEndOfMessages(bool  is_system_event_end_of_messages)
{
