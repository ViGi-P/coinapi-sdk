/*
 * Models.ClearBookModel.h
 *
 * Represents the response DTO for clear book information
 */

#ifndef _Models.ClearBookModel_H_
#define _Models.ClearBookModel_H_
...
class Models.ClearBookModel : public Object {
public:
	/*! \brief Constructor.
	 */
	Models.ClearBookModel();
	Models.ClearBookModel(char* str);

	/*! \brief Destructor.
	 */
	virtual ~Models.ClearBookModel();
...
#endif /* _Models.ClearBookModel_H_ */
