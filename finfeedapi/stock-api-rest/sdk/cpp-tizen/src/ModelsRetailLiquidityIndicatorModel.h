/*
 * Models.RetailLiquidityIndicatorModel.h
 *
 * Represents the response DTO for retail liquidity indicator information
 */

#ifndef _Models.RetailLiquidityIndicatorModel_H_
#define _Models.RetailLiquidityIndicatorModel_H_
...
class Models.RetailLiquidityIndicatorModel : public Object {
public:
	/*! \brief Constructor.
	 */
	Models.RetailLiquidityIndicatorModel();
	Models.RetailLiquidityIndicatorModel(char* str);

	/*! \brief Destructor.
	 */
	virtual ~Models.RetailLiquidityIndicatorModel();
...
#endif /* _Models.RetailLiquidityIndicatorModel_H_ */
