/*
 * Models.ShortSalePriceTestStatusModel.h
 *
 * Represents the response DTO for short sale price test status information
 */

#ifndef _Models.ShortSalePriceTestStatusModel_H_
#define _Models.ShortSalePriceTestStatusModel_H_
...
class Models.ShortSalePriceTestStatusModel : public Object {
public:
	/*! \brief Constructor.
	 */
	Models.ShortSalePriceTestStatusModel();
	Models.ShortSalePriceTestStatusModel(char* str);

	/*! \brief Destructor.
	 */
	virtual ~Models.ShortSalePriceTestStatusModel();
...
#endif /* _Models.ShortSalePriceTestStatusModel_H_ */
