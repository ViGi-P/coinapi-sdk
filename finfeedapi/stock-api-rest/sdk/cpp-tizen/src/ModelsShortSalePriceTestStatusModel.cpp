...
Models.ShortSalePriceTestStatusModel::Models.ShortSalePriceTestStatusModel()
{
	//__init();
}
...
void
Models.ShortSalePriceTestStatusModel::__init()
{
	//symbol = std::string();
...
void
Models.ShortSalePriceTestStatusModel::__cleanup()
{
	//if(symbol != NULL) {
	//
	//delete symbol;
...
void
Models.ShortSalePriceTestStatusModel::fromJson(char* jsonStr)
{
...
Models.ShortSalePriceTestStatusModel::Models.ShortSalePriceTestStatusModel(char* json)
{
	this->fromJson(json);
}

char*
Models.ShortSalePriceTestStatusModel::toJson()
{
...
std::string
Models.ShortSalePriceTestStatusModel::getSymbol()
{
	return symbol;
}

void
Models.ShortSalePriceTestStatusModel::setSymbol(std::string  symbol)
{
	this->symbol = symbol;
}

long long
Models.ShortSalePriceTestStatusModel::getTimestampNanos()
{
	return timestamp_nanos;
}

void
Models.ShortSalePriceTestStatusModel::setTimestampNanos(long long  timestamp_nanos)
{
	this->timestamp_nanos = timestamp_nanos;
}

std::string
Models.ShortSalePriceTestStatusModel::getTimestamp()
{
	return timestamp;
}

void
Models.ShortSalePriceTestStatusModel::setTimestamp(std::string  timestamp)
{
	this->timestamp = timestamp;
}

int
Models.ShortSalePriceTestStatusModel::getShortSalePriceTestStatus()
{
	return short_sale_price_test_status;
}

void
Models.ShortSalePriceTestStatusModel::setShortSalePriceTestStatus(int  short_sale_price_test_status)
{
	this->short_sale_price_test_status = short_sale_price_test_status;
}

std::string
Models.ShortSalePriceTestStatusModel::getShortSalePriceTestStatusCode()
{
	return short_sale_price_test_status_code;
}

void
Models.ShortSalePriceTestStatusModel::setShortSalePriceTestStatusCode(std::string  short_sale_price_test_status_code)
{
	this->short_sale_price_test_status_code = short_sale_price_test_status_code;
}

std::string
Models.ShortSalePriceTestStatusModel::getShortSalePriceTestStatusText()
{
	return short_sale_price_test_status_text;
}

void
Models.ShortSalePriceTestStatusModel::setShortSalePriceTestStatusText(std::string  short_sale_price_test_status_text)
{
	this->short_sale_price_test_status_text = short_sale_price_test_status_text;
}

bool
Models.ShortSalePriceTestStatusModel::getIsShortSalePriceTestNotInEffect()
{
	return is_short_sale_price_test_not_in_effect;
}

void
Models.ShortSalePriceTestStatusModel::setIsShortSalePriceTestNotInEffect(bool  is_short_sale_price_test_not_in_effect)
{
	this->is_short_sale_price_test_not_in_effect = is_short_sale_price_test_not_in_effect;
}

bool
Models.ShortSalePriceTestStatusModel::getIsShortSalePriceTestInEffect()
{
	return is_short_sale_price_test_in_effect;
}

void
Models.ShortSalePriceTestStatusModel::setIsShortSalePriceTestInEffect(bool  is_short_sale_price_test_in_effect)
{
	this->is_short_sale_price_test_in_effect = is_short_sale_price_test_in_effect;
}

int
Models.ShortSalePriceTestStatusModel::getDetail()
{
	return detail;
}

void
Models.ShortSalePriceTestStatusModel::setDetail(int  detail)
{
	this->detail = detail;
}

std::string
Models.ShortSalePriceTestStatusModel::getDetailCode()
{
	return detail_code;
}

void
Models.ShortSalePriceTestStatusModel::setDetailCode(std::string  detail_code)
{
	this->detail_code = detail_code;
}

std::string
Models.ShortSalePriceTestStatusModel::getDetailText()
{
	return detail_text;
}

void
Models.ShortSalePriceTestStatusModel::setDetailText(std::string  detail_text)
{
	this->detail_text = detail_text;
}

bool
Models.ShortSalePriceTestStatusModel::getIsDetailNoPriceTest()
{
	return is_detail_no_price_test;
}

void
Models.ShortSalePriceTestStatusModel::setIsDetailNoPriceTest(bool  is_detail_no_price_test)
{
	this->is_detail_no_price_test = is_detail_no_price_test;
}

bool
Models.ShortSalePriceTestStatusModel::getIsDetailActivated()
{
	return is_detail_activated;
}

void
Models.ShortSalePriceTestStatusModel::setIsDetailActivated(bool  is_detail_activated)
{
	this->is_detail_activated = is_detail_activated;
}

bool
Models.ShortSalePriceTestStatusModel::getIsDetailContinued()
{
	return is_detail_continued;
}

void
Models.ShortSalePriceTestStatusModel::setIsDetailContinued(bool  is_detail_continued)
{
	this->is_detail_continued = is_detail_continued;
}

bool
Models.ShortSalePriceTestStatusModel::getIsDetailDeactivated()
{
	return is_detail_deactivated;
}

void
Models.ShortSalePriceTestStatusModel::setIsDetailDeactivated(bool  is_detail_deactivated)
{
	this->is_detail_deactivated = is_detail_deactivated;
}

bool
Models.ShortSalePriceTestStatusModel::getIsDetailNotAvailable()
{
	return is_detail_not_available;
}

void
Models.ShortSalePriceTestStatusModel::setIsDetailNotAvailable(bool  is_detail_not_available)
{
