/*
 * IEXSystemEvent.SystemEventModel.h
 *
 * Represents the response DTO for system event information
 */

#ifndef _IEXSystemEvent.SystemEventModel_H_
#define _IEXSystemEvent.SystemEventModel_H_
...
class IEXSystemEvent.SystemEventModel : public Object {
public:
	/*! \brief Constructor.
	 */
	IEXSystemEvent.SystemEventModel();
	IEXSystemEvent.SystemEventModel(char* str);

	/*! \brief Destructor.
	 */
	virtual ~IEXSystemEvent.SystemEventModel();
...
#endif /* _IEXSystemEvent.SystemEventModel_H_ */
