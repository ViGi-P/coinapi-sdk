/*
 * OHLCVTimeSeries.TimeseriesItem.h
 *
 * Represents a timeseries item with price and volume information.
 */

#ifndef _OHLCVTimeSeries.TimeseriesItem_H_
#define _OHLCVTimeSeries.TimeseriesItem_H_
...
class OHLCVTimeSeries.TimeseriesItem : public Object {
public:
	/*! \brief Constructor.
	 */
	OHLCVTimeSeries.TimeseriesItem();
	OHLCVTimeSeries.TimeseriesItem(char* str);

	/*! \brief Destructor.
	 */
	virtual ~OHLCVTimeSeries.TimeseriesItem();
...
#endif /* _OHLCVTimeSeries.TimeseriesItem_H_ */
