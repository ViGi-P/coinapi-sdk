/*
 * Models.OfficialPriceModel.h
 *
 * Represents the response DTO for official price information
 */

#ifndef _Models.OfficialPriceModel_H_
#define _Models.OfficialPriceModel_H_
...
class Models.OfficialPriceModel : public Object {
public:
	/*! \brief Constructor.
	 */
	Models.OfficialPriceModel();
	Models.OfficialPriceModel(char* str);

	/*! \brief Destructor.
	 */
	virtual ~Models.OfficialPriceModel();
...
#endif /* _Models.OfficialPriceModel_H_ */
