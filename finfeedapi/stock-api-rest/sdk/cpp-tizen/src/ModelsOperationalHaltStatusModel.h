/*
 * Models.OperationalHaltStatusModel.h
 *
 * Represents the response DTO for operational halt status information
 */

#ifndef _Models.OperationalHaltStatusModel_H_
#define _Models.OperationalHaltStatusModel_H_
...
class Models.OperationalHaltStatusModel : public Object {
public:
	/*! \brief Constructor.
	 */
	Models.OperationalHaltStatusModel();
	Models.OperationalHaltStatusModel(char* str);

	/*! \brief Destructor.
	 */
	virtual ~Models.OperationalHaltStatusModel();
...
#endif /* _Models.OperationalHaltStatusModel_H_ */
