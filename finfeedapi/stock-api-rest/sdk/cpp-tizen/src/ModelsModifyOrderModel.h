/*
 * Models.ModifyOrderModel.h
 *
 * Represents the response DTO for order modify information
 */

#ifndef _Models.ModifyOrderModel_H_
#define _Models.ModifyOrderModel_H_
...
class Models.ModifyOrderModel : public Object {
public:
	/*! \brief Constructor.
	 */
	Models.ModifyOrderModel();
	Models.ModifyOrderModel(char* str);

	/*! \brief Destructor.
	 */
	virtual ~Models.ModifyOrderModel();
...
#endif /* _Models.ModifyOrderModel_H_ */
