...
Models.AuctionInformationModel::Models.AuctionInformationModel()
{
	//__init();
}
...
void
Models.AuctionInformationModel::__init()
{
	//symbol = std::string();
...
void
Models.AuctionInformationModel::__cleanup()
{
	//if(symbol != NULL) {
	//
	//delete symbol;
...
void
Models.AuctionInformationModel::fromJson(char* jsonStr)
{
...
Models.AuctionInformationModel::Models.AuctionInformationModel(char* json)
{
	this->fromJson(json);
}

char*
Models.AuctionInformationModel::toJson()
{
...
std::string
Models.AuctionInformationModel::getSymbol()
{
	return symbol;
}

void
Models.AuctionInformationModel::setSymbol(std::string  symbol)
{
	this->symbol = symbol;
}

long long
Models.AuctionInformationModel::getTimestampNanos()
{
	return timestamp_nanos;
}

void
Models.AuctionInformationModel::setTimestampNanos(long long  timestamp_nanos)
{
	this->timestamp_nanos = timestamp_nanos;
}

std::string
Models.AuctionInformationModel::getTimestamp()
{
	return timestamp;
}

void
Models.AuctionInformationModel::setTimestamp(std::string  timestamp)
{
	this->timestamp = timestamp;
}

int
Models.AuctionInformationModel::getAuctionType()
{
	return auction_type;
}

void
Models.AuctionInformationModel::setAuctionType(int  auction_type)
{
	this->auction_type = auction_type;
}

std::string
Models.AuctionInformationModel::getAuctionTypeCode()
{
	return auction_type_code;
}

void
Models.AuctionInformationModel::setAuctionTypeCode(std::string  auction_type_code)
{
	this->auction_type_code = auction_type_code;
}

std::string
Models.AuctionInformationModel::getAuctionTypeText()
{
	return auction_type_text;
}

void
Models.AuctionInformationModel::setAuctionTypeText(std::string  auction_type_text)
{
	this->auction_type_text = auction_type_text;
}

bool
Models.AuctionInformationModel::getIsAuctionTypeOpening()
{
	return is_auction_type_opening;
}

void
Models.AuctionInformationModel::setIsAuctionTypeOpening(bool  is_auction_type_opening)
{
	this->is_auction_type_opening = is_auction_type_opening;
}

bool
Models.AuctionInformationModel::getIsAuctionTypeClosing()
{
	return is_auction_type_closing;
}

void
Models.AuctionInformationModel::setIsAuctionTypeClosing(bool  is_auction_type_closing)
{
	this->is_auction_type_closing = is_auction_type_closing;
}

bool
Models.AuctionInformationModel::getIsAuctionTypeIpo()
{
	return is_auction_type_ipo;
}

void
Models.AuctionInformationModel::setIsAuctionTypeIpo(bool  is_auction_type_ipo)
{
	this->is_auction_type_ipo = is_auction_type_ipo;
}

bool
Models.AuctionInformationModel::getIsAuctionTypeHalt()
{
	return is_auction_type_halt;
}

void
Models.AuctionInformationModel::setIsAuctionTypeHalt(bool  is_auction_type_halt)
{
	this->is_auction_type_halt = is_auction_type_halt;
}

bool
Models.AuctionInformationModel::getIsAuctionTypeVolatility()
{
	return is_auction_type_volatility;
}

void
Models.AuctionInformationModel::setIsAuctionTypeVolatility(bool  is_auction_type_volatility)
{
	this->is_auction_type_volatility = is_auction_type_volatility;
}

int
Models.AuctionInformationModel::getPairedShares()
{
	return paired_shares;
}

void
Models.AuctionInformationModel::setPairedShares(int  paired_shares)
{
	this->paired_shares = paired_shares;
}

double
Models.AuctionInformationModel::getReferencePrice()
{
	return reference_price;
}

void
Models.AuctionInformationModel::setReferencePrice(double  reference_price)
{
	this->reference_price = reference_price;
}

double
Models.AuctionInformationModel::getIndicativeClearingPrice()
{
	return indicative_clearing_price;
}

void
Models.AuctionInformationModel::setIndicativeClearingPrice(double  indicative_clearing_price)
{
	this->indicative_clearing_price = indicative_clearing_price;
}

int
Models.AuctionInformationModel::getImbalanceShares()
{
	return imbalance_shares;
}

void
Models.AuctionInformationModel::setImbalanceShares(int  imbalance_shares)
{
	this->imbalance_shares = imbalance_shares;
}

int
Models.AuctionInformationModel::getImbalanceSide()
{
	return imbalance_side;
}

void
Models.AuctionInformationModel::setImbalanceSide(int  imbalance_side)
{
	this->imbalance_side = imbalance_side;
}

std::string
Models.AuctionInformationModel::getImbalanceSideCode()
{
	return imbalance_side_code;
}

void
Models.AuctionInformationModel::setImbalanceSideCode(std::string  imbalance_side_code)
{
	this->imbalance_side_code = imbalance_side_code;
}

std::string
Models.AuctionInformationModel::getImbalanceSideText()
{
	return imbalance_side_text;
}

void
Models.AuctionInformationModel::setImbalanceSideText(std::string  imbalance_side_text)
{
	this->imbalance_side_text = imbalance_side_text;
}

bool
Models.AuctionInformationModel::getIsImbalanceSideBuy()
{
	return is_imbalance_side_buy;
}

void
Models.AuctionInformationModel::setIsImbalanceSideBuy(bool  is_imbalance_side_buy)
{
	this->is_imbalance_side_buy = is_imbalance_side_buy;
}

bool
Models.AuctionInformationModel::getIsImbalanceSideSell()
{
	return is_imbalance_side_sell;
}

void
Models.AuctionInformationModel::setIsImbalanceSideSell(bool  is_imbalance_side_sell)
{
	this->is_imbalance_side_sell = is_imbalance_side_sell;
}

bool
Models.AuctionInformationModel::getIsImbalanceSideNone()
{
	return is_imbalance_side_none;
}

void
Models.AuctionInformationModel::setIsImbalanceSideNone(bool  is_imbalance_side_none)
{
	this->is_imbalance_side_none = is_imbalance_side_none;
}

int
Models.AuctionInformationModel::getExtensionNumber()
{
	return extension_number;
}

void
Models.AuctionInformationModel::setExtensionNumber(int  extension_number)
{
	this->extension_number = extension_number;
}

int
Models.AuctionInformationModel::getScheduledAuctionTimeSeconds()
{
	return scheduled_auction_time_seconds;
}

void
Models.AuctionInformationModel::setScheduledAuctionTimeSeconds(int  scheduled_auction_time_seconds)
{
	this->scheduled_auction_time_seconds = scheduled_auction_time_seconds;
}

std::string
Models.AuctionInformationModel::getScheduledAuctionTime()
{
	return scheduled_auction_time;
}

void
Models.AuctionInformationModel::setScheduledAuctionTime(std::string  scheduled_auction_time)
{
	this->scheduled_auction_time = scheduled_auction_time;
}

double
Models.AuctionInformationModel::getAuctionBookClearingPrice()
{
	return auction_book_clearing_price;
}

void
Models.AuctionInformationModel::setAuctionBookClearingPrice(double  auction_book_clearing_price)
{
	this->auction_book_clearing_price = auction_book_clearing_price;
}

double
Models.AuctionInformationModel::getCollarReferencePrice()
{
	return collar_reference_price;
}

void
Models.AuctionInformationModel::setCollarReferencePrice(double  collar_reference_price)
{
	this->collar_reference_price = collar_reference_price;
}

double
Models.AuctionInformationModel::getLowerAuctionCollar()
{
	return lower_auction_collar;
}

void
Models.AuctionInformationModel::setLowerAuctionCollar(double  lower_auction_collar)
{
	this->lower_auction_collar = lower_auction_collar;
}

double
Models.AuctionInformationModel::getUpperAuctionCollar()
{
	return upper_auction_collar;
}

void
Models.AuctionInformationModel::setUpperAuctionCollar(double  upper_auction_collar)
{
