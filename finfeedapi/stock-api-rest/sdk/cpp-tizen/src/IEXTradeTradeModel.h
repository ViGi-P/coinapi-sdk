/*
 * IEXTrade.TradeModel.h
 *
 * Represents the response DTO for a single trade event (report or break).
 */

#ifndef _IEXTrade.TradeModel_H_
#define _IEXTrade.TradeModel_H_
...
class IEXTrade.TradeModel : public Object {
public:
	/*! \brief Constructor.
	 */
	IEXTrade.TradeModel();
	IEXTrade.TradeModel(char* str);

	/*! \brief Destructor.
	 */
	virtual ~IEXTrade.TradeModel();
