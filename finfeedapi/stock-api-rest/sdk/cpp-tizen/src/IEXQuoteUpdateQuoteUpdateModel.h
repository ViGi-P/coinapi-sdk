/*
 * IEXQuoteUpdate.QuoteUpdateModel.h
 *
 * Represents the response DTO for quote update information
 */

#ifndef _IEXQuoteUpdate.QuoteUpdateModel_H_
#define _IEXQuoteUpdate.QuoteUpdateModel_H_
...
class IEXQuoteUpdate.QuoteUpdateModel : public Object {
public:
	/*! \brief Constructor.
	 */
	IEXQuoteUpdate.QuoteUpdateModel();
	IEXQuoteUpdate.QuoteUpdateModel(char* str);

	/*! \brief Destructor.
	 */
	virtual ~IEXQuoteUpdate.QuoteUpdateModel();
...
#endif /* _IEXQuoteUpdate.QuoteUpdateModel_H_ */
