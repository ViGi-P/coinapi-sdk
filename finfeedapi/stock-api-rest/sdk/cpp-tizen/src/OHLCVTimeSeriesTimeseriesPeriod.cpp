...
OHLCVTimeSeries.TimeseriesPeriod::OHLCVTimeSeries.TimeseriesPeriod()
{
	//__init();
}
...
void
OHLCVTimeSeries.TimeseriesPeriod::__init()
{
...
void
OHLCVTimeSeries.TimeseriesPeriod::__cleanup()
{
	//if(period_id != NULL) {
	//
	//delete period_id;
...
void
OHLCVTimeSeries.TimeseriesPeriod::fromJson(char* jsonStr)
{
...
OHLCVTimeSeries.TimeseriesPeriod::OHLCVTimeSeries.TimeseriesPeriod(char* json)
{
	this->fromJson(json);
}

char*
OHLCVTimeSeries.TimeseriesPeriod::toJson()
{
...
std::string
OHLCVTimeSeries.TimeseriesPeriod::getPeriodId()
{
	return period_id;
}

void
OHLCVTimeSeries.TimeseriesPeriod::setPeriodId(std::string  period_id)
{
	this->period_id = period_id;
}

int
OHLCVTimeSeries.TimeseriesPeriod::getLengthSeconds()
{
	return length_seconds;
}

void
OHLCVTimeSeries.TimeseriesPeriod::setLengthSeconds(int  length_seconds)
{
	this->length_seconds = length_seconds;
}

int
OHLCVTimeSeries.TimeseriesPeriod::getLengthMonths()
{
	return length_months;
}

void
OHLCVTimeSeries.TimeseriesPeriod::setLengthMonths(int  length_months)
{
	this->length_months = length_months;
}

int
OHLCVTimeSeries.TimeseriesPeriod::getUnitCount()
{
	return unit_count;
}

void
OHLCVTimeSeries.TimeseriesPeriod::setUnitCount(int  unit_count)
{
	this->unit_count = unit_count;
}

std::string
OHLCVTimeSeries.TimeseriesPeriod::getUnitName()
{
	return unit_name;
}

void
OHLCVTimeSeries.TimeseriesPeriod::setUnitName(std::string  unit_name)
{
	this->unit_name = unit_name;
}

std::string
OHLCVTimeSeries.TimeseriesPeriod::getDisplayName()
{
	return display_name;
}

void
OHLCVTimeSeries.TimeseriesPeriod::setDisplayName(std::string  display_name)
{
