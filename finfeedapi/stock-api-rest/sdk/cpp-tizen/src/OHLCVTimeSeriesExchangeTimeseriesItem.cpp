...
OHLCVTimeSeries.ExchangeTimeseriesItem::OHLCVTimeSeries.ExchangeTimeseriesItem()
{
	//__init();
}
...
void
OHLCVTimeSeries.ExchangeTimeseriesItem::__init()
{
...
void
OHLCVTimeSeries.ExchangeTimeseriesItem::__cleanup()
{
...
void
OHLCVTimeSeries.ExchangeTimeseriesItem::fromJson(char* jsonStr)
{
...
OHLCVTimeSeries.ExchangeTimeseriesItem::OHLCVTimeSeries.ExchangeTimeseriesItem(char* json)
{
	this->fromJson(json);
}

char*
OHLCVTimeSeries.ExchangeTimeseriesItem::toJson()
{
...
std::string
OHLCVTimeSeries.ExchangeTimeseriesItem::getTimePeriodStart()
{
	return time_period_start;
}

void
OHLCVTimeSeries.ExchangeTimeseriesItem::setTimePeriodStart(std::string  time_period_start)
{
	this->time_period_start = time_period_start;
}

std::string
OHLCVTimeSeries.ExchangeTimeseriesItem::getTimePeriodEnd()
{
	return time_period_end;
}

void
OHLCVTimeSeries.ExchangeTimeseriesItem::setTimePeriodEnd(std::string  time_period_end)
{
	this->time_period_end = time_period_end;
}

std::string
OHLCVTimeSeries.ExchangeTimeseriesItem::getTimeOpen()
{
	return time_open;
}

void
OHLCVTimeSeries.ExchangeTimeseriesItem::setTimeOpen(std::string  time_open)
{
	this->time_open = time_open;
}

std::string
OHLCVTimeSeries.ExchangeTimeseriesItem::getTimeClose()
{
	return time_close;
}

void
OHLCVTimeSeries.ExchangeTimeseriesItem::setTimeClose(std::string  time_close)
{
	this->time_close = time_close;
}

double
OHLCVTimeSeries.ExchangeTimeseriesItem::getPriceOpen()
{
	return price_open;
}

void
OHLCVTimeSeries.ExchangeTimeseriesItem::setPriceOpen(double  price_open)
{
	this->price_open = price_open;
}

double
OHLCVTimeSeries.ExchangeTimeseriesItem::getPriceHigh()
{
	return price_high;
}

void
OHLCVTimeSeries.ExchangeTimeseriesItem::setPriceHigh(double  price_high)
{
	this->price_high = price_high;
}

double
OHLCVTimeSeries.ExchangeTimeseriesItem::getPriceLow()
{
	return price_low;
}

void
OHLCVTimeSeries.ExchangeTimeseriesItem::setPriceLow(double  price_low)
{
	this->price_low = price_low;
}

double
OHLCVTimeSeries.ExchangeTimeseriesItem::getPriceClose()
{
	return price_close;
}

void
OHLCVTimeSeries.ExchangeTimeseriesItem::setPriceClose(double  price_close)
{
	this->price_close = price_close;
}

double
OHLCVTimeSeries.ExchangeTimeseriesItem::getVolumeTraded()
{
	return volume_traded;
}

void
OHLCVTimeSeries.ExchangeTimeseriesItem::setVolumeTraded(double  volume_traded)
{
	this->volume_traded = volume_traded;
}

long long
OHLCVTimeSeries.ExchangeTimeseriesItem::getTradesCount()
{
	return trades_count;
}

void
OHLCVTimeSeries.ExchangeTimeseriesItem::setTradesCount(long long  trades_count)
{
	this->trades_count = trades_count;
}

std::string
OHLCVTimeSeries.ExchangeTimeseriesItem::getSymbolIdExchange()
{
	return symbol_id_exchange;
}

void
OHLCVTimeSeries.ExchangeTimeseriesItem::setSymbolIdExchange(std::string  symbol_id_exchange)
{
