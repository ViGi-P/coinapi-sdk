/*
 * IEXPriceLevelUpdate.PriceLevelUpdateModel.h
 *
 * Represents the response DTO for price level update information
 */

#ifndef _IEXPriceLevelUpdate.PriceLevelUpdateModel_H_
#define _IEXPriceLevelUpdate.PriceLevelUpdateModel_H_
...
class IEXPriceLevelUpdate.PriceLevelUpdateModel : public Object {
public:
	/*! \brief Constructor.
	 */
	IEXPriceLevelUpdate.PriceLevelUpdateModel();
	IEXPriceLevelUpdate.PriceLevelUpdateModel(char* str);

	/*! \brief Destructor.
	 */
	virtual ~IEXPriceLevelUpdate.PriceLevelUpdateModel();
...
#endif /* _IEXPriceLevelUpdate.PriceLevelUpdateModel_H_ */
