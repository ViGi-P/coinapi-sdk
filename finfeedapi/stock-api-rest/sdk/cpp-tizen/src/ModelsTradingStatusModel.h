/*
 * Models.TradingStatusModel.h
 *
 * Represents the response DTO for trading status information
 */

#ifndef _Models.TradingStatusModel_H_
#define _Models.TradingStatusModel_H_
...
class Models.TradingStatusModel : public Object {
public:
	/*! \brief Constructor.
	 */
	Models.TradingStatusModel();
	Models.TradingStatusModel(char* str);

	/*! \brief Destructor.
	 */
	virtual ~Models.TradingStatusModel();
...
#endif /* _Models.TradingStatusModel_H_ */
