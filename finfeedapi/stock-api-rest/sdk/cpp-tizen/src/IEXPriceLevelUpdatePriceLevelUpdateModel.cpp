...
IEXPriceLevelUpdate.PriceLevelUpdateModel::IEXPriceLevelUpdate.PriceLevelUpdateModel()
{
	//__init();
}
...
void
IEXPriceLevelUpdate.PriceLevelUpdateModel::__init()
{
	//symbol = std::string();
...
void
IEXPriceLevelUpdate.PriceLevelUpdateModel::__cleanup()
{
	//if(symbol != NULL) {
	//
	//delete symbol;
...
void
IEXPriceLevelUpdate.PriceLevelUpdateModel::fromJson(char* jsonStr)
{
...
IEXPriceLevelUpdate.PriceLevelUpdateModel::IEXPriceLevelUpdate.PriceLevelUpdateModel(char* json)
{
	this->fromJson(json);
}

char*
IEXPriceLevelUpdate.PriceLevelUpdateModel::toJson()
{
...
std::string
IEXPriceLevelUpdate.PriceLevelUpdateModel::getSymbol()
{
	return symbol;
}

void
IEXPriceLevelUpdate.PriceLevelUpdateModel::setSymbol(std::string  symbol)
{
	this->symbol = symbol;
}

long long
IEXPriceLevelUpdate.PriceLevelUpdateModel::getTimestampNanos()
{
	return timestamp_nanos;
}

void
IEXPriceLevelUpdate.PriceLevelUpdateModel::setTimestampNanos(long long  timestamp_nanos)
{
	this->timestamp_nanos = timestamp_nanos;
}

std::string
IEXPriceLevelUpdate.PriceLevelUpdateModel::getTimestamp()
{
	return timestamp;
}

void
IEXPriceLevelUpdate.PriceLevelUpdateModel::setTimestamp(std::string  timestamp)
{
	this->timestamp = timestamp;
}

bool
IEXPriceLevelUpdate.PriceLevelUpdateModel::getIsSideBuy()
{
	return is_side_buy;
}

void
IEXPriceLevelUpdate.PriceLevelUpdateModel::setIsSideBuy(bool  is_side_buy)
{
	this->is_side_buy = is_side_buy;
}

bool
IEXPriceLevelUpdate.PriceLevelUpdateModel::getIsEventProcessingComplete()
{
	return is_event_processing_complete;
}

void
IEXPriceLevelUpdate.PriceLevelUpdateModel::setIsEventProcessingComplete(bool  is_event_processing_complete)
{
	this->is_event_processing_complete = is_event_processing_complete;
}

int
IEXPriceLevelUpdate.PriceLevelUpdateModel::getSize()
{
	return size;
}

void
IEXPriceLevelUpdate.PriceLevelUpdateModel::setSize(int  size)
{
	this->size = size;
}

double
IEXPriceLevelUpdate.PriceLevelUpdateModel::getPrice()
{
	return price;
}

void
IEXPriceLevelUpdate.PriceLevelUpdateModel::setPrice(double  price)
{
	this->price = price;
}
