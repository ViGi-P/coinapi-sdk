...
Models.TradingStatusModel::Models.TradingStatusModel()
{
	//__init();
}
...
void
Models.TradingStatusModel::__init()
{
	//symbol = std::string();
...
void
Models.TradingStatusModel::__cleanup()
{
	//if(symbol != NULL) {
	//
	//delete symbol;
...
void
Models.TradingStatusModel::fromJson(char* jsonStr)
{
...
Models.TradingStatusModel::Models.TradingStatusModel(char* json)
{
	this->fromJson(json);
}

char*
Models.TradingStatusModel::toJson()
{
...
std::string
Models.TradingStatusModel::getSymbol()
{
	return symbol;
}

void
Models.TradingStatusModel::setSymbol(std::string  symbol)
{
	this->symbol = symbol;
}

long long
Models.TradingStatusModel::getTimestampNanos()
{
	return timestamp_nanos;
}

void
Models.TradingStatusModel::setTimestampNanos(long long  timestamp_nanos)
{
	this->timestamp_nanos = timestamp_nanos;
}

std::string
Models.TradingStatusModel::getTimestamp()
{
	return timestamp;
}

void
Models.TradingStatusModel::setTimestamp(std::string  timestamp)
{
	this->timestamp = timestamp;
}

bool
Models.TradingStatusModel::getIsTradingLive()
{
	return is_trading_live;
}

void
Models.TradingStatusModel::setIsTradingLive(bool  is_trading_live)
{
	this->is_trading_live = is_trading_live;
}

bool
Models.TradingStatusModel::getIsTradingHalted()
{
	return is_trading_halted;
}

void
Models.TradingStatusModel::setIsTradingHalted(bool  is_trading_halted)
{
	this->is_trading_halted = is_trading_halted;
}

bool
Models.TradingStatusModel::getIsTradingInOrderAcceptancePeriod()
{
	return is_trading_in_order_acceptance_period;
}

void
Models.TradingStatusModel::setIsTradingInOrderAcceptancePeriod(bool  is_trading_in_order_acceptance_period)
{
	this->is_trading_in_order_acceptance_period = is_trading_in_order_acceptance_period;
}

bool
Models.TradingStatusModel::getIsTradingPaused()
{
	return is_trading_paused;
}

void
Models.TradingStatusModel::setIsTradingPaused(bool  is_trading_paused)
{
	this->is_trading_paused = is_trading_paused;
}

bool
Models.TradingStatusModel::getIsReasonHaltNewsPending()
{
	return is_reason_halt_news_pending;
}

void
Models.TradingStatusModel::setIsReasonHaltNewsPending(bool  is_reason_halt_news_pending)
{
	this->is_reason_halt_news_pending = is_reason_halt_news_pending;
}

bool
Models.TradingStatusModel::getIsReasonIpoNotYetTrading()
{
	return is_reason_ipo_not_yet_trading;
}

void
Models.TradingStatusModel::setIsReasonIpoNotYetTrading(bool  is_reason_ipo_not_yet_trading)
{
	this->is_reason_ipo_not_yet_trading = is_reason_ipo_not_yet_trading;
}

bool
Models.TradingStatusModel::getIsReasonIpoDeferred()
{
	return is_reason_ipo_deferred;
}

void
Models.TradingStatusModel::setIsReasonIpoDeferred(bool  is_reason_ipo_deferred)
{
	this->is_reason_ipo_deferred = is_reason_ipo_deferred;
}

bool
Models.TradingStatusModel::getIsReasonHaltNewsDissemination()
{
	return is_reason_halt_news_dissemination;
}

void
Models.TradingStatusModel::setIsReasonHaltNewsDissemination(bool  is_reason_halt_news_dissemination)
{
	this->is_reason_halt_news_dissemination = is_reason_halt_news_dissemination;
}

bool
Models.TradingStatusModel::getIsReasonIpoOrderAcceptancePeriod()
{
	return is_reason_ipo_order_acceptance_period;
}

void
Models.TradingStatusModel::setIsReasonIpoOrderAcceptancePeriod(bool  is_reason_ipo_order_acceptance_period)
{
	this->is_reason_ipo_order_acceptance_period = is_reason_ipo_order_acceptance_period;
}

bool
Models.TradingStatusModel::getIsReasonIpoPreLaunchPeriod()
{
	return is_reason_ipo_pre_launch_period;
}

void
Models.TradingStatusModel::setIsReasonIpoPreLaunchPeriod(bool  is_reason_ipo_pre_launch_period)
{
	this->is_reason_ipo_pre_launch_period = is_reason_ipo_pre_launch_period;
}

bool
Models.TradingStatusModel::getIsReasonMarketWideCircuitBreakerLevel1()
{
	return is_reason_market_wide_circuit_breaker_level1;
}

void
Models.TradingStatusModel::setIsReasonMarketWideCircuitBreakerLevel1(bool  is_reason_market_wide_circuit_breaker_level1)
{
	this->is_reason_market_wide_circuit_breaker_level1 = is_reason_market_wide_circuit_breaker_level1;
}

bool
Models.TradingStatusModel::getIsReasonMarketWideCircuitBreakerLevel2()
{
	return is_reason_market_wide_circuit_breaker_level2;
}

void
Models.TradingStatusModel::setIsReasonMarketWideCircuitBreakerLevel2(bool  is_reason_market_wide_circuit_breaker_level2)
{
	this->is_reason_market_wide_circuit_breaker_level2 = is_reason_market_wide_circuit_breaker_level2;
}

bool
Models.TradingStatusModel::getIsReasonMarketWideCircuitBreakerLevel3()
{
	return is_reason_market_wide_circuit_breaker_level3;
}

void
Models.TradingStatusModel::setIsReasonMarketWideCircuitBreakerLevel3(bool  is_reason_market_wide_circuit_breaker_level3)
{
	this->is_reason_market_wide_circuit_breaker_level3 = is_reason_market_wide_circuit_breaker_level3;
}

bool
Models.TradingStatusModel::getIsReasonNotApplicable()
{
	return is_reason_not_applicable;
}

void
Models.TradingStatusModel::setIsReasonNotApplicable(bool  is_reason_not_applicable)
{
	this->is_reason_not_applicable = is_reason_not_applicable;
}

bool
Models.TradingStatusModel::getIsReasonNotAvailable()
{
	return is_reason_not_available;
}

void
Models.TradingStatusModel::setIsReasonNotAvailable(bool  is_reason_not_available)
{
