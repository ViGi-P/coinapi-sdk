/*
 * Models.AuctionInformationModel.h
 *
 * Represents the response DTO for auction information
 */

#ifndef _Models.AuctionInformationModel_H_
#define _Models.AuctionInformationModel_H_
...
class Models.AuctionInformationModel : public Object {
public:
	/*! \brief Constructor.
	 */
	Models.AuctionInformationModel();
	Models.AuctionInformationModel(char* str);

	/*! \brief Destructor.
	 */
	virtual ~Models.AuctionInformationModel();
...
#endif /* _Models.AuctionInformationModel_H_ */
