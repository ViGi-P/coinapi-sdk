...
class ModelsAdminMessageModel {
  /// Returns a new [ModelsAdminMessageModel] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ModelsAdminMessageModel &&
  ...
  /// Returns a new [ModelsAdminMessageModel] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ModelsAdminMessageModel? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return ModelsAdminMessageModel(
        tradingStatus: ModelsTradingStatusModel.fromJson(json[r'trading_status']),
        officialPrice: ModelsOfficialPriceModel.fromJson(json[r'official_price']),
        securityEvent: ModelsSecurityEventModel.fromJson(json[r'security_event']),
        auctionInformation: ModelsAuctionInformationModel.fromJson(json[r'auction_information']),
        shortSalePriceTest: ModelsShortSalePriceTestStatusModel.fromJson(json[r'short_sale_price_test']),
        operationalHaltStatus: ModelsOperationalHaltStatusModel.fromJson(json[r'operational_halt_status']),
        retailLiquidityIndicator: ModelsRetailLiquidityIndicatorModel.fromJson(json[r'retail_liquidity_indicator']),
        systemEvent: IEXSystemEventSystemEventModel.fromJson(json[r'system_event']),
        securityDirectory: ModelsSecurityDirectoryModel.fromJson(json[r'security_directory']),
      );
    }
    return null;
  }

  static List<ModelsAdminMessageModel> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ModelsAdminMessageModel>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ModelsAdminMessageModel.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ModelsAdminMessageModel> mapFromJson(dynamic json) {
    final map = <String, ModelsAdminMessageModel>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ModelsAdminMessageModel.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ModelsAdminMessageModel-objects as value to a dart map
  static Map<String, List<ModelsAdminMessageModel>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ModelsAdminMessageModel>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ModelsAdminMessageModel.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
