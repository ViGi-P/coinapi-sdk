...
class ModelsRetailLiquidityIndicatorModel {
  /// Returns a new [ModelsRetailLiquidityIndicatorModel] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ModelsRetailLiquidityIndicatorModel &&
    other.symbol == symbol &&
  ...
  /// Returns a new [ModelsRetailLiquidityIndicatorModel] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ModelsRetailLiquidityIndicatorModel? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<ModelsRetailLiquidityIndicatorModel> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ModelsRetailLiquidityIndicatorModel>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ModelsRetailLiquidityIndicatorModel.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ModelsRetailLiquidityIndicatorModel> mapFromJson(dynamic json) {
    final map = <String, ModelsRetailLiquidityIndicatorModel>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ModelsRetailLiquidityIndicatorModel.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ModelsRetailLiquidityIndicatorModel-objects as value to a dart map
  static Map<String, List<ModelsRetailLiquidityIndicatorModel>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ModelsRetailLiquidityIndicatorModel>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ModelsRetailLiquidityIndicatorModel.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
