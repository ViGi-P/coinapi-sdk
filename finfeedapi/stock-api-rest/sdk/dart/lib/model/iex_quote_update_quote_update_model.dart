...
class IEXQuoteUpdateQuoteUpdateModel {
  /// Returns a new [IEXQuoteUpdateQuoteUpdateModel] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IEXQuoteUpdateQuoteUpdateModel &&
    other.symbol == symbol &&
  ...
  @override
  String toString() => 'IEXQuoteUpdateQuoteUpdateModel[symbol=$symbol, timestampNanos=$timestampNanos, timestamp=$timestamp, isSymbolAvailable=$isSymbolAvailable, isPrePostMarketSession=$isPrePostMarketSession, askSize=$askSize, askPrice=$askPrice, bidPrice=$bidPrice, bidSize=$bidSize]';
  ...
  /// Returns a new [IEXQuoteUpdateQuoteUpdateModel] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static IEXQuoteUpdateQuoteUpdateModel? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<IEXQuoteUpdateQuoteUpdateModel> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <IEXQuoteUpdateQuoteUpdateModel>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = IEXQuoteUpdateQuoteUpdateModel.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, IEXQuoteUpdateQuoteUpdateModel> mapFromJson(dynamic json) {
    final map = <String, IEXQuoteUpdateQuoteUpdateModel>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IEXQuoteUpdateQuoteUpdateModel.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of IEXQuoteUpdateQuoteUpdateModel-objects as value to a dart map
  static Map<String, List<IEXQuoteUpdateQuoteUpdateModel>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IEXQuoteUpdateQuoteUpdateModel>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = IEXQuoteUpdateQuoteUpdateModel.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
