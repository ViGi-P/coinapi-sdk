...
class ModelsOperationalHaltStatusModel {
  /// Returns a new [ModelsOperationalHaltStatusModel] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ModelsOperationalHaltStatusModel &&
    other.symbol == symbol &&
  ...
  /// Returns a new [ModelsOperationalHaltStatusModel] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ModelsOperationalHaltStatusModel? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return ModelsOperationalHaltStatusModel(
  ...
  static List<ModelsOperationalHaltStatusModel> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ModelsOperationalHaltStatusModel>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ModelsOperationalHaltStatusModel.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ModelsOperationalHaltStatusModel> mapFromJson(dynamic json) {
    final map = <String, ModelsOperationalHaltStatusModel>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ModelsOperationalHaltStatusModel.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ModelsOperationalHaltStatusModel-objects as value to a dart map
  static Map<String, List<ModelsOperationalHaltStatusModel>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ModelsOperationalHaltStatusModel>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ModelsOperationalHaltStatusModel.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
