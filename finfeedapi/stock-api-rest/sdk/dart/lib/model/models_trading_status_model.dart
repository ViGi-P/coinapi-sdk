...
class ModelsTradingStatusModel {
  /// Returns a new [ModelsTradingStatusModel] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ModelsTradingStatusModel &&
    other.symbol == symbol &&
  ...
  /// Returns a new [ModelsTradingStatusModel] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ModelsTradingStatusModel? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return ModelsTradingStatusModel(
  ...
  static List<ModelsTradingStatusModel> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ModelsTradingStatusModel>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ModelsTradingStatusModel.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ModelsTradingStatusModel> mapFromJson(dynamic json) {
    final map = <String, ModelsTradingStatusModel>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ModelsTradingStatusModel.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ModelsTradingStatusModel-objects as value to a dart map
  static Map<String, List<ModelsTradingStatusModel>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ModelsTradingStatusModel>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ModelsTradingStatusModel.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
