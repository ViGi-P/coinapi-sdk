...
class IEXSystemEventSystemEventModel {
  /// Returns a new [IEXSystemEventSystemEventModel] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IEXSystemEventSystemEventModel &&
  ...
  /// Returns a new [IEXSystemEventSystemEventModel] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static IEXSystemEventSystemEventModel? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<IEXSystemEventSystemEventModel> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <IEXSystemEventSystemEventModel>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = IEXSystemEventSystemEventModel.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, IEXSystemEventSystemEventModel> mapFromJson(dynamic json) {
    final map = <String, IEXSystemEventSystemEventModel>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IEXSystemEventSystemEventModel.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of IEXSystemEventSystemEventModel-objects as value to a dart map
  static Map<String, List<IEXSystemEventSystemEventModel>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IEXSystemEventSystemEventModel>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = IEXSystemEventSystemEventModel.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
