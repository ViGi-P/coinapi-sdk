...
class ModelsOfficialPriceModel {
  /// Returns a new [ModelsOfficialPriceModel] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ModelsOfficialPriceModel &&
    other.symbol == symbol &&
  ...
  @override
  String toString() => 'ModelsOfficialPriceModel[symbol=$symbol, timestampNanos=$timestampNanos, timestamp=$timestamp, priceType=$priceType, priceTypeCode=$priceTypeCode, priceTypeText=$priceTypeText, isPriceTypeOpening=$isPriceTypeOpening, isPriceTypeClosing=$isPriceTypeClosing, officialPrice=$officialPrice]';
  ...
  /// Returns a new [ModelsOfficialPriceModel] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ModelsOfficialPriceModel? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return ModelsOfficialPriceModel(
  ...
  static List<ModelsOfficialPriceModel> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ModelsOfficialPriceModel>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ModelsOfficialPriceModel.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ModelsOfficialPriceModel> mapFromJson(dynamic json) {
    final map = <String, ModelsOfficialPriceModel>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ModelsOfficialPriceModel.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ModelsOfficialPriceModel-objects as value to a dart map
  static Map<String, List<ModelsOfficialPriceModel>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ModelsOfficialPriceModel>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ModelsOfficialPriceModel.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
