...
class ModelsShortSalePriceTestStatusModel {
  /// Returns a new [ModelsShortSalePriceTestStatusModel] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ModelsShortSalePriceTestStatusModel &&
    other.symbol == symbol &&
  ...
  /// Returns a new [ModelsShortSalePriceTestStatusModel] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ModelsShortSalePriceTestStatusModel? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return ModelsShortSalePriceTestStatusModel(
  ...
  static List<ModelsShortSalePriceTestStatusModel> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ModelsShortSalePriceTestStatusModel>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ModelsShortSalePriceTestStatusModel.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ModelsShortSalePriceTestStatusModel> mapFromJson(dynamic json) {
    final map = <String, ModelsShortSalePriceTestStatusModel>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ModelsShortSalePriceTestStatusModel.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ModelsShortSalePriceTestStatusModel-objects as value to a dart map
  static Map<String, List<ModelsShortSalePriceTestStatusModel>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ModelsShortSalePriceTestStatusModel>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ModelsShortSalePriceTestStatusModel.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
