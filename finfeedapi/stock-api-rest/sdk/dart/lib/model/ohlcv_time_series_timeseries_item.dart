...
class OHLCVTimeSeriesTimeseriesItem {
  /// Returns a new [OHLCVTimeSeriesTimeseriesItem] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is OHLCVTimeSeriesTimeseriesItem &&
  ...
  @override
  String toString() => 'OHLCVTimeSeriesTimeseriesItem[timePeriodStart=$timePeriodStart, timePeriodEnd=$timePeriodEnd, timeOpen=$timeOpen, timeClose=$timeClose, priceOpen=$priceOpen, priceHigh=$priceHigh, priceLow=$priceLow, priceClose=$priceClose, volumeTraded=$volumeTraded, tradesCount=$tradesCount]';
  ...
  /// Returns a new [OHLCVTimeSeriesTimeseriesItem] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static OHLCVTimeSeriesTimeseriesItem? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<OHLCVTimeSeriesTimeseriesItem> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <OHLCVTimeSeriesTimeseriesItem>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = OHLCVTimeSeriesTimeseriesItem.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, OHLCVTimeSeriesTimeseriesItem> mapFromJson(dynamic json) {
    final map = <String, OHLCVTimeSeriesTimeseriesItem>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = OHLCVTimeSeriesTimeseriesItem.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of OHLCVTimeSeriesTimeseriesItem-objects as value to a dart map
  static Map<String, List<OHLCVTimeSeriesTimeseriesItem>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<OHLCVTimeSeriesTimeseriesItem>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = OHLCVTimeSeriesTimeseriesItem.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
