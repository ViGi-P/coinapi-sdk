...
class OHLCVExchangeTimeseriesItem {
  /// Returns a new [OHLCVExchangeTimeseriesItem] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is OHLCVExchangeTimeseriesItem &&
  ...
  @override
  String toString() => 'OHLCVExchangeTimeseriesItem[timePeriodStart=$timePeriodStart, timePeriodEnd=$timePeriodEnd, timeOpen=$timeOpen, timeClose=$timeClose, priceOpen=$priceOpen, priceHigh=$priceHigh, priceLow=$priceLow, priceClose=$priceClose, volumeTraded=$volumeTraded, tradesCount=$tradesCount, symbolIdExchange=$symbolIdExchange]';
  ...
  /// Returns a new [OHLCVExchangeTimeseriesItem] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static OHLCVExchangeTimeseriesItem? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<OHLCVExchangeTimeseriesItem> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <OHLCVExchangeTimeseriesItem>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = OHLCVExchangeTimeseriesItem.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, OHLCVExchangeTimeseriesItem> mapFromJson(dynamic json) {
    final map = <String, OHLCVExchangeTimeseriesItem>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = OHLCVExchangeTimeseriesItem.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of OHLCVExchangeTimeseriesItem-objects as value to a dart map
  static Map<String, List<OHLCVExchangeTimeseriesItem>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<OHLCVExchangeTimeseriesItem>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = OHLCVExchangeTimeseriesItem.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
