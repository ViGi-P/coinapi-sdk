...
class ModelsAuctionInformationModel {
  /// Returns a new [ModelsAuctionInformationModel] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ModelsAuctionInformationModel &&
    other.symbol == symbol &&
  ...
  /// Returns a new [ModelsAuctionInformationModel] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ModelsAuctionInformationModel? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return ModelsAuctionInformationModel(
  ...
  static List<ModelsAuctionInformationModel> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ModelsAuctionInformationModel>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ModelsAuctionInformationModel.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ModelsAuctionInformationModel> mapFromJson(dynamic json) {
    final map = <String, ModelsAuctionInformationModel>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ModelsAuctionInformationModel.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ModelsAuctionInformationModel-objects as value to a dart map
  static Map<String, List<ModelsAuctionInformationModel>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ModelsAuctionInformationModel>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ModelsAuctionInformationModel.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
