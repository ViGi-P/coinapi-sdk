...
class ModelsSecurityDirectoryModel {
  /// Returns a new [ModelsSecurityDirectoryModel] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ModelsSecurityDirectoryModel &&
    other.symbol == symbol &&
  ...
  /// Returns a new [ModelsSecurityDirectoryModel] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ModelsSecurityDirectoryModel? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return ModelsSecurityDirectoryModel(
  ...
  static List<ModelsSecurityDirectoryModel> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ModelsSecurityDirectoryModel>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ModelsSecurityDirectoryModel.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ModelsSecurityDirectoryModel> mapFromJson(dynamic json) {
    final map = <String, ModelsSecurityDirectoryModel>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ModelsSecurityDirectoryModel.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ModelsSecurityDirectoryModel-objects as value to a dart map
  static Map<String, List<ModelsSecurityDirectoryModel>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ModelsSecurityDirectoryModel>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ModelsSecurityDirectoryModel.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
