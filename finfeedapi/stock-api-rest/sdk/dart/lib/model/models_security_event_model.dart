...
class ModelsSecurityEventModel {
  /// Returns a new [ModelsSecurityEventModel] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ModelsSecurityEventModel &&
    other.symbol == symbol &&
  ...
  /// Returns a new [ModelsSecurityEventModel] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ModelsSecurityEventModel? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<ModelsSecurityEventModel> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ModelsSecurityEventModel>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ModelsSecurityEventModel.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ModelsSecurityEventModel> mapFromJson(dynamic json) {
    final map = <String, ModelsSecurityEventModel>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ModelsSecurityEventModel.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ModelsSecurityEventModel-objects as value to a dart map
  static Map<String, List<ModelsSecurityEventModel>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ModelsSecurityEventModel>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ModelsSecurityEventModel.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
