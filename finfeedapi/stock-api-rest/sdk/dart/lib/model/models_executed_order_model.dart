...
class ModelsExecutedOrderModel {
  /// Returns a new [ModelsExecutedOrderModel] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ModelsExecutedOrderModel &&
    other.symbol == symbol &&
  ...
  /// Returns a new [ModelsExecutedOrderModel] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ModelsExecutedOrderModel? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return ModelsExecutedOrderModel(
  ...
  static List<ModelsExecutedOrderModel> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ModelsExecutedOrderModel>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ModelsExecutedOrderModel.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ModelsExecutedOrderModel> mapFromJson(dynamic json) {
    final map = <String, ModelsExecutedOrderModel>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ModelsExecutedOrderModel.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ModelsExecutedOrderModel-objects as value to a dart map
  static Map<String, List<ModelsExecutedOrderModel>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ModelsExecutedOrderModel>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ModelsExecutedOrderModel.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
