...
class IEXTradeTradeModel {
  /// Returns a new [IEXTradeTradeModel] instance.
  IEXTradeTradeModel({
    this.isTradeBreak,
    this.symbol,
    this.timestampNanos,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IEXTradeTradeModel &&
  ...
  /// Returns a new [IEXTradeTradeModel] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static IEXTradeTradeModel? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<IEXTradeTradeModel> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <IEXTradeTradeModel>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = IEXTradeTradeModel.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, IEXTradeTradeModel> mapFromJson(dynamic json) {
    final map = <String, IEXTradeTradeModel>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IEXTradeTradeModel.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of IEXTradeTradeModel-objects as value to a dart map
  static Map<String, List<IEXTradeTradeModel>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IEXTradeTradeModel>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = IEXTradeTradeModel.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
