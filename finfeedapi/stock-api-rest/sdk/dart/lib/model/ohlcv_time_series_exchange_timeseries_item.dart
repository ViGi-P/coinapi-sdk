...
class OHLCVTimeSeriesExchangeTimeseriesItem {
  /// Returns a new [OHLCVTimeSeriesExchangeTimeseriesItem] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is OHLCVTimeSeriesExchangeTimeseriesItem &&
  ...
  /// Returns a new [OHLCVTimeSeriesExchangeTimeseriesItem] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static OHLCVTimeSeriesExchangeTimeseriesItem? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<OHLCVTimeSeriesExchangeTimeseriesItem> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <OHLCVTimeSeriesExchangeTimeseriesItem>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = OHLCVTimeSeriesExchangeTimeseriesItem.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, OHLCVTimeSeriesExchangeTimeseriesItem> mapFromJson(dynamic json) {
    final map = <String, OHLCVTimeSeriesExchangeTimeseriesItem>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = OHLCVTimeSeriesExchangeTimeseriesItem.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of OHLCVTimeSeriesExchangeTimeseriesItem-objects as value to a dart map
  static Map<String, List<OHLCVTimeSeriesExchangeTimeseriesItem>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<OHLCVTimeSeriesExchangeTimeseriesItem>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = OHLCVTimeSeriesExchangeTimeseriesItem.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
