...
class OHLCVTimeseriesPeriod {
  /// Returns a new [OHLCVTimeseriesPeriod] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is OHLCVTimeseriesPeriod &&
  ...
  @override
  String toString() => 'OHLCVTimeseriesPeriod[periodId=$periodId, lengthSeconds=$lengthSeconds, lengthMonths=$lengthMonths, unitCount=$unitCount, unitName=$unitName, displayName=$displayName]';
  ...
  /// Returns a new [OHLCVTimeseriesPeriod] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static OHLCVTimeseriesPeriod? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<OHLCVTimeseriesPeriod> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <OHLCVTimeseriesPeriod>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = OHLCVTimeseriesPeriod.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, OHLCVTimeseriesPeriod> mapFromJson(dynamic json) {
    final map = <String, OHLCVTimeseriesPeriod>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = OHLCVTimeseriesPeriod.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of OHLCVTimeseriesPeriod-objects as value to a dart map
  static Map<String, List<OHLCVTimeseriesPeriod>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<OHLCVTimeseriesPeriod>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = OHLCVTimeseriesPeriod.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
