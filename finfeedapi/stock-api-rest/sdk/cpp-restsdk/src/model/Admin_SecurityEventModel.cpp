...
web::json::value Admin_SecurityEventModel::toJson() const
{
    ...
    {   
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("security_event_code"))] = ModelBase::toJson(m_Security_event_code);
    }
    if(m_Security_event_textIsSet)
    {   
        
        val[utility::conversions::to_string_t(_XPLATSTR("security_event_text"))] = ModelBase::toJson(m_Security_event_text);
    }
...
void Admin_SecurityEventModel::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Security_event_codeIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("security_event_code")), m_Security_event_code));
    }
    if(m_Security_event_textIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("security_event_text")), m_Security_event_text));
    }
    if(m_Is_opening_process_completeIsSet)
    {
