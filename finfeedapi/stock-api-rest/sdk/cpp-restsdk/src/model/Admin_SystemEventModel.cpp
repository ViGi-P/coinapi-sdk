...
web::json::value Admin_SystemEventModel::toJson() const
{
    ...
    {   
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("system_event_code"))] = ModelBase::toJson(m_System_event_code);
    }
    if(m_System_event_textIsSet)
    {   
        
        val[utility::conversions::to_string_t(_XPLATSTR("system_event_text"))] = ModelBase::toJson(m_System_event_text);
    }
...
void Admin_SystemEventModel::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_System_event_codeIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("system_event_code")), m_System_event_code));
    }
    if(m_System_event_textIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("system_event_text")), m_System_event_text));
    }
    if(m_Is_system_event_start_of_messagesIsSet)
    {
