...
web::json::value Admin_SecurityDirectoryModel::toJson() const
{
    ...
    {   
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("luld_tier_code"))] = ModelBase::toJson(m_Luld_tier_code);
    }
    if(m_Luld_tier_textIsSet)
    {   
        
        val[utility::conversions::to_string_t(_XPLATSTR("luld_tier_text"))] = ModelBase::toJson(m_Luld_tier_text);
    }
...
void Admin_SecurityDirectoryModel::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Luld_tier_codeIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("luld_tier_code")), m_Luld_tier_code));
    }
    if(m_Luld_tier_textIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("luld_tier_text")), m_Luld_tier_text));
    }
    if(m_Is_luld_tier_not_applicableIsSet)
    {
