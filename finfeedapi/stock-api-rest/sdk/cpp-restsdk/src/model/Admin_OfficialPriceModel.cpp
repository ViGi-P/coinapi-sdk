...
web::json::value Admin_OfficialPriceModel::toJson() const
{
    ...
    {   
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("price_type_code"))] = ModelBase::toJson(m_Price_type_code);
    }
    if(m_Price_type_textIsSet)
    {   
        
        val[utility::conversions::to_string_t(_XPLATSTR("price_type_text"))] = ModelBase::toJson(m_Price_type_text);
    }
...
void Admin_OfficialPriceModel::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Price_type_codeIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("price_type_code")), m_Price_type_code));
    }
    if(m_Price_type_textIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("price_type_text")), m_Price_type_text));
    }
    if(m_Is_price_type_openingIsSet)
    {
