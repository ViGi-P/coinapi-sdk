...
public:
    ...
    pplx::task<std::vector<std::shared_ptr<OHLCV_ExchangeTimeseriesItem>>> v1OhlcvExchangeExchangeIdHistoryGet(
    ...
    pplx::task<std::vector<std::shared_ptr<OHLCV_TimeseriesItem>>> v1OhlcvExchangeSymbolExchangeIdSymbolIdHistoryGet(
        utility::string_t exchangeId,
    ...
    /// <param name="periodId">Identifier of requested timeseries period (e.g. &#x60;5SEC&#x60; or &#x60;2MTH&#x60;)</param>
    /// <param name="limit">Amount of items to return (mininum is 1, maximum is 100000, default value is 100, if the parameter is used then every 100 output items are counted as one request) (optional, default to 0)</param>
    pplx::task<std::vector<std::shared_ptr<OHLCV_TimeseriesItem>>> v1OhlcvExchangeSymbolExchangeIdSymbolIdLatestGet(
        utility::string_t exchangeId,
        utility::string_t symbolId,
        utility::string_t periodId,
        boost::optional<int32_t> limit
    ...
    /// </remarks>
    pplx::task<std::vector<std::shared_ptr<OHLCV_TimeseriesPeriod>>> v1OhlcvPeriodsGet(
    ) const;
