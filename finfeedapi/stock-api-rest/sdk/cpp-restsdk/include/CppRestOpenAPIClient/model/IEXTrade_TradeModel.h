...
/*
 * IEXTrade_TradeModel.h
 *
 * Represents the response DTO for a single trade event (report or break).
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_IEXTrade_TradeModel_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_IEXTrade_TradeModel_H_
...
/// Represents the response DTO for a single trade event (report or break).
/// </summary>
class  IEXTrade_TradeModel
    : public ModelBase
{
public:
    IEXTrade_TradeModel();
    virtual ~IEXTrade_TradeModel();
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_IEXTrade_TradeModel_H_ */
