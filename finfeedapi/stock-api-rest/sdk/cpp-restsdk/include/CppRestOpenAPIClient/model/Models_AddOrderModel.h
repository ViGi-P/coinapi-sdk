...
/*
 * Models_AddOrderModel.h
 *
 * Represents the response DTO for add order information
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_Models_AddOrderModel_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_Models_AddOrderModel_H_
...
{
public:
    Models_AddOrderModel();
    virtual ~Models_AddOrderModel();
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_Models_AddOrderModel_H_ */
