...
/*
 * Models_AuctionInformationModel.h
 *
 * Represents the response DTO for auction information
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_Models_AuctionInformationModel_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_Models_AuctionInformationModel_H_
...
{
public:
    Models_AuctionInformationModel();
    virtual ~Models_AuctionInformationModel();
    ...
    /////////////////////////////////////////////
    /// Models_AuctionInformationModel members
...
protected:
    ...
    boost::optional<utility::string_t> m_Auction_type_code;

    boost::optional<utility::string_t> m_Auction_type_text;
    ...
    boost::optional<utility::string_t> m_Imbalance_side_code;

    boost::optional<utility::string_t> m_Imbalance_side_text;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_Models_AuctionInformationModel_H_ */
