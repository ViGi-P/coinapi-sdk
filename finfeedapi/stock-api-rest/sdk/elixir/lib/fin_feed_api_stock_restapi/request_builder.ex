...
defmodule FinFeedAPIStockRESTAPI.RequestBuilder do
  @moduledoc """
  ...
  defp decode(%Tesla.Env{body: body}, %{}) do
    FinFeedAPIStockRESTAPI.Deserializer.json_decode(body)
  end

  defp decode(%Tesla.Env{body: body}, module) do
    FinFeedAPIStockRESTAPI.Deserializer.json_decode(body, module)
  end
end
