...
class OHLCVTimeSeriesExchangeTimeseriesItem(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["time_period_start", "time_period_end", "time_open", "time_close", "price_open", "price_high", "price_low", "price_close", "volume_traded", "trades_count", "symbol_id_exchange"]
