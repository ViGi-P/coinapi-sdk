...
class Level3ClearBookModel(BaseModel):
    """
    ...
    timestamp: Optional[datetime] = Field(default=None, description="Time when the book was cleared as DateTime")
    __properties: ClassVar[List[str]] = ["symbol", "timestamp_nanos", "timestamp"]
