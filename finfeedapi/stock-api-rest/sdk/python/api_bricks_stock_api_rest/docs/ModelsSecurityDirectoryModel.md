...
json = "{}"
# create an instance of ModelsSecurityDirectoryModel from a JSON string
models_security_directory_model_instance = ModelsSecurityDirectoryModel.from_json(json)
# print the JSON string representation of the object
print(ModelsSecurityDirectoryModel.to_json())

# convert the object into a dict
models_security_directory_model_dict = models_security_directory_model_instance.to_dict()
# create an instance of ModelsSecurityDirectoryModel from a dict
models_security_directory_model_from_dict = ModelsSecurityDirectoryModel.from_dict(models_security_directory_model_dict)
```
