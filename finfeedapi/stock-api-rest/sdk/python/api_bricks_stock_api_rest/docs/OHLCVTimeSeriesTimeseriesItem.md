...
json = "{}"
# create an instance of OHLCVTimeSeriesTimeseriesItem from a JSON string
ohlcv_time_series_timeseries_item_instance = OHLCVTimeSeriesTimeseriesItem.from_json(json)
# print the JSON string representation of the object
print(OHLCVTimeSeriesTimeseriesItem.to_json())

# convert the object into a dict
ohlcv_time_series_timeseries_item_dict = ohlcv_time_series_timeseries_item_instance.to_dict()
# create an instance of OHLCVTimeSeriesTimeseriesItem from a dict
ohlcv_time_series_timeseries_item_from_dict = OHLCVTimeSeriesTimeseriesItem.from_dict(ohlcv_time_series_timeseries_item_dict)
```
