...
json = "{}"
# create an instance of ModelsAuctionInformationModel from a JSON string
models_auction_information_model_instance = ModelsAuctionInformationModel.from_json(json)
# print the JSON string representation of the object
print(ModelsAuctionInformationModel.to_json())

# convert the object into a dict
models_auction_information_model_dict = models_auction_information_model_instance.to_dict()
# create an instance of ModelsAuctionInformationModel from a dict
models_auction_information_model_from_dict = ModelsAuctionInformationModel.from_dict(models_auction_information_model_dict)
```
