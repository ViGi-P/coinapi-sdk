...
json = "{}"
# create an instance of IEXSystemEventSystemEventModel from a JSON string
iex_system_event_system_event_model_instance = IEXSystemEventSystemEventModel.from_json(json)
# print the JSON string representation of the object
print(IEXSystemEventSystemEventModel.to_json())

# convert the object into a dict
iex_system_event_system_event_model_dict = iex_system_event_system_event_model_instance.to_dict()
# create an instance of IEXSystemEventSystemEventModel from a dict
iex_system_event_system_event_model_from_dict = IEXSystemEventSystemEventModel.from_dict(iex_system_event_system_event_model_dict)
```
