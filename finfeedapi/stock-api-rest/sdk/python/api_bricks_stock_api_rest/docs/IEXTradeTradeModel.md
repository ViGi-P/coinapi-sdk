...
json = "{}"
# create an instance of IEXTradeTradeModel from a JSON string
iex_trade_trade_model_instance = IEXTradeTradeModel.from_json(json)
# print the JSON string representation of the object
print(IEXTradeTradeModel.to_json())

# convert the object into a dict
iex_trade_trade_model_dict = iex_trade_trade_model_instance.to_dict()
# create an instance of IEXTradeTradeModel from a dict
iex_trade_trade_model_from_dict = IEXTradeTradeModel.from_dict(iex_trade_trade_model_dict)
```
