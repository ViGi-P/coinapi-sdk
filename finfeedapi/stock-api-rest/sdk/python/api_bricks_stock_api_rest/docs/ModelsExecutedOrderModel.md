...
json = "{}"
# create an instance of ModelsExecutedOrderModel from a JSON string
models_executed_order_model_instance = ModelsExecutedOrderModel.from_json(json)
# print the JSON string representation of the object
print(ModelsExecutedOrderModel.to_json())

# convert the object into a dict
models_executed_order_model_dict = models_executed_order_model_instance.to_dict()
# create an instance of ModelsExecutedOrderModel from a dict
models_executed_order_model_from_dict = ModelsExecutedOrderModel.from_dict(models_executed_order_model_dict)
```
