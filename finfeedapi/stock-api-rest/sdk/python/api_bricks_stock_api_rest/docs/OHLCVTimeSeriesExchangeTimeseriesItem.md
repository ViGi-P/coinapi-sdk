...
json = "{}"
# create an instance of OHLCVTimeSeriesExchangeTimeseriesItem from a JSON string
ohlcv_time_series_exchange_timeseries_item_instance = OHLCVTimeSeriesExchangeTimeseriesItem.from_json(json)
# print the JSON string representation of the object
print(OHLCVTimeSeriesExchangeTimeseriesItem.to_json())

# convert the object into a dict
ohlcv_time_series_exchange_timeseries_item_dict = ohlcv_time_series_exchange_timeseries_item_instance.to_dict()
# create an instance of OHLCVTimeSeriesExchangeTimeseriesItem from a dict
ohlcv_time_series_exchange_timeseries_item_from_dict = OHLCVTimeSeriesExchangeTimeseriesItem.from_dict(ohlcv_time_series_exchange_timeseries_item_dict)
```
