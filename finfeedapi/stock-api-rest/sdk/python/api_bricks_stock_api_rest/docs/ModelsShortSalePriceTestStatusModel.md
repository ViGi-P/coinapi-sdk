...
json = "{}"
# create an instance of ModelsShortSalePriceTestStatusModel from a JSON string
models_short_sale_price_test_status_model_instance = ModelsShortSalePriceTestStatusModel.from_json(json)
# print the JSON string representation of the object
print(ModelsShortSalePriceTestStatusModel.to_json())

# convert the object into a dict
models_short_sale_price_test_status_model_dict = models_short_sale_price_test_status_model_instance.to_dict()
# create an instance of ModelsShortSalePriceTestStatusModel from a dict
models_short_sale_price_test_status_model_from_dict = ModelsShortSalePriceTestStatusModel.from_dict(models_short_sale_price_test_status_model_dict)
```
