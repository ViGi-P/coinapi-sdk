...
json = "{}"
# create an instance of ModelsRetailLiquidityIndicatorModel from a JSON string
models_retail_liquidity_indicator_model_instance = ModelsRetailLiquidityIndicatorModel.from_json(json)
# print the JSON string representation of the object
print(ModelsRetailLiquidityIndicatorModel.to_json())

# convert the object into a dict
models_retail_liquidity_indicator_model_dict = models_retail_liquidity_indicator_model_instance.to_dict()
# create an instance of ModelsRetailLiquidityIndicatorModel from a dict
models_retail_liquidity_indicator_model_from_dict = ModelsRetailLiquidityIndicatorModel.from_dict(models_retail_liquidity_indicator_model_dict)
```
