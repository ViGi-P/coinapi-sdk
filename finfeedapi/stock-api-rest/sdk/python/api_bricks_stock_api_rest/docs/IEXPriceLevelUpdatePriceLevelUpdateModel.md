...
json = "{}"
# create an instance of IEXPriceLevelUpdatePriceLevelUpdateModel from a JSON string
iex_price_level_update_price_level_update_model_instance = IEXPriceLevelUpdatePriceLevelUpdateModel.from_json(json)
# print the JSON string representation of the object
print(IEXPriceLevelUpdatePriceLevelUpdateModel.to_json())

# convert the object into a dict
iex_price_level_update_price_level_update_model_dict = iex_price_level_update_price_level_update_model_instance.to_dict()
# create an instance of IEXPriceLevelUpdatePriceLevelUpdateModel from a dict
iex_price_level_update_price_level_update_model_from_dict = IEXPriceLevelUpdatePriceLevelUpdateModel.from_dict(iex_price_level_update_price_level_update_model_dict)
```
