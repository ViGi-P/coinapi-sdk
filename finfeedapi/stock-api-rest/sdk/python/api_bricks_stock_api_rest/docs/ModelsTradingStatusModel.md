...
json = "{}"
# create an instance of ModelsTradingStatusModel from a JSON string
models_trading_status_model_instance = ModelsTradingStatusModel.from_json(json)
# print the JSON string representation of the object
print(ModelsTradingStatusModel.to_json())

# convert the object into a dict
models_trading_status_model_dict = models_trading_status_model_instance.to_dict()
# create an instance of ModelsTradingStatusModel from a dict
models_trading_status_model_from_dict = ModelsTradingStatusModel.from_dict(models_trading_status_model_dict)
```
