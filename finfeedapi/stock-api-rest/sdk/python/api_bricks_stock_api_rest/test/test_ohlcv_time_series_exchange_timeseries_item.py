...
class TestOHLCVTimeSeriesExchangeTimeseriesItem(unittest.TestCase):
    """OHLCVTimeSeriesExchangeTimeseriesItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OHLCVTimeSeriesExchangeTimeseriesItem:
        """Test OHLCVTimeSeriesExchangeTimeseriesItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OHLCVTimeSeriesExchangeTimeseriesItem`
        """
        model = OHLCVTimeSeriesExchangeTimeseriesItem()
        if include_optional:
    ...
    def testOHLCVTimeSeriesExchangeTimeseriesItem(self):
        """Test OHLCVTimeSeriesExchangeTimeseriesItem"""
