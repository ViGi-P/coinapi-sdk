...
class TestIEXSystemEventSystemEventModel(unittest.TestCase):
    """IEXSystemEventSystemEventModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IEXSystemEventSystemEventModel:
        """Test IEXSystemEventSystemEventModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IEXSystemEventSystemEventModel`
        """
        model = IEXSystemEventSystemEventModel()
        if include_optional:
    ...
    def testIEXSystemEventSystemEventModel(self):
        """Test IEXSystemEventSystemEventModel"""
