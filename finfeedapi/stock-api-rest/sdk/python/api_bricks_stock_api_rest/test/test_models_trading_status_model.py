...
class TestModelsTradingStatusModel(unittest.TestCase):
    """ModelsTradingStatusModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ModelsTradingStatusModel:
        """Test ModelsTradingStatusModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ModelsTradingStatusModel`
        """
        model = ModelsTradingStatusModel()
        if include_optional:
    ...
    def testModelsTradingStatusModel(self):
        """Test ModelsTradingStatusModel"""
