...
class TestModelsAdminMessageModel(unittest.TestCase):
    """ModelsAdminMessageModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ModelsAdminMessageModel:
        """Test ModelsAdminMessageModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ModelsAdminMessageModel`
        """
        model = ModelsAdminMessageModel()
        if include_optional:
            return ModelsAdminMessageModel(
                trading_status = api_bricks_stock_api_rest.models.models/trading_status_model.Models.TradingStatusModel(
                    symbol = '', 
                    timestamp_nanos = 56, 
                ...
                official_price = api_bricks_stock_api_rest.models.models/official_price_model.Models.OfficialPriceModel(
                    symbol = '', 
                    timestamp_nanos = 56, 
                    timestamp = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    price_type = 56, 
                ...
                security_event = api_bricks_stock_api_rest.models.models/security_event_model.Models.SecurityEventModel(
                    symbol = '', 
                    timestamp_nanos = 56, 
                    timestamp = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    security_event = 56, 
                ...
                auction_information = api_bricks_stock_api_rest.models.models/auction_information_model.Models.AuctionInformationModel(
                    symbol = '', 
                    timestamp_nanos = 56, 
                    timestamp = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    auction_type = 56, 
                ...
                short_sale_price_test = api_bricks_stock_api_rest.models.models/short_sale_price_test_status_model.Models.ShortSalePriceTestStatusModel(
                    symbol = '', 
                    timestamp_nanos = 56, 
                    timestamp = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                ...
                operational_halt_status = api_bricks_stock_api_rest.models.models/operational_halt_status_model.Models.OperationalHaltStatusModel(
                    symbol = '', 
                    timestamp_nanos = 56, 
                    timestamp = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                ...
                retail_liquidity_indicator = api_bricks_stock_api_rest.models.models/retail_liquidity_indicator_model.Models.RetailLiquidityIndicatorModel(
                    symbol = '', 
                    timestamp_nanos = 56, 
                    timestamp = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                ...
                system_event = api_bricks_stock_api_rest.models.iex_system_event/system_event_model.IEXSystemEvent.SystemEventModel(
                    timestamp_nanos = 56, 
                    timestamp = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    system_event = 56, 
                    system_event_code = '', 
                ...
                security_directory = api_bricks_stock_api_rest.models.models/security_directory_model.Models.SecurityDirectoryModel(
                    symbol = '', 
                    timestamp_nanos = 56, 
                    timestamp = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    flags = 56, 
    ...
    def testModelsAdminMessageModel(self):
        """Test ModelsAdminMessageModel"""
