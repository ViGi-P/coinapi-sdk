...
class TestModelsAuctionInformationModel(unittest.TestCase):
    """ModelsAuctionInformationModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ModelsAuctionInformationModel:
        """Test ModelsAuctionInformationModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ModelsAuctionInformationModel`
        """
        model = ModelsAuctionInformationModel()
        if include_optional:
    ...
    def testModelsAuctionInformationModel(self):
        """Test ModelsAuctionInformationModel"""
