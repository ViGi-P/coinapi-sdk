...
feature -- Test routines
    ...
    test_v1_ohlcv_exchange_symbol_exchange_id_symbol_id_history_get
        ...
        do
            ...
            -- l_response := api.v1_ohlcv_exchange_symbol_exchange_id_symbol_id_history_get(l_exchange_id, l_symbol_id, l_period_id, l_time_start, l_time_end, l_limit)
            assert ("not_implemented", False)
        end

    test_v1_ohlcv_exchange_symbol_exchange_id_symbol_id_latest_get
            -- Latest data
            --
        ...
        do
            ...
            -- l_response := api.v1_ohlcv_exchange_symbol_exchange_id_symbol_id_latest_get(l_exchange_id, l_symbol_id, l_period_id, l_limit)
            assert ("not_implemented", False)
        end
    ...
    test_v1_ohlcv_periods_get
        ...
        local
            l_response: LIST [OHLCV_TIME_SERIES_TIMESERIES_PERIOD]
        do
            -- TODO: Initialize required params.
