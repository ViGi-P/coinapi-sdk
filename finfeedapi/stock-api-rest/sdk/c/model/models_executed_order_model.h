/*
 * models_executed_order_model.h
 *
 * Represents the response DTO for order executed information
 */

#ifndef _models_executed_order_model_H_
#define _models_executed_order_model_H_
...
typedef struct models_executed_order_model_t models_executed_order_model_t;




typedef struct models_executed_order_model_t {
    char *symbol; // string
...
#endif /* _models_executed_order_model_H_ */
