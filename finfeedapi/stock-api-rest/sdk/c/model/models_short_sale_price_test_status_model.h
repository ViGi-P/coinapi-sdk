/*
 * models_short_sale_price_test_status_model.h
 *
 * Represents the response DTO for short sale price test status information
 */

#ifndef _models_short_sale_price_test_status_model_H_
#define _models_short_sale_price_test_status_model_H_
...
typedef struct models_short_sale_price_test_status_model_t models_short_sale_price_test_status_model_t;




typedef struct models_short_sale_price_test_status_model_t {
    char *symbol; // string
...
} models_short_sale_price_test_status_model_t;
...
#endif /* _models_short_sale_price_test_status_model_H_ */
