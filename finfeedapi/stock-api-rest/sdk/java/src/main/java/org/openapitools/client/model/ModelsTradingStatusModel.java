 ...
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-05-04T06:07:08.730894736Z[Etc/UTC]", comments = "Generator version: 7.22.0")
public class ModelsTradingStatusModel {
  ...
  public ModelsTradingStatusModel() {
  }

  public ModelsTradingStatusModel symbol(@javax.annotation.Nullable String symbol) {
    this.symbol = symbol;
    return this;
  }
  ...
  public ModelsTradingStatusModel timestampNanos(@javax.annotation.Nullable Long timestampNanos) {
  ...
  public ModelsTradingStatusModel timestamp(@javax.annotation.Nullable OffsetDateTime timestamp) {
  ...
  public ModelsTradingStatusModel isTradingLive(@javax.annotation.Nullable Boolean isTradingLive) {
  ...
  public ModelsTradingStatusModel isTradingHalted(@javax.annotation.Nullable Boolean isTradingHalted) {
  ...
  public ModelsTradingStatusModel isTradingInOrderAcceptancePeriod(@javax.annotation.Nullable Boolean isTradingInOrderAcceptancePeriod) {
  ...
  public ModelsTradingStatusModel isTradingPaused(@javax.annotation.Nullable Boolean isTradingPaused) {
  ...
  public ModelsTradingStatusModel isReasonHaltNewsPending(@javax.annotation.Nullable Boolean isReasonHaltNewsPending) {
  ...
  public ModelsTradingStatusModel isReasonIpoNotYetTrading(@javax.annotation.Nullable Boolean isReasonIpoNotYetTrading) {
  ...
  public ModelsTradingStatusModel isReasonIpoDeferred(@javax.annotation.Nullable Boolean isReasonIpoDeferred) {
  ...
  public ModelsTradingStatusModel isReasonHaltNewsDissemination(@javax.annotation.Nullable Boolean isReasonHaltNewsDissemination) {
  ...
  public ModelsTradingStatusModel isReasonIpoOrderAcceptancePeriod(@javax.annotation.Nullable Boolean isReasonIpoOrderAcceptancePeriod) {
  ...
  public ModelsTradingStatusModel isReasonIpoPreLaunchPeriod(@javax.annotation.Nullable Boolean isReasonIpoPreLaunchPeriod) {
  ...
  public ModelsTradingStatusModel isReasonMarketWideCircuitBreakerLevel1(@javax.annotation.Nullable Boolean isReasonMarketWideCircuitBreakerLevel1) {
  ...
  public ModelsTradingStatusModel isReasonMarketWideCircuitBreakerLevel2(@javax.annotation.Nullable Boolean isReasonMarketWideCircuitBreakerLevel2) {
  ...
  public ModelsTradingStatusModel isReasonMarketWideCircuitBreakerLevel3(@javax.annotation.Nullable Boolean isReasonMarketWideCircuitBreakerLevel3) {
  ...
  public ModelsTradingStatusModel isReasonNotApplicable(@javax.annotation.Nullable Boolean isReasonNotApplicable) {
  ...
  public ModelsTradingStatusModel isReasonNotAvailable(@javax.annotation.Nullable Boolean isReasonNotAvailable) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.symbol, modelsTradingStatusModel.symbol) &&
        Objects.equals(this.timestampNanos, modelsTradingStatusModel.timestampNanos) &&
        Objects.equals(this.timestamp, modelsTradingStatusModel.timestamp) &&
        Objects.equals(this.isTradingLive, modelsTradingStatusModel.isTradingLive) &&
        Objects.equals(this.isTradingHalted, modelsTradingStatusModel.isTradingHalted) &&
        Objects.equals(this.isTradingInOrderAcceptancePeriod, modelsTradingStatusModel.isTradingInOrderAcceptancePeriod) &&
        Objects.equals(this.isTradingPaused, modelsTradingStatusModel.isTradingPaused) &&
        Objects.equals(this.isReasonHaltNewsPending, modelsTradingStatusModel.isReasonHaltNewsPending) &&
        Objects.equals(this.isReasonIpoNotYetTrading, modelsTradingStatusModel.isReasonIpoNotYetTrading) &&
        Objects.equals(this.isReasonIpoDeferred, modelsTradingStatusModel.isReasonIpoDeferred) &&
        Objects.equals(this.isReasonHaltNewsDissemination, modelsTradingStatusModel.isReasonHaltNewsDissemination) &&
        Objects.equals(this.isReasonIpoOrderAcceptancePeriod, modelsTradingStatusModel.isReasonIpoOrderAcceptancePeriod) &&
        Objects.equals(this.isReasonIpoPreLaunchPeriod, modelsTradingStatusModel.isReasonIpoPreLaunchPeriod) &&
        Objects.equals(this.isReasonMarketWideCircuitBreakerLevel1, modelsTradingStatusModel.isReasonMarketWideCircuitBreakerLevel1) &&
        Objects.equals(this.isReasonMarketWideCircuitBreakerLevel2, modelsTradingStatusModel.isReasonMarketWideCircuitBreakerLevel2) &&
        Objects.equals(this.isReasonMarketWideCircuitBreakerLevel3, modelsTradingStatusModel.isReasonMarketWideCircuitBreakerLevel3) &&
        Objects.equals(this.isReasonNotApplicable, modelsTradingStatusModel.isReasonNotApplicable) &&
        Objects.equals(this.isReasonNotAvailable, modelsTradingStatusModel.isReasonNotAvailable);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ModelsTradingStatusModel
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ModelsTradingStatusModel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ModelsTradingStatusModel is not found in the empty JSON string", ModelsTradingStatusModel.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ModelsTradingStatusModel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ModelsTradingStatusModel` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ModelsTradingStatusModel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ModelsTradingStatusModel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ModelsTradingStatusModel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ModelsTradingStatusModel.class));

       return (TypeAdapter<T>) new TypeAdapter<ModelsTradingStatusModel>() {
           @Override
           public void write(JsonWriter out, ModelsTradingStatusModel value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ModelsTradingStatusModel read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ModelsTradingStatusModel given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ModelsTradingStatusModel
   * @throws IOException if the JSON string is invalid with respect to ModelsTradingStatusModel
   */
  public static ModelsTradingStatusModel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ModelsTradingStatusModel.class);
  }

  /**
   * Convert an instance of ModelsTradingStatusModel to an JSON string
   *
   * @return JSON string
   */
