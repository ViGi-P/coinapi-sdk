...
public class MetadataApi {
     ...
     */
    public okhttp3.Call v1ExchangesGetCall(final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call v1ExchangesGetValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        return v1ExchangesGetCall(_callback);
     ...
     * List of exchanges
     * 
     * @return List&lt;FinFeedAPIExchangeModel&gt;
     ...
     */
    public List<FinFeedAPIExchangeModel> v1ExchangesGet() throws ApiException {
        ApiResponse<List<FinFeedAPIExchangeModel>> localVarResp = v1ExchangesGetWithHttpInfo();
     ...
     * List of exchanges
     * 
     * @return ApiResponse&lt;List&lt;FinFeedAPIExchangeModel&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
     ...
     */
    public ApiResponse<List<FinFeedAPIExchangeModel>> v1ExchangesGetWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = v1ExchangesGetValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<List<FinFeedAPIExchangeModel>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * List of exchanges (asynchronously)
     * 
     ...
     */
    public okhttp3.Call v1ExchangesGetAsync(final ApiCallback<List<FinFeedAPIExchangeModel>> _callback) throws ApiException {

        okhttp3.Call localVarCall = v1ExchangesGetValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<List<FinFeedAPIExchangeModel>>(){}.getType();
