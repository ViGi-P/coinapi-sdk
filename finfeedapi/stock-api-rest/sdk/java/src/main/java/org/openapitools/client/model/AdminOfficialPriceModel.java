  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AdminOfficialPriceModel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in AdminOfficialPriceModel is not found in the empty JSON string", AdminOfficialPriceModel.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AdminOfficialPriceModel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AdminOfficialPriceModel` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("price_type_code") != null && !jsonObj.get("price_type_code").isJsonNull()) && !jsonObj.get("price_type_code").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `price_type_code` to be a primitive type in the JSON string but got `%s`", jsonObj.get("price_type_code").toString()));
      }
      if ((jsonObj.get("price_type_text") != null && !jsonObj.get("price_type_text").isJsonNull()) && !jsonObj.get("price_type_text").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `price_type_text` to be a primitive type in the JSON string but got `%s`", jsonObj.get("price_type_text").toString()));
      }
  }
