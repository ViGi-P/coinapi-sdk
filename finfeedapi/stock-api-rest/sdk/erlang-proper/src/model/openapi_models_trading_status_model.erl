-module(openapi_models_trading_status_model).

-include("openapi.hrl").

-export([openapi_models_trading_status_model/0]).

-export([openapi_models_trading_status_model/1]).

-export_type([openapi_models_trading_status_model/0]).

-type openapi_models_trading_status_model() ::
  [ {'symbol', binary() }
...
openapi_models_trading_status_model() ->
    openapi_models_trading_status_model([]).

openapi_models_trading_status_model(Fields) ->
