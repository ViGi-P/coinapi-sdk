-module(openapi_models_auction_information_model).

-include("openapi.hrl").

-export([openapi_models_auction_information_model/0]).

-export([openapi_models_auction_information_model/1]).

-export_type([openapi_models_auction_information_model/0]).

-type openapi_models_auction_information_model() ::
  [ {'symbol', binary() }
...
openapi_models_auction_information_model() ->
    openapi_models_auction_information_model([]).

openapi_models_auction_information_model(Fields) ->
