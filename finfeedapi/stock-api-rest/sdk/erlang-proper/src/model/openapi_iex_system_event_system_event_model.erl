-module(openapi_iex_system_event_system_event_model).

-include("openapi.hrl").

-export([openapi_iex_system_event_system_event_model/0]).

-export([openapi_iex_system_event_system_event_model/1]).

-export_type([openapi_iex_system_event_system_event_model/0]).

-type openapi_iex_system_event_system_event_model() ::
...
openapi_iex_system_event_system_event_model() ->
    openapi_iex_system_event_system_event_model([]).

openapi_iex_system_event_system_event_model(Fields) ->
