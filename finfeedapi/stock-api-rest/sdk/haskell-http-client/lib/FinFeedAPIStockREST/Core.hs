...
module FinFeedAPIStockREST.Core where
...
-- * FinFeedAPIStockRESTConfig

-- |
data FinFeedAPIStockRESTConfig = FinFeedAPIStockRESTConfig
...
-- | display the config
instance P.Show FinFeedAPIStockRESTConfig where
  show c =
    T.printf
...
-- | constructs a default FinFeedAPIStockRESTConfig
--
-- configHost:
--
...
-- configUserAgent:
--
-- @"finfeedapi-stock-rest/0.1.0.0"@
--
newConfig :: IO FinFeedAPIStockRESTConfig
newConfig = do
    logCxt <- initLogContext
    return $ FinFeedAPIStockRESTConfig
        { configHost = "https://api-historical.stock.finfeedapi.com"
        , configUserAgent = "finfeedapi-stock-rest/0.1.0.0"
...
addAuthMethod :: AuthMethod auth => FinFeedAPIStockRESTConfig -> auth -> FinFeedAPIStockRESTConfig
addAuthMethod config@FinFeedAPIStockRESTConfig {configAuthMethods = as} a =
  config { configAuthMethods = AnyAuthMethod a : as}

-- | updates the config to use stdout logging
withStdoutLogging :: FinFeedAPIStockRESTConfig -> IO FinFeedAPIStockRESTConfig
...
withStderrLogging :: FinFeedAPIStockRESTConfig -> IO FinFeedAPIStockRESTConfig
...
withNoLogging :: FinFeedAPIStockRESTConfig -> FinFeedAPIStockRESTConfig
withNoLogging p = p { configLogExecWithContext =  runNullLogExec}

-- * FinFeedAPIStockRESTRequest
...
data FinFeedAPIStockRESTRequest req contentType res accept = FinFeedAPIStockRESTRequest
  { rMethod  :: NH.Method   -- ^ Method of FinFeedAPIStockRESTRequest
  , rUrlPath :: [BCL.ByteString] -- ^ Endpoint of FinFeedAPIStockRESTRequest
  , rParams   :: Params -- ^ params of FinFeedAPIStockRESTRequest
  , rAuthTypes :: [P.TypeRep] -- ^ types of auth methods
  }
  deriving (P.Show)

-- | 'rMethod' Lens
rMethodL :: Lens_' (FinFeedAPIStockRESTRequest req contentType res accept) NH.Method
rMethodL f FinFeedAPIStockRESTRequest{..} = (\rMethod -> FinFeedAPIStockRESTRequest { rMethod, ..} ) <$> f rMethod
{-# INLINE rMethodL #-}

-- | 'rUrlPath' Lens
rUrlPathL :: Lens_' (FinFeedAPIStockRESTRequest req contentType res accept) [BCL.ByteString]
rUrlPathL f FinFeedAPIStockRESTRequest{..} = (\rUrlPath -> FinFeedAPIStockRESTRequest { rUrlPath, ..} ) <$> f rUrlPath
{-# INLINE rUrlPathL #-}

-- | 'rParams' Lens
rParamsL :: Lens_' (FinFeedAPIStockRESTRequest req contentType res accept) Params
rParamsL f FinFeedAPIStockRESTRequest{..} = (\rParams -> FinFeedAPIStockRESTRequest { rParams, ..} ) <$> f rParams
{-# INLINE rParamsL #-}

-- | 'rParams' Lens
rAuthTypesL :: Lens_' (FinFeedAPIStockRESTRequest req contentType res accept) [P.TypeRep]
rAuthTypesL f FinFeedAPIStockRESTRequest{..} = (\rAuthTypes -> FinFeedAPIStockRESTRequest { rAuthTypes, ..} ) <$> f rAuthTypes
{-# INLINE rAuthTypesL #-}
...
class HasBodyParam req param where
  setBodyParam :: forall contentType res accept. (Consumes req contentType, MimeRender contentType param) => FinFeedAPIStockRESTRequest req contentType res accept -> param -> FinFeedAPIStockRESTRequest req contentType res accept
  setBodyParam req xs =
...
class HasOptionalParam req param where
  ...
  applyOptionalParam :: FinFeedAPIStockRESTRequest req contentType res accept -> param -> FinFeedAPIStockRESTRequest req contentType res accept
  applyOptionalParam = (-&-)
  {-# INLINE applyOptionalParam #-}

  -- | infix operator \/ alias for 'addOptionalParam'
  (-&-) :: FinFeedAPIStockRESTRequest req contentType res accept -> param -> FinFeedAPIStockRESTRequest req contentType res accept
  (-&-) = applyOptionalParam
  {-# INLINE (-&-) #-}
...
-- ** FinFeedAPIStockRESTRequest Utils

_mkRequest :: NH.Method -- ^ Method
          -> [BCL.ByteString] -- ^ Endpoint
          -> FinFeedAPIStockRESTRequest req contentType res accept -- ^ req: Request Type, res: Response Type
_mkRequest m u = FinFeedAPIStockRESTRequest m u _mkParams []

_mkParams :: Params
_mkParams = Params [] [] ParamBodyNone

setHeader ::
     FinFeedAPIStockRESTRequest req contentType res accept
  -> [NH.Header]
  -> FinFeedAPIStockRESTRequest req contentType res accept
...
removeHeader :: FinFeedAPIStockRESTRequest req contentType res accept -> [NH.HeaderName] -> FinFeedAPIStockRESTRequest req contentType res accept
...
_setContentTypeHeader :: forall req contentType res accept. MimeType contentType => FinFeedAPIStockRESTRequest req contentType res accept -> FinFeedAPIStockRESTRequest req contentType res accept
_setContentTypeHeader req =
    case mimeType (P.Proxy :: P.Proxy contentType) of
        Just m -> req `setHeader` [("content-type", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["content-type"]

_setAcceptHeader :: forall req contentType res accept. MimeType accept => FinFeedAPIStockRESTRequest req contentType res accept -> FinFeedAPIStockRESTRequest req contentType res accept
...
addForm :: FinFeedAPIStockRESTRequest req contentType res accept -> WH.Form -> FinFeedAPIStockRESTRequest req contentType res accept
addForm req newform =
...
_addMultiFormPart :: FinFeedAPIStockRESTRequest req contentType res accept -> NH.Part -> FinFeedAPIStockRESTRequest req contentType res accept
...
_setBodyBS :: FinFeedAPIStockRESTRequest req contentType res accept -> B.ByteString -> FinFeedAPIStockRESTRequest req contentType res accept
_setBodyBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyB body)

_setBodyLBS :: FinFeedAPIStockRESTRequest req contentType res accept -> BL.ByteString -> FinFeedAPIStockRESTRequest req contentType res accept
_setBodyLBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyBL body)

_hasAuthType :: AuthMethod authMethod => FinFeedAPIStockRESTRequest req contentType res accept -> P.Proxy authMethod -> FinFeedAPIStockRESTRequest req contentType res accept
...
class P.Typeable a =>
  ...
  applyAuthMethod
    ...
    -> a
    -> FinFeedAPIStockRESTRequest req contentType res accept
    -> IO (FinFeedAPIStockRESTRequest req contentType res accept)
...
_applyAuthMethods
  ...
  -> FinFeedAPIStockRESTConfig
  -> IO (FinFeedAPIStockRESTRequest req contentType res accept)
_applyAuthMethods req config@(FinFeedAPIStockRESTConfig {configAuthMethods = as}) =
  foldlM go req as
  where
