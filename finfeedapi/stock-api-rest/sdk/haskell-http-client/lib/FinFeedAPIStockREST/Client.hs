...
module FinFeedAPIStockREST.Client where
...
dispatchLbs
  ...
  -> FinFeedAPIStockRESTConfig -- ^ config
  -> FinFeedAPIStockRESTRequest req contentType res accept -- ^ request
