...
public class OHLCVTimeSeriesExchangeTimeseriesItem {
  ...
  public boolean equals(Object o) {
    ...
    return (this.timePeriodStart == null ? oHLCVTimeSeriesExchangeTimeseriesItem.timePeriodStart == null : this.timePeriodStart.equals(oHLCVTimeSeriesExchangeTimeseriesItem.timePeriodStart)) &&
        (this.timePeriodEnd == null ? oHLCVTimeSeriesExchangeTimeseriesItem.timePeriodEnd == null : this.timePeriodEnd.equals(oHLCVTimeSeriesExchangeTimeseriesItem.timePeriodEnd)) &&
        (this.timeOpen == null ? oHLCVTimeSeriesExchangeTimeseriesItem.timeOpen == null : this.timeOpen.equals(oHLCVTimeSeriesExchangeTimeseriesItem.timeOpen)) &&
        (this.timeClose == null ? oHLCVTimeSeriesExchangeTimeseriesItem.timeClose == null : this.timeClose.equals(oHLCVTimeSeriesExchangeTimeseriesItem.timeClose)) &&
        (this.priceOpen == null ? oHLCVTimeSeriesExchangeTimeseriesItem.priceOpen == null : this.priceOpen.equals(oHLCVTimeSeriesExchangeTimeseriesItem.priceOpen)) &&
        (this.priceHigh == null ? oHLCVTimeSeriesExchangeTimeseriesItem.priceHigh == null : this.priceHigh.equals(oHLCVTimeSeriesExchangeTimeseriesItem.priceHigh)) &&
        (this.priceLow == null ? oHLCVTimeSeriesExchangeTimeseriesItem.priceLow == null : this.priceLow.equals(oHLCVTimeSeriesExchangeTimeseriesItem.priceLow)) &&
        (this.priceClose == null ? oHLCVTimeSeriesExchangeTimeseriesItem.priceClose == null : this.priceClose.equals(oHLCVTimeSeriesExchangeTimeseriesItem.priceClose)) &&
        (this.volumeTraded == null ? oHLCVTimeSeriesExchangeTimeseriesItem.volumeTraded == null : this.volumeTraded.equals(oHLCVTimeSeriesExchangeTimeseriesItem.volumeTraded)) &&
        (this.tradesCount == null ? oHLCVTimeSeriesExchangeTimeseriesItem.tradesCount == null : this.tradesCount.equals(oHLCVTimeSeriesExchangeTimeseriesItem.tradesCount)) &&
        (this.symbolIdExchange == null ? oHLCVTimeSeriesExchangeTimeseriesItem.symbolIdExchange == null : this.symbolIdExchange.equals(oHLCVTimeSeriesExchangeTimeseriesItem.symbolIdExchange));
  }
