...
public class OHLCVTimeseriesItem {
  ...
  public boolean equals(Object o) {
    ...
    return (this.timePeriodStart == null ? oHLCVTimeseriesItem.timePeriodStart == null : this.timePeriodStart.equals(oHLCVTimeseriesItem.timePeriodStart)) &&
        (this.timePeriodEnd == null ? oHLCVTimeseriesItem.timePeriodEnd == null : this.timePeriodEnd.equals(oHLCVTimeseriesItem.timePeriodEnd)) &&
        (this.timeOpen == null ? oHLCVTimeseriesItem.timeOpen == null : this.timeOpen.equals(oHLCVTimeseriesItem.timeOpen)) &&
        (this.timeClose == null ? oHLCVTimeseriesItem.timeClose == null : this.timeClose.equals(oHLCVTimeseriesItem.timeClose)) &&
        (this.priceOpen == null ? oHLCVTimeseriesItem.priceOpen == null : this.priceOpen.equals(oHLCVTimeseriesItem.priceOpen)) &&
        (this.priceHigh == null ? oHLCVTimeseriesItem.priceHigh == null : this.priceHigh.equals(oHLCVTimeseriesItem.priceHigh)) &&
        (this.priceLow == null ? oHLCVTimeseriesItem.priceLow == null : this.priceLow.equals(oHLCVTimeseriesItem.priceLow)) &&
        (this.priceClose == null ? oHLCVTimeseriesItem.priceClose == null : this.priceClose.equals(oHLCVTimeseriesItem.priceClose)) &&
        (this.volumeTraded == null ? oHLCVTimeseriesItem.volumeTraded == null : this.volumeTraded.equals(oHLCVTimeseriesItem.volumeTraded)) &&
        (this.tradesCount == null ? oHLCVTimeseriesItem.tradesCount == null : this.tradesCount.equals(oHLCVTimeseriesItem.tradesCount));
  }
