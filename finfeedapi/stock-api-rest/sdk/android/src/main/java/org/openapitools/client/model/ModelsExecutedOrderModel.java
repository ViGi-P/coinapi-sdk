...
public class ModelsExecutedOrderModel {
  ...
  public boolean equals(Object o) {
    ...
    return (this.symbol == null ? modelsExecutedOrderModel.symbol == null : this.symbol.equals(modelsExecutedOrderModel.symbol)) &&
        (this.timestampNanos == null ? modelsExecutedOrderModel.timestampNanos == null : this.timestampNanos.equals(modelsExecutedOrderModel.timestampNanos)) &&
        (this.timestamp == null ? modelsExecutedOrderModel.timestamp == null : this.timestamp.equals(modelsExecutedOrderModel.timestamp)) &&
        (this.orderIdReference == null ? modelsExecutedOrderModel.orderIdReference == null : this.orderIdReference.equals(modelsExecutedOrderModel.orderIdReference)) &&
        (this.saleConditionFlags == null ? modelsExecutedOrderModel.saleConditionFlags == null : this.saleConditionFlags.equals(modelsExecutedOrderModel.saleConditionFlags)) &&
        (this.isIntermarketSweep == null ? modelsExecutedOrderModel.isIntermarketSweep == null : this.isIntermarketSweep.equals(modelsExecutedOrderModel.isIntermarketSweep)) &&
        (this.isExtendedHoursTrade == null ? modelsExecutedOrderModel.isExtendedHoursTrade == null : this.isExtendedHoursTrade.equals(modelsExecutedOrderModel.isExtendedHoursTrade)) &&
        (this.isOddLotTrade == null ? modelsExecutedOrderModel.isOddLotTrade == null : this.isOddLotTrade.equals(modelsExecutedOrderModel.isOddLotTrade)) &&
        (this.isTradeThroughExempt == null ? modelsExecutedOrderModel.isTradeThroughExempt == null : this.isTradeThroughExempt.equals(modelsExecutedOrderModel.isTradeThroughExempt)) &&
        (this.isSinglePriceCrossTrade == null ? modelsExecutedOrderModel.isSinglePriceCrossTrade == null : this.isSinglePriceCrossTrade.equals(modelsExecutedOrderModel.isSinglePriceCrossTrade)) &&
        (this.size == null ? modelsExecutedOrderModel.size == null : this.size.equals(modelsExecutedOrderModel.size)) &&
        (this.price == null ? modelsExecutedOrderModel.price == null : this.price.equals(modelsExecutedOrderModel.price)) &&
        (this.tradeId == null ? modelsExecutedOrderModel.tradeId == null : this.tradeId.equals(modelsExecutedOrderModel.tradeId));
  }
