...
public class MetadataApi {
  ...
  */
  public List<FinFeedAPIExchangeModel> v1ExchangesGet () throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    try {
      ...
      if (localVarResponse != null) {
         return (List<FinFeedAPIExchangeModel>) ApiInvoker.deserialize(localVarResponse, "array", FinFeedAPIExchangeModel.class);
      } else {
         return null;
      }
  ...
  */
  public void v1ExchangesGet (final Response.Listener<List<FinFeedAPIExchangeModel>> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
      ...
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((List<FinFeedAPIExchangeModel>) ApiInvoker.deserialize(localVarResponse,  "array", FinFeedAPIExchangeModel.class));
  ...
  */
  public List<FinFeedAPISymbolModel> v1SymbolsExchangeIdGet (String exchangeId) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    try {
      String localVarResponse = apiInvoker.invokeAPI (basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames);
      if (localVarResponse != null) {
         return (List<FinFeedAPISymbolModel>) ApiInvoker.deserialize(localVarResponse, "array", FinFeedAPISymbolModel.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((List<FinFeedAPISymbolModel>) ApiInvoker.deserialize(localVarResponse,  "array", FinFeedAPISymbolModel.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
