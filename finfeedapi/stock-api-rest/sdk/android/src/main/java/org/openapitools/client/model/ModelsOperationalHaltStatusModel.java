...
public class ModelsOperationalHaltStatusModel {
  ...
  public boolean equals(Object o) {
    ...
    return (this.symbol == null ? modelsOperationalHaltStatusModel.symbol == null : this.symbol.equals(modelsOperationalHaltStatusModel.symbol)) &&
        (this.timestampNanos == null ? modelsOperationalHaltStatusModel.timestampNanos == null : this.timestampNanos.equals(modelsOperationalHaltStatusModel.timestampNanos)) &&
        (this.timestamp == null ? modelsOperationalHaltStatusModel.timestamp == null : this.timestamp.equals(modelsOperationalHaltStatusModel.timestamp)) &&
        (this.operationalHaltStatus == null ? modelsOperationalHaltStatusModel.operationalHaltStatus == null : this.operationalHaltStatus.equals(modelsOperationalHaltStatusModel.operationalHaltStatus)) &&
        (this.operationalHaltStatusCode == null ? modelsOperationalHaltStatusModel.operationalHaltStatusCode == null : this.operationalHaltStatusCode.equals(modelsOperationalHaltStatusModel.operationalHaltStatusCode)) &&
        (this.operationalHaltStatusText == null ? modelsOperationalHaltStatusModel.operationalHaltStatusText == null : this.operationalHaltStatusText.equals(modelsOperationalHaltStatusModel.operationalHaltStatusText)) &&
        (this.isOperationallyHalted == null ? modelsOperationalHaltStatusModel.isOperationallyHalted == null : this.isOperationallyHalted.equals(modelsOperationalHaltStatusModel.isOperationallyHalted)) &&
        (this.isNotOperationallyHalted == null ? modelsOperationalHaltStatusModel.isNotOperationallyHalted == null : this.isNotOperationallyHalted.equals(modelsOperationalHaltStatusModel.isNotOperationallyHalted));
  }
