...
public class IEXTradeTradeModel {
  ...
  public boolean equals(Object o) {
    ...
    return (this.isTradeBreak == null ? iEXTradeTradeModel.isTradeBreak == null : this.isTradeBreak.equals(iEXTradeTradeModel.isTradeBreak)) &&
        (this.symbol == null ? iEXTradeTradeModel.symbol == null : this.symbol.equals(iEXTradeTradeModel.symbol)) &&
        (this.timestampNanos == null ? iEXTradeTradeModel.timestampNanos == null : this.timestampNanos.equals(iEXTradeTradeModel.timestampNanos)) &&
        (this.timestamp == null ? iEXTradeTradeModel.timestamp == null : this.timestamp.equals(iEXTradeTradeModel.timestamp)) &&
        (this.size == null ? iEXTradeTradeModel.size == null : this.size.equals(iEXTradeTradeModel.size)) &&
        (this.price == null ? iEXTradeTradeModel.price == null : this.price.equals(iEXTradeTradeModel.price)) &&
        (this.tradeId == null ? iEXTradeTradeModel.tradeId == null : this.tradeId.equals(iEXTradeTradeModel.tradeId)) &&
        (this.isIntermarketSweep == null ? iEXTradeTradeModel.isIntermarketSweep == null : this.isIntermarketSweep.equals(iEXTradeTradeModel.isIntermarketSweep)) &&
        (this.isExtendedHoursTrade == null ? iEXTradeTradeModel.isExtendedHoursTrade == null : this.isExtendedHoursTrade.equals(iEXTradeTradeModel.isExtendedHoursTrade)) &&
        (this.isOddLotTrade == null ? iEXTradeTradeModel.isOddLotTrade == null : this.isOddLotTrade.equals(iEXTradeTradeModel.isOddLotTrade)) &&
        (this.isTradeThroughExempt == null ? iEXTradeTradeModel.isTradeThroughExempt == null : this.isTradeThroughExempt.equals(iEXTradeTradeModel.isTradeThroughExempt)) &&
        (this.isSinglePriceCrossTrade == null ? iEXTradeTradeModel.isSinglePriceCrossTrade == null : this.isSinglePriceCrossTrade.equals(iEXTradeTradeModel.isSinglePriceCrossTrade));
  }
