...
public class OHLCVTimeSeriesTimeseriesItem {
  ...
  public boolean equals(Object o) {
    ...
    return (this.timePeriodStart == null ? oHLCVTimeSeriesTimeseriesItem.timePeriodStart == null : this.timePeriodStart.equals(oHLCVTimeSeriesTimeseriesItem.timePeriodStart)) &&
        (this.timePeriodEnd == null ? oHLCVTimeSeriesTimeseriesItem.timePeriodEnd == null : this.timePeriodEnd.equals(oHLCVTimeSeriesTimeseriesItem.timePeriodEnd)) &&
        (this.timeOpen == null ? oHLCVTimeSeriesTimeseriesItem.timeOpen == null : this.timeOpen.equals(oHLCVTimeSeriesTimeseriesItem.timeOpen)) &&
        (this.timeClose == null ? oHLCVTimeSeriesTimeseriesItem.timeClose == null : this.timeClose.equals(oHLCVTimeSeriesTimeseriesItem.timeClose)) &&
        (this.priceOpen == null ? oHLCVTimeSeriesTimeseriesItem.priceOpen == null : this.priceOpen.equals(oHLCVTimeSeriesTimeseriesItem.priceOpen)) &&
        (this.priceHigh == null ? oHLCVTimeSeriesTimeseriesItem.priceHigh == null : this.priceHigh.equals(oHLCVTimeSeriesTimeseriesItem.priceHigh)) &&
        (this.priceLow == null ? oHLCVTimeSeriesTimeseriesItem.priceLow == null : this.priceLow.equals(oHLCVTimeSeriesTimeseriesItem.priceLow)) &&
        (this.priceClose == null ? oHLCVTimeSeriesTimeseriesItem.priceClose == null : this.priceClose.equals(oHLCVTimeSeriesTimeseriesItem.priceClose)) &&
        (this.volumeTraded == null ? oHLCVTimeSeriesTimeseriesItem.volumeTraded == null : this.volumeTraded.equals(oHLCVTimeSeriesTimeseriesItem.volumeTraded)) &&
        (this.tradesCount == null ? oHLCVTimeSeriesTimeseriesItem.tradesCount == null : this.tradesCount.equals(oHLCVTimeSeriesTimeseriesItem.tradesCount));
  }
