...
public class ModelsRetailLiquidityIndicatorModel {
  ...
  public boolean equals(Object o) {
    ...
    return (this.symbol == null ? modelsRetailLiquidityIndicatorModel.symbol == null : this.symbol.equals(modelsRetailLiquidityIndicatorModel.symbol)) &&
        (this.timestampNanos == null ? modelsRetailLiquidityIndicatorModel.timestampNanos == null : this.timestampNanos.equals(modelsRetailLiquidityIndicatorModel.timestampNanos)) &&
        (this.timestamp == null ? modelsRetailLiquidityIndicatorModel.timestamp == null : this.timestamp.equals(modelsRetailLiquidityIndicatorModel.timestamp)) &&
        (this.retailLiquidityIndicator == null ? modelsRetailLiquidityIndicatorModel.retailLiquidityIndicator == null : this.retailLiquidityIndicator.equals(modelsRetailLiquidityIndicatorModel.retailLiquidityIndicator)) &&
        (this.retailLiquidityIndicatorCode == null ? modelsRetailLiquidityIndicatorModel.retailLiquidityIndicatorCode == null : this.retailLiquidityIndicatorCode.equals(modelsRetailLiquidityIndicatorModel.retailLiquidityIndicatorCode)) &&
        (this.retailLiquidityIndicatorText == null ? modelsRetailLiquidityIndicatorModel.retailLiquidityIndicatorText == null : this.retailLiquidityIndicatorText.equals(modelsRetailLiquidityIndicatorModel.retailLiquidityIndicatorText)) &&
        (this.isRetailIndicatorNotApplicable == null ? modelsRetailLiquidityIndicatorModel.isRetailIndicatorNotApplicable == null : this.isRetailIndicatorNotApplicable.equals(modelsRetailLiquidityIndicatorModel.isRetailIndicatorNotApplicable)) &&
        (this.isRetailIndicatorBuyInterest == null ? modelsRetailLiquidityIndicatorModel.isRetailIndicatorBuyInterest == null : this.isRetailIndicatorBuyInterest.equals(modelsRetailLiquidityIndicatorModel.isRetailIndicatorBuyInterest)) &&
        (this.isRetailIndicatorSellInterest == null ? modelsRetailLiquidityIndicatorModel.isRetailIndicatorSellInterest == null : this.isRetailIndicatorSellInterest.equals(modelsRetailLiquidityIndicatorModel.isRetailIndicatorSellInterest)) &&
        (this.isRetailIndicatorBuyAndSellInterest == null ? modelsRetailLiquidityIndicatorModel.isRetailIndicatorBuyAndSellInterest == null : this.isRetailIndicatorBuyAndSellInterest.equals(modelsRetailLiquidityIndicatorModel.isRetailIndicatorBuyAndSellInterest));
  }
