...
public class ModelsAuctionInformationModel {
  ...
  public boolean equals(Object o) {
    ...
    return (this.symbol == null ? modelsAuctionInformationModel.symbol == null : this.symbol.equals(modelsAuctionInformationModel.symbol)) &&
        (this.timestampNanos == null ? modelsAuctionInformationModel.timestampNanos == null : this.timestampNanos.equals(modelsAuctionInformationModel.timestampNanos)) &&
        (this.timestamp == null ? modelsAuctionInformationModel.timestamp == null : this.timestamp.equals(modelsAuctionInformationModel.timestamp)) &&
        (this.auctionType == null ? modelsAuctionInformationModel.auctionType == null : this.auctionType.equals(modelsAuctionInformationModel.auctionType)) &&
        (this.auctionTypeCode == null ? modelsAuctionInformationModel.auctionTypeCode == null : this.auctionTypeCode.equals(modelsAuctionInformationModel.auctionTypeCode)) &&
        (this.auctionTypeText == null ? modelsAuctionInformationModel.auctionTypeText == null : this.auctionTypeText.equals(modelsAuctionInformationModel.auctionTypeText)) &&
        (this.isAuctionTypeOpening == null ? modelsAuctionInformationModel.isAuctionTypeOpening == null : this.isAuctionTypeOpening.equals(modelsAuctionInformationModel.isAuctionTypeOpening)) &&
        (this.isAuctionTypeClosing == null ? modelsAuctionInformationModel.isAuctionTypeClosing == null : this.isAuctionTypeClosing.equals(modelsAuctionInformationModel.isAuctionTypeClosing)) &&
        (this.isAuctionTypeIpo == null ? modelsAuctionInformationModel.isAuctionTypeIpo == null : this.isAuctionTypeIpo.equals(modelsAuctionInformationModel.isAuctionTypeIpo)) &&
        (this.isAuctionTypeHalt == null ? modelsAuctionInformationModel.isAuctionTypeHalt == null : this.isAuctionTypeHalt.equals(modelsAuctionInformationModel.isAuctionTypeHalt)) &&
        (this.isAuctionTypeVolatility == null ? modelsAuctionInformationModel.isAuctionTypeVolatility == null : this.isAuctionTypeVolatility.equals(modelsAuctionInformationModel.isAuctionTypeVolatility)) &&
        (this.pairedShares == null ? modelsAuctionInformationModel.pairedShares == null : this.pairedShares.equals(modelsAuctionInformationModel.pairedShares)) &&
        (this.referencePrice == null ? modelsAuctionInformationModel.referencePrice == null : this.referencePrice.equals(modelsAuctionInformationModel.referencePrice)) &&
        (this.indicativeClearingPrice == null ? modelsAuctionInformationModel.indicativeClearingPrice == null : this.indicativeClearingPrice.equals(modelsAuctionInformationModel.indicativeClearingPrice)) &&
        (this.imbalanceShares == null ? modelsAuctionInformationModel.imbalanceShares == null : this.imbalanceShares.equals(modelsAuctionInformationModel.imbalanceShares)) &&
        (this.imbalanceSide == null ? modelsAuctionInformationModel.imbalanceSide == null : this.imbalanceSide.equals(modelsAuctionInformationModel.imbalanceSide)) &&
        (this.imbalanceSideCode == null ? modelsAuctionInformationModel.imbalanceSideCode == null : this.imbalanceSideCode.equals(modelsAuctionInformationModel.imbalanceSideCode)) &&
        (this.imbalanceSideText == null ? modelsAuctionInformationModel.imbalanceSideText == null : this.imbalanceSideText.equals(modelsAuctionInformationModel.imbalanceSideText)) &&
        (this.isImbalanceSideBuy == null ? modelsAuctionInformationModel.isImbalanceSideBuy == null : this.isImbalanceSideBuy.equals(modelsAuctionInformationModel.isImbalanceSideBuy)) &&
        (this.isImbalanceSideSell == null ? modelsAuctionInformationModel.isImbalanceSideSell == null : this.isImbalanceSideSell.equals(modelsAuctionInformationModel.isImbalanceSideSell)) &&
        (this.isImbalanceSideNone == null ? modelsAuctionInformationModel.isImbalanceSideNone == null : this.isImbalanceSideNone.equals(modelsAuctionInformationModel.isImbalanceSideNone)) &&
        (this.extensionNumber == null ? modelsAuctionInformationModel.extensionNumber == null : this.extensionNumber.equals(modelsAuctionInformationModel.extensionNumber)) &&
        (this.scheduledAuctionTimeSeconds == null ? modelsAuctionInformationModel.scheduledAuctionTimeSeconds == null : this.scheduledAuctionTimeSeconds.equals(modelsAuctionInformationModel.scheduledAuctionTimeSeconds)) &&
        (this.scheduledAuctionTime == null ? modelsAuctionInformationModel.scheduledAuctionTime == null : this.scheduledAuctionTime.equals(modelsAuctionInformationModel.scheduledAuctionTime)) &&
        (this.auctionBookClearingPrice == null ? modelsAuctionInformationModel.auctionBookClearingPrice == null : this.auctionBookClearingPrice.equals(modelsAuctionInformationModel.auctionBookClearingPrice)) &&
        (this.collarReferencePrice == null ? modelsAuctionInformationModel.collarReferencePrice == null : this.collarReferencePrice.equals(modelsAuctionInformationModel.collarReferencePrice)) &&
        (this.lowerAuctionCollar == null ? modelsAuctionInformationModel.lowerAuctionCollar == null : this.lowerAuctionCollar.equals(modelsAuctionInformationModel.lowerAuctionCollar)) &&
        (this.upperAuctionCollar == null ? modelsAuctionInformationModel.upperAuctionCollar == null : this.upperAuctionCollar.equals(modelsAuctionInformationModel.upperAuctionCollar));
  }
