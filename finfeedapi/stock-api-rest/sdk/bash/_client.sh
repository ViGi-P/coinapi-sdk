...
case $state in
  ops)
    ...
    _values "Operations" \
            ...
            "v1SymbolsExchangeIdGet[List of symbols for the exchange]"             "v1NativeIexAdminMessagesSymbolGet[Get Admin Messages]" \
            ...
            "v1NativeIexTradeSymbolGet[Get Trades]"             "v1OhlcvExchangeExchangeIdHistoryGet[Historical data by exchange]" \
