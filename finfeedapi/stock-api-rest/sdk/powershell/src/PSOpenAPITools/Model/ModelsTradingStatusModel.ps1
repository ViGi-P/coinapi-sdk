...
ModelsTradingStatusModel<PSCustomObject>
#>

function Initialize-ModelsTradingStatusModel {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ModelsTradingStatusModel' | Write-Debug
...
Convert from JSON to ModelsTradingStatusModel<PSCustomObject>
...
ModelsTradingStatusModel<PSCustomObject>
#>
function ConvertFrom-JsonToModelsTradingStatusModel {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ModelsTradingStatusModel' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ModelsTradingStatusModel
