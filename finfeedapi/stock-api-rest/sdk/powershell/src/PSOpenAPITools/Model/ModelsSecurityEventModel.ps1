...
ModelsSecurityEventModel<PSCustomObject>
#>

function Initialize-ModelsSecurityEventModel {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ModelsSecurityEventModel' | Write-Debug
...
Convert from JSON to ModelsSecurityEventModel<PSCustomObject>
...
ModelsSecurityEventModel<PSCustomObject>
#>
function ConvertFrom-JsonToModelsSecurityEventModel {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ModelsSecurityEventModel' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ModelsSecurityEventModel
