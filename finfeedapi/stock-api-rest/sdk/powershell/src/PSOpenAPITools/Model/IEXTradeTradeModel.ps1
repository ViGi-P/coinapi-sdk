...
IEXTradeTradeModel<PSCustomObject>
#>

function Initialize-IEXTradeTradeModel {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => IEXTradeTradeModel' | Write-Debug
...
Convert from JSON to IEXTradeTradeModel<PSCustomObject>
...
IEXTradeTradeModel<PSCustomObject>
#>
function ConvertFrom-JsonToIEXTradeTradeModel {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => IEXTradeTradeModel' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IEXTradeTradeModel
