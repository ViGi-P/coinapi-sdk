...
ModelsShortSalePriceTestStatusModel<PSCustomObject>
#>

function Initialize-ModelsShortSalePriceTestStatusModel {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ModelsShortSalePriceTestStatusModel' | Write-Debug
...
Convert from JSON to ModelsShortSalePriceTestStatusModel<PSCustomObject>
...
ModelsShortSalePriceTestStatusModel<PSCustomObject>
#>
function ConvertFrom-JsonToModelsShortSalePriceTestStatusModel {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ModelsShortSalePriceTestStatusModel' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ModelsShortSalePriceTestStatusModel
