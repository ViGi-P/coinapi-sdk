...
IEXSystemEventSystemEventModel<PSCustomObject>
#>

function Initialize-IEXSystemEventSystemEventModel {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => IEXSystemEventSystemEventModel' | Write-Debug
...
Convert from JSON to IEXSystemEventSystemEventModel<PSCustomObject>
...
IEXSystemEventSystemEventModel<PSCustomObject>
#>
function ConvertFrom-JsonToIEXSystemEventSystemEventModel {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => IEXSystemEventSystemEventModel' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IEXSystemEventSystemEventModel
