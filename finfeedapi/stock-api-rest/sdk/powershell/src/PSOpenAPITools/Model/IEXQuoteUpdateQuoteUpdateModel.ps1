...
IEXQuoteUpdateQuoteUpdateModel<PSCustomObject>
#>

function Initialize-IEXQuoteUpdateQuoteUpdateModel {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => IEXQuoteUpdateQuoteUpdateModel' | Write-Debug
...
Convert from JSON to IEXQuoteUpdateQuoteUpdateModel<PSCustomObject>
...
IEXQuoteUpdateQuoteUpdateModel<PSCustomObject>
#>
function ConvertFrom-JsonToIEXQuoteUpdateQuoteUpdateModel {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => IEXQuoteUpdateQuoteUpdateModel' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IEXQuoteUpdateQuoteUpdateModel
