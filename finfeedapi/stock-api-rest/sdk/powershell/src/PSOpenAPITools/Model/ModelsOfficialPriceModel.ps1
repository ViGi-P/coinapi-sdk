...
ModelsOfficialPriceModel<PSCustomObject>
#>

function Initialize-ModelsOfficialPriceModel {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ModelsOfficialPriceModel' | Write-Debug
...
Convert from JSON to ModelsOfficialPriceModel<PSCustomObject>
...
ModelsOfficialPriceModel<PSCustomObject>
#>
function ConvertFrom-JsonToModelsOfficialPriceModel {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ModelsOfficialPriceModel' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ModelsOfficialPriceModel
