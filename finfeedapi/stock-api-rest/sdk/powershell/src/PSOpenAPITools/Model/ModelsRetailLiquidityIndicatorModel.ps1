...
ModelsRetailLiquidityIndicatorModel<PSCustomObject>
#>

function Initialize-ModelsRetailLiquidityIndicatorModel {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ModelsRetailLiquidityIndicatorModel' | Write-Debug
...
Convert from JSON to ModelsRetailLiquidityIndicatorModel<PSCustomObject>
...
ModelsRetailLiquidityIndicatorModel<PSCustomObject>
#>
function ConvertFrom-JsonToModelsRetailLiquidityIndicatorModel {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ModelsRetailLiquidityIndicatorModel' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ModelsRetailLiquidityIndicatorModel
