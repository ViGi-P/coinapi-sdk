...
ModelsSecurityDirectoryModel<PSCustomObject>
#>

function Initialize-ModelsSecurityDirectoryModel {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ModelsSecurityDirectoryModel' | Write-Debug
...
Convert from JSON to ModelsSecurityDirectoryModel<PSCustomObject>
...
ModelsSecurityDirectoryModel<PSCustomObject>
#>
function ConvertFrom-JsonToModelsSecurityDirectoryModel {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ModelsSecurityDirectoryModel' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ModelsSecurityDirectoryModel
