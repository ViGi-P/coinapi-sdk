...
ModelsExecutedOrderModel<PSCustomObject>
#>

function Initialize-ModelsExecutedOrderModel {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ModelsExecutedOrderModel' | Write-Debug
...
Convert from JSON to ModelsExecutedOrderModel<PSCustomObject>
...
ModelsExecutedOrderModel<PSCustomObject>
#>
function ConvertFrom-JsonToModelsExecutedOrderModel {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ModelsExecutedOrderModel' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ModelsExecutedOrderModel
