...
IEXPriceLevelUpdatePriceLevelUpdateModel<PSCustomObject>
#>

function Initialize-IEXPriceLevelUpdatePriceLevelUpdateModel {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => IEXPriceLevelUpdatePriceLevelUpdateModel' | Write-Debug
...
Convert from JSON to IEXPriceLevelUpdatePriceLevelUpdateModel<PSCustomObject>
...
IEXPriceLevelUpdatePriceLevelUpdateModel<PSCustomObject>
#>
function ConvertFrom-JsonToIEXPriceLevelUpdatePriceLevelUpdateModel {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => IEXPriceLevelUpdatePriceLevelUpdateModel' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IEXPriceLevelUpdatePriceLevelUpdateModel
