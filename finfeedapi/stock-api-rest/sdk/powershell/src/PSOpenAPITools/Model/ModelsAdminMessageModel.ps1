...
ModelsAdminMessageModel<PSCustomObject>
#>

function Initialize-ModelsAdminMessageModel {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ModelsAdminMessageModel' | Write-Debug
...
Convert from JSON to ModelsAdminMessageModel<PSCustomObject>
...
ModelsAdminMessageModel<PSCustomObject>
#>
function ConvertFrom-JsonToModelsAdminMessageModel {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ModelsAdminMessageModel' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ModelsAdminMessageModel
