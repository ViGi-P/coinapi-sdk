...
OHLCVTimeSeriesTimeseriesPeriod<PSCustomObject>
#>

function Initialize-OHLCVTimeSeriesTimeseriesPeriod {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => OHLCVTimeSeriesTimeseriesPeriod' | Write-Debug
...
Convert from JSON to OHLCVTimeSeriesTimeseriesPeriod<PSCustomObject>
...
OHLCVTimeSeriesTimeseriesPeriod<PSCustomObject>
#>
function ConvertFrom-JsonToOHLCVTimeSeriesTimeseriesPeriod {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => OHLCVTimeSeriesTimeseriesPeriod' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in OHLCVTimeSeriesTimeseriesPeriod
