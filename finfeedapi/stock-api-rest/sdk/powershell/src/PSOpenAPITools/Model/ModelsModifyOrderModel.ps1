...
ModelsModifyOrderModel<PSCustomObject>
#>

function Initialize-ModelsModifyOrderModel {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ModelsModifyOrderModel' | Write-Debug
...
Convert from JSON to ModelsModifyOrderModel<PSCustomObject>
...
ModelsModifyOrderModel<PSCustomObject>
#>
function ConvertFrom-JsonToModelsModifyOrderModel {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ModelsModifyOrderModel' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ModelsModifyOrderModel
