...
ModelsAuctionInformationModel<PSCustomObject>
#>

function Initialize-ModelsAuctionInformationModel {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ModelsAuctionInformationModel' | Write-Debug
...
Convert from JSON to ModelsAuctionInformationModel<PSCustomObject>
...
ModelsAuctionInformationModel<PSCustomObject>
#>
function ConvertFrom-JsonToModelsAuctionInformationModel {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ModelsAuctionInformationModel' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ModelsAuctionInformationModel
