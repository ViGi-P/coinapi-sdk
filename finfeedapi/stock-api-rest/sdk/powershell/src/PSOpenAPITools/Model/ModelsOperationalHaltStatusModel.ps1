...
ModelsOperationalHaltStatusModel<PSCustomObject>
#>

function Initialize-ModelsOperationalHaltStatusModel {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ModelsOperationalHaltStatusModel' | Write-Debug
...
Convert from JSON to ModelsOperationalHaltStatusModel<PSCustomObject>
...
ModelsOperationalHaltStatusModel<PSCustomObject>
#>
function ConvertFrom-JsonToModelsOperationalHaltStatusModel {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ModelsOperationalHaltStatusModel' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ModelsOperationalHaltStatusModel
