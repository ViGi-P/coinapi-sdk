...
OHLCVTimeSeriesExchangeTimeseriesItem<PSCustomObject>
#>

function Initialize-OHLCVTimeSeriesExchangeTimeseriesItem {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => OHLCVTimeSeriesExchangeTimeseriesItem' | Write-Debug
...
Convert from JSON to OHLCVTimeSeriesExchangeTimeseriesItem<PSCustomObject>
...
OHLCVTimeSeriesExchangeTimeseriesItem<PSCustomObject>
#>
function ConvertFrom-JsonToOHLCVTimeSeriesExchangeTimeseriesItem {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => OHLCVTimeSeriesExchangeTimeseriesItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in OHLCVTimeSeriesExchangeTimeseriesItem
        $AllProperties = ('time_period_start', 'time_period_end', 'time_open', 'time_close', 'price_open', 'price_high', 'price_low', 'price_close', 'volume_traded', 'trades_count', 'symbol_id_exchange')
