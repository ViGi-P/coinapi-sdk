...
OHLCVTimeSeriesTimeseriesItem<PSCustomObject>
#>

function Initialize-OHLCVTimeSeriesTimeseriesItem {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => OHLCVTimeSeriesTimeseriesItem' | Write-Debug
...
Convert from JSON to OHLCVTimeSeriesTimeseriesItem<PSCustomObject>
...
OHLCVTimeSeriesTimeseriesItem<PSCustomObject>
#>
function ConvertFrom-JsonToOHLCVTimeSeriesTimeseriesItem {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => OHLCVTimeSeriesTimeseriesItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in OHLCVTimeSeriesTimeseriesItem
