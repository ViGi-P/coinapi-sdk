...
```powershell
$OHLCVTimeSeriesExchangeTimeseriesItem = Initialize-PSOpenAPIToolsOHLCVTimeSeriesExchangeTimeseriesItem  -TimePeriodStart null `
 -TimePeriodEnd null `
 -TimeOpen null `
 -TimeClose null `
 -PriceOpen null `
...
```powershell
$OHLCVTimeSeriesExchangeTimeseriesItem | ConvertTo-JSON
```
