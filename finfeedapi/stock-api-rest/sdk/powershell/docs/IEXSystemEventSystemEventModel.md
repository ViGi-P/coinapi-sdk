...
```powershell
$IEXSystemEventSystemEventModel = Initialize-PSOpenAPIToolsIEXSystemEventSystemEventModel  -TimestampNanos null `
 -Timestamp null `
 -SystemEvent null `
...
```powershell
$IEXSystemEventSystemEventModel | ConvertTo-JSON
```
