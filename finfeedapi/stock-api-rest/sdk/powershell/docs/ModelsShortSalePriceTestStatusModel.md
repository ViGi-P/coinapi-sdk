...
```powershell
$ModelsShortSalePriceTestStatusModel = Initialize-PSOpenAPIToolsModelsShortSalePriceTestStatusModel  -Symbol null `
 -TimestampNanos null `
 -Timestamp null `
...
```powershell
$ModelsShortSalePriceTestStatusModel | ConvertTo-JSON
```
