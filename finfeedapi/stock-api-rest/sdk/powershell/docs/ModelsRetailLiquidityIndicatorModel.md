...
```powershell
$ModelsRetailLiquidityIndicatorModel = Initialize-PSOpenAPIToolsModelsRetailLiquidityIndicatorModel  -Symbol null `
 -TimestampNanos null `
 -Timestamp null `
...
```powershell
$ModelsRetailLiquidityIndicatorModel | ConvertTo-JSON
```
