...
```powershell
$IEXPriceLevelUpdatePriceLevelUpdateModel = Initialize-PSOpenAPIToolsIEXPriceLevelUpdatePriceLevelUpdateModel  -Symbol null `
 -TimestampNanos null `
 -Timestamp null `
 -IsSideBuy null `
...
```powershell
$IEXPriceLevelUpdatePriceLevelUpdateModel | ConvertTo-JSON
```
